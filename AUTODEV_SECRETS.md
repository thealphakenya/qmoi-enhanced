...
- timestamp: 2026-07-19T22:37:40.529692Z
...
## Autonomous Hosting Manager Secret Environment Setup
- `QMOI_ALERT_EMAIL`: email address for hosted alert notifications.
- `QMOI_SLACK_WEBHOOK`: Slack webhook URL for monitoring alerts.
- `QMOI_EMAIL_PASSWORD`: (optionally) SMTP password for email notifications.
- Use `scripts/auto_host_manager.py --check` and `scripts/domain_health_check.py --check` in secure CI pipelines.
