...
check "[ -f public/q-alpha.html ]" "public/q-alpha.html shell exists"
check "[ -f public/qmoi-ai.html ]" "public/qmoi-ai.html shell exists"
check "[ -f public/qmoi-space.html ]" "public/qmoi-space.html shell exists"
check "[ -f public/qcity-enterprise.html ]" "public/qcity-enterprise.html dashboard shell exists"
check "[ -f public/qcity-complete.html ]" "public/qcity-complete.html dashboard shell exists"
check "[ -f public/qcity-dashboard.html ]" "public/qcity-dashboard.html dashboard shell exists"
