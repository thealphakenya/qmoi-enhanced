...
class LintWatcher {
  constructor() {
    ...
    this.ignoredDirs = ['node_modules', '.git', 'dist', 'build', 'logs', '.next'];
  ...
  shouldIgnoreFile(filePath) {
    ...
    return this.ignoredDirs.some(dir => relativePath.includes(dir)) ||
  ...
  startWatching() {
    ...
    this.log(`Watched extensions: ${this.watchedExtensions.join(', ')}`, 'info');
