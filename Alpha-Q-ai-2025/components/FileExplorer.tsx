  ...
  const [files, setFiles] = useState<FileItem[]>([
    {
      ...
      type: 'folder',
      children: [
        { id: '1-1', name: 'alpha-q-ai-system.tsx', type: 'file', size: '2.1KB', modified: '2024-01-15' },
        { id: '1-2', name: 'Chatbot.tsx', type: 'file', size: '1.8KB', modified: '2024-01-15' },
        { id: '1-3', name: 'FileExplorer.tsx', type: 'file', size: '1.5KB', modified: '2024-01-15' },
        { id: '1-4', name: 'GitStatus.tsx', type: 'file', size: '1.2KB', modified: '2024-01-15' },
        { id: '1-5', name: 'PreviewWindow.tsx', type: 'file', size: '1.7KB', modified: '2024-01-15' },
      ]
    },
    {
      id: '2',
      ...
      {selectedFile && (
        <div className="mt-4 pt-3 border-t border-green-700">
          <div className="text-xs text-gray-400">
            Selected: {files.flatMap(f => f.children || []).find(f => f?.id === selectedFile)?.name || 'Unknown'}
          </div>
        </div>
      )}
            </div>
