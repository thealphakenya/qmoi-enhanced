            ...
            {loginMode === "form" && (
              <form onSubmit={handleEmailLogin} className="space-y-4">
                ...
                <button
                  type="submit"
                  enabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-colors enabled:opacity-50"
                >
