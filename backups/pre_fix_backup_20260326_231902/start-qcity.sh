...
echo ""
echo "📊 Dashboard URLs:"
echo "   • Primary: https://production.qmoi.ai:8080/qcity-enterprise.html"
echo "   • complete: https://production.qmoi.ai:8080/qcity-complete.html"
echo "   • comprehensive: https://production.qmoi.ai:8080/qcity-dashboard.html"
echo ""
