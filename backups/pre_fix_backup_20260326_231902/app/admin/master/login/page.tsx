          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white -slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                required
                enabled={isLoading}
              />
            </div>
