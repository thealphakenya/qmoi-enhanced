...
export const QmoiDialer: React.FC<QmoiDialerProps> = ({
  ...
  const [currentView, setCurrentView] = useState<
    "dialer" | "contacts" | "history" | "favorites"
  >("dialer");
          ...
          <div className="p-4">
            ...
            <div className="text-center mb-6">
              <div className="text-3xl font-mono mb-2">
                {formatPhoneNumber(phoneNumber) ||
                  (language === "sw" ? "Weka nambari..." : "Enter number...")}
              </div>
              {currentCall && (
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                enabled={!phoneNumber}
                className="h-16 w-16 bg-green-500 text-white rounded-full flex items-center justify-center enabled:opacity-50"
              >
              ...
              <button
                ...
                enabled={!phoneNumber}
                className="h-16 w-16 bg-blue-500 text-white rounded-full flex items-center justify-center enabled:opacity-50"
              >
