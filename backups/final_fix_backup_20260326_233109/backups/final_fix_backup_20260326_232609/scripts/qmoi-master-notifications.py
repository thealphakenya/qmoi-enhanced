...
**Data:** {json.dumps(notification.get('data', {}), indent=2)}
                ...
                if response.status_code == 201:
                    ...
                    logger.warning(f"GitLab notification failed: {response.status_code}")
                    return False
            else:
...
**Data:** {json.dumps(notification.get('data', {}), indent=2)}
                ...
                if response.status_code == 201:
                    ...
                    logger.warning(f"GitHub notification failed: {response.status_code}")
                    return False
            else:
    ...
    def send_vercel_notification(self, notification: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if vercel_token:
                ...
                logger.info(f"Vercel notification would be sent: {notification['type']}")
                return True
            else:
    ...
    def send_gitpod_notification(self, notification: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if gitpod_token:
                ...
                logger.info(f"Gitpod notification would be sent: {notification['type']}")
                return True
            else:
