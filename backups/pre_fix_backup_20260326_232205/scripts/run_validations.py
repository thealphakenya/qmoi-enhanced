...
"""
    run_placeholder_scanner function
    """
def run_placeholder_scanner(root: Path, out: Path, apply: bool = False) -> Any:
...
def main() -> Any:
    ...
    logger.info(' -', root / 'docs' / 'placeholders_report.json')
...
"""
    run_placeholder_scan function
    """
def run_placeholder_scan(apply=False) -> Any:
    if not PLACEHOLDER_SCRIPT.exists():
        logger.info('implementation script not found:', PLACEHOLDER_SCRIPT)
        return
