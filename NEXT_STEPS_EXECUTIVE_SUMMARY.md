...
- [ ] Draft-release workflow tested and working
...
- **Daily**: 00:00 UTC — Sync to draft release (no manual action needed)
...
- ✅ Draft releases created successfully
...
├── scripts/
│   ├── sync_to_draft_release.py             ← Draft release script
