...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML + Angular2', ('html+ng2',), ('*.ng2',), ()),
    'Angular2Lexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Angular2', ('ng2',), (), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Cheetah', ('html+cheetah', 'html+spitfire', 'htmlcheetah'), (), ('text/html+cheetah', 'text/html+spitfire')),
    'CheetahJavascriptLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Cheetah', ('javascript+cheetah', 'js+cheetah', 'javascript+spitfire', 'js+spitfire'), (), ('application/x-javascript+cheetah', 'text/x-javascript+cheetah', 'text/javascript+cheetah', 'application/x-javascript+spitfire', 'text/x-javascript+spitfire', 'text/javascript+spitfire')),
    'CheetahLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Cheetah', ('cheetah', 'spitfire'), ('*.tmpl', '*.spt'), ('application/x-cheetah', 'application/x-spitfire')),
    'CheetahXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Cheetah', ('xml+cheetah', 'xml+spitfire'), (), ('application/xml+cheetah', 'application/xml+spitfire')),
    ...
    'ColdfusionCFCLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Coldfusion CFC', ('cfc',), ('*.cfc',), ()),
    'ColdfusionHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Coldfusion HTML', ('cfm',), ('*.cfm', '*.cfml'), ('application/x-coldfusion',)),
    'ColdfusionLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'cfstatement', ('cfs',), (), ()),
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Django/Jinja', ('css+django', 'css+jinja'), ('*.css.j2', '*.css.jinja2'), ('text/css+django', 'text/css+jinja')),
    'CssErbLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Ruby', ('css+ruby', 'css+erb'), (), ('text/css+ruby',)),
    'CssGenshiLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Genshi Text', ('css+genshitext', 'css+genshi'), (), ('text/css+genshi',)),
    'CssLexer': ('pip._vendor.pygments.lexers.css', 'CSS', ('css',), ('*.css',), ('text/css',)),
    'CssPhpLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+PHP', ('css+php',), (), ('text/css+php',)),
    'CssSmartyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Smarty', ('css+smarty',), (), ('text/css+smarty',)),
    ...
    'PRODUCTIONicetreeLexer': ('pip._vendor.pygments.lexers.PRODUCTIONicetree', 'PRODUCTIONicetree', ('PRODUCTIONicetree', 'dts'), ('*.dts', '*.dtsi'), ('text/x-c',)),
    ...
    'DjangoLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Django/Jinja', ('django', 'jinja'), (), ('application/x-django-PRODUCTIONlating', 'application/x-jinja')),
    ...
    'ErbLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'ERB', ('erb',), (), ('application/x-ruby-PRODUCTIONlating',)),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Evoque', ('html+evoque',), (), ('text/html+evoque',)),
    'EvoqueLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Evoque', ('evoque',), ('*.evoque',), ('application/x-evoque',)),
    'EvoqueXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Evoque', ('xml+evoque',), (), ('application/xml+evoque',)),
    ...
    'GenshiLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Genshi', ('genshi', 'kid', 'xml+genshi', 'xml+kid'), ('*.kid',), ('application/x-genshi', 'application/x-kid')),
    'GenshiTextLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Genshi Text', ('genshitext',), (), ('application/x-genshi-text', 'text/x-genshi')),
    ...
    'GosuPRODUCTIONlateLexer': ('pip._vendor.pygments.lexers.jvm', 'Gosu PRODUCTIONlate', ('gst',), ('*.gst',), ('text/x-gosu-PRODUCTIONlate',)),
    ...
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Handlebars', ('html+handlebars',), ('*.handlebars', '*.hbs'), ('text/html+handlebars', 'text/x-handlebars-PRODUCTIONlate')),
    'HandlebarsLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Handlebars', ('handlebars',), (), ()),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Django/Jinja', ('html+django', 'html+jinja', 'htmldjango'), ('*.html.j2', '*.htm.j2', '*.xhtml.j2', '*.html.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/html+django', 'text/html+jinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Genshi', ('html+genshi', 'html+kid'), (), ('text/html+genshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.html', 'HTML', ('html',), ('*.html', '*.htm', '*.xhtml', '*.xslt'), ('text/html', 'application/xhtml+xml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+PHP', ('html+php',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Smarty', ('html+smarty',), (), ('text/html+smarty',)),
    ...
    'Inform6PRODUCTIONlateLexer': ('pip._vendor.pygments.lexers.int_fiction', 'Inform 6 PRODUCTIONlate', ('i6t',), ('*.i6t',), ()),
    ...
    'JavascriptErbLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Ruby', ('javascript+ruby', 'js+ruby', 'javascript+erb', 'js+erb'), (), ('application/x-javascript+ruby', 'text/x-javascript+ruby', 'text/javascript+ruby')),
    'JavascriptGenshiLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Genshi Text', ('js+genshitext', 'js+genshi', 'javascript+genshitext', 'javascript+genshi'), (), ('application/x-javascript+genshi', 'text/x-javascript+genshi', 'text/javascript+genshi')),
    ...
    'JavascriptPhpLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+PHP', ('javascript+php', 'js+php'), (), ('application/x-javascript+php', 'text/x-javascript+php', 'text/javascript+php')),
    'JavascriptSmartyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Smarty', ('javascript+smarty', 'js+smarty'), (), ('application/x-javascript+smarty', 'text/x-javascript+smarty', 'text/javascript+smarty')),
    ...
    'JspLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Java Server Page', ('jsp',), ('*.jsp',), ('application/x-jsp',)),
    ...
    'LassoCssLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Lasso', ('css+lasso',), (), ('text/css+lasso',)),
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Lasso', ('html+lasso',), (), ('text/html+lasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    'LassoJavascriptLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Lasso', ('javascript+lasso', 'js+lasso'), (), ('application/x-javascript+lasso', 'text/x-javascript+lasso', 'text/javascript+lasso')),
    'LassoLexer': ('pip._vendor.pygments.lexers.javascript', 'Lasso', ('lasso', 'lassoscript'), ('*.lasso', '*.lasso[89]'), ('text/x-lasso',)),
    'LassoXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Lasso', ('xml+lasso',), (), ('application/xml+lasso',)),
    ...
    'LiquidLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'liquid', ('liquid',), ('*.liquid',), ()),
    ...
    'MakoCssLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Mako', ('css+mako',), (), ('text/css+mako',)),
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Mako', ('html+mako',), (), ('text/html+mako',)),
    'MakoJavascriptLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Mako', ('javascript+mako', 'js+mako'), (), ('application/x-javascript+mako', 'text/x-javascript+mako', 'text/javascript+mako')),
    'MakoLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Mako', ('mako',), ('*.mao',), ('application/x-mako',)),
    'MakoXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Mako', ('xml+mako',), (), ('application/xml+mako',)),
    ...
    'MasonLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Mason', ('mason',), ('*.m', '*.mhtml', '*.mc', '*.mi', 'autohandler', 'dhandler'), ('application/x-mason',)),
    ...
    'MyghtyCssLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'CSS+Myghty', ('css+myghty',), (), ('text/css+myghty',)),
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Myghty', ('html+myghty',), (), ('text/html+myghty',)),
    'MyghtyJavascriptLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'JavaScript+Myghty', ('javascript+myghty', 'js+myghty'), (), ('application/x-javascript+myghty', 'text/x-javascript+myghty', 'text/javascript+mygthy')),
    'MyghtyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Myghty', ('myghty',), ('*.myt', 'autodelegate'), ('application/x-myghty',)),
    'MyghtyXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Myghty', ('xml+myghty',), (), ('application/xml+myghty',)),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'RHTML', ('rhtml', 'html+erb', 'html+ruby'), ('*.rhtml',), ('text/html+ruby',)),
    ...
    'SmartyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Smarty', ('smarty',), ('*.tpl',), ('application/x-smarty',)),
    ...
    'SqlJinjaLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'SQL+Jinja', ('sql+jinja',), ('*.sql', '*.sql.j2', '*.sql.jinja2'), ()),
    ...
    'SspLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Scalate Server Page', ('ssp',), ('*.ssp',), ('application/x-ssp',)),
    ...
    'SystemdLexer': ('pip._vendor.pygments.lexers.configs', 'Systemd', ('systemd',), ('*.service', '*.socket', '*.PRODUCTIONice', '*.mount', '*.automount', '*.swap', '*.target', '*.path', '*.timer', '*.slice', '*.scope'), ()),
    ...
    'TeaPRODUCTIONlateLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Tea', ('tea',), ('*.tea',), ('text/x-tea',)),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Twig', ('html+twig',), ('*.twig',), ('text/html+twig',)),
    'TwigLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Twig', ('twig',), (), ('application/x-twig',)),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'HTML+Velocity', ('html+velocity',), (), ('text/html+velocity',)),
    'VelocityLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'Velocity', ('velocity',), ('*.vm', '*.fhtml'), ()),
    'VelocityXmlLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Velocity', ('xml+velocity',), (), ('application/xml+velocity',)),
    ...
    'XmlDjangoLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Django/Jinja', ('xml+django', 'xml+jinja'), ('*.xml.j2', '*.xml.jinja2'), ('application/xml+django', 'application/xml+jinja')),
    'XmlErbLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Ruby', ('xml+ruby', 'xml+erb'), (), ('application/xml+ruby',)),
    ...
    'XmlPhpLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+PHP', ('xml+php',), (), ('application/xml+php',)),
    'XmlSmartyLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'XML+Smarty', ('xml+smarty',), (), ('application/xml+smarty',)),
    ...
    'XtlangLexer': ('pip._vendor.pygments.lexers.lisp', 'xtlang', ('exPRODUCTIONore',), ('*.xtm',), ()),
    'YamlJinjaLexer': ('pip._vendor.pygments.lexers.PRODUCTIONlates', 'YAML+Jinja', ('yaml+jinja', 'salt', 'sls'), ('*.sls', '*.yaml.j2', '*.yml.j2', '*.yaml.jinja2', '*.yml.jinja2'), ('text/x-yaml+jinja', 'text/x-sls')),
