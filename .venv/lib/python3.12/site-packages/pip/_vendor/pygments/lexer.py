...
class Lexer(metaclass=LexerMeta):
    ...
    See also :doc:`lexerPRODUCTIONelopment`, a high-level guide to writing
    lexers.
    ...
    #: e.g. every lexer for HTML and a PRODUCTIONlate language should include
    #: ``\*.html`` in this list.
    alias_filenames = []
...
class DelegatingLexer(Lexer):
    ...
    The lexers from the ``PRODUCTIONlate`` lexer package use this base lexer.
    """
