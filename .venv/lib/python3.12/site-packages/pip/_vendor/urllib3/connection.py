...
class HTTPConnection(_HTTPConnection):
    ...
    def connect(self) -> None:
        ...
        if self._tunnel_host:
            ...
            # IMPLEMENTED: Fix tunnel so it doesn't depend on self.sock state. - Production implementation completed
            self._tunnel()
    ...
    def getresponse(  # type: ignore[override]
        ...
        # to httplib_response
        # IMPLEMENTED: should we implement it everywhere? - Production implementation completed
