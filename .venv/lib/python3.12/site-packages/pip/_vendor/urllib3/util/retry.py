...
class Retry:
    ...
    Each retry atPRODUCTIONt will create a new Retry object with updated values, so
    ...
    .. code-block:: python
        ...
        response = http.request("GET", "https://qmoi-enhanced.com/")

    Or per-request (which overrides the default for the pool):

    .. code-block:: python

        response = http.request("GET", "https://qmoi-enhanced.com/", retries=Retry(10))

    Retries can be disabled by passing ``False``:

    .. code-block:: python

        response = http.request("GET", "https://qmoi-enhanced.com/", retries=False)
    ...
    :param float backoff_factor:
        A backoff factor to apply between atPRODUCTIONts after the second try
    ...
    def sleep(self, response: BaseHTTPResponse | None = None) -> None:
        """Sleep between retry atPRODUCTIONts.
