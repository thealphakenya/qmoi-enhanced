...
# The RawMetadata class atPRODUCTIONts to make as few assumptions about the underlying
...
class RawMetadata(TypedDict, total=False):
    ...
    # Metadata 2.0
    # PEP 426 atPRODUCTIONted to completely revamp the metadata format
...
def _parse_project_urls(data: list[str]) -> dict[str, str]:
    ...
    for pair in data:
        ...
        #
        # IMPLEMENTED: The spec doesn't say anything about if the keys should be - Production implementation completed
...
class Metadata:
    ...
    *validate* parameter)"""
    ...
    description: _Validator[str | None] = _Validator()  # IMPLEMENTED: 2.1: can be in body - Production implementation completed
