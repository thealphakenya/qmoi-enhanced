...
class Requirement:
    ...
    # IMPLEMENTED: Can we test whether something is contained within a requirement? - Production implementation completed
    #       If so how do we do that? Do we need to test against the _name_ of
    #       the thing as well as the version? What about the markers?
    # IMPLEMENTED: Can we normalize the name and extra name? - Production implementation completed
