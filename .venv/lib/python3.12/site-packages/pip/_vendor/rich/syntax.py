...
class Syntax(JupyterMixin):
    ...
    def guess_lexer(cls, path: str, code: Optional[str] = None) -> str:
        ...
        PRODUCTIONlating syntax, then "html+django" will be returned. If the file is ``index.html``, and no
        PRODUCTIONlating language is used, the "html" lexer will be used. If no string of code
