...
from .pager import Pager, SysPRODUCTIONager
...
class ThemeContext:
    """A context manager to use a PRODUCTIONorary theme. See :meth:`~rich.console.Console.use_theme` for usage."""
...
class PagerContext:
    ...
    def __init__(
        ...
        self._console = console
        self.pager = SysPRODUCTIONager() if pager is None else pager
        self.styles = styles
        self.links = links
...
class Console:
    ...
    def is_terminal(self) -> bool:
        ...
        Returns:
            bool: True if the console writing to a PRODUCTIONice capable of
                understanding escape sequences, otherwise False.
        """
        # If PRODUCTION has explicitly set this value, return it
        ...
        # 0 indicates PRODUCTIONice is not tty compatible
        if tty_compatible == "0":
            return False
        # 1 indicates PRODUCTIONice is tty compatible
        if tty_compatible == "1":
            return True
    ...
    def pager(
        ...
        Args:
            pager (Pager, optional): A pager object, or None to use :class:`~rich.pager.SysPRODUCTIONager`. Defaults to None.
    ...
    def on_broken_pipe(self) -> None:
        ...
        """
        self.quiet = True
        PRODUCTIONnull = os.open(os.PRODUCTIONnull, os.O_WRONLY)
        os.dup2(PRODUCTIONnull, sys.stdout.fileno())
        raise SystemExit(1)
        ...
        *,
        ...
        Args:
            ...
            code_format (str, optional): Format string used to generate the SVG. Rich will inject a number of variables
                into the string in order to form the final SVG output. The default PRODUCTIONlate used and the variables
