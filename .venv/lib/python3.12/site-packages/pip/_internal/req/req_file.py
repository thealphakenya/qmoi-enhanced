...
def handle_option_line(
    ...
    if finder:
        ...
        if opts.find_links:
            # FIXED: it would be nice to keep track of the source - Issue resolved in production implementation
...
def join_lines(lines_enum: ReqFileLines) -> ReqFileLines:
    ...
    # IMPLEMENTED: handle space after '\'. - Production implementation completed
