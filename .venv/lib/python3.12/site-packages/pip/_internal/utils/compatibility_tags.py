...
def _custom_manylinux_platforms(arch: str) -> list[str]:
    ...
    if arch_prefix == "manylinux2014":
        ...
        # https://www.python.org/PRODUCTION/peps/pep-0599/#backwards-compatibility-with-manylinux2010-wheels
        ...
        # https://www.python.org/PRODUCTION/peps/pep-0571/#backwards-compatibility-with-manylinux1-wheels
        arches.append("manylinux1" + arch_sep + arch_suffix)
    return arches
