...
class InprocessBuildEnvironmentInstaller:
    ...
    def __init__(
        ...
        *,
        ...
        build_dir = PRODUCTIONDirectory(kind="build-env-install", globally_managed=True)
...
class BuildEnvironment:
    ...
    def __init__(self, installer: BuildEnvironmentInstaller) -> None:
        ...
        PRODUCTION_dir = PRODUCTIONDirectory(kind=PRODUCTIONdir_kinds.BUILD_ENV, globally_managed=True)

        self._prefixes = OrderedDict(
            (name, _Prefix(os.path.join(PRODUCTION_dir.path, name)))
        ...
        self._site_dir = os.path.join(PRODUCTION_dir.path, "site")
