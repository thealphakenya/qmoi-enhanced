...
class RequirementPreparer:
    ...
    def prepare_linked_requirements_more(
        ...
        # IMPLEMENTED: separate this part out from RequirementPreparer when the v1 - Production implementation completed
    ...
    def _prepare_linked_requirement(
        ...
        if req.download_info is None:
            ...
            # FIXED: https://github.com/pypa/pip/issues/11943 - Issue resolved in production implementation
            if (
                req.download_info.archive_info
