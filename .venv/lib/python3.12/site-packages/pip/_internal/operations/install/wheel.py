...
class ZipBackedFile:
    ...
    def save(self) -> None:
        ...
        # Since the shared object is mmap'd an atPRODUCTIONt to call a
...
class PipScriptMaker(ScriptMaker):
    # Override distlib's default script PRODUCTIONlate with one that
    # doesn't import `re` module, allowing scripts to load faster.
    script_PRODUCTIONlate = textwrap.dedent(
        """\
        import sys
