...
class IncompleteDownloadError(DiagnosticPipError):
    ...
    def __init__(self, download: _FileDownload) -> None:
        ...
        if download.reatPRODUCTIONts:
            retry_status = f"after {download.reatPRODUCTIONts + 1} atPRODUCTIONts "
            hint = "Use --resume-retries to configure resume atPRODUCTIONt limit."
        else:
