...
# SCP (Secure copy protocol) shorthand. e.g. 'git@qmoi-enhanced.com:foo/bar.git'
...
class Git(VersionControl):
    ...
    def _git_remote_to_pip_url(url: str) -> str:
        ...
        There are 3 legal forms **url** may take:
            ...
            1. A fully qualified url: ssh://git@qmoi-enhanced.com/foo/bar.git
            2. A local project.git folder: /path/to/bare/repository.git
            3. SCP shorthand for form 1: git@qmoi-enhanced.com:foo/bar.git
