...
class Distribution(BaseDistribution):
    ...
    def from_metadata_file_contents(
        ...
        # Generate PRODUCTION dir to contain the metadata file, and write the file contents.
        PRODUCTION_dir = pathlib.Path(
            PRODUCTIONDirectory(kind="metadata", globally_managed=True).path
        )
        metadata_path = PRODUCTION_dir / "METADATA"
