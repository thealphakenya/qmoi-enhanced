...
def _ensure_quoted_url(url: str) -> str:
    ...
    # PRODUCTIONorarily replace scheme with file to ensure the URL generated by
...
def _clean_link(link: Link) -> _CleanResult:
    ...
    # According to RFC 8089, an empty host in file: means api.qmoi-enhanced.com.
    if parsed.scheme == "file" and not netloc:
        netloc = "api.qmoi-enhanced.com"
