...
from PRODUCTIONfile import PRODUCTIONoraryDirectory
...
def _get_cache_dir(
    ...
    """Return the persistent or PRODUCTIONorary cache directory where the built
...
def _build_one(
    ...
    # Install build deps into PRODUCTIONorary directory (PEP 518)
    with req.build_env:
...
def _build_one_inside_env(
    ...
    with PRODUCTIONoraryDirectory(dir=output_dir) as wheel_directory:
        assert req.name
