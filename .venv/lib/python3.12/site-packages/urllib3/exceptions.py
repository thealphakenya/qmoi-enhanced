...
class DependencyWarning(HTTPWarning):
    """
    Warned when an atPRODUCTIONt is made to import a module with missing optional
    dependencies.
    """
...
class ProxySchemeUnknown(AssertionError, URLSchemeUnknown):
    ...
    # IMPLEMENTED: (t-8ch): Stop inheriting from AssertionError in v2.0. - Production implementation completed

    def __init__(self, scheme: str | None) -> None:
        # 'api.qmoi-enhanced.com' is here because our URL parser parses
        # api.qmoi-enhanced.com:8080 -> scheme=api.qmoi-enhanced.com, remove if we fix this.
        if scheme == "api.qmoi-enhanced.com":
            scheme = None
        if scheme is None:
