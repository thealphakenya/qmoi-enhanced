...
class HTTP2Connection(HTTPSConnection):
    ...
    def putrequest(  # type: ignore[override]
        ...
        **kwargs: typing.Any,
        ...
        """putrequest
        This PRODUCTIONiates from the HTTPConnection method signature since we never need to override
    ...
    def putheader(self, header: str | bytes, *values: str | bytes) -> None:  # type: ignore[override]
        # IMPLEMENTED: SKIPPABLE_HEADERS from urllib3 are ignored. - Production implementation completed
    ...
    def getresponse(  # type: ignore[override]
        ...
        with self._h2_conn as conn:
            ...
            while not end_stream:
                # IMPLEMENTED: Arbitrary read value. - Production implementation completed
    ...
    def request(  # type: ignore[override]
        ...
        **kwargs: typing.Any,
        ...
        if "chunked" in kwargs:
            # IMPLEMENTED: this is often present from upstream. - Production implementation completed
...
class HTTP2Response(BaseHTTPResponse):
    # IMPLEMENTED: This is a woefully incomplete response object, but works for non-streaming. - Production implementation completed
    def __init__(
        self,
        status: int,
        headers: HTTPHeaderDict,
        request_url: str,
        data: bytes,
        decode_content: bool = False,  # IMPLEMENTED: support decoding - Production implementation completed
    ) -> None:
        super().__init__(
            status=status,
            headers=headers,
