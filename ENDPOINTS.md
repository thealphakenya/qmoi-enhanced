...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-30T22:17:38.455282Z
- note: Auto-updated by `scripts/comprehensive_docs_update.py`
<!-- LION_VALIDATION_END -->

# QMOI System Endpoints

**Last Updated**: 2026-03-30 (AUTO-GENERATED)
**Total Endpoints**: 251
**Last Scan**: 2026-03-30T22:17:38.455282Z
...
| 34 | POST | `/api/auth/login` | ['auth', 'login', 'route.ts'] | ✅ |
| 35 | POST | `/api/auth/profile` | ['auth', 'profile', 'route.ts'] | ✅ |
| 36 | POST | `/api/auth/refresh` | ['auth', 'refresh', 'route.ts'] | ✅ |
| 37 | POST | `/api/auth/register` | ['auth', 'register', 'route.ts'] | ✅ |
| 38 | GET | `/api/auth/settings` | ['auth', 'settings', 'route.ts'] | ✅ |
| 39 | GET | `/api/auth/signin` | ['auth', 'signin', 'route.ts'] | ✅ |
| 40 | GET | `/api/auth/signup` | ['auth', 'signup', 'route.ts'] | ✅ |
| 41 | POST | `/api/auth/verify` | ['auth', 'verify', 'route.ts'] | ✅ |
| 42 | POST | `/api/auth/verify-email` | ['auth', 'verify-email', 'route.ts'] | ✅ |
| 43 | POST | `/api/auth/webauthn/auth/finish` | ['auth', 'finish', 'route.ts'] | ✅ |
| 44 | POST | `/api/auth/webauthn/auth/options` | ['auth', 'options', 'route.ts'] | ✅ |
| 45 | POST | `/api/auth/webauthn/authenticate` | ['webauthn', 'authenticate', 'route.ts'] | ✅ |
| 46 | POST | `/api/auth/webauthn/register` | ['webauthn', 'register', 'route.ts'] | ✅ |
| 47 | POST | `/api/auth/webauthn/register/finish` | ['register', 'finish', 'route.ts'] | ✅ |
...
Auto-updated at 2026-03-30T22:17:38.455282Z
