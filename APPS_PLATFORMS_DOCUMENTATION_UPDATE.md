...
- Known issues (specifically the Windows executable TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) status)
...
- **`QMOI_APPS_AND_PLATFORMS_INVENTORY_CORRECTED.md`** (updated master inventory)
  ...
  - ⚠️ Dedicated section on Windows `qmoi_ai.exe` TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) status with build instructions
...
- Added note clarifying TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) status
...
- Added detailed note about TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) stub
...
**Before:** Users saw download links that appeared valid but led to a 169-byte TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) stub.
...
- Direct link to `QMOI_APPS_AND_PLATFORMS_INVENTORY.md#-qmoi_aiexe-status` provides:
  - Clear explanation that it's a TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md)
...
- ⚠️ **TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md)/Needs Build:** Windows (qmoi_ai.exe)
...
- ✅ Prominent warning about Windows TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md)
...
|-------|--------|---------|
| Windows qmoi_ai.exe is TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) | ✅ **DOCUMENTED** | Clear warning and build instructions added to inventory |
...
| README doesn't mention TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) | ✅ **FIXED** | Windows link now shows ⚠️ and links to troubleshooting |
...
The QMOI apps and platforms documentation is now centralized, consistent, and user-friendly. All key documentation files reference the authoritative inventory, ensuring users get accurate information about what's available, how to download it, and how to install it—with clear warnings about known issues like the Windows TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) executable.
