  ...
  async validateConfiguration() {
    try {
      ...
      if (revenue.mpesa.target < 10000 || revenue.airtel.target < 10000) {
        console.warn('⚠️  Warning: Daily targets are below recommended minimum of 10,000 KES');
      }

      if (revenue.mpesa.autoTransfer < 2000 || revenue.airtel.autoTransfer < 2000) {
        console.warn('⚠️  Warning: Auto-transfer amounts are below recommended minimum of 2,000 KES');
      }
