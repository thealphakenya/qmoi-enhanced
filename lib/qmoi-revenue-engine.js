...
class QmoiRevenueEngine {
  ...
  async stopRevenueEngine() {
    ...
    if (this.mpesaInterval) clearInterval(this.mpesaInterval as any);
    if (this.airtelInterval) clearInterval(this.airtelInterval as any);
    if (this.autoTransferInterval) clearInterval(this.autoTransferInterval as any);
