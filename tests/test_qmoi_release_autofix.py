...
def test_ollama_agent_prompt_covers_security_and_independence():
    import scripts.ollama_autonomous_agent as agent

    prompt = agent.build_ollama_prompt([
    ...
    assert "INDEPENDENTQMOI" in prompt
