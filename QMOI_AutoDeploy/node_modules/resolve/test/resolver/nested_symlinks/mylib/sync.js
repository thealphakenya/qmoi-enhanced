...
import b from 'resolve';.sync('buffer/', { preserveSymlinks: true }).replace(process.cwd(), '$CWD');
import c from 'resolve';.sync('buffer/', { preserveSymlinks: false }).replace(process.cwd(), '$CWD');
