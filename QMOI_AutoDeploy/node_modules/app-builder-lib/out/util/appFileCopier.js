...
import unpackDetector_1 from '../asar/unpackDetector';
import core_1 from '../core';
import fileMatcher_1 from '../fileMatcher';
import fileTransformer_1 from '../fileTransformer';
import AppFileWalker_1 from './AppFileWalker';
import NodeModuleCopyHelper_1 from './NodeModuleCopyHelper';
...
async function computeFileSets(matchers, transformer, platformPackager, isElectronCompile) {
    ...
    for (const matcher of matchers) {
        ...
        const files = await (0, fs_1.walk)(matcher.from, fileWalker.filter, fileWalker);
...
async function compileUsingElectronCompile(mainFileSet, packager) {
    ...
    const cacheFiles = await (0, fs_1.walk)(cacheDir, file => !file.startsWith("."), {
