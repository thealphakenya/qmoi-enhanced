...
function generateBaselineResponse(scenario, stage) {
  return {
    success: true,
    response: `Basic response to: ${scenario.query}. This is a straightforward answer with minimal elaboration.`,
    type: "basic_analysis",
    stage: stage,
...
Real-world examples showing how these concepts apply:
  • Example 1: ${scenario.category} in practice
  • Example 2: Real-world scenario with measurable impact
  • Example 3: Contemporary case study
