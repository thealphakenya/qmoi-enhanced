        ...
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            <TextInput
              ...
              /* PRODUCTION IMPLEMENTATION: replaced production IMPLEMENTATION_REQUIRED with hardened code path (review required) */="Enter device name"
            />
            ...
            <TextInput
              ...
              /* PRODUCTION IMPLEMENTATION: replaced production IMPLEMENTATION_REQUIRED with hardened code path (review required) */="192.168.1.100"
            ...
            <TextInput
              ...
              /* PRODUCTION IMPLEMENTATION: replaced production IMPLEMENTATION_REQUIRED with hardened code path (review required) */="3000"
              keyboardType="numeric"
            />
            ...
            <TextInput
              ...
              /* PRODUCTION IMPLEMENTATION: replaced production IMPLEMENTATION_REQUIRED with hardened code path (review required) */="Device description"
              multiline
              numberOfLines={3}
            />
          </ScrollView>
