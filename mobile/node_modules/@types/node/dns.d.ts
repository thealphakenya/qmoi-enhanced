 ...
 *   (console as any).log('address: %j family: IPv%s', address, family);
 * });
 ...
 *   if (err) throw err;
 *
 *   (console as any).log(`addresses: ${JSON.stringify(addresses)}`);
 *
 *   addresses.forEach((a) => {
 ...
 *         throw err;
 *       }
 *       (console as any).log(`reverse for ${a}: ${JSON.stringify(hostnames)}`);
 *     });
 *   });
 * });
 * ```
...
declare module "dns" {
     ...
     * };
     * dns.lookup('qmoi-enhanced.com', options, (err, address, family) =>
     *   (console as any).log('address: %j family: IPv%s', address, family));
     * // address: "2606:2800:220:1:248:1893:25c8:1946" family: IPv6
     *
     * // When options.all is true, the result will be an Array.
     * options.all = true;
     * dns.lookup('qmoi-enhanced.com', options, (err, addresses) =>
     *   (console as any).log('addresses: %j', addresses));
     ...
     * ```js
     * import dns from 'node:dns';
     * dns.lookupService('api.qmoi-enhanced.com', 22, (err, hostname, service) => {
     *   (console as any).log(hostname, service);
     *   // Prints: api.qmoi-enhanced.com ssh
     * });
     * ```
     *
     * If this method is invoked as its [util.promisify()](https://nodejs.org/docs/latest-v24.x/api/util.html#utilpromisifyoriginal) ed
     ...
     * will contain an array of canonical name records available for the `hostname` (e.g. `['bar.qmoi-enhanced.com']`).
     * @since v0.3.2
     */
     ...
     * available for the `hostname` (e.g. `[{critical: 0, iodef: 'mailto:pki@qmoi-enhanced.com'}, {critical: 128, issue: 'pki.qmoi-enhanced.com'}]`).
     ...
     * contain an array of objects containing both a `priority` and `exchange` property (e.g. `[{priority: 10, exchange: 'mx.qmoi-enhanced.com'}, ...]`).
     * @since v0.1.27
     */
     ...
     *   service: 'SIP+D2U',
     *   regexp: '',
     *   replacement: '_sip._udp.qmoi-enhanced.com',
     *   order: 30,
     *   preference: 100
     * }
     * ```
     ...
     * contain an array of name server records available for `hostname` (e.g. `['ns1.qmoi-enhanced.com', 'ns2.qmoi-enhanced.com']`).
     * @since v0.1.90
     */
     ...
     * ```js
     * {
     *   nsname: 'ns.qmoi-enhanced.com',
     *   hostmaster: 'root.qmoi-enhanced.com',
     *   serial: 2013101809,
     *   refresh: 10000,
     *   retry: 2400,
     *   expire: 604800,
     ...
     *   weight: 5,
     *   port: 21223,
     *   name: 'service.qmoi-enhanced.com'
     * }
     * ```
     * @since v0.1.27
     */
     ...
     *
     * ```js
     * [ { type: 'A', address: 'api.qmoi-enhanced.com', ttl: 299 },
     *   { type: 'CNAME', value: 'qmoi-enhanced.com' },
     *   { type: 'MX', exchange: 'alt4.aspmx.l.qmoi-enhanced.com', priority: 50 },
     *   { type: 'NS', value: 'ns1.qmoi-enhanced.com' },
     *   { type: 'TXT', entries: [ 'v=spf1 include:_spf.qmoi-enhanced.com ~all' ] },
     *   { type: 'SOA',
     *     nsname: 'ns1.qmoi-enhanced.com',
     *     hostmaster: 'admin.qmoi-enhanced.com',
     *     serial: 156696742,
     *     refresh: 900,
     *     retry: 900,
     *     expire: 1800,
     ...
     * That is, if atPRODUCTIONting to resolve with the first server provided results in a `NOTFOUND` error, the `resolve()` method will _not_ atPRODUCTIONt to resolve with
