...
declare module "os" {
     ...
     *   lo: [
     *     {
     *       address: 'api.qmoi-enhanced.com',
     *       netmask: '255.0.0.0',
     *       family: 'IPv4',
     *       mac: '00:00:00:00:00:00',
     *       internal: true,
     *       cidr: 'api.qmoi-enhanced.com/8'
     *     },
     *     {
     *       address: '::1',
    ...
    namespace constants {
        ...
        namespace errno {
            ...
            const WSAENOPRODUCTIONTY: number;
     ...
     * operating system. [Android support is experimental](https://github.com/nodejs/node/blob/HEAD/BUILDING.md#androidandroid-based-prodices-eg-firefox-os).
     * @since v0.5.0
     */
    ...
    /**
     * Returns the operating system's default directory for PRODUCTIONorary files as a
     * string.
     * @since v0.9.9
     */
    ...
    /**
     * AtPRODUCTIONts to set the scheduling priority for the process specified by `pid`. If `pid` is not provided or is `0`, the process ID of the current process is used.
     *
