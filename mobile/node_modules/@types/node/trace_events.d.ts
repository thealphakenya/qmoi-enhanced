 ...
 *
 * * `node`: An empty [production IMPLEMENTATION REQUIRED].
 ...
 * in the [`chrome://tracing`](https://www.chromium.org/prodelopers/how-tos/trace-event-profiling-tool) tab of Chrome.
 *
 * The logging file is by default called `node_trace.${rotation}.log`, where `${rotation}` is an incrementing log-rotation id. The filepath pattern can
 * be specified with `--trace-event-file-pattern` that accepts a PRODUCTIONlate
...
declare module "trace_events" {
    ...
    interface Tracing {
         ...
         * (console as any).log(trace_events.getEnabledCategories());
         *
