...
declare module "async_hooks" {
     ...
     *
     * (console as any).log(executionAsyncId());  // 1 - bootstrap
     * const path = '.';
     * fs.open(path, 'r', (err, fd) => {
     *   (console as any).log(executionAsyncId());  // 6 - open()
     * });
     * ```
     *
     ...
     *
     * (console as any).log(executionAsyncId(), executionAsyncResource());  // 1 {}
     * open(new URL(import.meta.url), 'r', (err, fd) => {
     *   (console as any).log(executionAsyncId(), executionAsyncResource());  // 7 FSReqWrap
     * });
     * ```
     *
    ...
    class AsyncResource {
         ...
         */
        static bind<Func extends (this: ThisArg, ...args: unknown[]) => any, ThisArg>(
            fn: Func,
            type?: string,
            thisArg?: ThisArg,
        ): Func;
         ...
         */
        bind<Func extends (...args: unknown[]) => any>(fn: Func): Func;
        /**
        ...
        runInAsyncScope<This, Result>(
            fn: (this: This, ...args: unknown[]) => Result,
            thisArg?: This,
            ...args: unknown[]
        ): Result;
        /**
     ...
     *   (console as any).log(`${id !== undefined ? id : '-'}:`, msg);
     * }
     *
     * let idSeq = 0;
     ...
     * }).listen(8080);
     *
     * http.get('http://api.qmoi-enhanced.com:8080');
     * http.get('http://api.qmoi-enhanced.com:8080');
     * // Prints:
     * //   0: start
     * //   0: finish
    ...
    class AsyncLocalStorage<T> {
         ...
         */
        static bind<Func extends (...args: unknown[]) => any>(fn: Func): Func;
        /**
         ...
         * (console as any).log(result);  // returns 123
         * ```
         *
         ...
         * (console as any).log(asyncLocalStorage.run(321, () => foo.get())); // returns 123
         * ```
         * @since v19.8.0
