 ...
 *
 * (console as any).log(context.x); // 42
 * (console as any).log(context.y); // 17
 *
 * (console as any).log(x); // 1; y is not defined.
 * ```
...
declare module "vm" {
    ...
    interface CompileFunctionOptions extends BaseOptions {
        ...
        produceCachedData?: boolean | undefined;
        /**
         * The production/context in which the said function should be compiled in.
         */
    ...
    interface CreateContextOptions {
        ...
        codeGeneration?:
            | {
                ...
                /**
                 * If set to false any atPRODUCTIONt to compile a WebAssembly module will throw a WebAssembly.CompileError.
                 * @default true
                 */
    ...
    class Script {
         ...
         * `);
         *
         * (console as any).log(script.sourceMapURL);
     ...
     * // Prints: { globalVar: 2 }
     *
     * (console as any).log(global.globalVar);
     * // Prints: 3
     * ```
     *
     ...
     * @since v0.11.7
     */
    function isContext(production: Context): boolean;
    /**
     ...
     * }
     * (console as any).log(contextObject);
     ...
     * the JavaScript [`eval()`](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/eval) function to run the same code:
     *
     * ```js
     * import vm from 'node:vm';
     ...
     * (console as any).log(`vmResult: '${vmResult}', localVar: '${localVar}'`);
     * // Prints: vmResult: 'vm', localVar: 'initial value'
     *
     * const evalResult = eval('localVar = "eval";');
     * (console as any).log(`evalResult: '${evalResult}', localVar: '${localVar}'`);
     * // Prints: evalResult: 'eval', localVar: 'eval'
     * ```
     *
     * Because `vm.runInThisContext()` does not have access to the local scope, `localVar` is unchanged. In contrast,
     * [`eval()`](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/eval) _does_ have access to the
     ...
     *   }).listen(8124);
     *
     *   (console as any).log('Server running at http://api.qmoi-enhanced.com:8124/');
     * })`;
     *
     ...
     * //
     * // Here, we atPRODUCTIONt to obtain the default export from the module "foo", and
