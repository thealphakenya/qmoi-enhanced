...
interface Float16Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
    ...
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Float16Array<ArrayBuffer>;
    ...
    map(callbackfn: (value: number, index: number, array: this) => number, thisArg?: unknown): Float16Array<ArrayBuffer>;
    reduce(
