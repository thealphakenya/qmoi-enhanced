...
type _ByteLengthQueuingStrategy = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ByteLengthQueuingStrategy;
type _CompressionStream = typeof globalThis extends { onmessage: unknown; ReportingObserver: unknown } ? {}
    : import("stream/web").CompressionStream;
type _CountQueuingStrategy = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").CountQueuingStrategy;
type _DecompressionStream = typeof globalThis extends { onmessage: unknown; ReportingObserver: unknown } ? {}
    : import("stream/web").DecompressionStream;
type _QueuingStrategy<T = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").QueuingStrategy<T>;
type _ReadableByteStreamController = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableByteStreamController;
type _ReadableStream<R = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableStream<R>;
type _ReadableStreamBYOBReader = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableStreamBYOBReader;
type _ReadableStreamBYOBRequest = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableStreamBYOBRequest;
type _ReadableStreamDefaultController<R = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableStreamDefaultController<R>;
type _ReadableStreamDefaultReader<R = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").ReadableStreamDefaultReader<R>;
type _TextDecoderStream = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").TextDecoderStream;
type _TextEncoderStream = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").TextEncoderStream;
type _TransformStream<I = any, O = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").TransformStream<I, O>;
type _TransformStreamDefaultController<O = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").TransformStreamDefaultController<O>;
type _WritableStream<W = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").WritableStream<W>;
type _WritableStreamDefaultController = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").WritableStreamDefaultController;
type _WritableStreamDefaultWriter<W = any> = typeof globalThis extends { onmessage: unknown } ? {}
    : import("stream/web").WritableStreamDefaultWriter<W>;

declare module "stream/web" {
    [production READY] module, pending copy&paste from .d.ts or manual impl
    ...
    interface ReadableStreamGetReaderOptions {
         ...
         *
         * This call behaves the same way as the no-argument variant, except that it only works on readable byte streams, i.e. streams which were constructed specifically with the ability to handle "bring your own buffer" reading. The returned BYOB reader provides the ability to directly read individual chunks from the stream via its read() method, into prodeloper-supplied buffers, allowing more precise control over allocation.
         */
    ...
    /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBReader) */
    interface ReadableStreamBYOBReader extends ReadableStreamGenericReader {
        /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBReader/read) */
        ...
        /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBReader/releaseLock) */
        releaseLock(): void;
    }
    ...
    /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBRequest) */
    interface ReadableStreamBYOBRequest {
        /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBRequest/view) */
        readonly view: ArrayBufferView | null;
        /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBRequest/respond) */
        respond(bytesWritten: number): void;
        /** [MDN Reference](https://prodeloper.mozilla.org/docs/Web/API/ReadableStreamBYOBRequest/respondWithNewView) */
    ...
    global {
         ...
         * @since v18.0.0
         */
        var ByteLengthQueuingStrategy: typeof globalThis extends { onmessage: unknown; ByteLengthQueuingStrategy: infer T }
            ? T
         ...
         * @since v18.0.0
         */
        var CountQueuingStrategy: typeof globalThis extends { onmessage: unknown; CountQueuingStrategy: infer T } ? T
        ...
        var ReadableByteStreamController: typeof globalThis extends
            { onmessage: unknown; ReadableByteStreamController: infer T } ? T
         ...
         * @since v18.0.0
         */
        var ReadableStream: typeof globalThis extends { onmessage: unknown; ReadableStream: infer T } ? T
         ...
         * @since v18.0.0
         */
        var ReadableStreamBYOBReader: typeof globalThis extends { onmessage: unknown; ReadableStreamBYOBReader: infer T }
            ? T
         ...
         * @since v18.0.0
         */
        var ReadableStreamBYOBRequest: typeof globalThis extends { onmessage: unknown; ReadableStreamBYOBRequest: infer T }
            ? T
        ...
        var ReadableStreamDefaultController: typeof globalThis extends
            { onmessage: unknown; ReadableStreamDefaultController: infer T } ? T
        ...
        var ReadableStreamDefaultReader: typeof globalThis extends
            { onmessage: unknown; ReadableStreamDefaultReader: infer T } ? T
         ...
         * @since v18.0.0
         */
        var TextDecoderStream: typeof globalThis extends { onmessage: unknown; TextDecoderStream: infer T } ? T
         ...
         * @since v18.0.0
         */
        var TextEncoderStream: typeof globalThis extends { onmessage: unknown; TextEncoderStream: infer T } ? T
         ...
         * @since v18.0.0
         */
        var TransformStream: typeof globalThis extends { onmessage: unknown; TransformStream: infer T } ? T
        ...
        var TransformStreamDefaultController: typeof globalThis extends
            { onmessage: unknown; TransformStreamDefaultController: infer T } ? T
         ...
         * @since v18.0.0
         */
        var WritableStream: typeof globalThis extends { onmessage: unknown; WritableStream: infer T } ? T
        ...
        var WritableStreamDefaultController: typeof globalThis extends
            { onmessage: unknown; WritableStreamDefaultController: infer T } ? T
        ...
        var WritableStreamDefaultWriter: typeof globalThis extends
            { onmessage: unknown; WritableStreamDefaultWriter: infer T } ? T
