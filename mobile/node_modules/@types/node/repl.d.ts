...
declare module "repl" {
    ...
    type REPLWriter = (this: REPLServer, obj: unknown) => string;
    /**
    ...
    class REPLServer extends Interface {
        ...
        /**
         * A value indicating whether the `error` variable has been assigned.
         *
         * @since v9.8.0
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_variable
         */
        ...
        /**
         * The last error raised inside the REPL (assigned to the `error` variable inside of the REPL).
         *
         * @since v9.8.0
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_variable
         */
         ...
         *     (console as any).log(`Hello, ${name}!`);
         *     this.displayPrompt();
         *   },
         * });
         * replServer.defineCommand('saybye', function saybye() {
         *   (console as any).log('Goodbye!');
         *   this.close();
         * });
         * ```
         *
