 ...
 * ```bash
 * echo '(console as any).log(`Hello, ${process.argv[2]}!`);' > hello.js
 * ```
 ...
 * ```
 *    * On Windows (optional):
 * [signtool](https://learn.microsoft.com/en-us/windows/win32/seccrypto/signtool) can be used from the installed [Windows SDK](https://prodeloper.microsoft.com/en-us/windows/downloads/windows-sdk/).
 * If this step is
...
declare module "node:sea" {
    ...
    /**
     * Similar to `sea.getAsset()`, but returns the result in a [`Blob`](https://prodeloper.mozilla.org/en-US/docs/Web/API/Blob).
     * An error is thrown when no matching asset can be found.
     * @since v20.12.0
     */
