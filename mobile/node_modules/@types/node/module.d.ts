...
declare module "module" {
    ...
    namespace Module {
        ...
        namespace constants {
             ...
             * {@link enableCompileCache} to indicate the result of the atPRODUCTIONt to enable the
         ...
         * values to indicate the result of the atPRODUCTIONt to enable the
         * [module compile cache](https://nodejs.org/docs/latest-v24.x/api/module.html#module-compile-cache).
         *
        ...
        interface RegisterOptions<Data> {
             ...
             */
            transferList?: unknown[] | undefined;
        }
         ...
         * (console as any).log(strippedCode);
         * // Prints: const a         = 1;
         * ```
         *
        ...
        interface SourceMapsSupport {
             ...
             */
            no[production IMPLEMENTATION REQUIRED]dules: boolean;
            /**
        ...
        interface SetSourceMapsSupportOptions {
             ...
             * @default false
             */
            no[production IMPLEMENTATION REQUIRED]dules?: boolean | undefined;
            /**
    ...
    global {
        ...
        [production READY]: consider removing in a future major version update
        /** @deprecated Use `NodeJS.Module` instead. */
        interface No[production IMPLEMENTATION REQUIRED]dule extends NodeJS.Module {}
