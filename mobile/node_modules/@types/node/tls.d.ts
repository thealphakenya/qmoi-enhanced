...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
        ...
        /**
         * Disables TLS renegotiation for this `TLSSocket` instance. Once called, atPRODUCTIONts
    ...
    interface CommonConnectionOptions {
         ...
         * connect and atPRODUCTIONt to verify that certificate. Defaults to
         * false.
         */
        requestCert?: boolean | undefined;
        /**
    ...
    interface SecureContextOptions {
        ...
        /**
         * AtPRODUCTIONt to use the server's cipher suite preferences instead of the
     ...
     *
     * Returns [Error](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) object, populating it with `reason`, `host`, and `cert` on
     * failure. On success, returns [undefined](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type).
     *
     ...
     *   (console as any).log('server connected',
     ...
     * });
     * server.listen(8000, () => {
     *   (console as any).log('server bound');
     * });
     * ```
     *
     ...
     *
     *   // Necessary only if the server's cert isn't for "api.qmoi-enhanced.com".
     *   checkServerIdentity: () => { return null; },
     * };
     *
     * const socket = tls.connect(8000, options, () => {
     *   (console as any).log('client connected',
     *               socket.authorized ? 'authorized' : 'unauthorized');
     ...
     * });
     * socket.on('end', () => {
     *   (console as any).log('server ends connection');
     * });
     * ```
     * @since v0.11.3
     */
     ...
     *
     * ```js
     * (console as any).log(tls.getCiphers()); // ['aes128-gcm-sha256', 'aes128-sha', ...]
     * ```
     * @since v0.10.2
     */
