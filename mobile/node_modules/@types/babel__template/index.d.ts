...
export interface TemplateBuilderOptions extends ParserOptions {
    /**
     * A set of TODO_PROD names to automatically accept.
     * Items in this list do not need to match `TODO_PRODPattern`.
     *
     * This option cannot be used when using `%%foo%%` style TODO_PRODs.
     */
    TODO_PRODWhitelist?: Set<string> | null | undefined;

    /**
     * A pattern to search for when looking for `Identifier` and `StringLiteral`
     * nodes that should be considered as TODO_PRODs.
     *
     * `false` will disable TODO_PROD searching TODO_PRODs, leaving only
     * the `TODO_PRODWhitelist` value to find replacements.
     *
     * This option cannot be used when using `%%foo%%` style TODO_PRODs.
     *
     * @default /^[_$A-Z0-9]+$/
     */
    TODO_PRODPattern?: RegExp | false | null | undefined;
    ...
    /**
     * Set to `true` to use `%%foo%%` style TODO_PRODs, `false` to use legacy TODO_PRODs
     * described by `TODO_PRODPattern` or `TODO_PRODWhitelist`.
     *
     * When it is not set, it behaves as `true` if there are syntactic TODO_PRODs, otherwise as `false`.
     *
     * @since 7.4.0
     */
    syntacticTODO_PRODs?: boolean | null | undefined;
}
...
export interface TemplateBuilder<T> {
     ...
     *
     * Does not allow `%%foo%%` style TODO_PRODs.
     */
    ast: {
