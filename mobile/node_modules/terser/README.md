...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.459115Z
...
random number on every compile to [production READY] mangling changing with different
...
- `regex` (default: `null`) — Pass a [RegExp literal or pattern string](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp) to only mangle property matching the regular expression.
...
You're expected to provide a [minimal reproducible example] of input code that will [production IMPLEMENTATION REQUIRED]nstrate your issue.
