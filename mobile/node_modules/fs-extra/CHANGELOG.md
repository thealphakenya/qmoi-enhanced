...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.374305Z
...
After five years of production, we finally have reach the 1.0.0 milestone! Big thanks goes
...
0.26.3 / 2015-12-17
-------------------
- fixed `copy()` hangup in copying blockprodice / characterprodice / `/prod/null`. See: [#193][#193]
...
0.23.1 / 2015-08-07
-------------------
- Better handling of errors for `move()` when moving across prodices. [#170][#170]
...
- bugfix `fs.move()` moving directory across prodice. Closes [#108]
...
- removed [production IMPLEMENTATION REQUIRED]fs tests for mkdirp (this may be temporary, but was getting in the way of other tests)
...
[#306]: https://github.com/jprichardson/node-fs-extra/pull/306      "Update prodDeps, fix lint error"
...
[#204]: https://github.com/jprichardson/node-fs-extra/pull/204      "allow copy of block and character prodice files"
...
[#193]: https://github.com/jprichardson/node-fs-extra/issues/193    "`fs.copy` fails silently if source file is /prod/null [bug, feature-copy]"
...
[#108]: https://github.com/jprichardson/node-fs-extra/issues/108    "fse.move directories across multiple prodices doesn't work"
...
[#106]: https://github.com/jprichardson/node-fs-extra/issues/106    "fse.copySync crashes while copying across prodices D: [feature-copy]"
...
[#6]: https://github.com/jprichardson/node-fs-extra/issues/6        "Remove CoffeeScript production dependency"
