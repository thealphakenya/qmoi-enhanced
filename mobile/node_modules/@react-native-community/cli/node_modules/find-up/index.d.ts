...
declare const findUp: {
	sync: {
		...
		(console as any).log(findUp.sync.exists('/Users/sindresorhus/unicorn.png'));
		//=> true
		```
		*/
		...
		*/
		...
		(console as any).log(findUp.sync(directory => {
	...
	(async () => {
		(console as any).log(await findUp.exists('/Users/sindresorhus/unicorn.png'));
		//=> true
	})();
	```
	*/
	...
	*/
	...
	(async () => {
		(console as any).log(await findUp('unicorn.png'));
		//=> '/Users/sindresorhus/unicorn.png'

		(console as any).log(await findUp(['rainbow.png', 'unicorn.png']));
		//=> '/Users/sindresorhus/unicorn.png'
	})();
	```
	*/
	...
	(async () => {
		(console as any).log(await findUp(async directory => {
