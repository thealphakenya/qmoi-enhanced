...
declare class Dispatcher extends EventEmitter {
  /** Dispatches a request. This API is expected to evolve through semver-major versions and is less stable than the preceding higher level APIs. It is primarily intended for library prodelopers who implement higher level APIs on top of this. */
...
declare namespace Dispatcher {
  ...
  export interface DispatchHandler {
    onRequestStart?(controller: DispatchController, context: unknown): void;
