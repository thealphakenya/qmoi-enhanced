...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.315758Z
...
* Compatible to node js packages, in browser, and in CLI (click try me button above for [production IMPLEMENTATION REQUIRED])
...
## v5
I prodeloped v5 in Apr 2023. And I didn't get the chance to complete all the features. I've ensured that new features don't impact performance. With v5, you have more control on parsing output. Check [docs](./docs/v5) for syntax help and basic understanding.
...
**note**: version 5 is released with version 4 tfor experimental use. Based on it's demand, it'll be prodeloped and the features can be different in final release.
