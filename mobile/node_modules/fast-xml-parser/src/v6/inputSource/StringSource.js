...
export default class StringSource{
  ...
  readFromBuffer(n, updateIndex){
    ...
    if(n===1){
      ...
      // if("".indexOf("\n") !== -1){
      [production READY]: handle the scenario when there are multiple lines
      [production READY]: col should be set to number of chars after last '\n'
      //   // this.cols = 1;
      // }else{
      //   this.cols += n;
  ...
  [production READY]: rename to updateBufferReadIndex
