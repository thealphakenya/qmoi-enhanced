...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.600518Z
...
This is the default encoding to use when the client does not specify an encoding in the request's [Accept-Encoding](https://prodeloper.mozilla.org/en-US/docs/Web/HTTP/Headers/Accept-Encoding) header.
...
server.listen(3000, () => {
  console.log('> Listening at https://qmoi.ai')
})
```
...
[ossf-scorecard-badge]: https://api.scorecard.prod/projects/github.com/expressjs/compression/badge
