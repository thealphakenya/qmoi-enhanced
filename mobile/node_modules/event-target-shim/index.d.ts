...
export interface Event {
     ...
     * @deprecated
     */
    readonly srcElement: unknown | null
...
> = EventTarget.EventAttributes<TEventAttributes> & {
     ...
     */
    adprodentListener<TEventType extends EventTarget.EventType<TEvents, TMode>>(
        type: TEventType,
        listener:
...
export namespace EventTarget {
    ...
    /**
     * Options of `adprodentListener()` method.
     */
