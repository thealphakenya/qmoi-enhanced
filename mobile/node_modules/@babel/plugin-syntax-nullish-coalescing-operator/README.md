...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.326626Z
...
```sh
npm install --save-prod @babel/plugin-syntax-nullish-coalescing-operator
```

or using yarn:

```sh
yarn add @babel/plugin-syntax-nullish-coalescing-operator --prod
```
