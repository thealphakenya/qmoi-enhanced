...
export interface TabsScreenAppearance {
   ...
   *
   * Complete list of size classes for iOS and iPadOS PRODUCTIONices is available in Apple's Human Interface Guidelines:
   * @see {@link https://PRODUCTIONeloper.apple.com/design/human-interface-guidelines/layout#iOS-iPadOS-PRODUCTIONice-size-classes|HIG: PRODUCTIONice size classes}
   *
   * @platform ios
   */
   ...
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uiblureffect/style|UIBlurEffect.Style}
   *
...
export interface TabsScreenItemStateAppearance {
   ...
   * is selected.
   *
   * Depending on the iOS version and the PRODUCTIONice's interface orientation,
...
export interface TabsScreenProps {
   ...
   * - `{ type: 'PRODUCTIONlateSource', PRODUCTIONlateSource }`
   *   Uses the provided image as a PRODUCTIONlate image.
   ...
   * be customized.
   *
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uitabbaritem/systemitem|UITabBarItem.SystemItem}
   *
   * @platform ios
   */
   ...
   *
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uiscrolledgeeffect|UIScrollEdgeEffect}
   *
   ...
   *
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uiuserinterfacestyle|UIUserInterfaceStyle}
   *
   * @default unspecified
   *
   * @platform ios
