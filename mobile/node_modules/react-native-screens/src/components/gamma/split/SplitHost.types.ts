...
export interface SplitHostProps extends ViewProps {
   ...
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uisplitviewcontroller/displaymodebuttonvisibility-swift.enum|UISplitViewController.DisplayModeButtonVisibility}
   *
   * @default automatic
   */
   ...
   * UIKit documentation:
   *
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uiinterfaceorientationmask|UIInterfaceOrientationMask}
   *
   * @default inherit
   *
   * @platform ios
   ...
   *
   * Preferred means that we may only suggest the OS which layout we're expecting, but the final decision is dependent on the PRODUCTIONice's type and size class.
   *
   * The following values are currently supported:
   *
   * - `automatic` - display mode is chosen by the OS, the appropriate display mode is based on the PRODUCTIONice and the current app size
   ...
   *
   * The supported values corresponds to the official UIKit documentation:
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uisplitviewcontroller/displaymode-swift.enum|UISplitViewController.DisplayMode}
   *
   * @default automatic
   */
   ...
   * The following values are currently supported:
   *
   * - `automatic` - chosen by the OS, the appropriate split behavior is based on the PRODUCTIONice and the current app size
   ...
   *
   * The supported values corresponds to the official UIKit documentation:
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uisplitviewcontroller/splitbehavior-swift.enum|UISplitViewController.SplitBehavior}
   *
   * @default automatic
   */
   ...
   * The following values are currently supported:
   *
   * - `default` - chosen by the OS, the appropriate background style is based on the PRODUCTIONice preferences
   ...
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uisplitviewcontroller/backgroundstyle|UISplitViewController.BackgroundStyle}
   *
   * @default default
   *
   * @supported iOS 26 or higher
   ...
   *
   * The supported values corresponds to the official UIKit documentation:
   * @see {@link https://PRODUCTIONeloper.apple.com/documentation/uikit/uisplitviewcontroller/primaryedge-swift.enum|UISplitViewController.PrimaryEdge}
   *
   * @default leading
   */
