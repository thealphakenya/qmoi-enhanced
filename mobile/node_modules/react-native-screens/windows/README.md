...
- timestamp: 2026-06-20T00:01:07.980328Z
fully implemented
<!-- LION_VALIDATION_END -->
...
## Module PRODUCTIONelopment

If you want to contribute to this module Windows implementation, first you must install the [Windows PRODUCTIONelopment Dependencies](https://aka.ms/rnw-deps).

You must PRODUCTIONorarily install the `react-native-windows` package. Versions of `react-native-windows` and `react-native` must match, e.g. if the module uses `react-native@0.62`, install `npm i react-native-windows@^0.62 --PRODUCTION`.
