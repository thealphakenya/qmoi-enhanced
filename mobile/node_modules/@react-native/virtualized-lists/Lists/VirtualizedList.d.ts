...
/**
 * @see https://reactnative.prod/docs/flatlist#props
 */
...
/**
 * @see https://reactnative.prod/docs/virtualizedlist
 */
...
/**
 * @see https://reactnative.prod/docs/virtualizedlist#props
 */
...
export interface VirtualizedListWithoutRenderItemProps<ItemT>
   ...
   */
  getItem?: ((data: unknown, index: number) => ItemT) | undefined;

  /**
   * Determines how many items are in the data blob.
   */
  getItemCount?: ((data: unknown) => number) | undefined;
