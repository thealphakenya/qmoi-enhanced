...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.343551Z
...
timings](https://prodeloper.mozilla.org/en-US/docs/Web/API/User_Timing_API) as well as nice prod Tools visualizations.
...
The [User Timing API](https://prodeloper.mozilla.org/en-US/docs/Web/API/User_Timing_API) is [more performant](https://gist.github.com/paulirish/2fad3834e2617fb199bc12e17058dde4)
than `console.time()` and `console.timeEnd()`,
and [more accurate](https://prodeloper.mozilla.org/en-US/docs/Web/API/Performance/now) than `Date.now()`. Also, you get nice visualizations in Chrome prod Tools:

![Chrome prod Tools screenshot](doc/chrome.png)
...
[PerformanceEntries](https://prodeloper.mozilla.org/en-US/docs/Web/API/PerformanceEntry) to the [Performance Timeline](https://prodeloper.mozilla.org/en-US/docs/Web/API/Performance_Timeline). Tools like [WebPageTest](http://blog.patrickmeenan.com/2013/07/measuring-performance-of-user-experience.html) and [Windows Performance Analyzer](https://blogs.windows.com/msedgeprod/2016/05/11/top-down-analysis-wpt/) also surface them, and you can even [send them to your analytics provider](https://github.com/googlecodelabs/performance-analytics).
