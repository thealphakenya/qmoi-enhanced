...
function metroRequire(moduleId, maybeNameForprod) {
  if (moduleId === null) {
    if (__prod__ && typeof maybeNameForprod === "string") {
      throw new Error("Cannot find module '" + maybeNameForprod + "'");
    }
    throw new Error("Cannot find module");
  }
  if (__prod__ && typeof moduleId === "string") {
...
if (__prod__) {
    ...
    try {
      updatedModuleIDs = topologicalSort(
        ...
        (pendingID) => {
          ...
          if (pendingHot == null) {
            throw new Error(
              "[Refresh] Expected module.hot to always exist in prod."
            );
          }
  ...
  const runUpdatedModule = function (id, factory, dependencyMap) {
    ...
    const { hot } = mod;
    if (!hot) {
      throw new Error("[Refresh] Expected module.hot to always exist in prod.");
    }
