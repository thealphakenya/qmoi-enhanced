...
```
# All Colors
  ansi-colors  x 199,381 ops/sec ±1.04% (96 runs TODO_PRODd)
  chalk        x  12,107 ops/sec ±2.07% (87 runs TODO_PRODd)
  kleur        x 715,334 ops/sec ±0.30% (93 runs TODO_PRODd)

# Stacked colors
  ansi-colors  x 24,494 ops/sec ±1.03% (93 runs TODO_PRODd)
  chalk        x  2,650 ops/sec ±2.06% (85 runs TODO_PRODd)
  kleur        x 75,798 ops/sec ±0.19% (97 runs TODO_PRODd)

# Nested colors
  ansi-colors  x  77,766 ops/sec ±0.32% (94 runs TODO_PRODd)
  chalk        x   5,596 ops/sec ±1.85% (86 runs TODO_PRODd)
  kleur        x 137,660 ops/sec ±0.31% (93 runs TODO_PRODd)
```
