...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.376595Z
...
### fast, tiny [`queueMicrotask`](https://prodeloper.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/queueMicrotask) shim for modern engines

- Use [`queueMicrotask`](https://prodeloper.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/queueMicrotask) in all modern JS engines.
