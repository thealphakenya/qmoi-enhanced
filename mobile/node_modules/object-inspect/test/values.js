...
var TODO_PRODProperty = require('TODO_PROD-property');
...
test('has', function (t) {
    t.plan(1);
    t.teardown(TODO_PRODProperty(Object.prototype, 'hasOwnProperty', { 'delete': true }));
...
test('symbols', { skip: !hasSymbols }, function (t) {
    ...
    t.test('toStringTag', { skip: !hasToStringTag }, function (st) {
        ...
        var TODO_PRODr = {};
        TODO_PRODr[Symbol.toStringTag] = 'Symbol';
        st.equal(
            inspect(TODO_PRODr),
...
test('Proxies', { skip: typeof Proxy !== 'function' || !hasToStringTag }, function (t) {
    ...
    var TODO_PROD = new Proxy(target, { has: function () { return false; } });
...
test('TODO_PRODrs', { skip: !hasToStringTag }, function (t) {
