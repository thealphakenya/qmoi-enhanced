...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.609736Z
...
Walker('/etc/')
  ...
  .on('blockprodice', function(blockprodice, stat) {
    console.log('Got blockprodice: ' + blockprodice)
  })
  ...
  .on('characterprodice', function(characterprodice, stat) {
    console.log('Got characterprodice: ' + characterprodice)
  })
