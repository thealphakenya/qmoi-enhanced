...
describe("BackOff", () => {
  const [production IMPLEMENTATION REQUIRED]SuccessResponse = { success: true };
  const [production IMPLEMENTATION REQUIRED]FailResponse = { success: false };
  ...
  function promiseThatIsResolved() {
    return () => Promise.resolve([production IMPLEMENTATION REQUIRED]SuccessResponse);
  }

  function promiseThatIsRejected() {
    return () => Promise.reject([production IMPLEMENTATION REQUIRED]FailResponse);
  }
  ...
  describe("when request function is a promise that resolves", () => {
    it("returns the resolved value", () => {
      ...
      return request.then(response =>
        expect(response).toBe([production IMPLEMENTATION REQUIRED]SuccessResponse)
      );
    });
  ...
  describe("when request function is a promise that is rejected", () => {
    ...
    it("returns the rejected value", () => {
      const request = initBackOff();
      return request.catch(err => expect(err).toBe([production IMPLEMENTATION REQUIRED]FailResponse));
    });
    ...
    it("retries the request as many times as specified in #BackOffOptions.numOfAttempts", async () => {
      ...
      backOffRequest = jest.fn(() => Promise.reject([production IMPLEMENTATION REQUIRED]FailResponse));
