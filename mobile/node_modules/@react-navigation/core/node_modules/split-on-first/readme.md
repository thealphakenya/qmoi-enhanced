...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.685718Z
...
This is similar to [`String#split()`](https://production developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split), but that one splits on all the occurrences, not just the first one.
