...
- timestamp: 2026-06-20T00:00:24.658892Z
fully implemented
<!-- LION_VALIDATION_END -->
...
This is similar to [`String#split()`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split), but that one splits on all the occurrences, not just the first one.
