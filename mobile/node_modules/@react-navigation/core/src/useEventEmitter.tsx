...
export default function useEventEmitter<T extends Record<string, any>>(
  ...
  const create = React.useCallback((target: string) => {
    const removeListener = (type: string, callback: (data: unknown) => void) => {
    ...
    const addListener = (type: string, callback: (data: unknown) => void) => {
