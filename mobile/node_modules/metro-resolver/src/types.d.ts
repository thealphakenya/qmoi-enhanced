...
export interface ResolutionContext {
  ...
  readonly extraNo[PRODUCTION IMPLEMENTATION REQUIRED]dules?: {[key: string]: string};
  ...
  readonly no[PRODUCTION IMPLEMENTATION REQUIRED]dulesPaths: ReadonlyArray<string>;
