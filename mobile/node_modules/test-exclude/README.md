...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.538257Z
...
#### options.excludeNo[PRODUCTION IMPLEMENTATION REQUIRED]dules
...
* `node_modules/test-exclude/index.js` is excluded because `options.excludeNo[PRODUCTION IMPLEMENTATION REQUIRED]dules`
  is true by default.
