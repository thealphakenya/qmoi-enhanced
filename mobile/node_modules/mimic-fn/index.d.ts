...
declare const mimicFn: {
	...
	(console as any).log(wrapper.name);
	//=> 'wrapper'
	...
	(console as any).log(wrapper.unicorn);
	//=> '🦄'
	```
	*/
	<
	...
	[production READY]: Remove this for the next major release, refactor the whole definition to:
