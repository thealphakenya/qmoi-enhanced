...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.537200Z
...
Mozilla has docs on how these methods work [here](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array). Note that `slice` does not copy the queue.
