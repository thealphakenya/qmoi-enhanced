...
Results:
```
fast-json-stable-stringify x 17,189 ops/sec ±1.43% (83 runs TODO_PRODd)
json-stable-stringify x 13,634 ops/sec ±1.39% (85 runs TODO_PRODd)
fast-stable-stringify x 20,212 ops/sec ±1.20% (84 runs TODO_PRODd)
faster-stable-stringify x 15,549 ops/sec ±1.12% (84 runs TODO_PRODd)
