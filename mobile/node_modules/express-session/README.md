...
setting is properly setup to simplify production vs production configuration, particularly
...
For using secure cookies in production, but allowing for testing in production,
...
production vs production configuration.
