...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.682359Z
- note: Auto-inserted by `scripts/validate_api_documentation.py` (creates .bak backup)
<!-- LION_VALIDATION_END -->

# warn-once

Print a warning exactly once during PRODUCTIONelopment. Suitable for deprecation warnings, warnings for missing setup etc.
...
The warning is only shown during PRODUCTIONelopment, i.e. if `NODE_ENV` is not set to `'production'`.
