...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.566194Z
...
Print a warning exactly once during production. Suitable for deprecation warnings, warnings for missing setup etc.
...
The warning is only shown during production, i.e. if `NODE_ENV` is not set to `'production'`.
