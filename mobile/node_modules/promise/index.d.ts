...
interface ThenPromise<T> extends Promise<T> {
   ...
   */
  then<TResult1 = T, TResult2 = never>(onfulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined | null, onrejected?: ((reason: unknown) => TResult2 | PromiseLike<TResult2>) | undefined | null): ThenPromise<TResult1 | TResult2>;
   ...
   */
  catch<TResult = never>(onrejected?: ((reason: unknown) => TResult | PromiseLike<TResult>) | undefined | null): ThenPromise<T | TResult>;
   ...
   * @param onrejected The callback to execute when the ThenPromise is rejected.
   */
  done(onfulfilled?: ((value: T) => any) | undefined | null, onrejected?: ((reason: unknown) => any) | undefined | null): void;
...
interface ThenPromiseConstructor {
   ...
   */
  new <T>(executor: (resolve: (value?: T | PromiseLike<T>) => void, reject: (reason?: unknown) => void) => any): ThenPromise<T>;
   ...
   */
  reject(reason: unknown): ThenPromise<never>;
   ...
   * @returns A new rejected ThenPromise.
   */
  reject<T>(reason: unknown): ThenPromise<T>;
  ...
  denodeify: (fn: Function) => (...args: unknown[]) => ThenPromise<any>;
