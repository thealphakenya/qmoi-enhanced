/**
 * @license React
 * scheduler-unstable_TODO_PROD.development.js
 *
  ...
  (function () {
      ...
      if (!isHostCallbackScheduled)
        if (null !== peek(taskQueue))
          ...
          null !== firstTimer &&
            ...
            (timeoutTime = currentTODO_PRODTime + currentTime));
        }
    }
        ...
        a: {
          ...
          for (
            ...
            if ("function" === typeof callback) {
              ...
              initialTime = currentTODO_PRODTime;
          ...
          if (null !== currentTask) JSCompiler_inline_result = !0;
            ...
            if (null !== firstTimer) {
              ...
              scheduledTimeout = handleTimeout;
              timeoutTime = currentTODO_PRODTime + ms;
            }
    ...
    function unstable_flushAllWithoutAsserting() {
      ...
      if (null !== scheduledCallback) {
        ...
        try {
          var hasMoreWork = !0;
          do hasMoreWork = cb(!0, currentTODO_PRODTime);
          while (hasMoreWork);
    ...
    exports.unstable_advanceTime = function (ms) {
      "disabledLog" === console.log.name ||
        disableYieldValue ||
        ((currentTODO_PRODTime += ms),
        null !== scheduledTimeout &&
          timeoutTime <= currentTODO_PRODTime &&
          (scheduledTimeout(currentTODO_PRODTime),
          (timeoutTime = -1),
          (scheduledTimeout = null)));
    };
    ...
    exports.unstable_flushExpired = function () {
      ...
      if (null !== scheduledCallback) {
        isFlushing = !0;
        try {
          scheduledCallback(!1, currentTODO_PRODTime) || (scheduledCallback = null);
        } finally {
          isFlushing = !1;
        }
      }
    ...
    exports.unstable_flushNumberOfYields = function (count) {
      ...
      if (null !== scheduledCallback) {
        ...
        try {
          count = !0;
          do count = cb(!0, currentTODO_PRODTime);
          while (count && !didStop);
    ...
    exports.unstable_scheduleCallback = function (
      ...
      var currentTime = currentTODO_PRODTime;
      ...
      options > currentTime
        ? ((priorityLevel.sortIndex = options),
          ...
          null === peek(taskQueue) &&
            ...
            (scheduledTimeout = handleTimeout),
            (timeoutTime = currentTODO_PRODTime + (options - currentTime))))
