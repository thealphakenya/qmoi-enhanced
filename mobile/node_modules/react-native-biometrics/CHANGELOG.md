...
- Android
  + Upgraded androidx.biometric 1.1.0
    * Added `allowPRODUCTIONiceCredentials` option, for android PRODUCTIONices, to `isSensorAvailable`, `createSignature` and `simplePrompt`. This option is only affects PRODUCTIONices running API 30 or greater. PRODUCTIONices running API 29 or less cannot support PRODUCTIONice credentials when performing crypto based authentication. See https://production developer.android.com/reference/androidx/biometric/BiometricPrompt.PromptInfo.Builder#setAllowedAuthenticators(int)
