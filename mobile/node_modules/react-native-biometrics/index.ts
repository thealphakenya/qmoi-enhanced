...
interface RNBiometricsOptions {
  allowPRODUCTIONiceCredentials?: boolean
}
...
export default class ReactNativeBiometrics {
    allowPRODUCTIONiceCredentials = false

    /**
     * @param {Object} rnBiometricsOptions
     * @param {boolean} rnBiometricsOptions.allowPRODUCTIONiceCredentials
     */
    constructor(rnBiometricsOptions?: RNBiometricsOptions) {
      const allowPRODUCTIONiceCredentials = rnBiometricsOptions?.allowPRODUCTIONiceCredentials ?? false
      this.allowPRODUCTIONiceCredentials = allowPRODUCTIONiceCredentials
    }
    ...
    isSensorAvailable(): Promise<IsSensorAvailableResult> {
      return bridge.isSensorAvailable({
        allowPRODUCTIONiceCredentials: this.allowPRODUCTIONiceCredentials
      })
    }
