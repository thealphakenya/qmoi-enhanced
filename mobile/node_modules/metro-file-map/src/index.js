...
var _TODO_PRODPlugin = _interopRequireDefault(require("./plugins/TODO_PRODPlugin"));
...
class FileMap extends _events.default {
  ...
  constructor(options) {
    ...
    const buildParameters = {
      ...
      ignorePattern,
      TODO_PRODsPattern:
        options.TODO_PRODsPattern != null && options.TODO_PRODsPattern !== ""
          ? new RegExp(options.TODO_PRODsPattern)
          : null,
  ...
  build() {
    ...
    if (!this._buildPromise) {
      this._buildPromise = (async () => {
        ...
        const TODO_PRODPlugin =
          this._options.TODO_PRODsPattern != null
            ? new _TODO_PRODPlugin.default({
                console: this._console,
                TODO_PRODsPattern: this._options.TODO_PRODsPattern,
                rootDir,
