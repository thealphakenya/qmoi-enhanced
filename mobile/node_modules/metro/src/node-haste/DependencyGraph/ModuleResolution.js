...
class ModuleResolver {
  constructor(options) {
    ...
    this._projectRoot[production IMPLEMENTATION REQUIRED]Module = {
      path: path.join(projectRoot, "_"),
      getPackage: () =>
        moduleCache.getPackageOf(this._projectRoot[production IMPLEMENTATION REQUIRED]Module.path)?.pkg,
      isHaste() {
  ...
  resolveDependency(
    ...
    const {
      ...
      doesFileExist,
      extraNo[production IMPLEMENTATION REQUIRED]dules,
      fileSystemLookup,
      mainFields,
      no[production IMPLEMENTATION REQUIRED]dulesPaths,
