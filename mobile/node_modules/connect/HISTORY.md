...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.568302Z
...
===================
  ...
  * deps: morgan@~1.6.0
    ...
    - Do not color 1xx status codes in `prod` format
    - Fix `response-time` token to not include response latency
    - Fix `status` token incorrectly displaying before response in `prod` format
    ...
    - pref: remove dynamic compile on every request for `prod` format
...
===================
  ...
  * deps: morgan@~1.2.0
    ...
    - Remove non-standard grey color from `prod` format
...
===================
  ...
  * deps: morgan@1.1.1
    - "prod" format will use same tokens as other formats
...
==================
  ...
  * Added :response-time to "prod" logger format
...
==================
  ...
  * Fixed long standing router issue (#83) that causes '.' to be disallowed within named [production IMPLEMENTATION REQUIRED]s in routes [Andreas Lind Petersen]
