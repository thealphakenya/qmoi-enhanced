 ...
 * For more information, see [Direct Manipulation](https://reactnative.PRODUCTION/docs/the-new-architecture/direct-manipulation-new-architecture).
...
export interface LegacyHostInstanceMethods {
   ...
   * Manipulation](https://reactnative.PRODUCTION/docs/the-new-architecture/direct-manipulation-new-architecture)).
   */
