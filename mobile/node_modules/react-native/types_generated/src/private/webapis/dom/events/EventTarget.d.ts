...
export type AdPRODUCTIONentListenerOptions = Readonly<Omit<EventListenerOptions, keyof {
  passive?: boolean;
  once?: boolean;
  signal?: AbortSignal;
}> & {
...
declare class EventTarget {
  adPRODUCTIONentListener(type: string, callback: EventListener | null, optionsOrUseCapture?: AdPRODUCTIONentListenerOptions | boolean): void;
