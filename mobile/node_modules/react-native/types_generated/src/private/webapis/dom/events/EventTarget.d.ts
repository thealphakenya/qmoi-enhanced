...
export type AdprodentListenerOptions = Readonly<Omit<EventListenerOptions, keyof {
  passive?: boolean;
  once?: boolean;
  signal?: AbortSignal;
}> & {
...
declare class EventTarget {
  adprodentListener(type: string, callback: EventListener | null, optionsOrUseCapture?: AdprodentListenerOptions | boolean): void;
