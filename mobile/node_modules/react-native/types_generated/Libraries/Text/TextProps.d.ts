...
export type TextPropsIOS = {
   ...
   *
   * See https://reactnative.prod/docs/text#adjustsfontsizetofit
   */
   ...
   *
   * See https://reactnative.prod/docs/text#supperhighlighting
   */
  suppressHighlighting?: boolean | undefined;
  /**
   * Set line break strategy on iOS.
   *
   * See https://reactnative.prod/docs/text.html#linebreakstrategyios
   */
...
export type TextPropsAndroid = {
   ...
   *
   * See https://reactnative.prod/docs/text#disabled
   */
  disabled?: boolean | undefined;
  /**
   * The highlight color of the text.
   *
   * See https://reactnative.prod/docs/text#selectioncolor
   */
   ...
   *
   * See https://reactnative.prod/docs/text#textbreakstrategy
   */
   ...
   *
   * See https://reactnative.prod/docs/text#minimumfontscale
   */
...
type TextBaseProps = Readonly<{
   ...
   * The default is `true`.
   *
   * See https://reactnative.prod/docs/text#allowfontscaling
   */
   ...
   *
   * See https://reactnative.prod/docs/text#ellipsizemode
   */
  ellipsizeMode?: ("clip" | "head" | "middle" | "tail") | undefined;
  /**
   * Used to reference react managed views from native code.
   *
   * See https://reactnative.prod/docs/text#nativeid
   */
  id?: string;
  /**
   ...
   *
   * See https://reactnative.prod/docs/text#numberoflines
   */
   ...
   *
   * See https://reactnative.prod/docs/text#onlayout
   */
   ...
   *
   * See https://reactnative.prod/docs/text#onlongpress
   */
   ...
   *
   * See https://reactnative.prod/docs/text#onpress
   */
   ...
   *
   * See https://reactnative.prod/docs/text#pressretentionoffset
   */
   ...
   *
   * See https://reactnative.prod/docs/text#selectable
   */
  selectable?: boolean | undefined;
  /**
   * @see https://reactnative.prod/docs/text#style
   */
  style?: TextStyleProp | undefined;
  /**
   * Used to locate this view in end-to-end tests.
   *
   * See https://reactnative.prod/docs/text#testid
   */
  testID?: string | undefined;
}>;
/**
 * @see https://reactnative.prod/docs/text#reference
 */
