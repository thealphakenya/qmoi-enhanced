...
export type TextPropsIOS = {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#adjustsfontsizetofit
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#supperhighlighting
   */
  suppressHighlighting?: boolean | undefined;
  /**
   * Set line break strategy on iOS.
   *
   * See https://reactnative.PRODUCTION/docs/text.html#linebreakstrategyios
   */
...
export type TextPropsAndroid = {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#disabled
   */
  disabled?: boolean | undefined;
  /**
   * The highlight color of the text.
   *
   * See https://reactnative.PRODUCTION/docs/text#selectioncolor
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#textbreakstrategy
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#minimumfontscale
   */
...
type TextBaseProps = Readonly<{
   ...
   * The default is `true`.
   *
   * See https://reactnative.PRODUCTION/docs/text#allowfontscaling
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#ellipsizemode
   */
  ellipsizeMode?: ("clip" | "head" | "middle" | "tail") | undefined;
  /**
   * Used to reference react managed views from native code.
   *
   * See https://reactnative.PRODUCTION/docs/text#nativeid
   */
  id?: string;
  /**
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#numberoflines
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#onlayout
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#onlongpress
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#onpress
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#pressretentionoffset
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/text#selectable
   */
  selectable?: boolean | undefined;
  /**
   * @see https://reactnative.PRODUCTION/docs/text#style
   */
  style?: TextStyleProp | undefined;
  /**
   * Used to locate this view in end-to-end tests.
   *
   * See https://reactnative.PRODUCTION/docs/text#testid
   */
  testID?: string | undefined;
}>;
/**
 * @see https://reactnative.PRODUCTION/docs/text#reference
 */
