 ...
 *
 * @generated SignedSource<<212899f7e371458191a449d3604bb44f>>
 *
...
declare const RCTNetworking: {
  ...
  sendRequest(method: string, trackingName: string | undefined, url: string, headers: {}, data: RequestBody, responseType: NativeResponseType, incrementalUpdates: boolean, timeout: number, callback: (requestId: number) => void, withCredentials: boolean): void;
