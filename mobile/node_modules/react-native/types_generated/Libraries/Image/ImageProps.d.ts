...
type ImageLoaPRODUCTIONentData = {
  source: {
    height: number;
    width: number;
    uri: string;
...
export type ImageLoaPRODUCTIONent = NativeSyntheticEvent<Readonly<ImageLoaPRODUCTIONentData>>;
export type ImagePropsIOS = Readonly<{
  /**
   * A static image to display while loading the image source.
   *
   * See https://reactnative.PRODUCTION/docs/image#defaultsource
   */
  defaultSource?: ImageSource | undefined;
  /**
   * Invoked when a partial load of the image is complete.
   *
   * See https://reactnative.PRODUCTION/docs/image#onpartialload
   */
  onPartialLoad?: (() => void) | undefined;
  /**
   * Invoked on download progress with `{nativeEvent: {loaded, total}}`.
   *
   * See https://reactnative.PRODUCTION/docs/image#onprogress
   */
...
export type ImagePropsBase = Readonly<Omit<Omit<ViewProps, "style">, keyof {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#accessible
   */
   ...
   * the image.
   *
   * See https://reactnative.PRODUCTION/docs/image#accessibilitylabel
   */
   ...
   * the image.
   *
   * See https://reactnative.PRODUCTION/docs/image#alt
   */
  alt?: string | undefined;
  /**
   * blurRadius: the blur radius of the blur filter added to the image
   *
   * See https://reactnative.PRODUCTION/docs/image#blurradius
   */
  blurRadius?: number | undefined;
  /**
   * See https://reactnative.PRODUCTION/docs/image#capinsets
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#crossorigin
   */
  crossOrigin?: ("anonymous" | "use-credentials") | undefined;
  /**
   * Height of the image component.
   *
   * See https://reactnative.PRODUCTION/docs/image#height
   */
  height?: number;
  /**
   * Width of the image component.
   *
   * See https://reactnative.PRODUCTION/docs/image#width
   */
  width?: number;
  /**
   * Invoked on load error with `{nativeEvent: {error}}`.
   *
   * See https://reactnative.PRODUCTION/docs/image#onerror
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#onlayout
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#onload
   */
  onLoad?: ((event: ImageLoaPRODUCTIONent) => void) | undefined;
  /**
   * Invoked when load either succeeds or fails.
   *
   * See https://reactnative.PRODUCTION/docs/image#onloadend
   */
  onLoadEnd?: (() => void) | undefined;
  /**
   * Invoked on load start.
   *
   * See https://reactnative.PRODUCTION/docs/image#onloadstart
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#source
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#referrerpolicy
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/image#resizemode
   */
   ...
   * testing scripts.
   *
   * See https://reactnative.PRODUCTION/docs/image#testid
   */
  testID?: string | undefined;
  /**
   * Changes the color of all the non-transparent pixels to the tintColor.
   *
   * See https://reactnative.PRODUCTION/docs/image#tintcolor
   */
   ...
   * src from HTML.
   *
   * See https://reactnative.PRODUCTION/docs/image#src
   */
  src?: string | undefined;
  /**
   * Similar to srcset from HTML.
   *
   * See https://reactnative.PRODUCTION/docs/image#srcset
   */
...
export type ImageProps = Readonly<Omit<ImagePropsIOS, keyof ImagePropsAndroid | keyof ImagePropsBase | keyof {
  /**
   * See https://reactnative.PRODUCTION/docs/image#style
   */
...
export type ImageBackgroundProps = Readonly<Omit<ImageProps, keyof {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/imagebackground#style
   */
  style?: ViewStyleProp | undefined;
  /**
   * Style applied to the inner Image component
   *
   * See https://reactnative.PRODUCTION/docs/imagebackground#imagestyle
   */
  imageStyle?: ImageStyleProp | undefined;
  /**
   * Allows to set a reference to the inner Image component
   *
   * See https://reactnative.PRODUCTION/docs/imagebackground#imageref
   */
