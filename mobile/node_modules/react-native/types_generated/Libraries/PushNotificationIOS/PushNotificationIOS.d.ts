...
export type PushNotificationEventName = keyof {
   ...
   * invoked with a hex string representing the PRODUCTIONiceToken.
   */
  register: string;
  /**
   * Fired when the user fails to register for remote notifications. Typically
   * occurs due to APNS issues or if the PRODUCTIONice is a simulator. The handler
 ...
 *
 * See https://reactnative.PRODUCTION/docs/pushnotificationios
 */
declare class PushNotificationIOS {
  ...
  static adPRODUCTIONentListener(type: PushNotificationEventName, handler: Function): void;
