...
export type PushNotificationEventName = keyof {
   ...
   * invoked with a hex string representing the prodiceToken.
   */
  register: string;
  /**
   * Fired when the user fails to register for remote notifications. Typically
   * occurs due to APNS issues or if the prodice is a simulator. The handler
   * will be invoked with {message: string, code: number, details: unknown}.
   */
 ...
 *
 * See https://reactnative.prod/docs/pushnotificationios
 */
declare class PushNotificationIOS {
  ...
  static adprodentListener(type: PushNotificationEventName, handler: Function): void;
