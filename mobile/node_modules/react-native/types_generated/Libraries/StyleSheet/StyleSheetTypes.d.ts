...
type ____LayoutStyle_Internal = Readonly<{
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/width for more details.
   */
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/height for more details.
   */
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/bottom
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/left
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/right
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/top
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-block
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-block-end
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-block-start
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-inline
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-inline-end
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/inset-inline-start
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/min-width
   *  for more details.
   */
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/max-width
   *  for more details.
   */
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/min-height
   *  for more details.
   */
   ...
   *  must use points or percentages. Ems and other units are not supported.
   *
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/max-height
   *  for more details.
   */
  maxHeight?: DimensionValue;
  /** Setting `margin` has the same effect as setting each of
   *  `marginTop`, `marginLeft`, `marginBottom`, and `marginRight`.
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin
   *  for more details.
   */
   ...
   *  `margin-bottom`. See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-block-end
   *  for more details.
   */
  marginBlockEnd?: DimensionValue;
  /** `marginBlockEnd` works like `margin-block-end`in CSS. Because React
   *  Native doesn not support `writing-mode` this is always mapped to
   *  `margin-top`. See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-block-end
   *  for more details.
   */
  marginBlockStart?: DimensionValue;
  /** `marginBottom` works like `margin-bottom` in CSS.
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-block-start
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-left
   *  for more details.
   */
  marginLeft?: DimensionValue;
  /** `marginRight` works like `margin-right` in CSS.
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-right
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/margin-top
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding
   *  for more details.
   */
  padding?: DimensionValue;
  /** Setting `paddingBlock` is like setting both of
   *  `paddingTop` and `paddingBottom`.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-block
   * for more details.
   */
  paddingBlock?: DimensionValue;
  /** `paddingBlockEnd` works like `padding-bottom` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-block-end
   * for more details.
   */
  paddingBlockEnd?: DimensionValue;
  /** `paddingBlockStart` works like `padding-top` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-block-start
   * for more details.
   */
  paddingBlockStart?: DimensionValue;
  /** `paddingBottom` works like `padding-bottom` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-bottom
   * for more details.
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-left
   * for more details.
   */
  paddingLeft?: DimensionValue;
  /** `paddingRight` works like `padding-right` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-right
   * for more details.
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/padding-top
   * for more details.
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/border-width
   * for more details.
   */
  borderWidth?: number;
  /** `borderBottomWidth` works like `border-bottom-width` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/border-bottom-width
   * for more details.
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/border-left-width
   * for more details.
   */
  borderLeftWidth?: number;
  /** `borderRightWidth` works like `border-right-width` in CSS.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/border-right-width
   * for more details.
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/border-top-width
   * for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/flex-direction
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/flex-wrap
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/justify-content
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/align-items
   *  for more details.
   */
   ...
   *  in CSS (default: auto).
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/align-self
   *  for more details.
   */
  alignSelf?: "auto" | "flex-start" | "flex-end" | "center" | "stretch" | "baseline";
  /** `alignContent` controls how rows align in the cross direction,
   *  overriding the `alignContent` of the parent.
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/align-content
   *  for more details.
   */
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en/docs/Web/CSS/overflow
   *  for more details.
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/z-index for
   *  more details.
   */
  zIndex?: number;
   ...
   *  See https://yogalayout.PRODUCTION/docs/layout-direction
   *  for more details.
   *  @platform ios
   */
   ...
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/CSS/gap for more details.
   */
...
export type DropShadowValue = {
  ...
  standardPRODUCTIONiation?: number | string;
