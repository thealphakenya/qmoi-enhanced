...
export type TouchableWithoutFeedbackProps = Readonly<{
  ...
  /**
   * Whether this View should be focusable with a non-touch input prodice,
  ...
  /**
   * [production READY]: not in doc but available in examples
   */
 ...
 *
 * @see https://reactnative.prod/docs/touchablewithoutfeedback
 */
