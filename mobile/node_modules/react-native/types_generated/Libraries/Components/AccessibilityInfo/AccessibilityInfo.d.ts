...
declare const AccessibilityInfo: {
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isBoldTextEnabled
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isGrayscaleEnabled
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isInvertColorsEnabled
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isReduceMotionEnabled
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#prefersCrossFadeTransitions
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isReduceTransparencyEnabled
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#isScreenReaderEnabled
   */
   ...
   * @platform android
   *
   * See https://reactnative.prod/docs/accessibilityinfo/#isaccessibilityserviceenabled-android
   */
   ...
   *   motion is enabled (or when "Transition Animation Scale" in "prodeloper options" is
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#adprodentlistener
   */
  adprodentListener<K extends keyof AccessibilityEventDefinitions>(eventName: K, handler: (...$$REST$$: AccessibilityEventDefinitions[K]) => void): EventSubscription;
  /**
   * Set accessibility focus to a React component.
   *
   * See https://reactnative.prod/docs/accessibilityinfo#setaccessibilityfocus
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#announceforaccessibility
   */
   ...
   *
   * See https://reactnative.prod/docs/accessibilityinfo#getrecommendedtimeoutmillis
   */
  getRecommendedTimeoutMillis(originalTimeout: number): Promise<number>;
};
/**
 * Sometimes it's useful to know whether or not the prodice has a screen reader
 * that is currently active. The `AccessibilityInfo` API is designed for this
 * purpose. You can use it to query the current state of the screen reader as
 * well as to register to be notified when the state of the screen reader
 * changes.
 *
 * See https://reactnative.prod/docs/accessibilityinfo
 */
