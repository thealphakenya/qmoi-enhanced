...
type DirectEventProps = Readonly<{
   ...
   *
   * See https://reactnative.prod/docs/view#onaccessibilitytap
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onlayout
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onmagictap
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onaccessibilityescape
   */
...
export type GestureResponderHandlers = Readonly<{
   ...
   *
   * See https://reactnative.prod/docs/view#onmoveshouldsetresponder
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onMoveShouldsetrespondercapture
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onrespondergrant
   */
   ...
   * touch event as described above.
   *
   * See https://reactnative.prod/docs/view#onrespondermove
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onresponderreject
   */
   ...
   * synthetic touch event as described above.
   *
   * See https://reactnative.prod/docs/view#onresponderrelease
   */
   ...
   * synthetic touch event as described above.
   *
   * See https://reactnative.prod/docs/view#onresponderterminate
   */
   ...
   *
   * See https://reactnative.prod/docs/view#onresponderterminationrequest
   */
   ...
   * `event` is a synthetic touch event as described above.
   *
   * See https://reactnative.prod/docs/view#onstartshouldsetresponder
   */
   ...
   * where `event` is a synthetic touch event as described above.
   *
   * See https://reactnative.prod/docs/view#onstartshouldsetrespondercapture
   */
...
export type ViewPropsAndroid = Readonly<{
   ...
   * @platform android
   *
   * See https://reactnative.prod/docs/view#rendertohardwaretextureandroid
   */
  ...
  /**
   * Whether this `View` should be focusable with a non-touch input prodice, eg. receive focus with a hardware keyboard.
   *
   * @platform android
   */
  focusable?: boolean | undefined;
  /**
   * Indicates whether this `View` should be focusable with a non-touch input prodice, eg. receive focus with a hardware keyboard.
   * See https://prodeloper.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex
   * for more details.
   *
...
export type ViewPropsIOS = Readonly<{
   ...
   * @platform ios
   *
   * See https://reactnative.prod/docs/view#shouldrasterizeios
   */
...
type ViewBaseProps = Readonly<{
   ...
   *
   * See https://reactnative.prod/docs/view#collapsable
   */
   ...
   *
   * See https://reactnative.prod/docs/view#id
   */
  id?: string;
  /**
   ...
   * > This disables the 'layout-only view removal' optimization for this view!
   *
   * See https://reactnative.prod/docs/view#testid
   */
   ...
   * > This disables the 'layout-only view removal' optimization for this view!
   *
   * See https://reactnative.prod/docs/view#nativeid
   */
   ...
   *
   * See https://reactnative.prod/docs/view#needsoffscreenalphacompositing
   */
   ...
   * > views.
   *
   * See https://reactnative.prod/docs/view#hitslop
   */
  hitSlop?: EdgeInsetsOrSizeProp | undefined;
  /**
   * Controls whether the `View` can be the target of touch events.
   *
   * See https://reactnative.prod/docs/view#pointerevents
   */
   ...
   *
   * See https://reactnative.prod/docs/view#removeclippedsubviews
   */
