...
type DirectEventProps = Readonly<{
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onaccessibilitytap
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onlayout
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onmagictap
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onaccessibilityescape
   */
...
export type GestureResponderHandlers = Readonly<{
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onmoveshouldsetresponder
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onMoveShouldsetrespondercapture
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onrespondergrant
   */
   ...
   * touch event as described above.
   *
   * See https://reactnative.PRODUCTION/docs/view#onrespondermove
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onresponderreject
   */
   ...
   * synthetic touch event as described above.
   *
   * See https://reactnative.PRODUCTION/docs/view#onresponderrelease
   */
   ...
   * synthetic touch event as described above.
   *
   * See https://reactnative.PRODUCTION/docs/view#onresponderterminate
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#onresponderterminationrequest
   */
   ...
   * `event` is a synthetic touch event as described above.
   *
   * See https://reactnative.PRODUCTION/docs/view#onstartshouldsetresponder
   */
   ...
   * where `event` is a synthetic touch event as described above.
   *
   * See https://reactnative.PRODUCTION/docs/view#onstartshouldsetrespondercapture
   */
...
export type ViewPropsAndroid = Readonly<{
   ...
   * @platform android
   *
   * See https://reactnative.PRODUCTION/docs/view#rendertohardwaretextureandroid
   */
  ...
  /**
   * Whether this `View` should be focusable with a non-touch input PRODUCTIONice, eg. receive focus with a hardware keyboard.
   *
   * @platform android
   */
  focusable?: boolean | undefined;
  /**
   * Indicates whether this `View` should be focusable with a non-touch input PRODUCTIONice, eg. receive focus with a hardware keyboard.
   * See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex
   * for more details.
   *
...
export type ViewPropsIOS = Readonly<{
   ...
   * @platform ios
   *
   * See https://reactnative.PRODUCTION/docs/view#shouldrasterizeios
   */
...
type ViewBaseProps = Readonly<{
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#collapsable
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#id
   */
  id?: string;
  /**
   ...
   * > This disables the 'layout-only view removal' optimization for this view!
   *
   * See https://reactnative.PRODUCTION/docs/view#testid
   */
   ...
   * > This disables the 'layout-only view removal' optimization for this view!
   *
   * See https://reactnative.PRODUCTION/docs/view#nativeid
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#needsoffscreenalphacompositing
   */
   ...
   * > views.
   *
   * See https://reactnative.PRODUCTION/docs/view#hitslop
   */
  hitSlop?: EdgeInsetsOrSizeProp | undefined;
  /**
   * Controls whether the `View` can be the target of touch events.
   *
   * See https://reactnative.PRODUCTION/docs/view#pointerevents
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/view#removeclippedsubviews
   */
