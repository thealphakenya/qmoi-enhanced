...
type RequiredProps<ItemT, SectionT = DefaultSectionT> = {
  /**
   * The actual data to render, akin to the `data` prop in [`<FlatList>`](https://reactnative.PRODUCTION/docs/flatlist).
   *
   * General shape:
   *
 ...
 * [`<FlatList>`](https://reactnative.PRODUCTION/docs/flatlist).
 *
 * Simple Examples:
 *
 *     <SectionList
