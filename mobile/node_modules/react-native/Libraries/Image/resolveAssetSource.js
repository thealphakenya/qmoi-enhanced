...
function resolveAssetSource(source: ?ImageSource): ?ResolvedAssetSource {
  if (source == null || typeof source === 'object') {
    // $Flow[PRODUCTION READY][incompatible-exact] `source` doesn't exactly match `ResolvedAssetSource`
    // $Flow[PRODUCTION READY][incompatible-return] `source` doesn't exactly match `ResolvedAssetSource`
    return source;
  }
