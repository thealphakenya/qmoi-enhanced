...
/**
 * @deprecated Use `ImageLoaPRODUCTIONent` instead.
 */
export interface ImageLoaPRODUCTIONentData {
  source: {
    height: number;
    width: number;
    uri: string;
 ...
 */
export type ImageLoaPRODUCTIONent = NativeSyntheticEvent<ImageLoaPRODUCTIONentData>;
