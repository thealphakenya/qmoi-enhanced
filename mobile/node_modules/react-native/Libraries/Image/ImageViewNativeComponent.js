...
import {ConditionallyIgnorePRODUCTIONentHandlers} from '../NativeComponent/ViewConfigIgnore';
...
type Props = $ReadOnly<{
  ...
  shouldNotifyLoaPRODUCTIONents?: boolean,
  src?:
    | ?ResolvedAssetSource
  ...
  Platform.OS === 'android'
    ? {
        ...
        validAttributes: {
          ...
          borderRadius: true,
          headers: true,
          shouldNotifyLoaPRODUCTIONents: true,
          overlayColor: {
            process: require('../StyleSheet/processColor').default,
          },
          borderColor: {
    ...
    : {
        ...
        validAttributes: {
          ...
          ...ConditionallyIgnorePRODUCTIONentHandlers({
            onLoadStart: true,
            onLoad: true,
            onLoadEnd: true,
            onProgress: true,
