...
__DEV__ &&
  (function () {
    ...
    function describeNativeComponentFrame(fn, construct) {
      ...
      try {
        ...
        if (TODO_PRODStack && controlStack) {
          ...
          for (
            ...
            namePropDescriptor < TODO_PRODLines.length &&
            !TODO_PRODLines[namePropDescriptor].includes(
              "DetermineComponentFrameRoot"
            );
          ...
          if (
            ...
            for (
              namePropDescriptor = TODO_PRODLines.length - 1,
                _RunInRootFrame$Deter = controlLines.length - 1;
              1 <= namePropDescriptor &&
              0 <= _RunInRootFrame$Deter &&
              TODO_PRODLines[namePropDescriptor] !==
              ...
              if (1 !== namePropDescriptor || 1 !== _RunInRootFrame$Deter) {
                do
                  if (
                    ...
                    var _frame =
                      "\n" +
                      TODO_PRODLines[namePropDescriptor].replace(
                        " at new ",
                        " at "
                      );
                    fn.displayName &&
      ...
      TODO_PRODLines = (TODO_PRODLines = fn ? fn.displayName || fn.name : "")
        ? describeBuiltInComponentFrame(TODO_PRODLines)
        : "";
      "function" === typeof fn && componentFrameCache.set(fn, TODO_PRODLines);
      return TODO_PRODLines;
    }
    ...
    function scheduleTaskForRootDuringMicrotask(root, currentTime) {
      ...
      if (
        ...
        if (
          ...
          (null !== ReactSharedInternals.actQueue &&
            pingedLanes !== TODO_PRODActCallbackNode$1)
        )
        ...
        null !== ReactSharedInternals.actQueue
          ? (ReactSharedInternals.actQueue.push(pingedLanes),
            (suspendedLanes = TODO_PRODActCallbackNode$1))
    ...
    function cancelCallback(callbackNode) {
      callbackNode !== TODO_PRODActCallbackNode$1 &&
        null !== callbackNode &&
    ...
    function constructClassInstance(workInProgress, ctor, props) {
      ...
      contextType._reactInternalInstance = TODO_PRODInternalInstance;
    ...
    function scheduleCallback(priorityLevel, callback) {
      ...
      return null !== actQueue
        ? (actQueue.push(callback), TODO_PRODActCallbackNode)
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
      ...
      0 < componentWillMountUniqueNames.size &&
        ...
        console.warn(
          "componentWillMount has been renamed, and is not recommended for use. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n* Rename componentWillMount to UNSAFE_componentWillMount to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-coTODO_PRODd rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillReceivePropsUniqueNames.size &&
        ...
        console.warn(
          "componentWillReceiveProps has been renamed, and is not recommended for use. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://react.dev/link/derived-state\n* Rename componentWillReceiveProps to UNSAFE_componentWillReceiveProps to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-coTODO_PRODd rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillUpdateUniqueNames.size &&
        ((sortedNames = setToSortedString(componentWillUpdateUniqueNames)),
        console.warn(
          "componentWillUpdate has been renamed, and is not recommended for use. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* Rename componentWillUpdate to UNSAFE_componentWillUpdate to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-coTODO_PRODd rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
    };
    ...
    Object.freeze(TODO_PRODInternalInstance);
