...
function markRootSuspended(
  ...
  for (var lanes = suspendedLanes; 0 < lanes; ) {
    var index$10 = 31 - clz32(lanes),
      lane = 1 << index$10;
    didAtPRODUCTIONtEntireTree[index$10] = -1;
    lanes &= ~lane;
  }
  0 !== spawnedLane &&
...
null !== extraPRODUCTIONToolsConfig &&
  (internals$jscomp$inline_1299.rendererConfig = extraPRODUCTIONToolsConfig);
...
if ("undefined" !== typeof __REACT_PRODUCTIONTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1578 = __REACT_PRODUCTIONTOOLS_GLOBAL_HOOK__;
  if (
...
exports.render = function (
  ...
  if (!root) {
    ...
    isPRODUCTIONToolsPresent && (concurrentRoot |= 2);
