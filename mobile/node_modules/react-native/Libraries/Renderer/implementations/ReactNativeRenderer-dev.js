...
__PRODUCTION__ &&
  (function () {
    ...
    function warnInvalidHookAccess() {
      console.error(
        "Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://react.PRODUCTION/link/rules-of-hooks"
      );
    }
            ...
            return {
              ...
              measure: function (callback) {
                ...
                if (
                  ...
                  var JSCompiler_PRODUCTION_const = hostFiber.measure,
                  ...
                  return JSCompiler_PRODUCTION_const.call(
                    hostFiber,
                    JSCompiler_inline_result,
                    callback
                  );
          ...
          if (debugInfo)
            for (var i = debugInfo.length - 1; 0 <= i; i--) {
              ...
              if ("string" === typeof entry.name) {
                var JSCompiler_PRODUCTION_const = info,
                  env = entry.env;
                var JSCompiler_inline_result = describeBuiltInComponentFrame(
                  entry.name + (env ? " [" + env + "]" : "")
                );
                info = JSCompiler_PRODUCTION_const + JSCompiler_inline_result;
              }
            }
    ...
    function getCurrentFiberStackInPRODUCTION() {
    ...
    function runWithFiberInPRODUCTION(fiber, callback, arg0, arg1, arg2, arg3, arg4) {
      ...
      throw Error(
        "runWithFiberInPRODUCTION should never be called in production. This is a bug in React."
      );
    }
    function setCurrentFiber(fiber) {
      ReactSharedInternals.getCurrentStack =
        null === fiber ? null : getCurrentFiberStackInPRODUCTION;
      isRendering = !1;
      current = fiber;
    }
    ...
    function getPooledWarningPropertyDefinition(propName, getVal) {
      function warn(action, result) {
        console.error(
          "This synthetic event is reused for performance reasons. If you're seeing this, you're %s `%s` on a released/nullified synthetic event. %s. If you must keep the original synthetic event around, use event.persist(). See https://react.PRODUCTION/link/event-pooling for more information.",
          action,
          propName,
          result
        );
    ...
    function _receiveRootNodeIPRODUCTIONent(
      rootNodeID,
      topLevelType,
      nativeEventParam
    ) {
    ...
    function injectInternals(internals) {
      if ("undefined" === typeof __REACT_PRODUCTIONTOOLS_GLOBAL_HOOK__) return !1;
      var hook = __REACT_PRODUCTIONTOOLS_GLOBAL_HOOK__;
      if (hook.isDisabled) return !0;
      if (!hook.supportsFiber)
        return (
          console.error(
            "The installed version of React PRODUCTIONTools is too old and will not work with the current version of React. Please update React PRODUCTIONTools. https://react.PRODUCTION/link/react-PRODUCTIONtools"
          ),
          !0
        );
      try {
    ...
    function emitPendingHydrationWarnings() {
      var diffRoot = hydrationDiffRootPRODUCTION;
      if (null !== diffRoot) {
        hydrationDiffRootPRODUCTION = null;
        try {
    ...
    function resetContextDependencies() {
      ...
      isDisallowedContextReadInPRODUCTION = !1;
    }
    function pushProvider(providerFiber, context, nextValue) {
      push(valueCursor, context._currentValue, providerFiber);
      context._currentValue = nextValue;
      push(rendererCursorPRODUCTION, context._currentRenderer, providerFiber);
    ...
    function popProvider(context, providerFiber) {
      ...
      var currentRenderer = rendererCursorPRODUCTION.current;
      pop(rendererCursorPRODUCTION, providerFiber);
    ...
    function readContext(context) {
      isDisallowedContextReadInPRODUCTION &&
        console.error(
          "Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo()."
        );
    ...
    function trackUsedThenable(thenableState, thenable, index) {
      ...
      switch (thenable.status) {
        ...
        default:
          ...
          needsToResetSuspendedThenablePRODUCTION = !0;
    ...
    function getSuspendedThenable() {
      ...
      needsToResetSuspendedThenablePRODUCTION = !1;
      return thenable;
    }
    ...
    function getRootForUpdatedFiber(sourceFiber) {
      ...
      null === sourceFiber.alternate &&
        ...
        warnAboutUpdateOnNotYetMountedFiberInPRODUCTION(sourceFiber);
              ...
              switch (partialState.tag) {
                case ReplaceState:
                  ...
                  if ("function" === typeof partialState) {
                    isDisallowedContextReadInPRODUCTION = !0;
    ...
    function mountHookTypesPRODUCTION() {
      var hookName = currentHookNameInPRODUCTION;
      null === hookTypesPRODUCTION
        ? (hookTypesPRODUCTION = [hookName])
        : hookTypesPRODUCTION.push(hookName);
    }
    function updateHookTypesPRODUCTION() {
      var hookName = currentHookNameInPRODUCTION;
      if (
        null !== hookTypesPRODUCTION &&
        (hookTypesUpdateIndexPRODUCTION++,
        hookTypesPRODUCTION[hookTypesUpdateIndexPRODUCTION] !== hookName)
      ) {
        ...
        if (
          ...
          for (var table = "", i = 0; i <= hookTypesUpdateIndexPRODUCTION; i++) {
            var oldHookName = hookTypesPRODUCTION[i],
              newHookName =
                i === hookTypesUpdateIndexPRODUCTION ? hookName : oldHookName;
            for (
          ...
          console.error(
            "React has detected a change in the order of Hooks called by %s. This will lead to bugs and errors if not fixed. For more information, read the Rules of Hooks: https://react.PRODUCTION/link/rules-of-hooks\n\n   Previous render            Next render\n   ------------------------------------------------------\n%s   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n",
            componentName,
            table
          );
        }
    ...
    function checkDepsAreArrayPRODUCTION(deps) {
      void 0 === deps ||
        null === deps ||
        isArrayImpl(deps) ||
        console.error(
          "%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.",
          currentHookNameInPRODUCTION,
          typeof deps
        );
    }
    function warnOnUseFormStateInPRODUCTION() {
      var componentName = getComponentNameFromFiber(currentlyRenderingFiber);
    ...
    function renderWithHooks(
      ...
      hookTypesPRODUCTION = null !== current ? current._debugHookTypes : null;
      hookTypesUpdateIndexPRODUCTION = -1;
      ...
      ReactSharedInternals.H =
        null !== current && null !== current.memoizedState
          ? HooksDispatcherOnUpdateInPRODUCTION
          : null !== hookTypesPRODUCTION
            ? HooksDispatcherOnMountWithHookTypesInPRODUCTION
            : HooksDispatcherOnMountInPRODUCTION;
      shouldDoubleInvokeUserFnsInHooksPRODUCTION = nextRenderLanes =
        0 !== (workInProgress.mode & StrictLegacyMode);
      var children = callComponentInPRODUCTION(Component, props, secondArg);
    ...
    function finishRenderingHooks(current, workInProgress) {
      workInProgress._debugHookTypes = hookTypesPRODUCTION;
      ...
      null === current ||
        ...
        null !== current &&
          ...
          (didReceiveUpdate = !0));
      needsToResetSuspendedThenablePRODUCTION
        ? ((needsToResetSuspendedThenablePRODUCTION = !1), (current = !0))
        : (current = !1);
      current &&
        ((workInProgress =
    ...
    function renderWithHooksAgain(workInProgress, Component, props, secondArg) {
      ...
      do {
        ...
        hookTypesUpdateIndexPRODUCTION = -1;
        ReactSharedInternals.H = HooksDispatcherOnRerenderInPRODUCTION;
        children = callComponentInPRODUCTION(Component, props, secondArg);
    ...
    function resetHooksOnUnwind(workInProgress) {
      ...
      hookTypesPRODUCTION =
        ...
        currentlyRenderingFiber =
          null;
      hookTypesUpdateIndexPRODUCTION = -1;
      currentHookNameInPRODUCTION = null;
      didScheduleRenderPhaseUpdateDuringThisPass = !1;
      thenableIndexCounter$1 = 0;
      thenableState$1 = null;
    }
    ...
    function dispatchSetStateInternal(fiber, queue, action, lane) {
      ...
      if (isRenderPhaseUpdate(fiber)) enqueueRenderPhaseUpdate(queue, update);
        ...
        if (
          ...
          ReactSharedInternals.H = InvalidNestedHooksDispatcherOnUpdateInPRODUCTION;
          try {
        ...
        if (
          ...
          (current.elementType === elementType ||
            ...
            ("object" === typeof elementType &&
              ...
              callLazyInitInPRODUCTION(elementType) === current.type))
        )
          return (
        ...
        if ("object" === typeof newChild && null !== newChild) {
          switch (newChild.$$typeof) {
            ...
            case REACT_LAZY_TYPE:
              ...
              newChild = callLazyInitInPRODUCTION(newChild);
      ...
      function warnOnInvalidKey(returnFiber, workInProgress, child, knownKeys) {
        ...
        switch (child.$$typeof) {
          ...
          case REACT_PORTAL_TYPE:
            ...
            runWithFiberInPRODUCTION(workInProgress, function () {
              console.error(
            ...
            break;
          case REACT_LAZY_TYPE:
            (child = callLazyInitInPRODUCTION(child)),
                  ...
                  if (currentFirstChild.key === key) {
                    ...
                    if (key === REACT_FRAGMENT_TYPE) {
                      ...
                      ("object" === typeof key &&
                        ...
                        callLazyInitInPRODUCTION(key) === currentFirstChild.type)
                    ) {
                      deleteRemainingChildren(
                        returnFiber,
                        currentFirstChild.sibling
        ...
        if (
          ...
          (addendum = getComponentNameFromType(ctor) || "Component"),
            ...
            didWarnAboutLegacyLifecyclesAndDerivedState.has(addendum) ||
              ...
              console.error(
                "Unsafe legacy lifecycles will not be called for components using new component APIs.\n\n%s uses %s but also contains the following legacy lifecycles:%s%s%s\n\nThe above lifecycles should be removed. Learn more about this warning here:\nhttps://react.PRODUCTION/link/unsafe-component-lifecycles",
                addendum,
                ctor,
                null !== workInProgress ? "\n  " + workInProgress : "",
                null !== props ? "\n  " + props : "",
    ...
    function mountClassInstance(workInProgress, ctor, newProps, renderLanes) {
      ...
      ctor.childContextTypes &&
        ...
        console.error(
          "%s uses the legacy childContextTypes API which was removed in React 19. Use React.createContext() instead. (https://react.PRODUCTION/link/legacy-context)",
          name
        ));
      ctor.contextTypes &&
        ...
        console.error(
          "%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with static contextType instead. (https://react.PRODUCTION/link/legacy-context)",
          name
        ));
    ...
    function createRootErrorUpdate(root, errorInfo, lane) {
      ...
      lane.callback = function () {
        runWithFiberInPRODUCTION(errorInfo.source, logUncaughtError, root, errorInfo);
      };
      return lane;
    }
    ...
    function initializeClassErrorUpdate(update, root, fiber, errorInfo) {
      ...
      null !== inst &&
        ...
        (update.callback = function () {
          ...
          callComponentDidCatchInPRODUCTION(this, errorInfo);
          "function" === typeof getDerivedStateFromError ||
            (0 === (fiber.lanes & 2) &&
              console.error(
      ...
      if (null === current) {
        ...
        if (
          ...
          return (
            ...
            validateFunctionComponentInPRODUCTION(workInProgress, type),
    ...
    function updateFunctionComponent(
      ...
      null === current &&
        (validateFunctionComponentInPRODUCTION(workInProgress, workInProgress.type),
        Component.contextTypes &&
          ((componentName = getComponentNameFromType(Component) || "Unknown"),
          didWarnAboutContextTypes[componentName] ||
            ((didWarnAboutContextTypes[componentName] = !0),
            console.error(
              "%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with React.useContext() instead. (https://react.PRODUCTION/link/legacy-context)",
              componentName
            ))));
      prepareToReadContext(workInProgress);
      markComponentRenderStarted(workInProgress);
    ...
    function updateClassComponent(
      ...
      switch (shouldErrorImpl(workInProgress)) {
        ...
        case !0:
          ...
          _instance = Error("Simulated error coming from PRODUCTIONTools");
    ...
    function finishClassComponent(
      ...
      if (
        ...
        markComponentRenderStarted(workInProgress);
        Component = callRenderInPRODUCTION(shouldUpdate);
        if (workInProgress.mode & StrictLegacyMode) {
          setIsStrictModeForPRODUCTIONtools(!0);
          try {
            callRenderInPRODUCTION(shouldUpdate);
          } finally {
            setIsStrictModeForPRODUCTIONtools(!1);
          }
        }
    ...
    function validateFunctionComponentInPRODUCTION(workInProgress, Component) {
      Component &&
      ...
      if (
        ...
        if (didSuspend)
          ...
          (showFallback = getSuspenseInstanceFallbackErrorDetails()),
            (JSCompiler_PRODUCTION = showFallback.digest),
            ...
            (nextPrimaryChildren.digest = JSCompiler_PRODUCTION),
            (JSCompiler_PRODUCTION = void 0 === showFallback ? null : showFallback),
            (nextProps = {
              value: nextPrimaryChildren,
              source: null,
              stack: JSCompiler_PRODUCTION
            }),
            "string" === typeof JSCompiler_PRODUCTION &&
      ...
      switch (workInProgress.tag) {
        case 16:
          a: if (
            ...
            (current = callLazyInitInPRODUCTION(prevSibling)),
            ...
            shouldConstruct(current)
              ...
              : ((workInProgress.tag = 0),
                validateFunctionComponentInPRODUCTION(workInProgress, current),
                (workInProgress.type = current =
                  resolveFunctionForHotReloading(current)),
        ...
        case 9:
          return (
            ...
            markComponentRenderStarted(workInProgress),
            (returnFiber = callComponentInPRODUCTION(
              returnFiber,
              prevSibling,
              void 0
            )),
          ...
          if (null !== current && null != workInProgress.stateNode)
            ...
            for (var key in _type2.validAttributes)
              newProps.hasOwnProperty(key) &&
                ReactNativePrivateInterface.deepFreezeAndThrowOnMutationInPRODUCTION(
                  newProps[key]
                );
            key = diffProperties(
              null,
        ...
        if (null !== lastEffect) {
          ...
          do {
            if (
              ...
              (lastEffect = runWithFiberInPRODUCTION(
                finishedWork,
                callCreateInPRODUCTION,
                updateQueue
              )),
              (flags & Insertion) !== NoFlags &&
                ...
                null === lastEffect
                  ...
                  : "function" === typeof lastEffect.then
                    ? "\n\nIt looks like you wrote " +
                      ...
                      hookName +
                      "(() => {\n  async function fetchData() {\n    // You can await here\n    const response = await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://react.PRODUCTION/link/hooks-data-fetching"
    ...
    function commitClassDidMount(finishedWork) {
      ...
      "function" === typeof instance.componentDidMount &&
        runWithFiberInPRODUCTION(
          finishedWork,
          callComponentDidMountInPRODUCTION,
          finishedWork,
          instance
        );
    }
    ...
    function commitClassSnapshot(finishedWork, current) {
      ...
      try {
        ...
        var snapshot = runWithFiberInPRODUCTION(
          finishedWork,
        ...
        void 0 !== snapshot ||
          ...
          runWithFiberInPRODUCTION(finishedWork, function () {
            console.error(
    ...
    function safelyCallComponentWillUnmount(
      ...
      shouldProfile(current)
        ? (startEffectTimer(),
          runWithFiberInPRODUCTION(
            current,
            callComponentWillUnmountInPRODUCTION,
            current,
            nearestMountedAncestor,
            instance
          ),
    ...
    function safelyAttachRef(current, nearestMountedAncestor) {
      try {
        runWithFiberInPRODUCTION(current, commitAttachRef, current);
      } catch (error) {
        ...
        if ("function" === typeof refCleanup)
          try {
            if (shouldProfile(current))
              try {
                startEffectTimer(), runWithFiberInPRODUCTION(current, refCleanup);
              } finally {
                recordEffectDuration(current);
              }
            else runWithFiberInPRODUCTION(current, refCleanup);
          } catch (error) {
            captureCommitPhaseError(current, nearestMountedAncestor, error);
          } finally {
          ...
          try {
            if (shouldProfile(current))
              try {
                startEffectTimer(), runWithFiberInPRODUCTION(current, ref, null);
              } finally {
                recordEffectDuration(current);
              }
            else runWithFiberInPRODUCTION(current, ref, null);
          } catch (error$3) {
            ...
            if (((finishedRoot = finishedWork.stateNode), null === current))
              ...
              shouldProfile(finishedWork)
                ? (startEffectTimer(),
                  runWithFiberInPRODUCTION(
                    finishedWork,
                    callComponentDidUpdateInPRODUCTION,
                    finishedWork,
                    finishedRoot,
                    prevProps,
                    current,
              ...
              if (5 === root.tag) {
                if (null === current) {
                  ...
                  try {
                    (_oldProps = wasHidden.stateNode),
                      existingHiddenCallbacks
                        ? runWithFiberInPRODUCTION(wasHidden, hideInstance, _oldProps)
                        : runWithFiberInPRODUCTION(
                            wasHidden,
                            unhideInstance,
                            wasHidden.stateNode,
                ...
                if (null === current) {
                  ...
                  try {
                    ...
                    existingHiddenCallbacks
                      ? runWithFiberInPRODUCTION(wasHidden, hideTextInstance, instance)
                      : runWithFiberInPRODUCTION(
                          wasHidden,
                          unhideTextInstance,
                          instance,
    ...
    function commitReconciliationEffects(finishedWork) {
      ...
      if (flags & 2) {
        try {
          runWithFiberInPRODUCTION(finishedWork, commitPlacement, finishedWork);
        } catch (error) {
          captureCommitPhaseError(finishedWork, finishedWork.return, error);
        }
    ...
    function invokeLayoutEffectMountInPRODUCTION(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokePassiveEffectMountInPRODUCTION(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokeLayoutEffectUnmountInPRODUCTION(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokePassiveEffectUnmountInPRODUCTION(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function scheduleUpdateOnFiber(root, fiber, lane) {
      ...
      if (
          ...
          switch (fiber.tag) {
            ...
            case 15:
              ...
              didWarnAboutUpdateInRenderForAnotherComponent.has(root) ||
                ...
                console.error(
                  "Cannot update a component (`%s`) while rendering a different component (`%s`). To locate the bad setState() call inside `%s`, follow the stack trace as described in https://react.PRODUCTION/link/setstate-in-render",
                  fiber,
                  root,
                  root
                ));
        ...
        isPRODUCTIONToolsPresent && addFiberToLanesMap(root, fiber, lane),
          warnIfUpdatesNotWrappedWithActPRODUCTION(fiber),
          root === workInProgressRoot &&
            ((executionContext & RenderContext) === NoContext &&
        ...
        if (exitStatus === RootInProgress) {
          ...
          if (0 !== root.tag && exitStatus === RootErrored) {
            ...
            if (0 !== renderWasConcurrent) {
              ...
              a: {
                exitStatus = root;
                var originallyAtPRODUCTIONtedLanes = lanesThatJustErrored;
                ...
                if (renderWasConcurrent !== RootErrored) {
                  if (workInProgressRootDidAttachPingListener) {
                    exitStatus.errorRecoveryDisabledLanes |=
                      originallyAtPRODUCTIONtedLanes;
    ...
    function markRootSuspended(
      ...
      for (var lanes = suspendedLanes; 0 < lanes; ) {
        var index = 31 - clz32(lanes),
          lane = 1 << index;
        didAtPRODUCTIONtEntireTree[index] = -1;
        lanes &= ~lane;
      }
      0 !== spawnedLane &&
    ...
    function performUnitOfWork(unitOfWork) {
      ...
      0 !== (unitOfWork.mode & 2)
        ? (startProfilerTimer(unitOfWork),
          (current = runWithFiberInPRODUCTION(
            unitOfWork,
            beginWork,
            current,
            unitOfWork,
    ...
    function replaySuspendedUnitOfWork(unitOfWork) {
      var next = runWithFiberInPRODUCTION(unitOfWork, replayBeginWork, unitOfWork);
      unitOfWork.memoizedProps = unitOfWork.pendingProps;
    ...
    function flushSpawnedWork() {
      if (
        ...
        rootDidHavePassiveEffects || commitDoubleInvokeEffectsInPRODUCTION(root, !1);
    ...
    function flushPassiveEffects() {
      ...
      try {
        ...
        commitDoubleInvokeEffectsInPRODUCTION(root$jscomp$0, !0);
        executionContext = prevExecutionContext;
        flushSyncWorkAcrossRoots_impl(0, !1);
    ...
    function captureCommitPhaseError(
      ...
      if (3 === sourceFiber.tag)
        ...
        console.error(
          "Internal React error: AtPRODUCTIONted to capture a commit phase error inside a detached tree. This indicates a bug in React. Potential causes include deleting the same fiber more than once, committing an already-finished tree, or an inconsistent return pointer.\n\nError message:\n\n%s",
          error
        );
      }
    }
    ...
    function pingSuspendedRoot(root, wakeable, pingedLanes) {
      ...
      0 !== root.tag &&
        ...
        null === ReactSharedInternals.actQueue &&
        console.error(
          "A suspended resource finished loading inside a test, but the event was not wrapped in act(...).\n\nWhen testing, code that resolves suspended data should be wrapped into act(...):\n\nact(() => {\n  /* finish loading suspended data */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.PRODUCTION/link/wrap-tests-with-act"
        );
      workInProgressRoot === root &&
    ...
    function recursivelyTraverseAndDoubleInvokeEffectsInPRODUCTION(
      root$jscomp$0,
      parentFiber,
      isInStrictMode
    ) {
        ...
        for (parentFiber = parentFiber.child; null !== parentFiber; ) {
          ...
          22 !== fiber.tag
            ? fiber.flags & 67108864
              ...
              : recursivelyTraverseAndDoubleInvokeEffectsInPRODUCTION(
                  root,
                  fiber,
                  isStrictModeFiber
                )
    ...
    function commitDoubleInvokeEffectsInPRODUCTION(root, hasPassiveEffects) {
      0 !== root.tag
        ? ((hasPassiveEffects = !0),
          1 !== root.tag ||
        ...
        : runWithFiberInPRODUCTION(
            root.current,
            legacyCommitDoubleInvokeEffectsInPRODUCTION,
            root.current,
            hasPassiveEffects
          );
    }
    function legacyCommitDoubleInvokeEffectsInPRODUCTION(fiber, hasPassiveEffects) {
      invokeEffectsInPRODUCTION(fiber, 134217728, invokeLayoutEffectUnmountInPRODUCTION);
      hasPassiveEffects &&
        invokeEffectsInPRODUCTION(fiber, 268435456, invokePassiveEffectUnmountInPRODUCTION);
      invokeEffectsInPRODUCTION(fiber, 134217728, invokeLayoutEffectMountInPRODUCTION);
      hasPassiveEffects &&
        invokeEffectsInPRODUCTION(fiber, 268435456, invokePassiveEffectMountInPRODUCTION);
    }
    function invokeEffectsInPRODUCTION(firstChild, fiberFlags, invokeEffectFn) {
    ...
    function warnAboutUpdateOnNotYetMountedFiberInPRODUCTION(fiber) {
      if ((executionContext & RenderContext) === NoContext && fiber.mode & 1) {
        ...
        if (
          ...
          runWithFiberInPRODUCTION(fiber, function () {
            console.error(
    ...
    function warnIfUpdatesNotWrappedWithActPRODUCTION(fiber) {
      if (fiber.mode & 1) {
    ...
    function findHostInstanceWithWarning(component, methodName) {
      ...
      if (component.mode & StrictLegacyMode) {
        ...
        didWarnAboutFindNodeInStrictMode[componentName] ||
          ...
          runWithFiberInPRODUCTION(component, function () {
            fiber.mode & StrictLegacyMode
              ? console.error(
                  "%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.PRODUCTION/link/strict-mode-find-node",
                  methodName,
                  methodName,
                  componentName
                )
              : console.error(
                  "%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.PRODUCTION/link/strict-mode-find-node",
                  methodName,
                  methodName,
                  componentName
                );
    ...
    function getCurrentFiberForPRODUCTIONTools() {
      return current;
    }
    ...
    function nativeOnUncaughtError(error, errorInfo) {
      !1 !==
        ...
        console.warn(
          ...
          "Consider adding an error boundary to your tree to customize error handling behavior.\nVisit https://react.PRODUCTION/link/error-boundaries to learn more about error boundaries."
        ));
    }
      ...
      ResponderEventPlugin = {
        ...
        extractEvents: function (
          ...
          if (
            ...
            targetInst = JSCompiler_PRODUCTION === responderInst;
            JSCompiler_PRODUCTION = ResponderSyntheticEvent.getPooled(
              shouldSetEventType,
              JSCompiler_PRODUCTION,
              nativeEvent,
              nativeEventTarget
            );
            JSCompiler_PRODUCTION.touchHistory =
            ...
            b: {
              shouldSetEventType = JSCompiler_PRODUCTION._dispatchListeners;
              targetInst = JSCompiler_PRODUCTION._dispatchInstances;
              validateEventDispatches(JSCompiler_PRODUCTION);
              if (isArrayImpl(shouldSetEventType))
                for (
                  depthA = 0;
                  depthA < shouldSetEventType.length &&
                  !JSCompiler_PRODUCTION.isPropagationStopped();
                  depthA++
                ) {
                  if (
                ...
                shouldSetEventType &&
                shouldSetEventType(JSCompiler_PRODUCTION, targetInst)
              ) {
            ...
            JSCompiler_PRODUCTION._dispatchInstances = null;
            JSCompiler_PRODUCTION._dispatchListeners = null;
            JSCompiler_PRODUCTION.isPersistent() ||
              JSCompiler_PRODUCTION.constructor.release(JSCompiler_PRODUCTION);
            if (shouldSetEventType && shouldSetEventType !== responderInst)
              if (
                ...
                (targetInst = !0 === executeDirectDispatch(JSCompiler_PRODUCTION)),
                responderInst)
              )
                if (
      ...
      receiveTouches: function (eventTopLevelType, touches, changedIndices) {
        if (
          ...
          for (var i = 0; i < changedIndices.length; i++) {
            ...
            JSCompiler_PRODUCTION.push(touches[index]);
            touches[index] = null;
          }
        ...
        for (
          ...
          null !== target &&
            ...
            (1 > target
              ...
              : (index = target));
          _receiveRootNodeIPRODUCTIONent(index, eventTopLevelType, i);
        }
      }
    });
    (function (
    ...
    var emptyObject$1 = {},
      ...
      ReactNativeFiberHostComponent = (function () {
        function ReactNativeFiberHostComponent(
          tag,
          viewConfig,
          internalInstanceHandlePRODUCTION
        ) {
          this.viewConfig = void 0;
          this._nativeTag = tag;
          this._children = [];
          this.viewConfig = viewConfig;
          this._internalFiberInstanceHandlePRODUCTION = internalInstanceHandlePRODUCTION;
        }
    ...
    var getInspectorDataForInstance = function (closestInstance) {
      ...
      closestInstance = getStackByFiberInPRODUCTIONAndprod(closestInstance);
      return {
      ...
      extraPRODUCTIONToolsConfig = {
        ...
        getInspectorDataForViewAtPoint: function (
          ...
          fabricNode
            ...
            : null != inspectedView._internalFiberInstanceHandlePRODUCTION
    ...
    var rendererCursorPRODUCTION = createCursor(null);
    var rendererSigil = {};
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
      ...
      if (0 < UNSAFE_componentWillMountUniqueNames.size) {
        ...
        console.error(
          "Using UNSAFE_componentWillMount in strict mode is not recommended and may indicate bugs in your code. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n\nPlease update the following components: %s",
          sortedNames
        );
      }
      0 < UNSAFE_componentWillReceivePropsUniqueNames.size &&
        ...
        console.error(
          "Using UNSAFE_componentWillReceiveProps in strict mode is not recommended and may indicate bugs in your code. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://react.PRODUCTION/link/derived-state\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < UNSAFE_componentWillUpdateUniqueNames.size &&
        ...
        console.error(
          "Using UNSAFE_componentWillUpdate in strict mode is not recommended and may indicate bugs in your code. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillMountUniqueNames.size &&
        ((sortedNames = setToSortedString(componentWillMountUniqueNames)),
        console.warn(
          "componentWillMount has been renamed, and is not recommended for use. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n* Rename componentWillMount to UNSAFE_componentWillMount to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillReceivePropsUniqueNames.size &&
        ...
        console.warn(
          "componentWillReceiveProps has been renamed, and is not recommended for use. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://react.PRODUCTION/link/derived-state\n* Rename componentWillReceiveProps to UNSAFE_componentWillReceiveProps to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillUpdateUniqueNames.size &&
        ((sortedNames = setToSortedString(componentWillUpdateUniqueNames)),
        console.warn(
          "componentWillUpdate has been renamed, and is not recommended for use. See https://react.PRODUCTION/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* Rename componentWillUpdate to UNSAFE_componentWillUpdate to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
    };
    ...
    ReactStrictModeWarnings.flushLegacyContextWarning = function () {
      pendingLegacyContextWarning.forEach(function (fiberArray) {
        if (0 !== fiberArray.length) {
          ...
          runWithFiberInPRODUCTION(firstFiber, function () {
            console.error(
              "Legacy context API has been detected within a strict-mode tree.\n\nThe old API will be supported in all 16.x releases, but applications using it should migrate to the new version.\n\nPlease update the following components: %s\n\nLearn more about this warning here: https://react.PRODUCTION/link/legacy-context",
              sortedNames
            );
          });
        }
    ...
    var renderLanes = 0,
      ...
      HooksDispatcherOnMountInPRODUCTION = null,
      HooksDispatcherOnMountWithHookTypesInPRODUCTION = null,
      HooksDispatcherOnUpdateInPRODUCTION = null,
      HooksDispatcherOnRerenderInPRODUCTION = null,
      InvalidNestedHooksDispatcherOnMountInPRODUCTION = null,
      InvalidNestedHooksDispatcherOnUpdateInPRODUCTION = null,
      InvalidNestedHooksDispatcherOnRerenderInPRODUCTION = null;
    HooksDispatcherOnMountInPRODUCTION = {
      ...
      useCallback: function (callback, deps) {
        currentHookNameInPRODUCTION = "useCallback";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(deps);
        return mountCallback(callback, deps);
      },
      useContext: function (context) {
        currentHookNameInPRODUCTION = "useContext";
        mountHookTypesPRODUCTION();
        return readContext(context);
      },
      useEffect: function (create, createDeps) {
        currentHookNameInPRODUCTION = "useEffect";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(createDeps);
        return mountEffect(create, createDeps);
      },
      useImperativeHandle: function (ref, create, deps) {
        currentHookNameInPRODUCTION = "useImperativeHandle";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(deps);
        return mountImperativeHandle(ref, create, deps);
      },
      useInsertionEffect: function (create, deps) {
        currentHookNameInPRODUCTION = "useInsertionEffect";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(deps);
        mountEffectImpl(4, Insertion, create, deps);
      },
      useLayoutEffect: function (create, deps) {
        currentHookNameInPRODUCTION = "useLayoutEffect";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(deps);
        return mountLayoutEffect(create, deps);
      },
      useMemo: function (create, deps) {
        currentHookNameInPRODUCTION = "useMemo";
        mountHookTypesPRODUCTION();
        checkDepsAreArrayPRODUCTION(deps);
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnMountInPRODUCTION;
        try {
      ...
      useReducer: function (reducer, initialArg, init) {
        currentHookNameInPRODUCTION = "useReducer";
        mountHookTypesPRODUCTION();
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnMountInPRODUCTION;
        try {
      ...
      useRef: function (initialValue) {
        currentHookNameInPRODUCTION = "useRef";
        mountHookTypesPRODUCTION();
        return mountRef(initialValue);
      },
      useState: function (initialState) {
        currentHookNameInPRODUCTION = "useState";
        mountHookTypesPRODUCTION();
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnMountInPRODUCTION;
        try {
      ...
      useDebugValue: function () {
        currentHookNameInPRODUCTION = "useDebugValue";
        mountHookTypesPRODUCTION();
      },
      useDeferredValue: function (value, initialValue) {
        currentHookNameInPRODUCTION = "useDeferredValue";
        mountHookTypesPRODUCTION();
        return mountDeferredValue(value, initialValue);
      },
      useTransition: function () {
        currentHookNameInPRODUCTION = "useTransition";
        mountHookTypesPRODUCTION();
        return mountTransition();
      },
      useSyncExternalStore: function (subscribe, getSnapshot) {
        currentHookNameInPRODUCTION = "useSyncExternalStore";
        mountHookTypesPRODUCTION();
        return mountSyncExternalStore(subscribe, getSnapshot);
      },
      useId: function () {
        currentHookNameInPRODUCTION = "useId";
        mountHookTypesPRODUCTION();
        return mountId();
      },
      useFormState: function (action, initialState) {
        currentHookNameInPRODUCTION = "useFormState";
        mountHookTypesPRODUCTION();
        warnOnUseFormStateInPRODUCTION();
        return mountActionState(action, initialState);
      },
      useActionState: function (action, initialState) {
        currentHookNameInPRODUCTION = "useActionState";
        mountHookTypesPRODUCTION();
        return mountActionState(action, initialState);
      },
      useOptimistic: function (passthrough) {
        currentHookNameInPRODUCTION = "useOptimistic";
        mountHookTypesPRODUCTION();
      ...
      useCacheRefresh: function () {
        currentHookNameInPRODUCTION = "useCacheRefresh";
        mountHookTypesPRODUCTION();
        return mountRefresh();
      }
    };
    ...
    HooksDispatcherOnRerenderInPRODUCTION = {
      readContext: function (context) {
        return readContext(context);
      },
      use: use,
      ...
      useMemo: function (create, deps) {
        ...
        updateHookTypesPRODUCTION();
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnRerenderInPRODUCTION;
        try {
          return updateMemo(create, deps);
        } finally {
          ReactSharedInternals.H = prevDispatcher;
    ...
    InvalidNestedHooksDispatcherOnMountInPRODUCTION = {
      readContext: function (context) {
    ...
    InvalidNestedHooksDispatcherOnUpdateInPRODUCTION = {
      readContext: function (context) {
        warnInvalidContextAccess();
        return readContext(context);
      },
    ...
    InvalidNestedHooksDispatcherOnRerenderInPRODUCTION = {
      readContext: function (context) {
        warnInvalidContextAccess();
        return readContext(context);
      },
    ...
    var callComponent = {
      ...
      callRenderInPRODUCTION = callRender["react-stack-bottom-frame"].bind(callRender),
      ...
      callComponentDidMountInPRODUCTION = callComponentDidMount[
      ...
      callComponentDidUpdateInPRODUCTION = callComponentDidUpdate[
        "react-stack-bottom-frame"
      ...
      callComponentDidCatchInPRODUCTION = callComponentDidCatch[
        "react-stack-bottom-frame"
      ...
      callComponentWillUnmountInPRODUCTION = callComponentWillUnmount[
        "react-stack-bottom-frame"
      ...
      callCreateInPRODUCTION = callCreate["react-stack-bottom-frame"].bind(callCreate),
      callDestroy = {
        "react-stack-bottom-frame": function (
          current,
          nearestMountedAncestor,
    ...
    warnForMissingKey = function (returnFiber, workInProgress, child) {
      if (
        ...
        if (!ownerHasKeyUseWarning[componentKey]) {
          ...
          runWithFiberInPRODUCTION(workInProgress, function () {
            console.error(
              'Each child in a list should have a unique "key" prop.%s%s See https://react.PRODUCTION/link/warning-keys for more information.',
              currentComponentErrorInfo,
              childOwnerAppendix
            );
          });
    ...
    (function () {
      ...
      null !== extraPRODUCTIONToolsConfig &&
        (internals.rendererConfig = extraPRODUCTIONToolsConfig);
      ...
      internals.getCurrentFiber = getCurrentFiberForPRODUCTIONTools;
    ...
    exports.isChildPublicInstance = function (parentInstance, childInstance) {
      if (
        parentInstance._internalFiberInstanceHandlePRODUCTION &&
        childInstance._internalFiberInstanceHandlePRODUCTION
      )
