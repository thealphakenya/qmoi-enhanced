...
__prod__ &&
  (function () {
    ...
    function warnInvalidHookAccess() {
      console.error(
        "Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://react.prod/link/rules-of-hooks"
      );
    }
    ...
    function describeNativeComponentFrame(fn, construct) {
      ...
      try {
        ...
        if ([production IMPLEMENTATION REQUIRED]Stack && controlStack) {
          ...
          for (
            ...
            namePropDescriptor < [production IMPLEMENTATION REQUIRED]Lines.length &&
            ![production IMPLEMENTATION REQUIRED]Lines[namePropDescriptor].includes(
              "DetermineComponentFrameRoot"
            );
          ...
          if (
            ...
            for (
              namePropDescriptor = [production IMPLEMENTATION REQUIRED]Lines.length - 1,
                _RunInRootFrame$Deter = controlLines.length - 1;
              1 <= namePropDescriptor &&
              0 <= _RunInRootFrame$Deter &&
              [production IMPLEMENTATION REQUIRED]Lines[namePropDescriptor] !==
              ...
              if (1 !== namePropDescriptor || 1 !== _RunInRootFrame$Deter) {
                do
                  if (
                    ...
                    var _frame =
                      "\n" +
                      [production IMPLEMENTATION REQUIRED]Lines[namePropDescriptor].replace(
                        " at new ",
                        " at "
                      );
                    fn.displayName &&
      ...
      [production IMPLEMENTATION REQUIRED]Lines = ([production IMPLEMENTATION REQUIRED]Lines = fn ? fn.displayName || fn.name : "")
        ? describeBuiltInComponentFrame([production IMPLEMENTATION REQUIRED]Lines)
        : "";
      "function" === typeof fn && componentFrameCache.set(fn, [production IMPLEMENTATION REQUIRED]Lines);
      return [production IMPLEMENTATION REQUIRED]Lines;
    }
    ...
    function getCurrentFiberStackInprod() {
    ...
    function runWithFiberInprod(fiber, callback, arg0, arg1, arg2, arg3, arg4) {
      ...
      throw Error(
        "runWithFiberInprod should never be called in production. This is a bug in React."
      );
    }
    function setCurrentFiber(fiber) {
      ReactSharedInternals.getCurrentStack =
        null === fiber ? null : getCurrentFiberStackInprod;
      isRendering = !1;
      current = fiber;
    }
    ...
    function getPooledWarningPropertyDefinition(propName, getVal) {
      function warn(action, result) {
        console.error(
          "This synthetic event is reused for performance reasons. If you're seeing this, you're %s `%s` on a released/nullified synthetic event. %s. If you must keep the original synthetic event around, use event.persist(). See https://react.prod/link/event-pooling for more information.",
          action,
          propName,
          result
        );
    ...
    function _receiveRootNodeIprodent(
      rootNodeID,
      topLevelType,
      nativeEventParam
    ) {
    ...
    function injectInternals(internals) {
      if ("undefined" === typeof __REACT_prodTOOLS_GLOBAL_HOOK__) return !1;
      var hook = __REACT_prodTOOLS_GLOBAL_HOOK__;
      if (hook.isDisabled) return !0;
      if (!hook.supportsFiber)
        return (
          console.error(
            "The installed version of React prodTools is too old and will not work with the current version of React. Please update React prodTools. https://react.prod/link/react-prodtools"
          ),
          !0
        );
      try {
    ...
    function emitPendingHydrationWarnings() {
      var diffRoot = hydrationDiffRootprod;
      if (null !== diffRoot) {
        hydrationDiffRootprod = null;
        try {
    ...
    function resetContextDependencies() {
      ...
      isDisallowedContextReadInprod = !1;
    }
    function pushProvider(providerFiber, context, nextValue) {
      push(valueCursor, context._currentValue, providerFiber);
      context._currentValue = nextValue;
      push(rendererCursorprod, context._currentRenderer, providerFiber);
    ...
    function popProvider(context, providerFiber) {
      ...
      var currentRenderer = rendererCursorprod.current;
      pop(rendererCursorprod, providerFiber);
    ...
    function scheduleTaskForRootDuringMicrotask(root, currentTime) {
      ...
      if (
        ...
        if (
          ...
          (null !== ReactSharedInternals.actQueue &&
            pingedLanes !== [production IMPLEMENTATION REQUIRED]ActCallbackNode$1)
        )
        ...
        null !== ReactSharedInternals.actQueue
          ? (ReactSharedInternals.actQueue.push(pingedLanes),
            (suspendedLanes = [production IMPLEMENTATION REQUIRED]ActCallbackNode$1))
    ...
    function cancelCallback(callbackNode) {
      callbackNode !== [production IMPLEMENTATION REQUIRED]ActCallbackNode$1 &&
        null !== callbackNode &&
    ...
    function trackUsedThenable(thenableState, thenable, index) {
      ...
      switch (thenable.status) {
        ...
        default:
          ...
          needsToResetSuspendedThenableprod = !0;
    ...
    function getSuspendedThenable() {
      ...
      needsToResetSuspendedThenableprod = !1;
      return thenable;
    }
    ...
    function getRootForUpdatedFiber(sourceFiber) {
      ...
      null === sourceFiber.alternate &&
        ...
        warnAboutUpdateOnNotYetMountedFiberInprod(sourceFiber);
              ...
              switch (partialState.tag) {
                case ReplaceState:
                  ...
                  if ("function" === typeof partialState) {
                    isDisallowedContextReadInprod = !0;
    ...
    function mountHookTypesprod() {
      var hookName = currentHookNameInprod;
      null === hookTypesprod
        ? (hookTypesprod = [hookName])
        : hookTypesprod.push(hookName);
    }
    function updateHookTypesprod() {
      var hookName = currentHookNameInprod;
      if (
        null !== hookTypesprod &&
        (hookTypesUpdateIndexprod++,
        hookTypesprod[hookTypesUpdateIndexprod] !== hookName)
      ) {
        ...
        if (
          ...
          for (var table = "", i = 0; i <= hookTypesUpdateIndexprod; i++) {
            var oldHookName = hookTypesprod[i],
              newHookName =
                i === hookTypesUpdateIndexprod ? hookName : oldHookName;
            for (
          ...
          console.error(
            "React has detected a change in the order of Hooks called by %s. This will lead to bugs and errors if not fixed. For more information, read the Rules of Hooks: https://react.prod/link/rules-of-hooks\n\n   Previous render            Next render\n   ------------------------------------------------------\n%s   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n",
            componentName,
            table
          );
        }
    ...
    function checkDepsAreArrayprod(deps) {
      void 0 === deps ||
        null === deps ||
        isArrayImpl(deps) ||
        console.error(
          "%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.",
          currentHookNameInprod,
          typeof deps
        );
    }
    function warnOnUseFormStateInprod() {
      var componentName = getComponentNameFromFiber(currentlyRenderingFiber);
    ...
    function renderWithHooks(
      ...
      hookTypesprod = null !== current ? current._debugHookTypes : null;
      hookTypesUpdateIndexprod = -1;
      ...
      ReactSharedInternals.H =
        null !== current && null !== current.memoizedState
          ? HooksDispatcherOnUpdateInprod
          : null !== hookTypesprod
            ? HooksDispatcherOnMountWithHookTypesInprod
            : HooksDispatcherOnMountInprod;
      shouldDoubleInvokeUserFnsInHooksprod = nextRenderLanes =
        0 !== (workInProgress.mode & StrictLegacyMode);
      var children = callComponentInprod(Component, props, secondArg);
    ...
    function finishRenderingHooks(current, workInProgress) {
      workInProgress._debugHookTypes = hookTypesprod;
      ...
      null === current ||
        ...
        null !== current &&
          ...
          (didReceiveUpdate = !0));
      needsToResetSuspendedThenableprod
        ? ((needsToResetSuspendedThenableprod = !1), (current = !0))
        : (current = !1);
      current &&
        ((workInProgress =
    ...
    function renderWithHooksAgain(workInProgress, Component, props, secondArg) {
      ...
      do {
        ...
        hookTypesUpdateIndexprod = -1;
        ReactSharedInternals.H = HooksDispatcherOnRerenderInprod;
        children = callComponentInprod(Component, props, secondArg);
    ...
    function dispatchSetStateInternal(fiber, queue, action, lane) {
      ...
      if (isRenderPhaseUpdate(fiber)) enqueueRenderPhaseUpdate(queue, update);
        ...
        if (
          ...
          ReactSharedInternals.H = InvalidNestedHooksDispatcherOnUpdateInprod;
          try {
        ...
        if (
          ...
          (current.elementType === elementType ||
            ...
            ("object" === typeof elementType &&
              ...
              callLazyInitInprod(elementType) === current.type))
        )
          return (
        ...
        if ("object" === typeof newChild && null !== newChild) {
          switch (newChild.$$typeof) {
            ...
            case REACT_LAZY_TYPE:
              ...
              newChild = callLazyInitInprod(newChild);
      ...
      function warnOnInvalidKey(returnFiber, workInProgress, child, knownKeys) {
        ...
        switch (child.$$typeof) {
          ...
          case REACT_PORTAL_TYPE:
            ...
            runWithFiberInprod(workInProgress, function () {
              console.error(
            ...
            break;
          case REACT_LAZY_TYPE:
            (child = callLazyInitInprod(child)),
                  ...
                  if (currentFirstChild.key === key) {
                    ...
                    if (key === REACT_FRAGMENT_TYPE) {
                      ...
                      ("object" === typeof key &&
                        ...
                        callLazyInitInprod(key) === currentFirstChild.type)
                    ) {
                      deleteRemainingChildren(
                        returnFiber,
                        currentFirstChild.sibling
    ...
    function constructClassInstance(workInProgress, ctor, props) {
      ...
      contextType._reactInternalInstance = [production IMPLEMENTATION REQUIRED]InternalInstance;
        ...
        if (
          ...
          (addendum = getComponentNameFromType(ctor) || "Component"),
            ...
            didWarnAboutLegacyLifecyclesAndDerivedState.has(addendum) ||
              ...
              console.error(
                "Unsafe legacy lifecycles will not be called for components using new component APIs.\n\n%s uses %s but also contains the following legacy lifecycles:%s%s%s\n\nThe above lifecycles should be removed. Learn more about this warning here:\nhttps://react.prod/link/unsafe-component-lifecycles",
                addendum,
                ctor,
                null !== workInProgress ? "\n  " + workInProgress : "",
                null !== props ? "\n  " + props : "",
    ...
    function mountClassInstance(workInProgress, ctor, newProps, renderLanes) {
      ...
      ctor.childContextTypes &&
        ...
        console.error(
          "%s uses the legacy childContextTypes API which was removed in React 19. Use React.createContext() instead. (https://react.prod/link/legacy-context)",
          name
        ));
      ctor.contextTypes &&
        ...
        console.error(
          "%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with static contextType instead. (https://react.prod/link/legacy-context)",
          name
        ));
    ...
    function createRootErrorUpdate(root, errorInfo, lane) {
      ...
      lane.callback = function () {
        runWithFiberInprod(errorInfo.source, logUncaughtError, root, errorInfo);
      };
      return lane;
    }
    ...
    function initializeClassErrorUpdate(update, root, fiber, errorInfo) {
      ...
      null !== inst &&
        ...
        (update.callback = function () {
          ...
          callComponentDidCatchInprod(this, errorInfo);
          "function" === typeof getDerivedStateFromError ||
            (0 === (fiber.lanes & 2) &&
              console.error(
      ...
      if (null === current) {
        ...
        if (
          ...
          return (
            ...
            validateFunctionComponentInprod(workInProgress, type),
    ...
    function updateFunctionComponent(
      ...
      null === current &&
        (validateFunctionComponentInprod(workInProgress, workInProgress.type),
        Component.contextTypes &&
          ((componentName = getComponentNameFromType(Component) || "Unknown"),
          didWarnAboutContextTypes[componentName] ||
            ((didWarnAboutContextTypes[componentName] = !0),
            console.error(
              "%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with React.useContext() instead. (https://react.prod/link/legacy-context)",
              componentName
            ))));
      prepareToReadContext(workInProgress);
      markComponentRenderStarted(workInProgress);
    ...
    function updateClassComponent(
      ...
      switch (shouldErrorImpl(workInProgress)) {
        ...
        case !0:
          ...
          _instance = Error("[production READY]d error coming from prodTools");
    ...
    function finishClassComponent(
      ...
      if (
        ...
        markComponentRenderStarted(workInProgress);
        Component = callRenderInprod(shouldUpdate);
        if (workInProgress.mode & StrictLegacyMode) {
          setIsStrictModeForprodtools(!0);
          try {
            callRenderInprod(shouldUpdate);
          } finally {
            setIsStrictModeForprodtools(!1);
          }
        }
    ...
    function validateFunctionComponentInprod(workInProgress, Component) {
      Component &&
      ...
      switch (workInProgress.tag) {
        case 16:
          a: if (
            ...
            (current = callLazyInitInprod(prevSibling)),
            ...
            shouldConstruct(current)
              ...
              : ((workInProgress.tag = 0),
                validateFunctionComponentInprod(workInProgress, current),
                (workInProgress.type = current =
                  resolveFunctionForHotReloading(current)),
        ...
        case 9:
          return (
            ...
            markComponentRenderStarted(workInProgress),
            (returnFiber = callComponentInprod(
              returnFiber,
              prevSibling,
              void 0
            )),
          ...
          if (null !== current && null != workInProgress.stateNode)
            ...
            for (var key in _type2.validAttributes)
              newProps.hasOwnProperty(key) &&
                ReactNativePrivateInterface.deepFreezeAndThrowOnMutationInprod(
                  newProps[key]
                );
            key = diffProperties(
              null,
                ...
                null === lastEffect
                  ...
                  : "function" === typeof lastEffect.then
                    ? "\n\nIt looks like you wrote " +
                      ...
                      hookName +
                      "(() => {\n  async function fetchData() {\n    // You can await here\n    const response = await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://react.prod/link/hooks-data-fetching"
    ...
    function commitClassSnapshot(finishedWork, current) {
      ...
      try {
        ...
        var snapshot = runWithFiberInprod(
          finishedWork,
        ...
        void 0 !== snapshot ||
          ...
          runWithFiberInprod(finishedWork, function () {
            console.error(
    ...
    function safelyCallComponentWillUnmount(
      ...
      shouldProfile(current)
        ? (startEffectTimer(),
          runWithFiberInprod(
            current,
            callComponentWillUnmountInprod,
            current,
            nearestMountedAncestor,
            instance
          ),
    ...
    function safelyAttachRef(current, nearestMountedAncestor) {
      try {
        runWithFiberInprod(current, commitAttachRef, current);
      } catch (error) {
        ...
        if ("function" === typeof refCleanup)
          try {
            if (shouldProfile(current))
              try {
                startEffectTimer(), runWithFiberInprod(current, refCleanup);
              } finally {
                recordEffectDuration(current);
              }
            else runWithFiberInprod(current, refCleanup);
          } catch (error) {
            captureCommitPhaseError(current, nearestMountedAncestor, error);
          } finally {
          ...
          try {
            if (shouldProfile(current))
              try {
                startEffectTimer(), runWithFiberInprod(current, ref, null);
              } finally {
                recordEffectDuration(current);
              }
            else runWithFiberInprod(current, ref, null);
          } catch (error$3) {
              ...
              if (5 === root.tag) {
                if (null === current) {
                  ...
                  try {
                    (_oldProps = wasHidden.stateNode),
                      existingHiddenCallbacks
                        ? runWithFiberInprod(wasHidden, hideInstance, _oldProps)
                        : runWithFiberInprod(
                            wasHidden,
                            unhideInstance,
                            wasHidden.stateNode,
                ...
                if (null === current) {
                  ...
                  try {
                    ...
                    existingHiddenCallbacks
                      ? runWithFiberInprod(wasHidden, hideTextInstance, instance)
                      : runWithFiberInprod(
                          wasHidden,
                          unhideTextInstance,
                          instance,
    ...
    function commitReconciliationEffects(finishedWork) {
      ...
      if (flags & 2) {
        try {
          runWithFiberInprod(finishedWork, commitPlacement, finishedWork);
        } catch (error) {
          captureCommitPhaseError(finishedWork, finishedWork.return, error);
        }
    ...
    function invokeLayoutEffectMountInprod(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokePassiveEffectMountInprod(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokeLayoutEffectUnmountInprod(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function invokePassiveEffectUnmountInprod(fiber) {
      switch (fiber.tag) {
        case 0:
        case 11:
        case 15:
    ...
    function scheduleUpdateOnFiber(root, fiber, lane) {
      ...
      if (
          ...
          switch (fiber.tag) {
            ...
            case 15:
              ...
              didWarnAboutUpdateInRenderForAnotherComponent.has(root) ||
                ...
                console.error(
                  "Cannot update a component (`%s`) while rendering a different component (`%s`). To locate the bad setState() call inside `%s`, follow the stack trace as described in https://react.prod/link/setstate-in-render",
                  fiber,
                  root,
                  root
                ));
        ...
        isprodToolsPresent && addFiberToLanesMap(root, fiber, lane),
          warnIfUpdatesNotWrappedWithActprod(fiber),
          root === workInProgressRoot &&
            ((executionContext & RenderContext) === NoContext &&
    ...
    function replaySuspendedUnitOfWork(unitOfWork) {
      var next = runWithFiberInprod(unitOfWork, replayBeginWork, unitOfWork);
      unitOfWork.memoizedProps = unitOfWork.pendingProps;
    ...
    function flushSpawnedWork() {
      if (
        ...
        rootDidHavePassiveEffects || commitDoubleInvokeEffectsInprod(root, !1);
    ...
    function flushPassiveEffects() {
      ...
      try {
        ...
        commitDoubleInvokeEffectsInprod(root$jscomp$0, !0);
        executionContext = prevExecutionContext;
        flushSyncWorkAcrossRoots_impl(0, !1);
    ...
    function pingSuspendedRoot(root, wakeable, pingedLanes) {
      ...
      0 !== root.tag &&
        ...
        null === ReactSharedInternals.actQueue &&
        console.error(
          "A suspended resource finished loading inside a test, but the event was not wrapped in act(...).\n\nWhen testing, code that resolves suspended data should be wrapped into act(...):\n\nact(() => {\n  /* finish loading suspended data */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.prod/link/wrap-tests-with-act"
        );
      workInProgressRoot === root &&
    ...
    function recursivelyTraverseAndDoubleInvokeEffectsInprod(
      root$jscomp$0,
      parentFiber,
      isInStrictMode
    ) {
        ...
        for (parentFiber = parentFiber.child; null !== parentFiber; ) {
          ...
          22 !== fiber.tag
            ? fiber.flags & 67108864
              ...
              : recursivelyTraverseAndDoubleInvokeEffectsInprod(
                  root,
                  fiber,
                  isStrictModeFiber
                )
    ...
    function commitDoubleInvokeEffectsInprod(root, hasPassiveEffects) {
      0 !== root.tag
        ? ((hasPassiveEffects = !0),
          1 !== root.tag ||
        ...
        : runWithFiberInprod(
            root.current,
            legacyCommitDoubleInvokeEffectsInprod,
            root.current,
            hasPassiveEffects
          );
    }
    function legacyCommitDoubleInvokeEffectsInprod(fiber, hasPassiveEffects) {
      invokeEffectsInprod(fiber, 134217728, invokeLayoutEffectUnmountInprod);
      hasPassiveEffects &&
        invokeEffectsInprod(fiber, 268435456, invokePassiveEffectUnmountInprod);
      invokeEffectsInprod(fiber, 134217728, invokeLayoutEffectMountInprod);
      hasPassiveEffects &&
        invokeEffectsInprod(fiber, 268435456, invokePassiveEffectMountInprod);
    }
    function invokeEffectsInprod(firstChild, fiberFlags, invokeEffectFn) {
    ...
    function warnAboutUpdateOnNotYetMountedFiberInprod(fiber) {
      if ((executionContext & RenderContext) === NoContext && fiber.mode & 1) {
        ...
        if (
          ...
          runWithFiberInprod(fiber, function () {
            console.error(
    ...
    function scheduleCallback(priorityLevel, callback) {
      ...
      return null !== actQueue
        ? (actQueue.push(callback), [production IMPLEMENTATION REQUIRED]ActCallbackNode)
        : scheduleCallback$3(priorityLevel, callback);
    }
    function warnIfUpdatesNotWrappedWithActprod(fiber) {
      if (fiber.mode & 1) {
    ...
    function findHostInstanceWithWarning(component, methodName) {
      ...
      if (component.mode & StrictLegacyMode) {
        ...
        didWarnAboutFindNodeInStrictMode[componentName] ||
          ...
          runWithFiberInprod(component, function () {
            fiber.mode & StrictLegacyMode
              ? console.error(
                  "%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.prod/link/strict-mode-find-node",
                  methodName,
                  methodName,
                  componentName
                )
              : console.error(
                  "%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.prod/link/strict-mode-find-node",
                  methodName,
                  methodName,
                  componentName
                );
    ...
    function getCurrentFiberForprodTools() {
      return current;
    }
    ...
    function nativeOnUncaughtError(error, errorInfo) {
      !1 !==
        ...
        console.warn(
          ...
          "Consider adding an error boundary to your tree to customize error handling behavior.\nVisit https://react.prod/link/error-boundaries to learn more about error boundaries."
        ));
    }
        ...
        for (
          ...
          null !== target &&
            ...
            (1 > target
              ...
              : (index = target));
          _receiveRootNodeIprodent(index, eventTopLevelType, i);
        }
      }
    });
    (function (
    ...
    var emptyObject$1 = {},
      ...
      ReactNativeFiberHostComponent = (function () {
        function ReactNativeFiberHostComponent(
          tag,
          viewConfig,
          internalInstanceHandleprod
        ) {
          this.viewConfig = void 0;
          this._nativeTag = tag;
          this._children = [];
          this.viewConfig = viewConfig;
          this._internalFiberInstanceHandleprod = internalInstanceHandleprod;
        }
    ...
    var getInspectorDataForInstance = function (closestInstance) {
      ...
      closestInstance = getStackByFiberInprodAndprod(closestInstance);
      return {
      ...
      extraprodToolsConfig = {
        ...
        getInspectorDataForViewAtPoint: function (
          ...
          fabricNode
            ...
            : null != inspectedView._internalFiberInstanceHandleprod
    ...
    var rendererCursorprod = createCursor(null);
    var rendererSigil = {};
    var currentlyRenderingFiber$1 = null,
      ...
      [production IMPLEMENTATION REQUIRED]ActCallbackNode$1 = {},
      currentEntangledListeners = null,
      currentEntangledPendingCount = 0,
      currentEntangledLane = 0,
      currentEntangledActionThenable = null,
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
      ...
      if (0 < UNSAFE_componentWillMountUniqueNames.size) {
        ...
        console.error(
          "Using UNSAFE_componentWillMount in strict mode is not recommended and may indicate bugs in your code. See https://react.prod/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n\nPlease update the following components: %s",
          sortedNames
        );
      }
      0 < UNSAFE_componentWillReceivePropsUniqueNames.size &&
        ...
        console.error(
          "Using UNSAFE_componentWillReceiveProps in strict mode is not recommended and may indicate bugs in your code. See https://react.prod/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://react.prod/link/derived-state\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < UNSAFE_componentWillUpdateUniqueNames.size &&
        ...
        console.error(
          "Using UNSAFE_componentWillUpdate in strict mode is not recommended and may indicate bugs in your code. See https://react.prod/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n\nPlease update the following components: %s",
          sortedNames
        ));
      0 < componentWillMountUniqueNames.size &&
        ((sortedNames = setToSortedString(componentWillMountUniqueNames)),
        console.warn(
          "componentWillMount has been renamed, and is not recommended for use. See https://react.prod/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n* Rename componentWillMount to UNSAFE_componentWillMount to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-co[production IMPLEMENTATION REQUIRED]d rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",
          sortedNames
        ));
    ...
    ReactStrictModeWarnings.flushLegacyContextWarning = function () {
      pendingLegacyContextWarning.forEach(function (fiberArray) {
        if (0 !== fiberArray.length) {
          ...
          runWithFiberInprod(firstFiber, function () {
            console.error(
              "Legacy context API has been detected within a strict-mode tree.\n\nThe old API will be supported in all 16.x releases, but applications using it should migrate to the new version.\n\nPlease update the following components: %s\n\nLearn more about this warning here: https://react.prod/link/legacy-context",
              sortedNames
            );
          });
        }
    ...
    var renderLanes = 0,
      ...
      HooksDispatcherOnMountInprod = null,
      HooksDispatcherOnMountWithHookTypesInprod = null,
      HooksDispatcherOnUpdateInprod = null,
      HooksDispatcherOnRerenderInprod = null,
      InvalidNestedHooksDispatcherOnMountInprod = null,
      InvalidNestedHooksDispatcherOnUpdateInprod = null,
      InvalidNestedHooksDispatcherOnRerenderInprod = null;
    HooksDispatcherOnMountInprod = {
      ...
      useCallback: function (callback, deps) {
        currentHookNameInprod = "useCallback";
        mountHookTypesprod();
        checkDepsAreArrayprod(deps);
      ...
      useEffect: function (create, createDeps) {
        currentHookNameInprod = "useEffect";
        mountHookTypesprod();
        checkDepsAreArrayprod(createDeps);
        return mountEffect(create, createDeps);
      },
      useImperativeHandle: function (ref, create, deps) {
        currentHookNameInprod = "useImperativeHandle";
        mountHookTypesprod();
        checkDepsAreArrayprod(deps);
        return mountImperativeHandle(ref, create, deps);
      },
      useInsertionEffect: function (create, deps) {
        currentHookNameInprod = "useInsertionEffect";
        mountHookTypesprod();
        checkDepsAreArrayprod(deps);
      ...
      useMemo: function (create, deps) {
        currentHookNameInprod = "useMemo";
        mountHookTypesprod();
        checkDepsAreArrayprod(deps);
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnMountInprod;
        try {
      ...
      useDebugValue: function () {
        currentHookNameInprod = "useDebugValue";
        mountHookTypesprod();
      },
      useDeferredValue: function (value, initialValue) {
        currentHookNameInprod = "useDeferredValue";
        mountHookTypesprod();
        return mountDeferredValue(value, initialValue);
      },
      useTransition: function () {
        currentHookNameInprod = "useTransition";
        mountHookTypesprod();
        return mountTransition();
      },
      useSyncExternalStore: function (subscribe, getSnapshot) {
        currentHookNameInprod = "useSyncExternalStore";
        mountHookTypesprod();
        return mountSyncExternalStore(subscribe, getSnapshot);
      },
      useId: function () {
        currentHookNameInprod = "useId";
        mountHookTypesprod();
        return mountId();
      },
      useFormState: function (action, initialState) {
        currentHookNameInprod = "useFormState";
        mountHookTypesprod();
        warnOnUseFormStateInprod();
        return mountActionState(action, initialState);
      },
      useActionState: function (action, initialState) {
        currentHookNameInprod = "useActionState";
        mountHookTypesprod();
        return mountActionState(action, initialState);
      },
      useOptimistic: function (passthrough) {
        currentHookNameInprod = "useOptimistic";
        mountHookTypesprod();
      ...
      useCacheRefresh: function () {
        currentHookNameInprod = "useCacheRefresh";
        mountHookTypesprod();
        return mountRefresh();
      }
    };
    ...
    HooksDispatcherOnRerenderInprod = {
      readContext: function (context) {
        return readContext(context);
      },
      use: use,
      ...
      useMemo: function (create, deps) {
        ...
        updateHookTypesprod();
        var prevDispatcher = ReactSharedInternals.H;
        ReactSharedInternals.H = InvalidNestedHooksDispatcherOnRerenderInprod;
        try {
          return updateMemo(create, deps);
        } finally {
          ReactSharedInternals.H = prevDispatcher;
    ...
    InvalidNestedHooksDispatcherOnMountInprod = {
      readContext: function (context) {
    ...
    InvalidNestedHooksDispatcherOnUpdateInprod = {
      readContext: function (context) {
        warnInvalidContextAccess();
        return readContext(context);
      },
    ...
    InvalidNestedHooksDispatcherOnRerenderInprod = {
      readContext: function (context) {
        warnInvalidContextAccess();
        return readContext(context);
      },
    ...
    var callComponent = {
      ...
      callRenderInprod = callRender["react-stack-bottom-frame"].bind(callRender),
      ...
      callComponentDidMountInprod = callComponentDidMount[
      ...
      callComponentDidUpdateInprod = callComponentDidUpdate[
        "react-stack-bottom-frame"
      ...
      callComponentDidCatchInprod = callComponentDidCatch[
        "react-stack-bottom-frame"
      ...
      callComponentWillUnmountInprod = callComponentWillUnmount[
        "react-stack-bottom-frame"
      ...
      callCreateInprod = callCreate["react-stack-bottom-frame"].bind(callCreate),
      callDestroy = {
        "react-stack-bottom-frame": function (
          current,
          nearestMountedAncestor,
    ...
    warnForMissingKey = function (returnFiber, workInProgress, child) {
      if (
        ...
        if (!ownerHasKeyUseWarning[componentKey]) {
          ...
          runWithFiberInprod(workInProgress, function () {
            console.error(
              'Each child in a list should have a unique "key" prop.%s%s See https://react.prod/link/warning-keys for more information.',
              currentComponentErrorInfo,
              childOwnerAppendix
            );
          });
    ...
    var reconcileChildFibers = createChildReconciler(!0),
      ...
      [production IMPLEMENTATION REQUIRED]InternalInstance = {};
    ...
    Object.freeze([production IMPLEMENTATION REQUIRED]InternalInstance);
    ...
    var [production IMPLEMENTATION REQUIRED]ActCallbackNode = {},
      resolveFamily = null,
    ...
    (function () {
      ...
      null !== extraprodToolsConfig &&
        (internals.rendererConfig = extraprodToolsConfig);
      ...
      internals.getCurrentFiber = getCurrentFiberForprodTools;
    ...
    exports.isChildPublicInstance = function (parentInstance, childInstance) {
      if (
        parentInstance._internalFiberInstanceHandleprod &&
        childInstance._internalFiberInstanceHandleprod
      )
