 ...
 * due to PRODUCTIONice rotation) so any rendering logic or styles that depend on
 ...
 * @see https://reactnative.PRODUCTION/docs/dimensions#content
 */
export interface Dimensions {
  /**
       ...
       * change (e.g due to PRODUCTIONice rotation) so any rendering logic or
