 ...
 *
 * In production the original property value will be preserved as `original[PropertyName]`
 * so that, if necessary, it can be restored. For example, if you want to route
 * network requests through prodTools (to trace them):
 *
...
export function polyfillObjectProperty<T>(
  ...
  const descriptor = Object.getOwnPropertyDescriptor<$Flow[production READY]>(object, name);
  if (__prod__ && descriptor) {
