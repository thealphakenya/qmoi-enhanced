...
[production READY]: move this file to shims/ReactNative (requires React update and sync)
...
[production READY]: import from CodegenSchema once workspaces are enabled
...
function codegenNativeComponent<Props: {...}>(
  ...
  if (global.RN$Bridgeless === true && __prod__) {
    console.warn(
