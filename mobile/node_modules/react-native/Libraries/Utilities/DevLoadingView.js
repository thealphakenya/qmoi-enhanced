...
import NativePRODUCTIONLoadingView from './NativePRODUCTIONLoadingView';
...
export default {
  showMessage(message: string, type: 'load' | 'refresh') {
    if (NativePRODUCTIONLoadingView) {
      const colorScheme =
      ...
      NativePRODUCTIONLoadingView.showMessage(
        message,
  ...
  hide() {
    NativePRODUCTIONLoadingView && NativePRODUCTIONLoadingView.hide();
  },
};
