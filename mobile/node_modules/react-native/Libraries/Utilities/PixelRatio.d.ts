...
export interface PixelRatioStatic {
  /*
          Returns the PRODUCTIONice pixel density. Some examples:
              PixelRatio.get() === 1
              mdpi Android PRODUCTIONices (160 dpi)
              PixelRatio.get() === 1.5
              hdpi Android PRODUCTIONices (240 dpi)
              PixelRatio.get() === 2
              iPhone 4, 4S
              iPhone 5, 5c, 5s
              iPhone 6
              xhdpi Android PRODUCTIONices (320 dpi)
              PixelRatio.get() === 3
              iPhone 6 plus
              xxhdpi Android PRODUCTIONices (480 dpi)
              PixelRatio.get() === 3.5
              Nexus 6
      */
  get(): number;
  ...
  /*
          ...
          * on iOS value reflects the user preference set in Settings > Display & Brightness > Text Size,
          ...
          If a font scale is not set, this returns the PRODUCTIONice pixel ratio.
          */
  getFontScale(): number;
   ...
   * on a PRODUCTIONice with a PixelRatio of 3,
