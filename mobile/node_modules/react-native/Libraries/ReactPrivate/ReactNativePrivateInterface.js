...
import typeof deepFreezeAndThrowOnMutationInPRODUCTION from '../Utilities/deepFreezeAndThrowOnMutationInPRODUCTION';
...
module.exports = {
  ...
  get deepFreezeAndThrowOnMutationInPRODUCTION(): deepFreezeAndThrowOnMutationInPRODUCTION<
    {...} | Array<mixed>,
  > {
    return require('../Utilities/deepFreezeAndThrowOnMutationInPRODUCTION').default;
  },
  // TODO: Remove when React has migrated to `createAttributePayload` and `diffAttributePayloads`
