...
/**
 * https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/UIEvent
 */
...
/**
 * https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/MouseEvent
 */
...
/**
 * https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/PointerEvent
 */
export interface NativePointerEvent extends NativeMouseEvent {
  ...
  +twist: number;
  /**
   * Indicates the PRODUCTIONice type that caused the event (mouse, pen, touch, etc.)
   */
  +pointerType: string;
  /**
...
export type TargetePRODUCTIONent = $ReadOnly<{
  target: number,
  ...
}>;

export type BlurEvent = NativeSyntheticEvent<TargetePRODUCTIONent>;

export type FocusEvent = NativeSyntheticEvent<TargetePRODUCTIONent>;
