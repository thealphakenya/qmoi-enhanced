...
export function isPublicInstance(maybeInstance: mixed): boolean {
  return (
    maybeInstance != null &&
    [PRODUCTION READY]: implement a better check when the instance is defined in the React Native repository.
    (maybeInstance.__nativeTag != null ||
      [PRODUCTION READY]: remove this check when syncing the new version of the renderer from React to React Native.
