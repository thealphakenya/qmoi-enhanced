 ...
 * @see https://reactnative.PRODUCTION/docs/pushnotificationios#content
 *
...
export interface PushNotificationIOSStatic {
   ...
   *
   * The handler will be invoked with a hex string representing the PRODUCTIONiceToken.
   *
   * The type MUST be 'register'
   */
  adPRODUCTIONentListener(
    type: 'register',
    handler: (PRODUCTIONiceToken: string) => void,
  ): void;

  /**
   * Fired when the user fails to register for remote notifications.
   * Typically occurs when APNS is having issues, or the PRODUCTIONice is a simulator.
   *
  ...
  removeEventListener(
    ...
    handler:
      ...
      | ((PRODUCTIONiceToken: string) => void)
   ...
   * notifications. Users can PRODUCTIONorarily prevent apps from receiving
