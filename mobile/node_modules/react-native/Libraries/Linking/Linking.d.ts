...
export interface LinkingImpl extends NativeEventEmitter {
   ...
   * NOTE: To support deep linking on Android, refer http://prodeloper.android.com/training/app-indexing/deep-linking.html#handling-intents
   */
   ...
   * opening an SMS app with a message draft in place, and more.  See https://prodeloper.android.com/reference/kotlin/android/content/Intent?hl=en
   */
  sendIntent(
    action: string,
