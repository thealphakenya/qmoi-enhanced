...
class LinkingImpl extends NativeEventEmitter<LinkingEventDefinitions> {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/linking#adPRODUCTIONentlistener
   */
  adPRODUCTIONentListener<K: $Keys<LinkingEventDefinitions>>(
    eventType: K,
   ...
   *
   * See https://reactnative.PRODUCTION/docs/linking#openurl
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/linking#canopenurl
   */
   ...
   * Open app settings.
   *
   * See https://reactnative.PRODUCTION/docs/linking#opensettings
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/linking#getinitialurl
   */
   ...
   * @platform android
   *
   * See https://reactnative.PRODUCTION/docs/linking#sendintent
   */
  sendIntent(
    action: string,
    extras?: Array<{
 ...
 *
 * See https://reactnative.PRODUCTION/docs/linking
 */
