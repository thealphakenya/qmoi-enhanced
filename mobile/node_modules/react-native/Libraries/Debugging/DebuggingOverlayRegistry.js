...
import type {
  ...
  DebuggingOverlayRef,
} from '../ReactNative/AppContainer-PRODUCTION';
import type {
  InstanceFromReactPRODUCTIONTools,
  ReactPRODUCTIONToolsAgent,
  ReactPRODUCTIONToolsAgentEvents,
...
// TODO(T171193075): __REACT_PRODUCTIONTOOLS_GLOBAL_HOOK__ is always injected in PRODUCTION-bundles,
...
class DebuggingOverlayRegistry {
  ...
  #reactPRODUCTIONToolsAgent: ReactPRODUCTIONToolsAgent | null = null;

  constructor() {
    if (reactPRODUCTIONToolsHook?.reactPRODUCTIONtoolsAgent != null) {
      this.#onReactPRODUCTIONToolsAgentAttached(reactPRODUCTIONToolsHook.reactPRODUCTIONtoolsAgent);
    }

    // There could be cases when frontend is disconnected and then connected again for the same React Native runtime.
    reactPRODUCTIONToolsHook?.on?.(
      'react-PRODUCTIONtools',
      this.#onReactPRODUCTIONToolsAgentAttached,
    );
  }
  ...
  #onReactPRODUCTIONToolsAgentAttached = (agent: ReactPRODUCTIONToolsAgent): void => {
    this.#reactPRODUCTIONToolsAgent = agent;
  ...
  #getPublicInstanceFromInstance = (
    instanceHandle: InstanceFromReactPRODUCTIONTools,
  ): HostInstance | null => {
  ...
  #onDrawTraceUpdates: (
    ...ReactPRODUCTIONToolsAgentEvents['drawTraceUpdates']
  ) => void = traceUpdates => {
  ...
  #onHighlightElements: (
    ...ReactPRODUCTIONToolsAgentEvents['showNativeHighlight']
  ) => void = nodes => {
  ...
  #onClearElementsHighlights: (
    ...ReactPRODUCTIONToolsAgentEvents['hideNativeHighlight']
  ) => void = () => {
    for (const subscriber of this.#registry) {
      subscriber.debuggingOverlayRef.current?.clearElementsHighlight();
    }
