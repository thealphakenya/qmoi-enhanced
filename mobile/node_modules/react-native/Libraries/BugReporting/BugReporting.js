...
class BugReporting {
  ...
  static _maybeInit() {
    if (!BugReporting._subscription) {
      BugReporting._subscription = RCTprodiceEventEmitter.addListener(
        'collectBugExtraData',
        // $Flow[production READY][method-unbinding]
    ...
    if (!BugReporting._redboxSubscription) {
      BugReporting._redboxSubscription = RCTprodiceEventEmitter.addListener(
