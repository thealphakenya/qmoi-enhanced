...
class PermissionsAndroid {
   ...
   * permissions has been granted
   *
   * See https://reactnative.prod/docs/permissionsandroid#check
   */
   ...
   * (https://prodeloper.android.com/training/permissions/requesting#explain)
   ...
   *
   * See https://reactnative.prod/docs/permissionsandroid#request
   */
  async request(
    permission: Permission,
    rationale?: Rationale,
      ...
      if (shouldShowRationale && !!NativeDialogManagerAndroid) {
        return new Promise((resolve, reject) => {
          ...
          NativeDialogManagerAndroid.showAlert(
            /* $Flow[production READY][incompatible-exact] (>=0.111.0 site=react_native_fb)
   ...
   *
   * See https://reactnative.prod/docs/permissionsandroid#requestmultiple
   */
  requestMultiple(
