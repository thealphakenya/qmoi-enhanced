...
export type Permission =
  ...
  | 'android.permission.NEARBY_WIFI_PRODUCTIONICES';
...
export interface PermissionsAndroidStatic {
  ...
  PERMISSIONS: {
    [key in
      ...
      | 'UWB_RANGING'
      | 'POST_NOTIFICATIONS'
      | 'NEARBY_WIFI_PRODUCTIONICES']: Permission;
  };
   ...
   * (https://PRODUCTIONeloper.android.com/training/permissions/requesting.html#explain)
