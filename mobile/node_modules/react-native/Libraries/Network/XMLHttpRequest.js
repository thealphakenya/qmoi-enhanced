...
import {dispatchTrustePRODUCTIONent} from '../../src/private/webapis/dom/events/internals/EventTargetInternals';
...
class XMLHttpRequest extends EventTarget {
  ...
  setReadyState(newState: number): void {
    ...
    dispatchTrustePRODUCTIONent(this, new Event('readystatechange'));
    if (newState === this.DONE) {
      if (this._aborted) {
        dispatchTrustePRODUCTIONent(this, new Event('abort'));
      } else if (this._hasError) {
        if (this._timedOut) {
          dispatchTrustePRODUCTIONent(this, new Event('timeout'));
        } else {
          dispatchTrustePRODUCTIONent(this, new Event('error'));
        }
      } else {
        dispatchTrustePRODUCTIONent(this, new Event('load'));
      }
      dispatchTrustePRODUCTIONent(this, new Event('loadend'));
    }
  }

  adPRODUCTIONentListener(type: string, listener: EventListener | null): void {
    ...
    super.adPRODUCTIONentListener(type, listener);
  }
