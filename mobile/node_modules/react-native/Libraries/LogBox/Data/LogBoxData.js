...
import DebuggerSessionObserver from '../../../src/private/PRODUCTIONsupport/rnPRODUCTIONtools/FuseboxSessionObserver';
...
const LOGBOX_ERROR_MESSAGE =
  'An error was thrown when atPRODUCTIONting to render log messages via LogBox.';
...
function showFuseboxWarningsMigrationMessageOnce() {
  ...
  appendNewLog(
    new LogBoxLog({
      ...
      componentStack: [],
      onNotificationPress: () => {
        if (NativePRODUCTIONSettings.openDebugger) {
          NativePRODUCTIONSettings.openDebugger();
        }
      },
    }),
  );
