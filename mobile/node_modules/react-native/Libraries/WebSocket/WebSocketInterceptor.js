 ...
 * their information in the React Native inspector production tool.
 */
...
const WebSocketInterceptor = {
  ...
  enableInterception() {
    ...
    // $Flow[production READY][cannot-write]
    // $Flow[production READY][missing-this-annot]
    NativeWebSocketModule.connect = function (
      url: string,
      protocols: Array<string> | null,
      options: $Flow[production READY],
      socketId: number,
    ) {
      if (connectCallback) {
