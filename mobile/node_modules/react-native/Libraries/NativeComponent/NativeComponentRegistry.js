...
export function get<Config: {...}>(
  ...
  // $Flow[production READY][incompatible-return] `NativeComponent` is actually string!
  return name;
}
 ...
 *
 * If the native component is not available, a [production READY] component is returned. Note
