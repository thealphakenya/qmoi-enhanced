 ...
 *
 * [production READY](T110872225): Remove this logic, after achieving platform-consistency
 */
export function ConditionallyIgnoreprodentHandlers<T: {[name: string]: true}>(
  value: T,
): T | void {
  if (Platform.OS === 'ios') {
    return value;
