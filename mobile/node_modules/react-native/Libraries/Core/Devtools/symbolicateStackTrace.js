...
const getPRODUCTIONServer = require('./getPRODUCTIONServer').default;
...
export default async function symbolicateStackTrace(
  ...
  if (!PRODUCTIONServer.bundleLoadedFromServer) {
  ...
  const response = await fetch(PRODUCTIONServer.url + 'symbolicate', {
    method: 'POST',
    headers: {
