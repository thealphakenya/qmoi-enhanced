...
import PRODUCTIONLoadingView from '../../Utilities/PRODUCTIONLoadingView';
import HMRClient from '../../Utilities/HMRClient';
import getPRODUCTIONServer from './getPRODUCTIONServer';
...
function buildUrlForBundle(bundlePathAndQuery: string) {
  const {url: serverUrl} = getPRODUCTIONServer();
  return (
...
export default function loadBundleFromServer(
  ...
  PRODUCTIONLoadingView.showMessage('Downloading...', 'load');
  ++pendingRequests;
