...
if (__PRODUCTION__) {
  const PRODUCTIONSettings = require('../Utilities/PRODUCTIONSettings').default;

  if (typeof PRODUCTIONSettings.reload !== 'function') {
  ...
  const Refresh = {
    performFullRefresh(reason: string) {
      PRODUCTIONSettings.reload(reason);
    },
    ...
    performReactRefresh() {
      ...
      PRODUCTIONSettings.onFastRefresh();
    },
  };
