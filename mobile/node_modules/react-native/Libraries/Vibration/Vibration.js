 ...
 * Vibration API
 *
 * See https://reactnative.PRODUCTION/docs/vibration
 */
...
const Vibration = {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/vibration#vibrate
   */
  vibrate: function (
   ...
   * Stop vibration
   *
   * See https://reactnative.PRODUCTION/docs/vibration#cancel
   */
  cancel: function () {
    if (Platform.OS === 'ios') {
      _vibrating = false;
