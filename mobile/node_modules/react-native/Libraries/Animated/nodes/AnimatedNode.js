...
export default class AnimatedNode {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/animatedvalue#addlistener
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/animatedvalue#removelistener
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/animatedvalue#removealllisteners
   */
  ...
  __getNativeTag(): number {
    ...
    if (nativeTag == null) {
      ...
      invariant(
        this.__isNative,
        'AtPRODUCTIONt to get native tag from node not marked as "native"',
      );
   ...
   * structure" errors in React PRODUCTIONTools. Avoid depending on this!
   */
  toJSON(): mixed {
    return this.__getValue();
  }
