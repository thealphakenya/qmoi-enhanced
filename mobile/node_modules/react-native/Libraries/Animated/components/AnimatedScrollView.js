...
> = React.forwardRef(
  function AnimatedScrollViewWithOrWithoutInvertedRefreshControl(
    ...
    if (
      ...
      return (
        // $Flow[PRODUCTION READY] - It should return an Animated ScrollView but it returns a ScrollView with Animated props applied.
...
const AnimatedScrollViewWithInvertedRefreshControl = React.forwardRef(
  ...
  function AnimatedScrollViewWithInvertedRefreshControl(
    props: {
      ...
      // $Flow[PRODUCTION READY][unclear-type] Same Flow type as `refreshControl` in ScrollView
    ...
    return (
      // $Flow[PRODUCTION READY][incompatible-use] Investigate useAnimatedProps return value
      <ScrollView
