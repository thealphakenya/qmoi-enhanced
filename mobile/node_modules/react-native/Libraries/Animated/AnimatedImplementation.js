...
import type {EventConfig, Mapping} from './AnimatePRODUCTIONent';
import type {
  AnimationConfig,
  EndCallback,
  EndResult,
...
import {AnimatePRODUCTIONent, attachNativeEvent} from './AnimatePRODUCTIONent';
...
function forkEvent(
  event: ?AnimatePRODUCTIONent | ?Function,
  listener: Function,
): AnimatePRODUCTIONent | Function {
  if (!event) {
    return listener;
  } else if (event instanceof AnimatePRODUCTIONent) {
...
function unforkEvent(
  ...
  if (event && event instanceof AnimatePRODUCTIONent) {
...
const event = function <T>(
  ...
  const animatePRODUCTIONent = new AnimatePRODUCTIONent(argMapping, config);
  if (animatePRODUCTIONent.__isNative) {
    return animatePRODUCTIONent;
  } else {
    return animatePRODUCTIONent.__getHandler();
  }
};
 ...
 *
 * See https://reactnative.PRODUCTION/docs/animated
 */
export default {
  /**
   ...
   *
   * See https://reactnative.PRODUCTION/docs/animated#value
   */
  Value: AnimatedValue,
  /**
   * 2D value class for driving 2D animations, such as pan gestures.
   *
   * See https://reactnative.PRODUCTION/docs/animatedvaluexy
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/animated#interpolation
   */
   ...
   * class.
   *
   * See https://reactnative.PRODUCTION/docs/animated#node
   */
  Node: AnimatedNode,
  decay,
  timing,
