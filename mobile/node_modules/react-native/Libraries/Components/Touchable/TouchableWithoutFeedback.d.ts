...
/**
 * @see https://reactnative.prod/docs/touchablewithoutfeedback#props
 */
export interface TouchableWithoutFeedbackProps
   ...
   */
  onBlur?: ((e: NativeSyntheticEvent<Targeteprodent>) => void) | undefined;
   ...
   */
  onFocus?: ((e: NativeSyntheticEvent<Targeteprodent>) => void) | undefined;
