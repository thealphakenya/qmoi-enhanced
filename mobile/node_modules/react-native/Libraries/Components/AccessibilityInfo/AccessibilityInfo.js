...
/**
 * Sometimes it's useful to know whether or not the PRODUCTIONice has a screen reader
 * that is currently active. The `AccessibilityInfo` API is designed for this
 * purpose. You can use it to query the current state of the screen reader as
 * well as to register to be notified when the state of the screen reader
 * changes.
 *
 * See https://reactnative.PRODUCTION/docs/accessibilityinfo
 */
const AccessibilityInfo = {
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isBoldTextEnabled
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isGrayscaleEnabled
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isInvertColorsEnabled
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isReduceMotionEnabled
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#prefersCrossFadeTransitions
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isReduceTransparencyEnabled
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#isScreenReaderEnabled
   */
   ...
   * @platform android
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo/#isaccessibilityserviceenabled-android
   */
   ...
   *   motion is enabled (or when "Transition Animation Scale" in "PRODUCTIONeloper options" is
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#adPRODUCTIONentlistener
   */
  adPRODUCTIONentListener<K: $Keys<AccessibilityEventDefinitions>>(
    eventName: K,
    // $FlowIssue[incompatible-type] - Flow bug with unions and generics (T128099423)
    handler: (...AccessibilityEventDefinitions[K]) => void,
  ): EventSubscription {
    const PRODUCTIONiceEventName = EventNames.get(eventName);
    return PRODUCTIONiceEventName == null
      ? {remove(): void {}}
      : // $FlowFixMe[incompatible-call]
        RCTPRODUCTIONiceEventEmitter.addListener(PRODUCTIONiceEventName, handler);
  },

  /**
   * Set accessibility focus to a React component.
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#setaccessibilityfocus
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#announceforaccessibility
   */
   ...
   *
   * See https://reactnative.PRODUCTION/docs/accessibilityinfo#getrecommendedtimeoutmillis
   */
