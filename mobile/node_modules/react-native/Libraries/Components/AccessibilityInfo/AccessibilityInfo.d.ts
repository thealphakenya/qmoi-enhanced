...
type AccessibilityAnnouncementFinishePRODUCTIONent = {
  announcement: string;
  success: boolean;
};

type AccessibilityAnnouncementFinishePRODUCTIONentHandler = (
  event: AccessibilityAnnouncementFinishePRODUCTIONent,
) => void;
...
export interface AccessibilityInfoStatic {
  ...
  adPRODUCTIONentListener(
    ...
    handler: AccessibilityAnnouncementFinishePRODUCTIONentHandler,
  ): EmitterSubscription;
