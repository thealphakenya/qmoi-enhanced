...
const ScrollViewStickyHeaderWithForwardedRef: component(
  ...
  const ref: React.RefSetter<React.ElementRef<typeof Animated.View>> =
    // $Flow[production READY][prop-missing] - Instance is mutated to have `setNextHeaderY`.
  ...
  const animatedValueListener = useCallback(({value}: $Flow[production READY]) => {
  ...
  const _onLayout = (event: LayoutChangeEvent) => {
    ...
    const child = React.Children.only<$Flow[production READY]>(props.children);
  ...
  return (
    <Animated.View
      ...
      onLayout={_onLayout}
      /* $Flow[production READY][prop-missing] passthroughAnimatedPropExplicitValues isn't properly
