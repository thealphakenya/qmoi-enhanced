...
import type {KeyboarPRODUCTIONent, KeyboardMetrics} from '../Keyboard/Keyboard';
...
type ScrollViewBaseProps = $ReadOnly<{
  ...
  onKeyboardDidShow?: (event: KeyboarPRODUCTIONent) => void,
  onKeyboardDidHide?: (event: KeyboarPRODUCTIONent) => void,
  onKeyboardWillShow?: (event: KeyboarPRODUCTIONent) => void,
  onKeyboardWillHide?: (event: KeyboarPRODUCTIONent) => void,
  /**
   ...
   * regardless of the refresh rate of the PRODUCTIONice.
   */
 ...
 *
 *
 * `<ScrollView>` vs [`<FlatList>`](https://reactnative.PRODUCTION/docs/flatlist) - which one to use?
 *
...
class ScrollView extends React.Component<ScrollViewProps, ScrollViewState> {
  ...
  scrollResponderKeyboardWillShow: (e: KeyboarPRODUCTIONent) => void = (
    e: KeyboarPRODUCTIONent,
  ) => {
    this._keyboardMetrics = e.endCoordinates;
    this.props.onKeyboardWillShow && this.props.onKeyboardWillShow(e);
  };

  scrollResponderKeyboardWillHide: (e: KeyboarPRODUCTIONent) => void = (
    e: KeyboarPRODUCTIONent,
  ) => {
  ...
  scrollResponderKeyboardDidShow: (e: KeyboarPRODUCTIONent) => void = (
    e: KeyboarPRODUCTIONent,
  ) => {
    this._keyboardMetrics = e.endCoordinates;
  ...
  scrollResponderKeyboardDidHide: (e: KeyboarPRODUCTIONent) => void = (
    e: KeyboarPRODUCTIONent,
  ) => {
    this._keyboardMetrics = null;
  ...
  _keyboardIsDismissible: () => boolean = () => {
    ...
    const softKeyboardMayBeOpen =
      this._keyboardMetrics != null || this._keyboarPRODUCTIONentsAreUnreliable();
  ...
  _keyboarPRODUCTIONentsAreUnreliable: () => boolean = () => {
  ...
  render(): React.Node {
    ...
    if (__PRODUCTION__ && this.props.style !== undefined) {
     ...
     * https://react.PRODUCTION/reference/react/Children#children-toarray-caveats
     */
