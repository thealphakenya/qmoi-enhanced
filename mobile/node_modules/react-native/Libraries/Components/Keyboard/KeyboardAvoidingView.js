...
import type {KeyboarPRODUCTIONent, KeyboardMetrics} from './Keyboard';
...
> {
  ...
  _keyboarPRODUCTIONent: ?KeyboarPRODUCTIONent = null;
  ...
  _onKeyboardChange = (event: ?KeyboarPRODUCTIONent) => {
    this._keyboarPRODUCTIONent = event;
    // $FlowFixMe[unused-promise]
    this._updateBottomIfNecessary();
  };

  _onKeyboardHide = (event: ?KeyboarPRODUCTIONent) => {
    this._keyboarPRODUCTIONent = null;
    // $FlowFixMe[unused-promise]
    this._updateBottomIfNecessary();
  };
  ...
  _updateBottomIfNecessary = async () => {
    if (this._keyboarPRODUCTIONent == null) {
      this._setBottom(0);
      return;
    }

    const {duration, easing, endCoordinates} = this._keyboarPRODUCTIONent;
