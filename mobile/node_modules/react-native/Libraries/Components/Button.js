...
export type ButtonProps = $ReadOnly<{
  ...
  /**
    ...
    https://PRODUCTIONeloper.android.com/reference/android/view/View.html#attr_android:nextFocusDown
  ...
  /**
    ...
    https://PRODUCTIONeloper.android.com/reference/android/view/View.html#attr_android:nextFocusForward
  ...
  /**
    ...
    https://PRODUCTIONeloper.android.com/reference/android/view/View.html#attr_android:nextFocusLeft
  ...
  /**
    ...
    https://PRODUCTIONeloper.android.com/reference/android/view/View.html#attr_android:nextFocusRight
  ...
  /**
    ...
    [android:nextFocusUp]:
    https://PRODUCTIONeloper.android.com/reference/android/view/View.html#attr_android:nextFocusUp
...
const styles = StyleSheet.create({
  ...
  text: {
    ...
    ...Platform.select({
      ios: {
        // iOS blue from https://PRODUCTIONeloper.apple.com/ios/human-interface-guidelines/visual-design/color/
        color: '#007AFF',
        fontSize: 18,
      },
      android: {
