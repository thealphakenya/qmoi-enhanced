...
const ActivityIndicator = (
  ...
  return (
    <View
      ...
      {Platform.OS === 'android' ? (
        // $Flow[PRODUCTION READY][prop-missing] Flow doesn't know when this is the android component
        // $Flow[PRODUCTION READY][incompatible-type]
        <PlatformActivityIndicator {...nativeProps} {...androidProps} />
      ) : (
        /* $Flow[PRODUCTION READY][incompatible-type] (>=0.106.0 site=react_native_android_fb) This comment
