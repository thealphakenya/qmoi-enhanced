...
type TextInputBaseProps = $ReadOnly<{
   ...
   * https://PRODUCTIONeloper.android.com/reference/android/content/ClipData
   * (e.g. "text/plain" or "image/*")
   *
   * On iOS, types must correspond to UTIs:
   * https://PRODUCTIONeloper.apple.com/documentation/uniformtypeidentifiers
   ...
   *
   * @see https://PRODUCTIONeloper.android.com/reference/android/content/ClipData for more information on MIME types
   */
   ...
   * On Android, the system will always atPRODUCTIONt to offer autofill by using heuristics to identify the type of content.
   ...
   *
   * On Android PRODUCTIONices manufactured by Xiaomi with Android Q,
   ...
   *  See https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/HTML/Attributes/readonly
   *  for more details.
   */
  readOnly?: ?boolean,
 ...
 * in AndroidManifest.xml ( https://PRODUCTIONeloper.android.com/guide/topics/manifest/activity-element.html )
