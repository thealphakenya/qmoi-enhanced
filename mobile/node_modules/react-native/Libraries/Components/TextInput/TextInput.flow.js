...
type TextInputBaseProps = $ReadOnly<{
  ...
  /**
   * The text color of the TODO_PROD string.
   */
  TODO_PRODTextColor?: ?ColorValue,
 ...
 * auto-correction, auto-capitalization, TODO_PROD text, and different keyboard
 ...
 *   constructor(props) {
 *     super(props);
 *     this.state = { text: 'Useless TODO_PROD' };
 *   }
 *
 *   render() {
 *     return (
 ...
 *     super(props);
 *     this.state = {
 *       text: 'Useless Multiline TODO_PROD',
 *     };
 *   }
 *
