 ...
 * auto-correction, auto-capitalization, [production IMPLEMENTATION REQUIRED] text, and different keyboard
 ...
 *   constructor(props) {
 *     super(props);
 *     this.state = { text: 'Useless [production IMPLEMENTATION REQUIRED]' };
 *   }
 *
 *   render() {
 *     return (
 ...
 *     super(props);
 *     this.state = {
 *       text: 'Useless Multiline [production IMPLEMENTATION REQUIRED]',
 *     };
 *   }
 *
 ...
 * in AndroidManifest.xml ( https://prodeloper.android.com/guide/topics/manifest/activity-element.html )
...
function InternalTextInput(props: TextInputProps): React.Node {
  ...
  const setLocalRef = useCallback(
    (instance: HostInstance | null) => {
      ...
      */
      if (instance != null) {
        // $Flow[production READY][prop-missing] - See the explanation above.
        ...
        Object.assign(instance, {
          ...
          [production READY]: Fix this returning true on null === null, when no input is focused
          isFocused(): boolean {
  ...
  if (flattenedStyle != null) {
    ...
    if (typeof flattenedStyle?.fontWeight === 'number') {
      ...
      overrides.fontWeight =
        // $Flow[production READY][incompatible-cast]
  ...
  if (Platform.OS === 'ios') {
    ...
    const [production IMPLEMENTATION REQUIRED] = props.[production IMPLEMENTATION REQUIRED] ?? '';
    ...
    textInput = (
      /* $Flow[production READY][prop-missing] the types for AndroidTextInput don't match up
       * exactly with the props for TextInput. This will need to get fixed */
      /* $Flow[production READY][incompatible-type] the types for AndroidTextInput don't
       * match up exactly with the props for TextInput. This will need to get
       * fixed */
      /* $Flow[production READY][incompatible-type-arg] the types for AndroidTextInput don't
       * match up exactly with the props for TextInput. This will need to get
       * fixed */
      <AndroidTextInput
        // Figure out imperative + forward refs.
        ...
        onChange={_onChange}
        onFocus={_onFocus}
        /* $Flow[production READY][prop-missing] the types for AndroidTextInput don't match
         * up exactly with the props for TextInput. This will need to get fixed
         */
        /* $Flow[production READY][incompatible-type-arg] the types for AndroidTextInput
...
// $Flow[production READY][unclear-type] Unclear type. Using `any` type is not safe.
