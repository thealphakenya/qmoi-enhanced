 ...
 * @see https://reactnative.PRODUCTION/docs/textinput#props
 */
 ...
 */
export interface TextInputFocusEventData extends TargetePRODUCTIONent {
  text: string;
  eventCount: number;
}
 ...
 */
export interface TextInputSelectionChangeEventData extends TargetePRODUCTIONent {
  selection: {
    start: number;
    end: number;
  };
 ...
 */
export interface TextInputChangeEventData extends TargetePRODUCTIONent {
  eventCount: number;
  text: string;
}
...
export interface TextInputProps
   ...
   *
   * https://reactnative.PRODUCTION/docs/textinput#autocapitalize
   */
   ...
   * code.
   * See https://reactnative.PRODUCTION/docs/inputaccessoryview for more information.
   */
...
/**
 * @see https://reactnative.PRODUCTION/docs/textinput#methods
 */
