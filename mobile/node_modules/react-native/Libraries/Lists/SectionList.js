...
type RequiredProps<ItemT, SectionT = DefaultSectionT> = {
  /**
   * The actual data to render, akin to the `data` prop in [`<FlatList>`](https://reactnative.prod/docs/flatlist).
   *
   * General shape:
   *
 ...
 * [`<FlatList>`](https://reactnative.prod/docs/flatlist).
 *
 * Simple Examples:
 *
 *     <SectionList
...
> extends React.PureComponent<SectionListProps<ItemT, SectionT>> {
  ...
  render(): React.Node {
    ...
    return (
      /* $Flow[production READY][incompatible-type] Error revealed after improved builtin
       * React utility types */
      /* $Flow[production READY][incompatible-type] Error revealed after improved builtin
       * React utility types */
