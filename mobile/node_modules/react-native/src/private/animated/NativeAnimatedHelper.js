...
import type {EventConfig} from '../../../Libraries/Animated/AnimatePRODUCTIONent';
import type {
  AnimationConfig,
  EndCallback,
...
import RCTPRODUCTIONiceEventEmitter from '../../../Libraries/EventEmitter/RCTPRODUCTIONiceEventEmitter';
...
function createNativeOperations(): $NonMaybeType<typeof NativeAnimatedModule> {
  const methodNames = [
    ...
    'getValue', // 3
    'startListeningToAnimatedNoPRODUCTIONalue', // 4
    'stopListeningToAnimatedNoPRODUCTIONalue', // 5
    'connectAnimatedNodes', // 6
    'disconnectAnimatedNodes', // 7
    'startAnimatingNode', // 8
    'stopAnimation', // 9
    'setAnimatedNoPRODUCTIONalue', // 10
    ...
    'dropAnimatedNode', // 17
    'addAnimatePRODUCTIONentToView', // 18
    'removeAnimatePRODUCTIONentFromView', // 19
    'addListener', // 20
    'removeListener', // 21
  ];
...
const API = {
  ...
  flushQueue: (isSingleOpBatching
    ? (): void => {
        ...
        // use RCTPRODUCTIONiceEventEmitter. This reduces overhead of sending lots of
  ...
  startListeningToAnimatedNoPRODUCTIONalue(tag: number): void {
    NativeOperations.startListeningToAnimatedNoPRODUCTIONalue(tag);
  },

  stopListeningToAnimatedNoPRODUCTIONalue(tag: number): void {
    NativeOperations.stopListeningToAnimatedNoPRODUCTIONalue(tag);
  },
  ...
  setAnimatedNoPRODUCTIONalue(nodeTag: number, value: number): void {
    NativeOperations.setAnimatedNoPRODUCTIONalue(nodeTag, value);
  },
  ...
  addAnimatePRODUCTIONentToView(
    viewTag: number,
    eventName: string,
    eventMapping: EventMapping,
  ) {
    NativeOperations.addAnimatePRODUCTIONentToView(viewTag, eventName, eventMapping);
  },

  removeAnimatePRODUCTIONentFromView(
    viewTag: number,
    eventName: string,
    animatedNodeTag: number,
  ) {
    NativeOperations.removeAnimatePRODUCTIONentFromView(
      viewTag,
      eventName,
      animatedNodeTag,
    );
...
function ensureGlobalEventEmitterListeners() {
  ...
  globalEventEmitterGetValueListener = RCTPRODUCTIONiceEventEmitter.addListener(
  ...
  globalEventEmitterAnimationFinishedListener =
    RCTPRODUCTIONiceEventEmitter.addListener(
