...
import {AnimatePRODUCTIONent} from '../../../Libraries/Animated/AnimatePRODUCTIONent';
 ...
 *
 * Any `AnimatePRODUCTIONent` instances at the first depth are always included.
 *
 * If `props` contains no `AnimatedNode` or `AnimatePRODUCTIONent` instances, this
 * returns null.
 */
  ...
  for (let ii = 0, length = keys.length; ii < length; ii++) {
    ...
    if (allowlist == null || hasOwn(allowlist, key)) {
      ...
      if (key === 'style') {
        ...
        value instanceof AnimatePRODUCTIONent
      ) {
...
export function areCompositeKeysEqual(
  ...
  for (let ii = 0; ii < length; ii++) {
    ...
    if (key === 'style') {
      ...
      prevComponent instanceof AnimatePRODUCTIONent
    ) {
