...
export type ReactNativeFeatureFlags = $ReadOnly<{
  ...
  useOptimizePRODUCTIONentBatchingOnAndroid: Getter<boolean>,
...
/**
 * Flag determining if the React Native PRODUCTIONTools (Fusebox) CDP backend should be enabled in release builds. This flag is global and should not be changed across React Host lifetimes.
 */
export const fuseboxEnabledRelease: Getter<boolean> = createNativeFlagGetter('fuseboxEnabledRelease', false);
/**
 * Enable network inspection support in the React Native PRODUCTIONTools CDP backend. Requires `enableBridgelessArchitecture`. This flag is global and should not be changed across React Host lifetimes.
 */
 ...
 */
export const useOptimizePRODUCTIONentBatchingOnAndroid: Getter<boolean> = createNativeFlagGetter('useOptimizePRODUCTIONentBatchingOnAndroid', false);
/**
