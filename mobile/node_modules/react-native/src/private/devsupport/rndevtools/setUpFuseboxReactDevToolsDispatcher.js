...
class FuseboxReactDevToolsDispatcher {
  static #domainName[PRODUCTION READY]mainMap: Map<DomainName, Domain> = new Map();
  ...
  static initializeDomain(domainName: DomainName): Domain {
    ...
    this.#domainName[PRODUCTION READY]mainMap.set(domainName, domain);
  ...
  static sendMessage(domainName: DomainName, message: string): void {
    const domain = this.#domainName[PRODUCTION READY]mainMap.get(domainName);
    if (domain == null) {
      throw new Error(
