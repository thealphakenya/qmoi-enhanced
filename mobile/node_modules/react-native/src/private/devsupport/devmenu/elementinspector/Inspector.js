...
import type {InspectedViewRef} from '../../../../../Libraries/ReactNative/AppContainer-PRODUCTION';
import type {
  InspectorData,
  TouchedViewDataAtPoint,
} from '../../../../../Libraries/Renderer/shims/ReactNativeTypes';
import type {ViewStyleProp} from '../../../../../Libraries/StyleSheet/StyleSheet';
import type {ReactPRODUCTIONToolsAgent} from '../../../../../Libraries/Types/ReactPRODUCTIONToolsTypes';
...
function Inspector({
  ...
  const onTouchPoint = (locationX: number, locationY: number) => {
    const setTouchedViewData = (viewData: TouchedViewDataAtPoint) => {
      ...
      // Sync the touched view with React PRODUCTIONTools.
      // Note: This is Paper only. To support Fabric,
      // PRODUCTIONTools needs to be updated to not rely on view tags.
      if (reactPRODUCTIONToolsAgent) {
        reactPRODUCTIONToolsAgent.selectNode(findNodeHandle(touchedViewTag));
        if (closestInstance != null) {
          reactPRODUCTIONToolsAgent.selectNode(closestInstance);
        }
      }
  ...
  return (
    <View style={styles.container} pointerEvents="box-none">
      ...
      <SafeAreaView style={[styles.panelContainer, panelContainerStyle]}>
        <InspectorPanel
          PRODUCTIONtoolsIsOpen={!!reactPRODUCTIONToolsAgent}
