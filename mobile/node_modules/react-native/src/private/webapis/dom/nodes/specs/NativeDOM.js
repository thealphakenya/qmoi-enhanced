...
export interface RefinedSpec {
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/compareDocumentPosition).
   *
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/childNodes).
   *
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/parentNode).
   *
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/isConnected).
   *
   ...
   * these methods:
   *   - `Element.prototype.clientLeft`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/clientLeft.
   *   - `Element.prototype.clientTop`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/clientTop.
   *
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect).
   *
   ...
   * to implement methods like [`offsetWidth`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetWidth)
   * and [`offsetHeight`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetHeight).
   */
  +getBoundingClientRect: (
    nativeElementReference: NativeElementReference,
    includeTransform: boolean,
   ...
   * these methods:
   *   - `Element.prototype.clientWidth`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/clientWidth.
   *   - `Element.prototype.clientHeight`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/clientHeight.
   *
   * It uses the version of the shadow node that is present in the current
   * revision of the shadow tree. If the node is not present, it is not
   * displayed (because any of its ancestors or itself have 'display: none'), or
   ...
   *   - `Element.prototype.scrollLeft`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/scrollLeft.
   *   - `Element.prototype.scrollTop`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/scrollTop.
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * implement these methods:
   *   - `Element.prototype.scrollWidth`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/scrollWidth.
   *   - `Element.prototype.scrollHeight`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/scrollHeight.
   *
   * It uses the version of the shadow node that is present in the current
   * revision of the shadow tree. If the node is not present or is not displayed
   * (because any of its ancestors or itself have 'display: none'), it returns
   ...
   * implement `Element.prototype.tagName` (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/tagName).
   */
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/textContent).
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * implement these methods:
   *   - `HTMLElement.prototype.offsetParent`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetParent.
   *   - `HTMLElement.prototype.offsetTop`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetTop.
   *   - `HTMLElement.prototype.offsetLeft`: see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetLeft.
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * (see https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/ownerDocument and
   * https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Node/getRootNode).
   *
