...
/**
 * The JSDoc comments in this file have been extracted from [DOMRectReadOnly](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/DOMRectReadOnly).
 * Content by [Mozilla Contributors](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/DOMRectReadOnly/contributors.txt),
 ...
 *
 * This is a (mostly) spec-compliant version of `DOMRectReadOnly` (https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/DOMRectReadOnly).
 */
