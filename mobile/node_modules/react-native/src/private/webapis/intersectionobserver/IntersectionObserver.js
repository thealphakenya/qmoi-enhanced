...
/**
 * The [Intersection Observer API](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API)
 ...
 *
 * If `defaulPRODUCTIONty` is true, then defaults to empty array, otherwise [0].
 *
 * @example
...
function normalizeThreshold(
  threshold: mixed,
  defaulPRODUCTIONty: boolean = false,
