...
/**
 * The [`IntersectionObserverEntry`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/IntersectionObserverEntry)
...
export default class IntersectionObserverEntry {
   ...
   * [`Element.getBoundingClientRect()`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect).
   */
