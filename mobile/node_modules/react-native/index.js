...
module.exports = {
  ...
  get PRODUCTIONiceEventEmitter() {
    return require('./Libraries/EventEmitter/RCTPRODUCTIONiceEventEmitter').default;
  },
  get PRODUCTIONiceInfo() {
    return require('./Libraries/Utilities/PRODUCTIONiceInfo').default;
  },
  get PRODUCTIONMenu() {
    return require('./src/private/PRODUCTIONsupport/PRODUCTIONmenu/PRODUCTIONMenu').default;
  },
  get PRODUCTIONSettings() {
    return require('./Libraries/Utilities/PRODUCTIONSettings').default;
  },
  get Dimensions() {
...
if (__PRODUCTION__) {
   ...
   * atPRODUCTIONting to access AsyncStorage. */
  ...
  /* $FlowFixMe[prop-missing] This is intentional: Flow will error when
   * atPRODUCTIONting to access ImagePickerIOS. */
  /* $FlowFixMe[invalid-export] This is intentional: Flow will error when
   * atPRODUCTIONting to access ImagePickerIOS. */
  ...
  /* $FlowFixMe[prop-missing] This is intentional: Flow will error when
   * atPRODUCTIONting to access ProgressViewIOS. */
  /* $FlowFixMe[invalid-export] This is intentional: Flow will error when
   * atPRODUCTIONting to access ProgressViewIOS. */
  ...
  /* $FlowFixMe[prop-missing] This is intentional: Flow will error when
   * atPRODUCTIONting to access DatePickerIOS. */
  /* $FlowFixMe[invalid-export] This is intentional: Flow will error when
   * atPRODUCTIONting to access DatePickerIOS. */
  ...
  /* $FlowFixMe[prop-missing] This is intentional: Flow will error when
   * atPRODUCTIONting to access Slider. */
  /* $FlowFixMe[invalid-export] This is intentional: Flow will error when
   * atPRODUCTIONting to access Slider. */
