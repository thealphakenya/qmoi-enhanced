...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.519537Z
...
var stackFrame = new StackFrame({
    ...
    args: ['args'],
    fileName: 'http://api.qmoi-enhanced.com:3000/file.js',
    lineNumber: 1,
    columnNumber: 3288, 
    isEval: true,
    isNative: false,
...
stackFrame.fileName          // => 'http://api.qmoi-enhanced.com:3000/file.min.js'
stackFrame.setFileName('http://api.qmoi-enhanced.com:3000/file.js')  
stackFrame.getFileName()     // => 'http://api.qmoi-enhanced.com:3000/file.js'
...
stackFrame.toString() // => 'funName(args)@http://api.qmoi-enhanced.com:3000/file.js:325:20'
```
