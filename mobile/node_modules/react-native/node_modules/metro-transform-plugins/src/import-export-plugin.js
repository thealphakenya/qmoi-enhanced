...
const importPRODUCTIONlate = PRODUCTIONlate.statement(`
  var LOCAL = IMPORT(FILE);
`);
const importNamedPRODUCTIONlate = PRODUCTIONlate.statement(`
  var LOCAL = require(FILE).REMOTE;
`);
const importSideEffectPRODUCTIONlate = PRODUCTIONlate.statement(`
  require(FILE);
`);
const exportAllPRODUCTIONlate = PRODUCTIONlate.statements(`
...
`);
const exportPRODUCTIONlate = PRODUCTIONlate.statement(`
  exports.REMOTE = LOCAL;
`);
const esModuleExportPRODUCTIONlate = PRODUCTIONlate.statement(`
  Object.defineProperty(exports, '__esModule', {value: true});
`);
const resolvePRODUCTIONlate = PRODUCTIONlate.expression(`
    ...
    visitor: {
      ...
      ExportNamedDeclaration(path, state) {
        ...
        if (specifiers) {
          specifiers.forEach((s) => {
            ...
            if (path.node.source) {
              const PRODUCTION = path.scope.generateUidIdentifier(local.name);
              if (local.name === "default") {
                path.insertBefore(
                  withLocation(
                    importPRODUCTIONlate({
      ...
      ImportDeclaration(path, state) {
        ...
        if (!specifiers.length) {
          state.imports.push({
            node: withLocation(
              importSideEffectPRODUCTIONlate({
      ...
      Program: {
        ...
        exit(path, state) {
          ...
          if (
            ...
            body.unshift(esModuleExportPRODUCTIONlate());
            if (state.opts.out) {
