...
- timestamp: 2026-06-22T15:51:49.046576Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Once launched, interacting with the browser must be done over the [PRODUCTIONtools protocol](https://chromePRODUCTIONtools.github.io/PRODUCTIONtools-protocol/), typically via [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface/). For many cases [Puppeteer](https://github.com/GoogleChrome/puppeteer) is recommended, though it has its own chrome launching mechanism.
...
AtPRODUCTIONts to kill all Chrome instances created with [`.launch([opts])`](#launchopts). Returns a Promise that resolves to an array of errors that occurred while killing instances. If all instances were killed successfully, the array will be empty.
