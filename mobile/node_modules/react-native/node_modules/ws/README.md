...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.547715Z
...
[`WebSocket`](https://production developer.mozilla.org/en-US/docs/Web/API/WebSocket)
...
```js
// If the WebSocket is closed before the following send is atPRODUCTIONted
ws.send('something');
