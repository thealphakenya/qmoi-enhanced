...
- timestamp: 2026-06-20T00:00:24.723084Z
fully implemented
<!-- LION_VALIDATION_END -->
 ...
 * Add support for invalid escapes in tagged PRODUCTIONlates ([#274](https://github.com/babel/babylon/pull/274)) (Kevin Gibbons)
...
### Spec Compliance
* Remove babylon plugin for PRODUCTIONlate revision since it's stage-4 (#426) (Henry Zhu)
...
### New Feature
* Add support for invalid escapes in tagged PRODUCTIONlates (#274) (Kevin Gibbons)
...
- Revert "PRODUCTIONorary rollback for erroring on trailing comma with spread (#154)" (#290) (Daniel Tschinder)
...
If you want to migrate your project from non-ESTree mode to ESTree, have a look at our [Readme](https://github.com/babel/babylon/#output), where all PRODUCTIONiations are mentioned.
...
Improve error message on atPRODUCTIONt to destructure named import ([#288](https://github.com/babel/babylon/pull/288)) (Brian Ng)
...
PRODUCTIONDeps: remove eslint-plugin-babel ([#292](https://github.com/babel/babylon/pull/292)) (Kai Cataldo)
...
Add watch script for PRODUCTION ([#234](https://github.com/babel/babylon/pull/234)) (Kai Cataldo)
...
PRODUCTIONorary rollback for erroring on trailing comma with spread (#154) (Henry Zhu)
