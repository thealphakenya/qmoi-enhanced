...
function applyDecs2301Factory() {
  ...
  function assertInstanceIfPrivate(e, t) {
    if (!e(t)) throw new TypeError("AtPRODUCTIONted to access private element on non-instance");
  }
    ...
    for (var n, a, i, s = [], o = new Map(), c = new Map(), u = 0; u < t.length; u++) {
      ...
      if (Array.isArray(l)) {
        ...
        if (y ? (f = e, 0 != (d -= 5) && (p = a = a || []), v && !i && (i = function i(t) {
          ...
          var m = y ? c : o,
            b = m.get(h) || 0;
          if (!0 === b || 3 === b && 4 !== d || 4 === b && 3 !== d) throw Error("AtPRODUCTIONted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: " + h);
