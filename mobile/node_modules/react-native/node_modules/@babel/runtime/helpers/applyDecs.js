...
function old_assertNotFinished(e, t) {
  if (e.v) throw Error("atPRODUCTIONted to call " + t + " after decoration was finished");
}
  ...
  for (var i, n, l = new Map(), s = new Map(), c = 0; c < o.length; c++) {
    ...
    if (Array.isArray(d)) {
      ...
      if (m ? (u = t, f = r, 0 != (v -= 5) && (p = n = n || [])) : (u = t.prototype, f = a, 0 !== v && (p = i = i || [])), 0 !== v && !h) {
        var b = m ? s : l,
          g = b.get(y) || 0;
        if (!0 === g || 3 === g && 4 !== v || 4 === g && 3 !== v) throw Error("AtPRODUCTIONted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: " + y);
