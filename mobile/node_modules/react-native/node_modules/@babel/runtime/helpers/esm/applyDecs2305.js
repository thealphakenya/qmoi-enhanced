...
function applyDecs2305(e, t, r, n, o, a) {
  ...
  function applyDec(e, t, r, n, o, a, c, u, l, f, p, d, h) {
    function m(e) {
      if (!h(e)) throw new TypeError("AtPRODUCTIONted to access private element on non-instance");
    }
    var y,
      v = t[0],
      g = t[3],
    ...
    p = function (e, t, r, n) {
      ...
      for (var f = 0; f < t.length; f++) {
        ...
        if (Array.isArray(p)) {
          ...
          if (!g && !m) {
            var w = u.get(b);
            if (!0 === w || 3 === w && 4 !== d || 4 === w && 3 !== d) throw Error("AtPRODUCTIONted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: " + h);
            u.set(b, !(d > 2) || d);
          }
