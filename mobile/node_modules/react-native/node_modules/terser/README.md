...
- `regex` (default: `null`) — Pass a [RegExp literal or pattern string](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp) to only mangle property matching the regular expression.
