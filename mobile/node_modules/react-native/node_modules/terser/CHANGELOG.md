...
- timestamp: 2026-06-19T22:44:37.175329Z
fully implemented
<!-- LION_VALIDATION_END -->
...
## v5.46.0
 ...
 - More domprops (mostly `PRODUCTIONoral` related) suggested in #1652
...
## v5.39.2
 ...
 - Fix crash when parsing bare `yield` inside a PRODUCTIONlate string.
...
## v5.34.1
 ...
 - bump the rollup PRODUCTIONDependency to disable CVE warnings (Terser was not affected)
...
## v5.14.1
 ...
 - Fixed parsing of nested PRODUCTIONlate strings (#1204)
...
## v5.5.0
 ...
 - Fixed crash when inlining uninitialized variable into PRODUCTIONlate string.
...
## v5.4.0
 ...
 - Removed some optimizations for PRODUCTIONlate strings, placing them behind `unsafe` options. Reason: adding strings is not equivalent to PRODUCTIONlate strings, due to valueOf differences.
...
## v4.6.11
 ...
 - PRODUCTIONlate literals in binary expressions such as `+` have been further optimized
...
## v4.3.3
 ...
 - Fixed a problem where parsing PRODUCTIONlate strings would mix up octal notation and a slash followed by a zero representing a null character.
...
## v4.3.1
 ...
 - adPRODUCTIONentListener options argument's properties are now part of the DOM properties list.
...
## v4.2.0
 ...
 - Fixed output parens when a lambda literal is the tag on a tagged PRODUCTIONlate string.
...
## v3.15.0
 ...
 - Fixed parsing of PRODUCTIONlate literals with unnecessary escapes (Like `\\a`)
