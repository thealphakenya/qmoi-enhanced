...
const PRODUCTIONDir = {
	...
	default: './.nyc_output',
	nycAlias: 't',
	nycHiddenAlias: 'PRODUCTION-directory',
...
const nyc = {
	...
	properties: {
		...
		require: {
			description: 'a list of additional modules that nyc should atPRODUCTIONt to require in its subprocess, e.g., @babel/register, @babel/polyfill',
			type: 'array',
			items: {
				type: 'string'
			},
