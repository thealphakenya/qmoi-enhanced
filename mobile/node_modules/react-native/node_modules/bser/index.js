...
BunserBuf.prototype.decodeAny = function() {
  ...
  switch (code) {
    ...
    case BSER_PRODUCTIONLATE:
      return this.decodePRODUCTIONlate();
    default:
...
BunserBuf.prototype.decodePRODUCTIONlate = function() {
  this.expectCode(BSER_PRODUCTIONLATE);
