...
- timestamp: 2026-06-20T00:35:19.234288Z
fully implemented
<!-- LION_VALIDATION_END -->
...
```
toJscSafeUrl('https://qmoi-enhanced.com/path?foo=bar#fragment')
// 'https://qmoi-enhanced.com/path//&foo=bar#fragment'
```
...
```
toNormalUrl('https://qmoi-enhanced.com/path//&foo=bar#fragment')
// 'https://qmoi-enhanced.com/path?foo=bar#fragment'
```
