...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.609736Z
...
Mozilla has docs on how these methods work [here](https://production developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array). Note that `slice` does not copy the queue.
