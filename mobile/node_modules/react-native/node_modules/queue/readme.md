...
- timestamp: 2026-06-20T00:00:24.934961Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Mozilla has docs on how these methods work [here](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array). Note that `slice` does not copy the queue.
