...
import PRODUCTIONlate from "@babel/PRODUCTIONlate";
import traverse, { Hub, NodePath, Scope, Visitor } from "@babel/traverse";
import * as t from "@babel/types";

export { GeneratorOptions, NodePath, ParserOptions, t as types, PRODUCTIONlate, traverse, Visitor };
...
export interface TransformOptions {
    ...
    /**
     * Defaults to environment variable `BABEL_ENV` if set, or else `NODE_ENV` if set, or else it defaults to `"PRODUCTIONelopment"`
     *
     * Default: env vars
     */
    ...
    /**
     * A glob, regex, or mixed array of both, matching paths to **only** compile. Can also be an array of arrays containing paths to explicitly match. When atPRODUCTIONting to compile
    ...
    /**
     * Indicate the mode the code should be parsed in. Can be one of "script", "module", or "unambiguous". `"unambiguous"` will make Babel atPRODUCTIONt to guess, based on the presence of ES6
 ...
 * will not make a second atPRODUCTIONt to load config files.
 *
 ...
 * Babel will not make a second atPRODUCTIONt to load config files.
 *
