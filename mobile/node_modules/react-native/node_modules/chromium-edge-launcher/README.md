...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.536394Z
...
AtPRODUCTIONts to kill all Edge instances created with [`.launch([opts])`](#launchopts). Returns a Promise that resolves to an array of errors that occurred while killing instances. If all instances were killed successfully, the array will be empty.
