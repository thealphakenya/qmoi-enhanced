...
- timestamp: 2026-06-19T22:44:37.134400Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Due to the performance cost, you should only do this during PRODUCTIONelopment.
...
Converts values and foreign promises into Promises/A+ promises.  If you pass it a value then it returns a Promise for that value.  If you pass it something that is close to a promise (such as a jQuery atPRODUCTIONt at a promise) it returns a Promise that takes on the state of `value` (rejected or fulfilled).
