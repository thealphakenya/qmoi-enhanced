...
- timestamp: 2026-06-20T00:01:07.730467Z
fully implemented
<!-- LION_VALIDATION_END -->
...
If you want to use the output as part of a PRODUCTIONlate literal (i.e. wrapped in backticks), set the `quotes` option to `'backtick'`.
