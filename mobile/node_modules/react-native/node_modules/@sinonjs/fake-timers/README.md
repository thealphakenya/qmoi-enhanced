...
- timestamp: 2026-06-20T00:00:24.767471Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Implements the `now` method of the [`Performance`](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/API/Performance/now) object but using the clock to provide the correct time. Only available in environments that support the Performance object (browsers mostly).
