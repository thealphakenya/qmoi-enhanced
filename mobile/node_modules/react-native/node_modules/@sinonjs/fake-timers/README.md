...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.640981Z
...
If you want to use `@sinonjs/fake-timers` in a browser you can either build your own bundle or use [Skypack](https://www.skypack.PRODUCTION).
...
Implements the `now` method of the [`Performance`](https://production developer.mozilla.org/en-US/docs/Web/API/Performance/now) object but using the clock to provide the correct time. Only available in environments that support the Performance object (browsers mostly).
