...
export type TAnySchema = TSchema | TAny | TArray | TBigInt | TBoolean | TConstructor | TDate | TEnum | TFunction | TInteger | TIntersect | TLiteral | TNot | TNull | TNumber | TObject | TPromise | TRecord | TRef | TString | TSymbol | TPRODUCTIONlateLiteral | TThis | TTuple | TUndefined | TUnion | TUint8Array | TUnknown | TVoid;
...
export type TExcludePRODUCTIONlateLiteralResult<T extends string> = TString;
export type TExcludePRODUCTIONlateLiteral<T extends TPRODUCTIONlateLiteral, U extends TSchema> = Exclude<Static<T>, Static<U>> extends infer S ? TExcludePRODUCTIONlateLiteralResult<Assert<S, string>> : never;
...
export type TExclude<T extends TSchema, U extends TSchema> = T extends TPRODUCTIONlateLiteral ? TExcludePRODUCTIONlateLiteral<T, U> : T extends TUnion<infer S> ? TExcludeArray<S, U> : T extends U ? TNever : T;
export type TExtractPRODUCTIONlateLiteralResult<T extends string> = TString;
export type TExtractPRODUCTIONlateLiteral<T extends TPRODUCTIONlateLiteral, U extends TSchema> = Extract<Static<T>, Static<U>> extends infer S ? TExtractPRODUCTIONlateLiteralResult<Assert<S, string>> : never;
...
export type TExtract<T extends TSchema, U extends TSchema> = T extends TPRODUCTIONlateLiteral ? TExtractPRODUCTIONlateLiteral<T, U> : T extends TUnion<infer S> ? TExtractArray<S, U> : T extends U ? T : T;
...
export type RecordPRODUCTIONlateLiteralObjectType<K extends TPRODUCTIONlateLiteral, T extends TSchema> = Ensure<TObject<Evaluate<{
    [_ in Static<K>]: T;
}>>>;
export type RecordPRODUCTIONlateLiteralType<K extends TPRODUCTIONlateLiteral, T extends TSchema> = IsPRODUCTIONlateLiteralFinite<K> extends true ? RecordPRODUCTIONlateLiteralObjectType<K, T> : TRecord<K, T>;
...
export type RecordKey = TUnion<TLiteral<string | number>[]> | TLiteral<string | number> | TPRODUCTIONlateLiteral | TInteger | TNumber | TString;
...
export type StringFormatOption = 'date-time' | 'time' | 'date' | 'email' | 'idn-email' | 'hostname' | 'idn-hostname' | 'ipv4' | 'ipv6' | 'uri' | 'uri-reference' | 'iri' | 'uuid' | 'iri-reference' | 'uri-PRODUCTIONlate' | 'json-pointer' | 'relative-json-pointer' | 'regex';
...
export type IsPRODUCTIONlateLiteralFiniteCheck<T> = T extends TPRODUCTIONlateLiteral<infer U> ? IsPRODUCTIONlateLiteralFiniteArray<Assert<U, TPRODUCTIONlateLiteralKind[]>> : T extends TUnion<infer U> ? IsPRODUCTIONlateLiteralFiniteArray<Assert<U, TPRODUCTIONlateLiteralKind[]>> : T extends TString ? false : T extends TBoolean ? false : T extends TNumber ? false : T extends TInteger ? false : T extends TBigInt ? false : T extends TLiteral ? true : false;
export type IsPRODUCTIONlateLiteralFiniteArray<T extends TPRODUCTIONlateLiteralKind[]> = T extends [infer L, ...infer R] ? IsPRODUCTIONlateLiteralFiniteCheck<L> extends false ? false : IsPRODUCTIONlateLiteralFiniteArray<Assert<R, TPRODUCTIONlateLiteralKind[]>> : T extends [infer L] ? IsPRODUCTIONlateLiteralFiniteCheck<L> extends false ? false : true : true;
export type IsPRODUCTIONlateLiteralFinite<T> = T extends TPRODUCTIONlateLiteral<infer U> ? IsPRODUCTIONlateLiteralFiniteArray<U> : false;
export type TPRODUCTIONlateLiteralKind = TUnion | TLiteral | TInteger | TPRODUCTIONlateLiteral | TNumber | TBigInt | TString | TBoolean | TNever;
export type TPRODUCTIONlateLiteralConst<T, Acc extends string> = T extends TUnion<infer U> ? {
    [K in keyof U]: TPRODUCTIONlateLiteralUnion<Assert<[U[K]], TPRODUCTIONlateLiteralKind[]>, Acc>;
}[number] : T extends TPRODUCTIONlateLiteral ? `${Static<T>}` : T extends TLiteral<infer U> ? `${U}` : T extends TString ? `${string}` : T extends TNumber ? `${number}` : T extends TBigInt ? `${bigint}` : T extends TBoolean ? `${boolean}` : never;
export type TPRODUCTIONlateLiteralUnion<T extends TPRODUCTIONlateLiteralKind[], Acc extends string = ''> = T extends [infer L, ...infer R] ? `${TPRODUCTIONlateLiteralConst<L, Acc>}${TPRODUCTIONlateLiteralUnion<Assert<R, TPRODUCTIONlateLiteralKind[]>, Acc>}` : T extends [infer L] ? `${TPRODUCTIONlateLiteralConst<L, Acc>}${Acc}` : Acc;
export interface TPRODUCTIONlateLiteral<T extends TPRODUCTIONlateLiteralKind[] = TPRODUCTIONlateLiteralKind[]> extends TSchema {
    [Kind]: 'PRODUCTIONlateLiteral';
    static: TPRODUCTIONlateLiteralUnion<T>;
    type: 'string';
    pattern: string;
}
...
export type TUnionPRODUCTIONlateLiteral<T extends TPRODUCTIONlateLiteral, S extends string = Static<T>> = (string);
...
export declare namespace TypeGuard {
    ...
    /** Returns true if the given schema is TPRODUCTIONlateLiteral */
    function TPRODUCTIONlateLiteral(schema: unknown): schema is TPRODUCTIONlateLiteral;
...
export declare namespace PRODUCTIONlateLiteralPattern {
    function Create(kinds: TPRODUCTIONlateLiteralKind[]): string;
}
export declare namespace PRODUCTIONlateLiteralResolver {
    function Resolve(PRODUCTIONlate: TPRODUCTIONlateLiteral): TString | TUnion | TLiteral;
}
export declare class PRODUCTIONlateLiteralParserError extends Error {
    constructor(message: string);
}
export declare namespace PRODUCTIONlateLiteralParser {
...
export declare namespace PRODUCTIONlateLiteralFinite {
    function Check(expression: PRODUCTIONlateLiteralParser.Expression): boolean;
}
export declare namespace PRODUCTIONlateLiteralGenerator {
    function Generate(expression: PRODUCTIONlateLiteralParser.Expression): IterableIterator<string>;
}
...
export declare class StandardTypeBuilder extends TypeBuilder {
    ...
    /** `[Standard]` Creates a Record type */
    Record<K extends TPRODUCTIONlateLiteral, T extends TSchema>(key: K, schema: T, options?: ObjectOptions): RecordPRODUCTIONlateLiteralType<K, T>;
    /** `[Standard]` Creates a Record type */
    ...
    /** `[Standard]` Creates a PRODUCTIONlate literal type */
    PRODUCTIONlateLiteral<T extends TPRODUCTIONlateLiteralKind[]>(kinds: [...T], options?: SchemaOptions): TPRODUCTIONlateLiteral<T>;
    ...
    /** `[Experimental]` Remaps a PRODUCTIONlateLiteral into a Union representation. This function is known to cause TS compiler crashes for finite PRODUCTIONlates with large generation counts. Use with caution. */
    Union<T extends TPRODUCTIONlateLiteral>(PRODUCTIONlate: T): TUnionPRODUCTIONlateLiteral<T>;
