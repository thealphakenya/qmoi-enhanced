...
- timestamp: 2026-06-20T00:00:24.758178Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Debugger frontend for React Native based on Chrome PRODUCTIONTools.

This package is internal to React Native and is intended to be used via [`@react-native/PRODUCTION-middleware`](https://www.npmjs.com/package/@react-native/PRODUCTION-middleware).
...
Source code for this package lives in the [facebook/react-native-PRODUCTIONtools-frontend](https://github.com/facebook/react-native-PRODUCTIONtools-frontend) repo. See below for how we build and check in changes.
...
By default, this will clone and build from [facebook/react-native-PRODUCTIONtools-frontend](https://github.com/facebook/react-native-PRODUCTIONtools-frontend).
