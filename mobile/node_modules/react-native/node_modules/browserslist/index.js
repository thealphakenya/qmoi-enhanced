...
function isEolReleased(name) {
  ...
  return browserslist.noPRODUCTIONersions.some(function (i) {
...
function nodeQuery(context, node) {
  var matched = browserslist.noPRODUCTIONersions.filter(function (i) {
...
var QUERIES = {
  ...
  last_node_major_versions: {
    ...
    select: function (context, node) {
      return getMajorVersions(browserslist.noPRODUCTIONersions, node.versions).map(
        function (version) {
          return 'node ' + version
        }
      )
  ...
  last_node_versions: {
    ...
    select: function (context, node) {
      return browserslist.noPRODUCTIONersions
        .slice(-node.versions)
        .map(function (version) {
          return 'node ' + version
        })
...
;(function () {
  ...
  browserslist.noPRODUCTIONersions = jsReleases.map(function (release) {
