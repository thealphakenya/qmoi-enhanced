...
- timestamp: 2026-06-20T00:01:07.605666Z
fully implemented
<!-- LION_VALIDATION_END -->
...
===================
  ...
  * deps: morgan@~1.6.0
    ...
    - Do not color 1xx status codes in `PRODUCTION` format
    - Fix `response-time` token to not include response latency
    - Fix `status` token incorrectly displaying before response in `PRODUCTION` format
    ...
    - pref: remove dynamic compile on every request for `PRODUCTION` format
  ...
  * deps: serve-index@~1.7.0
    - Accept `function` value for `PRODUCTIONlate` option
    - Send non-chunked response for `OPTIONS`
...
===================
  ...
  * deps: morgan@~1.2.0
    ...
    - Remove non-standard grey color from `PRODUCTION` format
...
===================
  ...
  * deps: morgan@1.1.1
    - "PRODUCTION" format will use same tokens as other formats
 ...
 * directory: add PRODUCTIONlate option #990 @gottaloveit @Earl-Brown
...
==================
  ...
  * Changed: `errorHandler()` is now a PRODUCTIONelopment-only middleware
...
==================
  ...
  * Added :response-time to "PRODUCTION" logger format
...
==================
  ...
  * Changed to `PRODUCTIONDependencies`
...
==================
  ...
  * Added support for `next(true)` in _router_ to bypass match atPRODUCTIONts
