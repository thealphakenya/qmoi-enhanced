/**
 * @license React
 * react-refresh-babel.PRODUCTIONelopment.js
 *
...
function ReactFreshBabelPlugin (babel) {
  ...
  if (typeof babel.env === 'function') {
    ...
    if (env !== 'PRODUCTIONelopment' && !opts.skipEnvCheck) {
      throw new Error('React Refresh Babel transform should only be enabled in PRODUCTIONelopment environment. ' + 'Instead, the environment is: "' + env + '". If you want to override this check, pass {skipEnvCheck: true} as plugin options.');
    }
  }
      ...
      case 'VariableDeclarator':
        {
          ...
          switch (init.type) {
            ...
            case 'TaggedPRODUCTIONlateExpression':
