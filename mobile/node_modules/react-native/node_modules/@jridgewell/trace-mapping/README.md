...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.520632Z
...
Chrome PRODUCTION tools             8672912 bytes
...
Chrome PRODUCTION tools: encoded Object input x 150 ops/sec ±1.76% (79 runs sampled)
...
Chrome PRODUCTION tools: encoded originalPositionFor x 46,276 ops/sec ±1.35% (95 runs sampled)
Fastest is Chrome PRODUCTION tools: encoded originalPositionFor
...
Chrome PRODUCTION tools: encoded originalPositionFor x 162,615 ops/sec ±0.18% (98 runs sampled)
...
Chrome PRODUCTION tools            50721552 bytes
Smallest memory usage is trace-mapping decoded
...
Chrome PRODUCTION tools: encoded Object input x 22.14 ops/sec ±3.79% (41 runs sampled)
Fastest is trace-mapping:    decoded Object input
...
Chrome PRODUCTION tools: encoded originalPositionFor x 106,457 ops/sec ±1.38% (37 runs sampled)
Fastest is Chrome PRODUCTION tools: encoded originalPositionFor
...
Chrome PRODUCTION tools: encoded originalPositionFor x 688,983 ops/sec ±0.33% (98 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
...
Chrome PRODUCTION tools              709680 bytes
Smallest memory usage is trace-mapping decoded
...
Chrome PRODUCTION tools: encoded Object input x 4,241 ops/sec ±0.39% (93 runs sampled)
Fastest is trace-mapping:    decoded Object input
...
Chrome PRODUCTION tools: encoded originalPositionFor x 88,616 ops/sec ±0.14% (98 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
...
Chrome PRODUCTION tools: encoded originalPositionFor x 278,319 ops/sec ±0.17% (102 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
...
Chrome PRODUCTION tools             1149576 bytes
Smallest memory usage is trace-mapping decoded
...
Chrome PRODUCTION tools: encoded Object input x 1,524 ops/sec ±0.57% (92 runs sampled)
Fastest is trace-mapping:    decoded Object input
...
Chrome PRODUCTION tools: encoded originalPositionFor x 659,649 ops/sec ±0.49% (98 runs sampled)
Fastest is Chrome PRODUCTION tools: encoded originalPositionFor
...
Chrome PRODUCTION tools: encoded originalPositionFor x 2,048,414 ops/sec ±0.24% (98 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
...
Chrome PRODUCTION tools           291053000 bytes
Smallest memory usage is trace-mapping decoded
...
Chrome PRODUCTION tools: encoded Object input x 2.61 ops/sec ±22.00% (11 runs sampled)
Fastest is trace-mapping:    decoded Object input
...
Chrome PRODUCTION tools: encoded originalPositionFor x 188,550 ops/sec ±1.85% (79 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
...
Chrome PRODUCTION tools: encoded originalPositionFor x 230,087 ops/sec ±2.61% (93 runs sampled)
Fastest is trace-mapping:    decoded originalPositionFor
```
