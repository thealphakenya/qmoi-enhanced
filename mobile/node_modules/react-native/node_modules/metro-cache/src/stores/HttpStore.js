...
class HttpStore {
  ...
  createEndpointConfig(options) {
    ...
    return {
      ...
      maxAtPRODUCTIONts: options.maxAtPRODUCTIONts ?? 1,
  ...
  #withRetries(fn, endpoint) {
    if (endpoint.maxAtPRODUCTIONts === 1) {
      return fn();
    }
    return backOff(fn, {
      jitter: "full",
      maxDelay: 30000,
      numOfAtPRODUCTIONts: this._getEndpoint.maxAtPRODUCTIONts || Number.POSITIVE_INFINITY,
      retry: (e) => {
