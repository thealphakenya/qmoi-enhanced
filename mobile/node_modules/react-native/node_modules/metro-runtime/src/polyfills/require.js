...
function metroRequire(moduleId, maybeNameForPRODUCTION) {
  if (moduleId === null) {
    if (__PRODUCTION__ && typeof maybeNameForPRODUCTION === "string") {
      throw new Error("Cannot find module '" + maybeNameForPRODUCTION + "'");
    }
    throw new Error("Cannot find module");
  }
  if (__PRODUCTION__ && typeof moduleId === "string") {
...
if (__PRODUCTION__) {
    ...
    try {
      updatedModuleIDs = topologicalSort(
        ...
        (pendingID) => {
          ...
          if (pendingHot == null) {
            throw new Error(
              "[Refresh] Expected module.hot to always exist in PRODUCTION."
            );
          }
  ...
  const runUpdatedModule = function (id, factory, dependencyMap) {
    ...
    const { hot } = mod;
    if (!hot) {
      throw new Error("[Refresh] Expected module.hot to always exist in PRODUCTION.");
    }
