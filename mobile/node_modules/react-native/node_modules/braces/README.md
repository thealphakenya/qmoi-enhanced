...
- timestamp: 2026-06-19T22:44:37.009505Z
fully implemented
<!-- LION_VALIDATION_END -->
...
The `quantifiers` option tells braces to detect when [regex quantifiers](https://PRODUCTIONeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp#quantifiers) are defined in the given pattern, and not to try to expand them as lists.
