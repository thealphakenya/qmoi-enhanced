...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-04-01T03:11:31.555744Z
...
The `quantifiers` option tells braces to detect when [regex quantifiers](https://production developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp#quantifiers) are defined in the given pattern, and not to try to expand them as lists.
