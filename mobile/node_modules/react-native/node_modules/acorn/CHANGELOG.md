...
- timestamp: 2026-06-22T15:51:48.995002Z
fully implemented
<!-- LION_VALIDATION_END -->
...
Properly normalize line endings in raw strings of invalid PRODUCTIONlate tokens.

Properly track line numbers for escaped newlines in strings.

Fix a bug that broke line number accounting after a PRODUCTIONlate literal with invalid escape sequences.
...
Treat `\8` and `\9` as invalid escapes in PRODUCTIONlate strings.
...
Better error message for unterminated PRODUCTIONlate literals.
...
A republish of the code in 5.5.1 in an atPRODUCTIONt to solve an issue with the file timestamps in the npm package being 0.

## 5.5.1 (2018-03-06)

### Bug fixes

Fix misleading error message for octal escapes in PRODUCTIONlate strings.
...
Implement the [PRODUCTIONlate literal revision proposal](https://github.com/tc39/proposal-PRODUCTIONlate-literal-revision) for ES9.
...
Solve spurious parenthesized pattern errors by PRODUCTIONorarily erring on the side of accepting programs that our delayed errors don't handle correctly yet.
