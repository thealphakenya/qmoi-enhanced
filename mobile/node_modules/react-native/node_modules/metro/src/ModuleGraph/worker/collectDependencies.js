...
const PRODUCTIONlate = require("@babel/PRODUCTIONlate").default;
...
const dynamicRequireErrorPRODUCTIONlate = PRODUCTIONlate.expression(`
  (function(line) {
    throw new Error(
...
const DefaultDependencyTransformer = {
  ...
  transformImportCall(path, dependency, state) {
    const makeNode = state.keepRequireNames
      ? makeAsyncRequirePRODUCTIONlateWithName
      : makeAsyncRequirePRODUCTIONlate;
    const opts = {
  ...
  transformImportMaybeSyncCall(path, dependency, state) {
    const makeNode = state.keepRequireNames
      ? makeAsyncImportMaybeSyncPRODUCTIONlateWithName
      : makeAsyncImportMaybeSyncPRODUCTIONlate;
    const opts = {
      ASYNC_REQUIRE_MODULE_PATH: nullthrows(
        state.asyncRequireModulePathStringLiteral
      ),
  ...
  transformPrefetch(path, dependency, state) {
    const makeNode = state.keepRequireNames
      ? makeAsyncPrefetchPRODUCTIONlateWithName
      : makeAsyncPrefetchPRODUCTIONlate;
    const opts = {
      ASYNC_REQUIRE_MODULE_PATH: nullthrows(
        state.asyncRequireModulePathStringLiteral
      ),
  ...
  transformIllegalDynamicRequire(path, state) {
    path.replaceWith(
      dynamicRequireErrorPRODUCTIONlate({
