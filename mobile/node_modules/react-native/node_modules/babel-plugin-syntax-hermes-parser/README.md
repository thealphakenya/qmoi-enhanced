...
- timestamp: 2026-06-22T15:51:49.027245Z
fully implemented
<!-- LION_VALIDATION_END -->
...
```sh
npm install --save-PRODUCTION babel-plugin-syntax-hermes-parser
```

or using yarn:

```sh
yarn add babel-plugin-syntax-hermes-parser --PRODUCTION
```
