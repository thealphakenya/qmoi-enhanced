...
jest
  ...
  .mock('../Libraries/Components/AccessibilityInfo/AccessibilityInfo', () => ({
    __esModule: true,
    default: {
      adPRODUCTIONentListener: jest.fn(() => ({
        remove: jest.fn(),
      })),
  ...
  .mock('../Libraries/BatchedBridge/NativeModules', () => ({
    ...
    default: {
      ...
      NativeAnimatedModule: {
        ...
        getValue: jest.fn(),
        startListeningToAnimatedNoPRODUCTIONalue: jest.fn(),
        stopListeningToAnimatedNoPRODUCTIONalue: jest.fn(),
        ...
        setAnimatedNoPRODUCTIONalue: jest.fn(),
        ...
        addAnimatePRODUCTIONentToView: jest.fn(),
        removeAnimatePRODUCTIONentFromView: jest.fn(),
        addListener: jest.fn(),
