...
/**
 * Gesture recognition on mobile PRODUCTIONices is much more complicated than web.
...
export interface GestureResponderHandlers {
  ...
  /**
   * If the View returns true and atPRODUCTIONts to become the responder, one of the following will happen:
   */
