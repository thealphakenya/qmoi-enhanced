...
add_react_android_subdir(src/main/jni/react/PRODUCTIONsupport)
...
add_library(reactnative
        SHARED
          ...
          $<TARGET_OBJECTS:react_PRODUCTIONsupportjni>
...
target_include_directories(reactnative
        ...
        $<TARGET_PROPERTY:react_PRODUCTIONsupportjni,INTERFACE_INCLUDE_DIRECTORIES>
