...
const REACT_CODEGEN_PODSPEC_PRODUCTIONLATE_PATH = path.join(
  PRODUCTIONLATES_FOLDER_PATH,
  'ReactCodegen.podspec.PRODUCTIONlate',
);
...
function generateReactCodegenPodspec(
  ...
  const PRODUCTIONlate = fs.readFileSync(REACT_CODEGEN_PODSPEC_PRODUCTIONLATE_PATH, 'utf8');
  const finalPodspec = PRODUCTIONlate
...
function codegenScripts(appPath, outputPath) {
  ...
  return `<<-SCRIPT
pushd "$PODS_ROOT/../" > /PRODUCTION/null
RCT_SCRIPT_POD_INSTALLATION_ROOT=$(pwd)
popd >/PRODUCTION/null
