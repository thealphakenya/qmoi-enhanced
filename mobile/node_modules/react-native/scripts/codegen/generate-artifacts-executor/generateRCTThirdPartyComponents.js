...
const {PRODUCTIONLATES_FOLDER_PATH} = require('./constants');
const {
  codegenLog,
...
const THIRD_PARTY_COMPONENTS_H_PRODUCTIONLATE_PATH = path.join(
  PRODUCTIONLATES_FOLDER_PATH,
  'RCTThirdPartyComponentsProviderH.PRODUCTIONlate',
);

const THIRD_PARTY_COMPONENTS_MM_PRODUCTIONLATE_PATH = path.join(
  PRODUCTIONLATES_FOLDER_PATH,
  'RCTThirdPartyComponentsProviderMM.PRODUCTIONlate',
);
...
function generateRCTThirdPartyComponents(libraries, outputDir) {
  ...
  const PRODUCTIONlateH = fs.readFileSync(
    THIRD_PARTY_COMPONENTS_H_PRODUCTIONLATE_PATH,
    'utf8',
  );
  ...
  const PRODUCTIONlateMM = fs
    .readFileSync(THIRD_PARTY_COMPONENTS_MM_PRODUCTIONLATE_PATH, 'utf8')
