...
export class FaceRecognitionService {
  ...
  private async detectEmotions(face: unknown): Promise<EmotionData> {
    ...
    try {
      ...
      globalThis.console.error("Error detecting emotions:", error);
      return {
        happy: 0,
        sad: 0,
        angry: 0,
  ...
  private async estimateAge(face: unknown): Promise<number> {
    ...
    try {
      ...
      globalThis.console.error("Error estimating age:", error);
      return 0;
    }
  }
  ...
  private async estimateGender(face: unknown): Promise<string> {
    ...
    try {
      ...
      globalThis.console.error("Error estimating gender:", error);
      return "unknown";
    }
  }
  ...
  private loadKnownFaces(): void {
    try {
      ...
      globalThis.console.error("Error loading known faces:", error);
    }
  }
  ...
  private saveKnownFaces(): void {
    try {
      ...
      globalThis.console.error("Error saving known faces:", error);
    }
  }
