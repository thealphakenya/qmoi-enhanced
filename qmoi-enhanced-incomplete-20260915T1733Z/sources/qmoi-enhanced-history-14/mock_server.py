...
"""
Mock Backend Server for Testing Frontend Adapters
...
def health():
    ...
    return jsonify({
        ...
        'note': 'This is a MOCK backend for testing. Replace with real backend.'
    }), 200
...
def send_mail():
    ...
    try:
        ...
        print(f"[MOCK MAIL] Subject: {subject}")
        print(f"[MOCK MAIL] Body: {body[:100]}...")
        ...
        return jsonify({
            ...
            'note': 'This is a mock response. Real email was not sent.'
        }), 200
...
def upload_file():
    ...
    try:
        ...
        print(f"[MOCK FILE] Uploaded: {file.filename} ({file_size} bytes)")
        ...
        return jsonify({
            ...
            'note': 'This is a mock file storage. Real upload was not performed.'
        }), 200
...
def emergency_action():
    """Emergency actions: SOS, lockdown, wipe, alert (mock)"""
    if request.method == 'OPTIONS':
        return '', 204
    ...
    try:
        ...
        return jsonify({
            ...
            'note': f'This is a MOCK emergency action. Real {action} was NOT executed.'
        }), 200
...
def verify_product():
    ...
    try:
        ...
        print(f"[MOCK VERIFY] SKU: {sku}, Result: {'✅ AUTHENTIC' if verified else '❌ COUNTERFEIT'}")
        ...
        return jsonify({
            ...
            'note': 'This is a MOCK verification result.'
        }), 200
...
def youtube_download():
    ...
    try:
        ...
        print(f"[MOCK YOUTUBE] URL: {url[:50]}... Format: {format_type} Quality: {quality}")
        ...
        return jsonify({
            ...
            'expiresIn': 3600,
            'timestamp': datetime.now().isoformat(),
            'message': '📹 Download queued (mock)',
            'note': f'This is a MOCK download. No actual video was downloaded.'
        }), 200
...
def index():
    ...
    <html>
    <head>
        <title>QCity Backend Mock Server</title>
        <style>
            body {{
    ...
    <body>
        <h1>🚀 QCity Backend Mock Server</h1>
        ...
        <div class="warning">
            <strong>⚠️  Important:</strong> This is a MOCK server for testing only.
    ...
    file: File
        ...
        <div class="endpoint">
            ...
            <p>Emergency action: sos, lockdown, wipe, alert (mock)</p>
            <pre>{{
    "action": "sos",
    "reason": "Test"
}}</pre>
    ...
    "format": "mp4"
        ...
        <div class="endpoint">
            <span class="method get">GET</span>
            <code>/api/media</code>
            <p>List media items (mock)</p>
            <pre>Query: ?limit=20&offset=0&type=video</pre>
        </div>
        
        <h2>Testing</h2>
        <p>Update <code>.env.local</code> to use this mock server:</p>
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🚀 QCity Backend Mock Server")
    print("="*60)
    ...
    print("\n  3. Test components (they'll call this mock server)")
    print("\n⚠️  IMPORTANT: This is a MOCK server for testing only!")
