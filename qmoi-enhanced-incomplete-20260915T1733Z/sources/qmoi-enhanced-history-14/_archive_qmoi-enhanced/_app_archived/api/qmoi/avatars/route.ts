...
export async function GET() {
  try {
    ...
    globalThis.console.error("Error fetching avatars:", error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    globalThis.console.error("Error in avatars API:", error);
    return NextResponse.json(
...
async function switchAvatar(avatarId: string) {
  try {
    ...
    globalThis.console.error("Error switching avatar:", error);
    return NextResponse.json(
...
async function upgradeAvatar(avatarId: string) {
  try {
    ...
    globalThis.console.error("Error upgrading avatar:", error);
    return NextResponse.json(
...
async function enhanceAvatar(
  ...
  try {
    ...
    globalThis.console.error("Error enhancing avatar:", error);
    return NextResponse.json(
...
async function customizeAvatar(avatarId: string, voiceProfile: string) {
  try {
    ...
    globalThis.console.error("Error customizing avatar:", error);
    return NextResponse.json(
