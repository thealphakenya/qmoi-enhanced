...
export function QMOIGitLabClone({ className }: QMOIGitLabCloneProps) {
  ...
  const fetchPipelines = async () => {
    try {
      ...
      globalThis.console.error("Error fetching pipelines:", error);
    }
  };
  ...
  const fetchJobs = async () => {
    try {
      ...
      globalThis.console.error("Error fetching jobs:", error);
    }
  };
  ...
  const checkErrors = async () => {
    try {
      ...
      globalThis.console.error("Error checking errors:", error);
    }
  };
  ...
  const triggerPipeline = async () => {
    try {
      ...
      globalThis.console.error("Error triggering pipeline:", error);
      setSyncStatus("error");
      setTimeout(() => setSyncStatus("idle"), 3000);
    }
  };
