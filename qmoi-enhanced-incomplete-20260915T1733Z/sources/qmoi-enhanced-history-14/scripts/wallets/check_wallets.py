...
class AdapterBase:
    ...
    def check_balance(self, config, real=False):
        ...
        In mock mode return safe mocked values.
...
class CashonAdapter(AdapterBase):
    def check_balance(self, config, real=False):
        ...
        # mock
        return {"balance": "100.00 (mock)", "currency": "USD", "last_checked": now_iso(), "status": "mocked", "meta": {"adapter": self.name}}
...
# Merge in registry from adapter_base (testnet/mock adapters)
try:
...
def discover_wallets():
    # Minimal discovery: look for known MD docs and known env vars
    wallets = {}
...
def load_config_for(wallet_name):
    ...
    cfg = {}
    # Example: CASHON_API_KEY, CASHON_API_URL
...
def main():
    ...
    for name in names:
        ...
        if adapter_key and adapter_key in ADAPTERS:
            ...
            res = {"balance": "0.00 (mock)", "currency": cfg.get('currency','USD'), "last_checked": now_iso(), "status": "mocked", "meta": {"adapter": 'mock'}}
...
# AUTOFIXED by Ollama at 2026-07-26T18:54:41.340194Z

# AUTOFIXED by Ollama at 2026-07-26T18:57:34.376034Z

# AUTOFIXED by Ollama at 2026-07-26T19:31:06.511609Z

# AUTOFIXED by Ollama at 2026-07-26T19:39:17.561205Z
