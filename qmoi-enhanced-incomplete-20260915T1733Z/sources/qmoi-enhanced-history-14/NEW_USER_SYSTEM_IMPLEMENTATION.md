...
- **How**: Create temporary guest profile
- **Data**: Minimal profile, generic responses
...
Response:
{
  ...
  "message": "Welcome Leah! Verification code sent to leah@example.com",
...
[Determine Stage] → (A-H progression)
    ↓
[Select Response Template] → (personalized version)
    ↓
