...
- **qmoi_ai.exe** — Main Windows executable
  ...
  - Status: ⚠️ **TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) stub** (169 bytes) — See build instructions below
...
**The Windows executable (`qmoi_ai.exe`) in this repository is currently a 169-byte TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) stub.** This is used for documentation and link verification purposes only.
...
|----------|--------|---|---|
| Windows | ⚠️ TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) | v1.2.3 | EXE Installer |
...
- **Cause:** TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) stub file used instead of real executable
