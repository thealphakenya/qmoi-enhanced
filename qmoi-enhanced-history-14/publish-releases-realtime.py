...
Usage:
    ...
    python publish-releases-realtime.py --version v1.2.3 --draft
...
class QMOIReleasePublisher:
    ...
    def __init__(self, version: str, draft: bool = False, repo: str = None, verbose: bool = False):
    ...
    def _validate_version(self) -> bool:
        ...
        if not re.match(pattern, self.version):
            ...
            logger.info("Expected format: v1.2.3 or v1.2.3-beta")
            return False
        return True
...
**Status:** {'🟡 Draft' if self.draft else '🟢 Production Ready'}
...
"""
    ...
    def print_summary(self):
        ...
        print(f"Status:         {'DRAFT' if self.draft else 'PUBLISHED'}")
