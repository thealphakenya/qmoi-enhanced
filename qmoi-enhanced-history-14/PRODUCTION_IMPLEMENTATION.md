...
- Master user validation for master operations
...
- Master alerts for security events
...
ADMIN_EMAILS=master@qmoi.app,support@qmoi.app
```
...
- ✅ Master user role for master operations
