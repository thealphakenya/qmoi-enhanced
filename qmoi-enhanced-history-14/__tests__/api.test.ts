...
describe.skip("QMOI Enhanced API Tests", () => {
  ...
  describe("Master Endpoints", () => {
    it("GET /api/master/users - Should list all users (master only)", async () => {
      const response = await apiRequest(
        "GET",
        "/api/master/users",
        undefined,
    ...
    it("GET /api/master/dashboard - Should return dashboard stats", async () => {
      const response = await apiRequest(
        "GET",
    ...
    it("GET /api/master/audit-logs - Should retrieve audit logs", async () => {
      const response = await apiRequest(
        "GET",
    ...
    it("GET /api/master/alerts - Should get system alerts", async () => {
      const response = await apiRequest(
        "GET",
        "/api/master/alerts",
        undefined,
  ...
  describe("Error Handling", () => {
    it("Should return 401 for unauthorized requests", async () => {
      const response = await apiRequest("GET", "/api/master/users");
