...
- /api/master/alerts [GET, POST]
- /api/master/audit-logs [GET, POST]
- /api/master/autofix/automation [GET, POST]
- /api/master/autofix/autoscan [GET]
- /api/master/autofix/background-automation [GET, POST]
- /api/master/autofix/bootstrap [GET, DELETE]
- /api/master/autofix/config [GET, POST, PUT, DELETE]
- /api/master/autofix/errors [GET, POST]
- /api/master/autofix/fix-all [GET, POST]
- /api/master/autofix/fix/[errorId] [POST]
- /api/master/autofix/health [GET]
- /api/master/autofix/healthmonitor [GET]
- /api/master/autofix/scan [GET, POST]
- /api/master/autofix/stream [GET]
- /api/master/dashboard [GET]
- /api/master/financial/summary [GET]
- /api/master/master/auth [POST]
- /api/master/master/logout [POST]
- /api/master/monitoring [GET]
- /api/master/monitoring [GET]
- /api/master/rate-limits [GET, PUT]
- /api/master/users [GET, PUT, DELETE]
- /api/ai [GET, POST]
