...
- **`app/api/master/autofix/background-automation/route.ts`** - Control API
- **`app/api/master/autofix/autoscan/route.ts`** - Auto-scan status
- **`app/api/master/autofix/healthmonitor/route.ts`** - Health status
- **`app/api/master/autofix/config/route.ts`** - Configuration management
- **`app/api/master/autofix/bootstrap/route.ts`** - Bootstrap logs
...
- [ ] Visit dashboard: `http://localhost:3000/master`
- [ ] Check logs: `tail -f .logs/qmoi-autoscan.log`
- [ ] Test API: `curl ... /api/master/autofix/background-automation`
...
# Visit http://localhost:3000/master      # Monitor (immediate)
```
