  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4 flex items-center">
        Aviator Gallery
        <HelpLink href="/docs/AVATAR.md" label="Avatar Gallery Documentation" />
      </h2>
      ...
      >
        ...
        <label htmlFor="voice-upload" className="text-sm">
          Voice Audio (.mp3, .wav):
        </label>
        <input
          id="voice-upload"
...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/src.backup.20260121144720/components/q-city/AviatorGalleryPanel.tsx -->
import React, { useEffect, useState } from "react";
import type { AvatarConfig } from "./avatarsConfig";
import { useToast } from "@/components/ui/use-toast";
import { getSessionHeaders } from "../../services/qmoiSession";
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/src.backup.20260121144720/components/q-city/AviatorGalleryPanel.tsx -->
import React, { useEffect, useState } from "react";
import type { AvatarConfig } from "./avatarsConfig";
import { useToast } from "@/components/ui/use-toast";
import { getSessionHeaders } from "../../services/qmoiSession";
