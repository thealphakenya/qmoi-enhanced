...
export const FloatingAQ: React.FC = () => {
  ...
  const { chatHistory, setChatHistory, aiHealth, deviceHealth } =
    useAIContext();
  ...
  useEffect(() => {
    try {
      ...
      globalThis.console.error("Failed to save settings:", error);
      toast({
        title: "Error",
  ...
  useEffect(() => {
    try {
      ...
      globalThis.console.error("Failed to save voice URI:", error);
      toast({
        title: "Error",
  ...
  const speak = useCallback(
    (text: string) => {
      ...
      const voice =
        voices.find((v) => v.voiceURI === selectedVoiceURI) || voices[0];
      ...
      <div
        ...
        style={{
          ...
          background: open
            ...
            : "#1a1a2e",
          boxShadow: open
            ? "0 4px 32px 4px #00f2fe99, 0 2px 12px rgba(0,0,0,0.2)"
            : "0 2px 16px 2px #00f2fe55, 0 2px 12px rgba(0,0,0,0.2)",
          display: "flex",
          alignItems: "center",
      ...
      >
        <button
          ...
          style={{
            ...
            borderRadius: 24,
            boxShadow: open
              ? "0 0 16px 4px #00f2fe88"
              : "0 0 8px 2px #00f2fe44",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        ...
        >
          <motion.span
            ...
            aria-label="A-Q"
            style={{
              filter: open ? "drop-shadow(0 0 6px #00f2fe)" : undefined,
            }}
            animate={
              open
          ...
          >
            ...
            <div style={{ flex: 1, minHeight: 0 }}>
              ...
              >
                ...
                >
                  {selectedVoiceURI ? "Change Voice" : "Pick Voice"}
                </button>
              </div>
              {/* Voice picker dialog */}
              {showVoicePicker && (
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    ...
                    >
                      ...
                      <input
                        ...
                        placeholder="Describe your image or animation..."
                        style={{
                          width: "100%",
                          margin: "8px 0",
                          padding: 8,
                    ...
                    {imageLoading && (
                      <div style={{ marginTop: 16 }}>Generating image...</div>
                    )}
                    {imageError && (
                    ...
                    {imageUrl && (
                      <div style={{ marginTop: 16 }}>
                        ...
                        <div style={{ fontSize: 12, color: "#888" }}>
                          Preview (AI generated or placeholder)
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    {walletLoading ? (
                      ...
                      <>
                          ...
                          {walletTransactions.map((tx, i) => (
                            ...
                            >
                              ...
                              <span
                                style={{
                                  color:
                                    tx.type === "BUY" || tx.side === "BUY"
                                      ? "#0a0"
                                      : "#a00",
                                }}
                              >
                                ({tx.result || tx.status || "Simulated"})
                              </span>
                        ...
                        >
                          Multi-wallet/service support coming soon.
                        </div>
                      </>
                    )}
                  </div>
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    ...
                    {automationLoading ? (
                      ...
                      <>
                        ...
                        >
                          Full automation and integration coming soon.
                        </div>
                      </>
                    )}
                  </div>
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    <div style={{ marginBottom: 10 }}>
                      ...
                      >
                        ...
                        <li>
                          Memory:{" "}
                          {deviceHealth.memory
                            ? deviceHealth.memory + " GB"
                            : "Unknown"}
                        </li>
                        <li>
                          Battery:{" "}
                          {deviceHealth.battery !== null
                    ...
                    <div style={{ marginBottom: 10 }}>
                      ...
                      >
                        ...
                        <li>
                          Last Check:{" "}
                          {new Date(aiHealth.lastCheck).toLocaleString()}
                        </li>
                        {aiHealth.error && (
                          <li style={{ color: "red" }}>
                    ...
                    {healthScanResult && (
                      <div style={{ marginTop: 8, color: "#0a0" }}>
                        {healthScanResult}
                      </div>
                    )}
                    {selfHealResult && (
                    ...
                    >
                      ...
                      simulated. For advanced protection, see system integration
                      docs.
                    </div>
                  </div>
                </motion.div>
              ...
              {modal === "settings" && (
                ...
                >
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    <div>
                      <label>
                        <input type="checkbox" checked readOnly /> Enable A-Q
                        Assistant
                      </label>
                    </div>
                    <div>
                    ...
                    >
                      A-Q will auto-open if enabled. For true OS-level
                      auto-start, see system integration docs.
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              {modal === "globalcall" && (
                ...
                >
                  ...
                  <div style={{ color: "#333", width: "100%" }}>
                    ...
                    >
                      Global call feature is in beta. For issues, contact
                      support.
                    </div>
                  </div>
                </motion.div>
...
// AUTOFIXED by Ollama at 2026-07-26T18:54:40.369119Z

// AUTOFIXED by Ollama at 2026-07-26T18:57:33.505568Z

// AUTOFIXED by Ollama at 2026-07-26T19:31:04.554919Z
