...
```
POST http://localhost:3000/api/admin/autofix/scan
```

**Status Endpoint:**

```
GET http://localhost:3000/api/admin/autofix/status
```
...
# Get status
curl -X GET http://localhost:3000/api/admin/autofix/status \
  -H "Authorization: Bearer your-admin-token"

# Fix all
curl -X POST http://localhost:3000/api/admin/autofix/fix-all \
  -H "Authorization: Bearer your-admin-token"
```
