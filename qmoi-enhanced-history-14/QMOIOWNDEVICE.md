...
- **M-KOPA Restrictions**: Payment locks, app restrictions, device master policies
...
- **Device Master Policies**: Remote device management restrictions
...
- **Remove Device Master**: Uninstall all device master policies
...
class DeviceOwnershipDetector:
    def detect_mkopa_restrictions(self):
        ...
        # Check for M-KOPA device master
        if self.check_device_admin("com.mkopa"):
            restrictions.append({
                "type": "mkopa",
                "severity": "high",
                "description": "M-KOPA device master detected",
                "organization": "M-KOPA"
            })
    ...
    def detect_watu_restrictions(self):
        ...
        if self.check_device_admin("com.watu"):
            restrictions.append({
                "type": "watu",
                "severity": "high",
                "description": "Watu Credit device master detected",
...
- New device master installations
...
- **Android**: Full device master removal and policy bypass
...
- **Master Rights Check:** Verifies administrative privileges
...
- **Master Elevation:** Attempts to gain master rights
...
## Merged source: qmoi-enhanced-history-14/_archive_qmoi-enhanced/QMOIOWNDEVICE.md
