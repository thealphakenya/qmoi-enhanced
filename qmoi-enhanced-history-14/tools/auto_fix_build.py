...
conservative: it only installs missing packages and never rewrites code.
"""
...
def main():
    ...
    print("Detected missing node modules:", node_mods)
    print("Detected missing python modules:", py_mods)
