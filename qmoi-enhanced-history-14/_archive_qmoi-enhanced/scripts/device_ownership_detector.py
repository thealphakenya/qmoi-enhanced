...
class DeviceOwnershipDetector:
    ...
    def _detect_mdm_restrictions(self) -> List[DeviceRestriction]:
        ...
        try:
            ...
            # Check for device master policies (Android/Windows)
            if self._check_device_admin_policies():
                restrictions.append(DeviceRestriction(
                    type='mdm',
                    severity='high',
                    description='Device master policies detected',
                    detected_at=datetime.now(),
                    organization='Mobile Device Management',
    ...
    def _check_device_admin_policies(self) -> bool:
        """Check for device master policies"""
        try:
            # Check for common MDM/device master indicators
            indicators = [
                'device_policy',
                'device_admin',
                'enterprise_policy',
            ...
            logger.error(f"Error checking device master policies: {e}")
            return False
...
if __name__ == "__main__":
    main() 
# AUTOFIXED by Ollama at 2026-07-26T18:54:39.737643Z

# AUTOFIXED by Ollama at 2026-07-26T18:57:32.886806Z

# AUTOFIXED by Ollama at 2026-07-26T19:31:03.261622Z
