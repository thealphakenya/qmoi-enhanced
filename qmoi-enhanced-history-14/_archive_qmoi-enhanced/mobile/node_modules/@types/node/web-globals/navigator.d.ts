...
type _Navigator = typeof globalThis extends { onabort: unknown } ? {} : Navigator;
interface Navigator {
...
declare global {
    ...
    var Navigator: typeof globalThis extends { onabort: unknown; Navigator: infer T } ? T : {
        prototype: Navigator;
        new(): Navigator;
    };

    // Needs conditional inference for lib.dom and lib.webworker compatibility
    var navigator: typeof globalThis extends { onmessage: unknown; navigator: infer T } ? T : Navigator;
}
