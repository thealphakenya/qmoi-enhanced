...
- Master-only controls: Only master/master can view, manage, or override parallel jobs and scaling
...
- UI features, master/master controls, and self-healing logic are applied in parallel across all device types.
