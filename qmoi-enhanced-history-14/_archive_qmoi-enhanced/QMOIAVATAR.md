...
- Remote command and management endpoints will require master/master authentication
...
- All remote command and management endpoints require an API key for master/master access
- Send the key in the request header: `x-qcity-master-key`
...
- **Master/Master Controls:** Only master/master users can trigger or schedule self-heal
...
- All panels are visible and actionable only for master/master users
...
"validated_at": "2025-10-26T20:51:24.749616Z",
