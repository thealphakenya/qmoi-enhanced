          ...
          <Card className="w-80 shadow-xl">
            ...
            <CardContent className="space-y-3">
              <div className="flex gap-2">
                <Input
                  placeholder="Ask about finances, music..."
                  value={question}
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        <div className="flex gap-2">
          <Input
            placeholder="Ask QMoi about finances, music production, or any question..."
            value={question}
            onChange={(e) => setQuestion(e.target.value)}
            onKeyPress={handleKeyPress}
            disabled={isLoading}
...
// AUTOFIXED by Ollama at 2026-07-28T23:33:46.978795Z
