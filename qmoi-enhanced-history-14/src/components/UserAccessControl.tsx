...
export const AccessControlProvider: React.FC<AccessControlProviderProps> = ({
  ...
  const [users, setUsers] = useState<User[]>([
    {
      ...
      username: "master",
      role: "master",
      permissions: ["read", "write", "delete", "master", "system"],
  ...
  const authenticate = async (
    ...
    console.log(`User ${user.username} authenticated via ${method}`);
...
export const UserAccessControl: React.FC<UserAccessControlProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      {isAuthenticated && checkPermission("master") && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="mt-2 space-y-2">
                        {["read", "write", "delete", "master", "system"].map(
                          (permission) => (
                            <label
                              key={permission}
