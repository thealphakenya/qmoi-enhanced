...
export function WifiPanel({ onClose }: WifiPanelProps) {
  ...
  useEffect(() => {
    try {
      ...
      globalThis.console.error("Failed to load WiFi logs:", error);
      toast({
        title: "Error",
  ...
  useEffect(() => {
    try {
      ...
      globalThis.console.error("Failed to save WiFi logs:", error);
      toast({
        title: "Error",
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      globalThis.console.error("Failed to fetch analytics:", error);
      toast({
        title: "Error",
