...
| ---------- | --------------- | -------------- | ----------- |
| master      | Master Dashboard | master.zip      | npm/webpack |
...
# Output:
# dist/pwa/release/
# ├── master-TIMESTAMP-production.zip
...
2. build-pwas       (ubuntu-latest)  → master.zip, deals.zip, ...
...
master.pwa.zip:      ~3MB (minified, gzipped)
```
