...
- Deals: purchasable offerings (features, subscriptions, bundles). Stored in the `deals` table and manageable by master/master endpoints.
...
- POST /deals/create — create a new deal (master/master)
- GET /deals — list deals
- GET /deals/<id> — get deal details
- POST /deals/<id>/activate — activate deal (master/master)
- POST /deals/<id>/deactivate — deactivate deal (master/master)
