...
- ✅ `/api/master/autofix/bootstrap` - Bootstrap functions working
- ✅ `/api/master/autofix/config` - Config management working
...
- `/api/master/autofix/bootstrap` - Bootstrap status
- `/api/master/autofix/config` - Configuration status
