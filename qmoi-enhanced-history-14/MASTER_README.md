...
Access the main dashboard at `/master/master`:
...
Configure automation at `/master/master/settings`:
...
Review security at `/master/master/security`:
...
Track operations at `/master/master/activity`:
...
# Visit http://localhost:3000/master/master/login
```
...
- Check `/api/master/financial/summary` endpoint
