...
# → Open: http://localhost:3000/master/master/login
...
### Production - Option 2 (Pre-Configured - Recommended)
```bash
...
```bash
# Check API status
curl http://localhost:3000/api/qmoi/auto-setup

# Access dashboard
open http://localhost:3000/master/master/login

# View automation
open http://localhost:3000/master/master

# Check logs
open http://localhost:3000/master/master/activity
```
...
- [.env.master.example](.env.master.example)
