...
This checklist ensures all QMOI applications and their builds are free of security vulnerabilities, hardcoded secrets, and other security risks before production release.
...
- [ ] **Production Configuration**
  ...
  - [ ] No hardcoded production keys anywhere
...
- [ ] **API Keys Management**
  - [ ] No API keys hardcoded in client apps
...
- [ ] **Accountability**
  - [ ] User/master actions traceable (user ID logged with each action)
