...
┌────────────────────────────────────────────────────────────────┐
│                      API Endpoints                              │
│  /api/master/autofix/background-automation  (control)           │
│  /api/master/autofix/autoscan               (status)            │
│  /api/master/autofix/healthmonitor          (status)            │
│  /api/master/autofix/config                 (config mgmt)       │
│  /api/master/autofix/bootstrap              (logs)              │
└────────────────────────────────────────────────────────────────┘
                              ↓
┌────────────────────────────────────────────────────────────────┐
│                    Dashboard (/master)                           │
...
```
app/api/master/autofix/background-automation/route.ts
app/api/master/autofix/autoscan/route.ts
app/api/master/autofix/healthmonitor/route.ts
app/api/master/autofix/config/route.ts
app/api/master/autofix/bootstrap/route.ts
```
...
| ------------------------------------------ | ------ | ----------------------------- |
| `/api/master/autofix/background-automation` | GET    | Get status & report           |
| `/api/master/autofix/background-automation` | POST   | Control (start/stop/restart)  |
| `/api/master/autofix/autoscan`              | GET    | Auto-scan status, stats, logs |
| `/api/master/autofix/healthmonitor`         | GET    | Health monitor status, alerts |
| `/api/master/autofix/config`                | GET    | Get configuration             |
| `/api/master/autofix/config`                | POST   | Update configuration          |
| `/api/master/autofix/config`                | PUT    | Update configuration          |
| `/api/master/autofix/config`                | DELETE | Reset to defaults             |
| `/api/master/autofix/bootstrap`             | GET    | Get bootstrap logs            |
| `/api/master/autofix/bootstrap`             | DELETE | Clear bootstrap logs          |
...
3. **Monitor** → Visit: `http://localhost:3000/master`
