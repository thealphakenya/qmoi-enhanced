...
- `app/master/master/page.tsx` - Main dashboard
- `app/master/master/login/page.tsx` - Authentication
...
- `app/api/master/financial/summary/route.ts` - Financial data API
...
curl -I http://localhost:3000/master/master/login
...
```
URL: http://localhost:3000/master/master/login
