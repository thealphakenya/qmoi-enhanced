...
#### Scenario 3: Missing API Response
...
- Other master endpoints require Bearer token
...
**Symptoms**: App shows missing config errors
...
Access at: `http://localhost:3000/master/master/login`
...
# Test 4: API endpoint
curl -X POST http://localhost:3000/api/qmoi/auto-setup
