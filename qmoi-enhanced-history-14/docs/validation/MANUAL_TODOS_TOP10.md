...
- **scripts/qmoi_master_website_automation.js** (23 markers)
  ...
  - Recommendation: Keep as manual. Add a dry-run mode, require master API with `requireApiKey`, strip secrets from code, and create documented operator playbooks.

- **scripts/qmoi-master-system.js** (10 markers)
  - Danger: resource management and CPU/Memory offloading — safety-critical.
  - Recommendation: Implement simulated resource management and safety checks; add a configuration toggle and require master gating in production.
