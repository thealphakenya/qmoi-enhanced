...
```bash
curl -H "Authorization: Bearer TOKEN" \
  http://localhost:3000/api/master/autofix/autoscan | jq '.logs'
```
...
- Never share or expose your master token

### Best Practices

1. Use strong, randomly-generated master token
...
- Missing or incorrect `ADMIN_TOKEN`
