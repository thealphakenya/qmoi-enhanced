...
- POST /master/backup-db — /workspaces/qmoi-enhanced/qmoi_control_server.py
- POST /master/update-ngrok — /workspaces/qmoi-enhanced/qmoi_control_server.py
...
- The control server contains master endpoints which may require `QMOI_CONTROL_TOKEN` or other env vars.
