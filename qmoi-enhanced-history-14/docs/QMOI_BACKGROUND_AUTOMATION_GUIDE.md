...
# Master Access
ADMIN_TOKEN=your-secure-token             # Required for all master operations
...
**Endpoint**: `/api/master/autofix/background-automation`
...
**Endpoint**: `/api/master/autofix/autoscan`
...
**Endpoint**: `/api/master/autofix/healthmonitor`
...
**Endpoint**: `/api/master/autofix/config`
...
1. **Master Token**: Always set `ADMIN_TOKEN` to a strong random value
...
3. Visit `/master` dashboard to view automation status
