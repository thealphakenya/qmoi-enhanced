...
class TestLinkValidator:
    ...
    def test_validate_invalid_link(self, test_links_file):
        ...
        with patch('requests.head') as mock_head:
            ...
            result = validate_links(test_links_file, ["https://invalid.example"])
            assert "https://invalid.example" in result["invalid"]
    ...
    def test_respect_network_gate(self, test_links_file):
        ...
        with pytest.raises(LinkValidationError):
            validate_links(test_links_file, ["https://example.com"], allow_network=False)
...
class TestLinkCache:
    def test_prune_old_entries(self, test_cache_file):
        ...
        assert "https://old.example" not in cache
