...
Quick example (from your master workstation):

```bash
# Deploy to your QCity host (replace with your host and user)
QCITY_HOST=qmoi-qcity.example.com QCITY_USER=master ./qcity/provision_qvillage.sh

# Watch logs
ssh master@qmoi-qcity.example.com 'sudo docker logs -f qvillage-standalone'
```
