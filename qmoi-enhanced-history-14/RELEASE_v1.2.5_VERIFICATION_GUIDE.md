...
| Web (PWA)    | `master.zip`, `deals.zip`, `q-alpha.zip`, `qmoi.zip`, `qmoi-ai.zip`, `qmoi-space.zip` | ~500KB each | Progressive Web Apps               |
...
for pwa in master.zip deals.zip q-alpha.zip qmoi.zip qmoi-ai.zip qmoi-space.zip; do
  echo "Verifying $pwa"
