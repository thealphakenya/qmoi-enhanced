...
function MainPage() {
  ...
  const handleLogin = (userData: unknown) => {
    ...
    const roleMap: Record<
      string,
      "master" | "master" | "user" | "sponsored" | "guest"
    > = {
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-xs text-blue-600 font-semibold mt-3">
                🔐 Master Administrator (Victor Kwemoi) - System Master
              </p>
            </div>
...
// AUTOFIXED by Ollama at 2026-07-26T19:31:03.426852Z


<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/app.backup.20260121144720/page.tsx -->
"use client";
...
// AUTOFIXED by Ollama at 2026-07-26T19:39:17.424088Z
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/app.backup.20260121144720/page.tsx -->
"use client";
