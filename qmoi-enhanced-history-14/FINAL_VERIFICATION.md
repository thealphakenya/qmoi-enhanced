...
- [x] `app/api/master/autofix/background-automation/route.ts` - Main control
- [x] `app/api/master/autofix/autoscan/route.ts` - Auto-scan status
- [x] `app/api/master/autofix/healthmonitor/route.ts` - Health monitor status
- [x] `app/api/master/autofix/config/route.ts` - Configuration management
- [x] `app/api/master/autofix/bootstrap/route.ts` - Bootstrap logs
