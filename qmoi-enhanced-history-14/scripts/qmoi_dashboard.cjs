...
// Load users from .qmoi_validation/users.json if present, otherwise fallback to minimal local master
let USERS = [];
try {
  ...
  USERS = [
    { username: "master", password: "master", role: "master", biometrics: false },
  ];
}
