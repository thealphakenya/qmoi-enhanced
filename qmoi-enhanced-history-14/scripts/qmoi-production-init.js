...
class QMOIProductionInit {
  ...
  async setupEnvironment() {
    ...
    try {
      ...
      if (fs.existsSync(envProduction)) {
        ...
        this.log("Creating .env.production from template...", "warning");
  ...
  /**
   * Create default .env.production template
   */
  createEnvTemplate() {
    const template = `# QMOI Production Environment
...
`;
    ...
    this.log("Created .env.production template", "success");
  }
