...
def main():
    ...
    # Master check access for payer
    r = client.get(f'/master/check-access/payer/feature', headers=headers_master)
    print('/master/check-access/payer/feature', r.status_code, pretty(r))

    # Master lists users
    r = client.get('/master/users', headers=headers_master)
    print('/master/users', r.status_code, pretty(r))
