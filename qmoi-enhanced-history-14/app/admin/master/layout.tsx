...
export function MasterLayout({ children }: MasterLayoutProps) {
  ...
  const handleLogout = async () => {
    try {
      ...
      router.push("/master/master/login");
    } catch (error) {
  ...
  const navigationItems = [
    {
      ...
      href: "/master/master",
      icon: Home,
      active: pathname === "/master/master",
    },
    {
      label: "Settings",
      href: "/master/master/settings",
      icon: Settings,
      active: pathname === "/master/master/settings",
    },
    {
      label: "Security",
      href: "/master/master/security",
      icon: Shield,
      active: pathname === "/master/master/security",
    },
    {
      label: "Activity",
      href: "/master/master/activity",
      icon: BarChart3,
      active: pathname === "/master/master/activity",
    },
  ];
