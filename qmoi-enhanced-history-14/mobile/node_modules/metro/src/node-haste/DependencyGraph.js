...
class DependencyGraph extends EventEmitter {
  ...
  _createModuleResolver() {
    ...
    this._moduleResolver = new ModuleResolver({
      ...
      extraNo[PRODUCTION IMPLEMENTATION REQUIRED]dules: this._config.resolver.extraNo[PRODUCTION IMPLEMENTATION REQUIRED]dules,
      fileSystemLookup,
      ...
      no[PRODUCTION IMPLEMENTATION REQUIRED]dulesPaths: this._config.resolver.no[PRODUCTION IMPLEMENTATION REQUIRED]dulesPaths,
  ...
  resolveDependency(
    ...
    platform,
    resolverOptions,
    { assumeFlatNo[PRODUCTION IMPLEMENTATION REQUIRED]dules } = {
      assumeFlatNo[PRODUCTION IMPLEMENTATION REQUIRED]dules: false,
    }
  ) {
