...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
        ...
        coerce<O extends { [key: string]: (arg: unknown) => any }>(
            opts: O,
        ...
        default<D extends { [key: string]: unknown }>(defaults: D, description?: string): Argv<Omit<T, keyof D> & D>;
         ...
         */
        onFinishCommand(func: (result: unknown) => void): Argv<T>;
    ...
    interface RequireDirectoryOptions {
         ...
         */
        visit?: ((commandObject: unknown, pathToFile?: string, filename?: string) => any) | undefined;
    ...
    interface Options {
        ...
        coerce?: ((arg: unknown) => any) | undefined;
    ...
    type InferredOptionType<O extends Options | PositionalOptions> =
        ...
        O extends ({ coerce: (arg: unknown) => infer T }) ? IsRequiredOrHasDefault<O> extends true ? T : T | undefined
            : O extends (
    ...
    type SyncCompletionFunction = (current: string, argv: unknown) => string[];
    type AsyncCompletionFunction = (
        current: string,
        argv: unknown,
        done: (completion: readonly string[]) => void,
    ) => void;
    type PromiseCompletionFunction = (current: string, argv: unknown) => Promise<string[]>;
    ...
    type BuilderArguments<T extends (...args: unknown) => R, R = ReturnType<T>> = R extends Argv<infer X>
