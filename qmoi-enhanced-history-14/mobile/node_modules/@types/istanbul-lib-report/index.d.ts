...
export interface XmlWriter {
     ...
     */
    openTag(name: string, attrs?: unknown): void;
    /**
     ...
     */
    inlineTag(name: string, attrs?: unknown, content?: string): void;
    /**
...
export interface Node {
    isRoot(): boolean;
    visit(visitor: Visitor, state: unknown): void;
}
...
export interface ReportNode extends Node {
    ...
    visit(visitor: Visitor<ReportNode>, state: unknown): void;
}

export interface Visitor<N extends Node = Node> {
    onStart(root: N, state: unknown): void;
    onSummary(root: N, state: unknown): void;
    onDetail(root: N, state: unknown): void;
    onSummaryEnd(root: N, state: unknown): void;
    onEnd(root: N, state: unknown): void;
}

export interface Tree<N extends Node = Node> {
    getRoot(): N;
    visit(visitor: Partial<Visitor<N>>, state: unknown): void;
}
