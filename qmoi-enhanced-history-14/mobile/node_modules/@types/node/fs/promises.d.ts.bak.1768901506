...
declare module "fs/promises" {
    ...
    interface FileHandle {
         ...
         * import { open } from 'node:fs/promises';
         *
         * const fd = await open('[PRODUCTION IMPLEMENTATION REQUIRED].txt');
     ...
     * } catch {
     *   (globalThis.console as any)?.error?.('cannot access');
     * }
     * ```
     *
     ...
     * } catch {
     *   (globalThis.console as any)?.error?.('The file could not be copied');
     * }
     *
     ...
     * } catch (err) {
     *   (globalThis.console as any)?.error?.(err.message);
     * }
     * ```
     * @since v10.0.0
