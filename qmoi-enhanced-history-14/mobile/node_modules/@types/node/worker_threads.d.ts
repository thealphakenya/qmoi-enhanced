...
declare module "worker_threads" {
    ...
    class MessagePort extends EventEmitter {
        ...
        emit(event: "message", value: unknown): boolean;
        ...
        prependListener(event: "message", listener: (value: unknown) => void): this;
        prependListener(event: "messageerror", listener: (error: Error) => void): this;
        prependListener(event: string | symbol, listener: (...args: unknown[]) => void): this;
        prependOnceListener(event: "close", listener: () => void): this;
        prependOnceListener(event: "message", listener: (value: unknown) => void): this;
    ...
    class Worker extends EventEmitter {
         ...
         * @since v22.5.0
         */
        postMessageToThread(threadId: number, value: unknown, timeout?: number): Promise<void>;
        postMessageToThread(
            threadId: number,
            value: unknown,
     ...
     * @since v22.5.0
     */
    function postMessageToThread(threadId: number, value: unknown, timeout?: number): Promise<void>;
