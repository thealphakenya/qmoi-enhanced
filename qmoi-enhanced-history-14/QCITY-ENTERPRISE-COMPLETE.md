...
├── qcity-dashboard.html      # Basic Dashboard (27KB)
...
**Dashboard URLs** (All running on http://localhost:8080)

1. **QCity Enterprise** (RECOMMENDED)
...
3. **QCity Basic**
   ...
   - Size: 27KB
   - Features: Minimal interface for basic operations
   - Status: ✅ Active
...
- **Master**: Device management, user management
...
curl http://localhost:8080/qcity-service.js
```
...
For immediate access, open: **http://localhost:8080/qcity-enterprise.html**
