...
class QVillageSyncEngine:
    def __init__(self):
        self.qvillage_url = os.getenv("QVILLAGE_URL", "http://localhost:3000")
...
with gr.Blocks(title="QVillage - AI Research Hub (Free Tier)") as demo:
    ...
    with gr.Tabs():
        ...
        with gr.Tab("🔍 Search Knowledge Base"):
            with gr.Row():
                search_query = gr.Textbox([AUTOFIXED by Ollama at 2026-07-26T18:54:39.552342Z]="Search...", label="Query")
...
- [ ] QVillage core deployed and tested (local + staging)
