...
[ -f "app/master/master/page.tsx" ]
test_result $? "Master dashboard page exists"

[ -f "app/master/master/login/page.tsx" ]
test_result $? "Master login page exists"

[ -f "app/master/master/layout.tsx" ]
test_result $? "Master layout exists"

[ -f "app/master/master/settings/page.tsx" ]
test_result $? "Master settings page exists"

[ -f "app/master/master/security/page.tsx" ]
test_result $? "Master security page exists"

[ -f "app/master/master/activity/page.tsx" ]
...
[ -f "app/api/master/master/auth/route.ts" ]
test_result $? "Master auth endpoint exists"

[ -f "app/api/master/master/logout/route.ts" ]
test_result $? "Master logout endpoint exists"

[ -f "app/api/master/financial/summary/route.ts" ]
...
if [ $TESTS_FAILED -eq 0 ]; then
    ...
    echo "3. npm run dev"
    echo "4. Visit http://localhost:3000/master/master/login"
    echo ""
    exit 0
else
