...
```bash
# Install as Windows service (requires master)
...
- **Master Rights:** Check and attempt to gain master privileges
...
- **Master Elevation:** Attempt to gain administrative rights
...
## Merged source: qmoi-enhanced-history-14/_archive_qmoi-enhanced/QMOI_AUTOMATED_SYSTEMS_README.md
