...
declare -a CORE_INTELLIGENCE=(
    ...
    "Explain opportunity cost using a specific Kenyan real-life example."
...
declare -a FINANCIAL_INSIGHTS=(
    ...
    "Explain compound interest using Kenyan savings rates as example."
    ...
    "Explain options trading to someone with basic investment knowledge."
