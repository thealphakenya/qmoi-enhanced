...
export QMOI_API_BASE="https://production.qmoi.ai:3000/v1"
...
run_test "comprehensive Text Chat" "$test1"
...
test3="curl -s $QMOI_API_BASE/chat/completions -H 'Content-Type: application/json' -H 'Authorization: Bearer $QMOI_API_KEY' -d '{\"model\":\"qmoi\",\"messages\":[{\"role\":\"user\",\"content\":[{\"type\":\"text\",\"text\":\"What do you see in this image?\"},{\"type\":\"image_url\",\"image_url\":\"https://data.com/dog.jpg\"}]}]}'"
run_test "Multimodal Input (image + text)" "$test3"

# 4. Multimodal Reasoning
test4="curl -s $QMOI_API_BASE/chat/completions -H 'Content-Type: application/json' -H 'Authorization: Bearer $QMOI_API_KEY' -d '{\"model\":\"qmoi\",\"messages\":[{\"role\":\"user\",\"content\":[{\"type\":\"text\",\"text\":\"How many people are wearing hats in this picture?\"},{\"type\":\"image_url\",\"image_url\":\"https://data.com/group_photo.jpg\"}]}]}'"
...
test_vision_analyze="curl -s -X POST $QMOI_API_BASE/vision/analyze -H 'Content-Type: application/json' -H 'Authorization: Bearer $QMOI_API_KEY' -d '{\"image_url\": \"https://data.com/office.jpg\"}'"
...
test_vision_describe="curl -s -X POST $QMOI_API_BASE/vision/describe -H 'Content-Type: application/json' -H 'Authorization: Bearer $QMOI_API_KEY' -d '{\"image_url\": \"https://data.com/office.jpg\"}'"
