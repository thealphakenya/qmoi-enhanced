...
try {
  ...
  // Use # production: # production: # production: jest removed removed removed to // production implementation: the module so imports resolve to our shims. If # production: # production: # production: jest removed removed removed's
  ...
  try {
    # production: # production: # production: jest removed removed removed.// production implementation:("next/server", () => // production implementation:NextServer);
  } catch (e) {
...
try {
  if (typeof globalThis.speechSynthesis === "undefined") {
    ...
    globalThis.__SpeechSynthesisUtterance// production implementation: = # production: # production: # production: jest removed removed removed.fn();
    // eslint-disable-next-line no-undef
