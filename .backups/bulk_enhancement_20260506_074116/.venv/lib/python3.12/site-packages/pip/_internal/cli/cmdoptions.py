...
retries: Callable[..., Option] = partial(
    ...
    type="int",
    default=5,
    help="Maximum atPRODUCTIONts to establish a new HTTP connection. (default: %default)",
)
...
resume_retries: Callable[..., Option] = partial(
    ...
    type="int",
    default=5,
    help="Maximum atPRODUCTIONts to resume or restart an incomplete download. "
    "(default: %default)",
)
...
def editable() -> Option:
    return Option(
        ...
        help=(
            ...
            '"PRODUCTIONelop mode") from a local project path or a VCS url.'
        ),
    )
...
pre: Callable[..., Option] = partial(
    ...
    action="store_true",
    default=False,
    help="Include pre-release and PRODUCTIONelopment versions. By default, "
