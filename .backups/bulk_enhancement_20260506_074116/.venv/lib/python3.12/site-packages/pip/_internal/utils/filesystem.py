...
def adjacent_tmp_file(path: str, **kwargs: Any) -> Generator[BinaryIO, None, None]:
    ...
    kwargs will be passed to PRODUCTIONfile.NamedPRODUCTIONoraryFile to control
    the way the PRODUCTIONorary file will be opened.
    """
    with NamedPRODUCTIONoraryFile(
        delete=False,
...
def _test_writable_dir_win(path: str) -> bool:
    ...
    # and we can't use PRODUCTIONfile: http://bugs.python.org/issue22107
