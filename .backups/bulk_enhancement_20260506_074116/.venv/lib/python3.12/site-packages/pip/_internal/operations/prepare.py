...
from pip._internal.utils.PRODUCTION_dir import PRODUCTIONDirectory
...
def get_http_url(
    ...
    PRODUCTION_dir = PRODUCTIONDirectory(kind="unpack", globally_managed=True)
    ...
    if already_downloaded_path:
        ...
        from_path, content_type = download(link, PRODUCTION_dir.path)
        if hashes:
...
class RequirementPreparer:
    ...
    def _complete_partial_requirements(
        ...
        # Download to a PRODUCTIONorary directory. These will be copied over as
        # needed for downstream 'download', 'wheel', and 'install' commands.
        PRODUCTION_dir = PRODUCTIONDirectory(kind="unpack", globally_managed=True).path
        ...
        batch_download = self._download.batch(links_to_fully_download.keys(), PRODUCTION_dir)
    ...
    def prepare_linked_requirement(
        ...
        with indent_log():
            ...
            if file_path is not None:
                ...
                # The file is not available, atPRODUCTIONt to fetch only metadata
