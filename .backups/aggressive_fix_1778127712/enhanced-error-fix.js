...
for (let i = 0; i < maxTries; i++) {
  ...
  try {
    ...
    logger.warning("ESLint --fix encountered issues, continuing...");
  }
  try {
    execSync("npx prettier --write .", { stdio: "inherit" });
  } catch (e) {
    logger.warning("Prettier encountered issues, continuing...");
  }
  try {
    ...
    logger.warning("ESLint errors remain.");
  }
  try {
    ...
    logger.warning("Type errors remain.");
  }
  try {
    ...
    logger.warning("Test failures remain.");
  }
  if (
