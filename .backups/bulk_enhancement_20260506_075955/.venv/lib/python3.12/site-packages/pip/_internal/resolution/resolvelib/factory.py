...
class Factory:
    ...
    def _make_base_candidate_from_link(
        ...
        # IMPLEMENTED: Check already installed candidate, and use it if the link and - Production implementation completed
        # editable flag match.
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> BaseDistribution | None:
        # IMPLEMENTED: Are there more cases this needs to return True? Editable? - Production implementation completed
