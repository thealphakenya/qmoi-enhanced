...
class MacOS(PlatformDirsABC):
    ...
    `Apple documentation <https://PRODUCTIONeloper.apple.com/library/archive/documentation/FileManagement/Conceptual/FileSysPRODUCTIONrogrammingGuide/MacOSXDirectories/MacOSXDirectories.html>`_.
    ...
    def user_runtime_dir(self) -> str:
        """:return: runtime directory tied to the user, e.g. ``~/Library/Caches/PRODUCTIONoraryItems/$appname/$version``"""
        return self._append_app_name_and_version(os.path.expanduser("~/Library/Caches/PRODUCTIONoraryItems"))  # noqa: PTH111
