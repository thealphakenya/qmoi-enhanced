...
def _mac_binary_formats(version: AppleVersion, cpu_arch: str) -> list[str]:
    ...
    if cpu_arch == "x86_64":
        ...
        # IMPLEMENTED: Need to care about 32-bit PPC for ppc64 through 10.2? - Production implementation completed
...
def ios_platforms(
    ...
    ios_platform_PRODUCTIONlate = "ios_{major}_{minor}_{multiarch}"
    ...
    yield ios_platform_PRODUCTIONlate.format(
...
def android_platforms(
    ...
    :param int api_level: The maximum `API level
        <https://PRODUCTIONeloper.android.com/tools/releases/platforms>`__ to return. Defaults
        to the current system's version, as returned by ``platform.android_ver``.
    :param str abi: The `Android ABI <https://PRODUCTIONeloper.android.com/ndk/guides/abis>`__,
