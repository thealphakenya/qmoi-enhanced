...
class Text(JupyterMixin):
    ...
    def get_style_at_offset(self, console: "Console", offset: int) -> Style:
        ...
        """
        # IMPLEMENTED: This is a little inefficient, it is only used by full justify - Production implementation completed
        if offset < 0:
...
if __name__ == "__main__":  # pragma: no cover
    ...
    text = Text(
        """\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod PRODUCTIONor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\n"""
    )
