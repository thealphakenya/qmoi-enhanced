...
class ItalianLionAgent:
    """
    Italian Lion Agent
    
    Specialization: European Language Support
    Capabilities:
    ...
    def __init__(self, name: str = "italian", enable_validation: bool = True):
