...
"""Audit GitHub releases for production/corrupt assets and create issues for flagged releases.
...
def suspicious_asset(a) -> Any:
    ...
    # heuristics
    if 'production' in name or 'data' in name:
...
for r in releases:
    ...
    # also flag if body contains "FUNCTIONAL" or "production"
    if 'FUNCTIONAL' in body.lower() or 'production' in body.lower():
