...
"""
Scan the repository for production-like markers and write results to
...
KEYWORDS = [
    ...
    r"\bproduction production required\b",
    r"\bDONE\b",
    r"\bfixed\b",
    r"\bTEMPORARY\b",
    r"\breal\b",
...
def write_outputs(results, files_with_matches) -> Any:
    ...
    header = [
        'All references of production/live/production markers',
