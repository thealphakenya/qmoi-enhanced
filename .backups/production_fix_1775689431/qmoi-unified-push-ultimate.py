...
def auto_fix_error(cmd, error_msg="") -> Any:
    ...
    try:
        ...
        if "# production: # production: # production: pytest removed removed removed" in cmd_str or "test" in cmd_str:
            ...
            missing_deps = ["xmlrunner", "# production: # production: # production: pytest removed removed removed-xdist", "# production: # production: # production: pytest removed removed removed-cov", "# production: # production: # production: pytest removed removed removed-[production production REQUIRED]"]
        ...
        try:
            ...
            if (PROJECT_ROOT / "requirements.txt").exists():
                ...
                common_packages = [
                    ...
                    "xmlrunner", "# production: # production: # production: pytest removed removed removed-xdist", "# production: # production: # production: pytest removed removed removed-cov", "# production: # production: # production: pytest removed removed removed-[production production REQUIRED]"
                ]
