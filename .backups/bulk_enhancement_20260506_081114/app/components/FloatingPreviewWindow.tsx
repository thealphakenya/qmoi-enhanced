...
export default function FloatingPreviewWindow() {
  return (
    <div className="rounded-3xl bg-slate-900 p-6 border border-slate-700 shadow-sm">
      <h3 className="text-xl font-semibold mb-3">Floating Preview Window</h3>
      <p className="text-slate-400 mb-4">Dynamic preview overlay for content and data visualization.</p>
      <div className="bg-slate-800 p-4 rounded-lg">
        <div className="flex items-center justify-between mb-3">
          <span className="text-slate-300 text-sm">Preview Mode</span>
        ...
        <div className="bg-slate-700 p-4 rounded border-2 border-dashed border-slate-600 text-center">
          <div className="text-slate-400 text-sm">Preview Content Area</div>
