...
│ ├─ 10+ testing tools: # production: # production: # production: jest removed removed removed, # production: # production: # production: pytest removed removed removed, XCTest, Espresso, Cypress, Selenium, Puppeteer, etc.
│ ├─ 52 CI/CD workflows
