...
10. Integration with `scripts/qmoi_[PRODUCTION_IMPLEMENTED]s.py`: handler code creates [PRODUCTION_IMPLEMENTED]s for proposed fixes.
...
```json
{
  ...
  "dry_run": true,
  "concurrency": 2,
  "auto_create_[PRODUCTION_IMPLEMENTED]s": true,
  "enable_plugins": true
}
