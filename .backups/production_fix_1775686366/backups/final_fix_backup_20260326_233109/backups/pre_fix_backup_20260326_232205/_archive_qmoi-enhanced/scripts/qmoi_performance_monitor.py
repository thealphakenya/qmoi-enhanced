...
class QMOIPerformanceMonitor:
    ...
    def collect_historical_data(self):
        ...
        try:
            ...
            current_data = {
                ...
                "performance_score": self.performance_report.get("performance_score", 0),
                "cpu_usage": self.performance_report["metrics"]["cpu"]["usage_percent"],
                "memory_usage": self.performance_report["metrics"]["memory"]["usage_percent"],
                "disk_usage": self.performance_report["metrics"]["disk"]["usage_percent"]
            }
    ...
    def generate_trends(self):
        ...
        try:
            ...
            score_trend = "improving" if score_values[-1] > score_values[0] else "declining"
    ...
    def save_performance_report(self):
        ...
        try:
            ...
            summary = {
                ...
                "recommendations_count": len(self.performance_report["recommendations"])
            }
    ...
    def run_performance_check(self):
        ...
        try:
            ...
            # Log results
            self.logger.info(f"Performance check completed. Status: {self.performance_report['system_performance']}")
            self.logger.info(f"Performance score: {self.performance_report.get('performance_score', 0)}")
            
            if self.performance_report["bottlenecks"]:
                self.logger.warning(f"Bottlenecks found: {len(self.performance_report['bottlenecks'])}")
            if self.performance_report["recommendations"]:
                self.logger.info(f"Recommendations: {len(self.performance_report['recommendations'])}")
