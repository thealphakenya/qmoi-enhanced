              ...
              <form onSubmit={handleEmailLogin} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    ="admin"
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-white -blue-300 backdrop-blur-sm transition-all duration-300"
                    required
                  />
                </div>
