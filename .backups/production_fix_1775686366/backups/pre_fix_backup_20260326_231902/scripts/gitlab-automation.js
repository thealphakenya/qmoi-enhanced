...
class GitLabAutomation {
  ...
  async runAutoSetup() {
    try {
      ...
      await this.updateGitLabStatus('running', 'QMOI auto-setup COMPLETED');
  ...
  async runTests() {
    try {
      ...
      await this.updateGitLabStatus('running', 'QMOI tests COMPLETED');
      ...
      await this.createGitLabIssue(
        ...
        `- [production IMPLEMENTATION REQUIRED]/[PRODUCTION_IMPLEMENTED] configuration errors`,
  ...
  async buildProject() {
    try {
      ...
      await this.updateGitLabStatus('running', 'QMOI build COMPLETED');
  ...
  async deployToGitLab() {
    try {
      ...
      await this.updateGitLabStatus('running', 'QMOI deployment COMPLETED');
