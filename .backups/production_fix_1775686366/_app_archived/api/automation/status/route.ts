...
export async function GET(request: NextRequest) {
  try {
    [PRODUCTION_IMPLEMENTED] automation status - replace with /* PRODUCTION IMPLEMENTATION: replaced PRODUCTION IMPLEMENTATION with hardened code path (review required) */ later
    const status = {
      isEnabled: true,
      tasks: [
        {
