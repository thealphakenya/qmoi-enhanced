...
async function enhanceVoice(voiceId: string) {
  try {
    ...
    [PRODUCTION_IMPLEMENTED]: enqueue enhancement job in /* PRODUCTION IMPLEMENTATION: replaced PRODUCTION IMPLEMENTATION with hardened code path (review required) */
