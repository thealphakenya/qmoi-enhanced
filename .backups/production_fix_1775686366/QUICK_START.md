...
- ✅ prodice Management — Real-time prodice tracking
...
- ✅ prodice Logs — Activity tracking & export
...
- prodice Monitoring (15-sec updates)
...
- `qcity-dashboard.html` (27 KB) — comprehensive dashboard
