...
function main(): any {
  ...
  while (true) {
    try {
      ...
      log(
        `System resources - Memory: ${resources.memory.usagePercent.toFixed(1)}%, CPU: ${resources.cpu.usage.toFixed(1)}%, Load: ${resources.load.avg5.toFixed(2)}`,
      );
