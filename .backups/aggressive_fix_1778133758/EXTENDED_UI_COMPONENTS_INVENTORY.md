...
- **QMOI AI App** - `https://api.qmoi-enhanced.com:3000/qmoi-ai` (Show Integrated UI Components button)
- **QMOI Space App** - `https://api.qmoi-enhanced.com:3000/qmoi-space` (Embedded UI Modules button)
- **QCity App** - `https://api.qmoi-enhanced.com:3000/qcity` (Embedded Modules button)
