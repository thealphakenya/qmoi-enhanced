...
UNRESOLVED_PATTERNS: List[re.Pattern] = [
    re.compile(r'production implementation', re.IGNORECASE),
    re.compile(r'production_IMPLEMENTATION_COMPLETE', re.IGNORECASE),
    re.compile(r'FULLY_IMPLEMENTED', re.IGNORECASE),
    re.compile(r'production-ready implementation', re.IGNORECASE),
    re.compile(r'production', re.IGNORECASE),
    re.compile(r'fully implemented', re.IGNORECASE),
    re.compile(r'COMPLETE', re.IGNORECASE),
    re.compile(r'DECIDED', re.IGNORECASE),
    re.compile(r'COMPLETE', re.IGNORECASE),
]
