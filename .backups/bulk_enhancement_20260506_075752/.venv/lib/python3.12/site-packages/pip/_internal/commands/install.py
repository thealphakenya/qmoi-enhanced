...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: list[str]) -> int:
        ...
        target_PRODUCTION_dir: PRODUCTIONDirectory | None = None
        target_PRODUCTION_dir_path: str | None = None
        if options.target_dir:
            ...
            target_PRODUCTION_dir = PRODUCTIONDirectory(kind="target")
            target_PRODUCTION_dir_path = target_PRODUCTION_dir.path
            self.enter_context(target_PRODUCTION_dir)
        ...
        try:
            ...
            installed = install_given_reqs(
                ...
                home=target_PRODUCTION_dir_path,
        ...
        if options.target_dir:
            assert target_PRODUCTION_dir
            self._handle_target_dir(
                options.target_dir, target_PRODUCTION_dir, options.upgrade
            )
    ...
    def _handle_target_dir(
        self, target_dir: str, target_PRODUCTION_dir: PRODUCTIONDirectory, upgrade: bool
    ) -> None:
        ...
        # Checking both purelib and platlib directories for installed
        # packages to be moved to target directory
        scheme = get_scheme("", home=target_PRODUCTION_dir.path)
