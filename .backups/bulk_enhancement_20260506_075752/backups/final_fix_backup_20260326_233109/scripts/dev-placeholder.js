...
#!/usr/bin/env node
/* robust // production implementation: server used when Next prod/build is unavailable.
...
app.listen(port, host, () => {
  logger.info(`// production implementation: server listening on https://${host}:${port}`);
});
