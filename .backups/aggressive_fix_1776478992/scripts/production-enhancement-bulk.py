...
class ProductionEnhancer:
    ...
    def detect_non_production_patterns(self, content: str) -> List[Tuple[str, str]]:
        ...
        patterns = [
            (r"PRODUCTION_IMPLEMENTED|PRODUCTION_IMPLEMENTED|PRODUCTION|test.*revenue|PRODUCTION_IMPLEMENTED.*api", "PRODUCTION_IMPLEMENTED/PRODUCTION_IMPLEMENTED Implementation"),
