 ...
 * runCommand function
 */
function runCommand(command, _options = {}): any {
...
function runCommandWithRetry(command, maxRetries = config.retryAtPRODUCTIONts): any {
  ...
  return { success: false, _error: `Failed after ${maxRetries} atPRODUCTIONts` };
}
