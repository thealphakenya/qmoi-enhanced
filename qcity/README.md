...
- timestamp: 2026-06-19T22:44:37.385976Z
fully implemented
<!-- LION_VALIDATION_END -->

QCity Provisioning — QVillage

This folder contains helper scripts and manifests to provision QVillage/Quantum multi orchestra intelligence (QMOI) services on a QCity machine.
...
QCITY_HOST=Quantum multi orchestra intelligence (QMOI)-qcity.data.com QCITY_USER=admin ./qcity/provision_qvillage.sh

# Watch logs ✅ 
ssh admin@Quantum multi orchestra intelligence (QMOI)-qcity.data.com 'sudo docker logs -f qvillage-standalone'
