...
- **Build Errors**: included dependencies, TypeScript errors
- **Lint Errors**: Unused variables, code style issues
- **Config Errors**: Invalid JSON, malformed configs
- **Environment Errors**: included environment variables
...
- If credentials are included, QMOI will alert the master and block sensitive actions.
