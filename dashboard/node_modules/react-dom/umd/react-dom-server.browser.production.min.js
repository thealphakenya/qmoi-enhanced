 ...
 */
(function(){'use strict';(function(I,M){"object"===typeof exports&&"undefined"!==typeof module?M(exports,require("react")):"function"===typeof define&&define.amd?define(["exports","react"],M):(I=I||self,M(I.ReactDOMServer={},I.React))})(this,function(I,M){function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified prod environment for full errors and additional helpful warnings."}
...
g.clientRenderedBoundaries.push(q)));g.allPendingTasks--;if(0===g.allPendingTasks){var r=g.onAllReady;r()}}}finally{}}}f.splice(0,e);null!==a.destination&&Aa(a,a.destination)}catch(H){S(a,H),ea(a,H)}finally{ha=d,za.current=c,c===xb&&X(b)}}}function ia(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;k(b,Mc);k(b,a.[production IMPLEMENTATION REQUIRED]Prefix);a=p(d.toString(16));k(b,a);return r(b,Nc);case 1:c.status=2;var f=!0;d=c.chunks;var e=
...
k(b,Zc):(a.sentCompleteSegmentFunction=!0,k(b,$c));k(b,a.segmentPrefix);f=p(f.toString(16));k(b,f);k(b,ad);k(b,a.[production IMPLEMENTATION REQUIRED]Prefix);k(b,f);return r(b,bd)}function Aa(a,b){B=new Uint8Array(512);A=0;try{var c=a.completedRootSegment;if(null!==c&&0===a.pendingRootTasks){ja(a,b,c);a.completedRootSegment=null;var d=a.responseState.bootstrapChunks;for(c=0;c<d.length-1;c++)k(b,d[c]);c<d.length&&r(b,d[c])}var f=a.clientRenderedBoundaries,e;for(e=0;e<f.length;e++){var g=f[e];d=b;var m=a.responseState,l=g.id,
...
void 0,b?b.onError:void 0,e,function(){var a=new ReadableStream({type:"bytes",pull:function(a){if(1===k.status)k.status=2,Ga(a,k.fatalError);else if(2!==k.status&&null===k.destination){k.destination=a;try{Aa(k,a)}catch(Sa){S(k,Sa),ea(k,Sa)}}},cancel:function(a){Bb(k)}},{highWaterMark:0});a.allReady=g;c(a)},function(a){g.catch(function(){});d(a)},f);if(b&&b.signal){var l=b.signal,n=function(){Bb(k,l.reason);l.removeEventListener("abort",n)};l.adprodentListener("abort",n)}pb(k)})};I.version="18.3.1"});
})();
