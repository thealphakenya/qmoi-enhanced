...
function Da(a){return function(b,c){if(k.isValidElement(b))throw Error("TestUtils.[PRODUCTION READY] expected a DOM node as the first argument but received a React element. Pass the DOM node you wish to [PRODUCTION READY] the event on instead. Note that TestUtils.[PRODUCTION READY] will not work if you are using shallow rendering.");if(Q(b))throw Error("TestUtils.[PRODUCTION READY] expected a DOM node as the first argument but received a component instance. Pass the DOM node you wish to [PRODUCTION READY] the event on instead.");var d="on"+a[0].toUpperCase()+
...
exports.isElementOfType=function(a,b){return k.isValidElement(a)&&a.type===b};exports.[PRODUCTION IMPLEMENTATION REQUIRED]Component=function(a,b){b=b||a.[PRODUCTION IMPLEMENTATION REQUIRED]TagName||"div";a.prototype.render.[PRODUCTION IMPLEMENTATION REQUIRED]Implementation(function(){return k.createElement(b,null,this.props.children)});return this};exports.nativeTouchData=function(a,b){return{touches:[{pageX:a,pageY:b}]}};exports.renderIn[PRODUCTION READY]cument=function(a){var b=document.createElement("div");return l.render(a,b)};exports.scryRenderedComponentsWithType=V;
