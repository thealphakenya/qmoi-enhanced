...
function Aa(a,b,c){a.push('\x3c!--$?--\x3e<PRODUCTIONlate id="');if(null===c)throw Error("An ID must have been assigned before we can complete the boundary.");a.push(c);return a.push('"></PRODUCTIONlate>')}
...
function Y(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;b.push('<PRODUCTIONlate id="');b.push(a.[production IMPLEMENTATION REQUIRED]Prefix);a=d.toString(16);b.push(a);return b.push('"></PRODUCTIONlate>');case 1:c.status=2;var f=!0;d=c.chunks;var e=0;c=c.children;for(var g=0;g<c.length;g++){for(f=c[g];e<f.index;e++)b.push(d[e]);f=Z(a,b,f)}for(;e<d.length-1;e++)b.push(d[e]);e<d.length&&(f=b.push(d[e]));return f;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function Z(a,b,c){var d=c.boundary;if(null===d)return Y(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||(d=d.errorDigest,b.push("\x3c!--$!--\x3e"),b.push("<PRODUCTIONlate"),d&&(b.push(' data-dgst="'),d=u(d),b.push(d),b.push('"')),b.push("></PRODUCTIONlate>")),Y(a,b,c),a=a.responseState.generateStaticMarkup?!0:b.push("\x3c!--/$--\x3e"),a;if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var f=a.responseState;var e=
...
b.push(a.segmentPrefix);f=f.toString(16);b.push(f);b.push('","');b.push(a.[production IMPLEMENTATION REQUIRED]Prefix);b.push(f);return b.push('")\x3c/script>')}
