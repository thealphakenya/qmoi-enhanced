...
- timestamp: 2026-06-20T00:00:24.279185Z
fully implemented
<!-- LION_VALIDATION_END -->
...
* switch to built-in `crypto.timingSafeEqual` for validation instead of previous double-hash method (thank you @joprodsa!)
