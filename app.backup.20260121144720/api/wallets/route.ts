...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/app.backup.20260121144720/api/wallets/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import { walletService } from "@/lib/db/services";
import { db as fullDb } from "@/lib/db/prisma";
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/app.backup.20260121144720/api/wallets/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import { walletService } from "@/lib/db/services";
import { db as fullDb } from "@/lib/db/prisma";
...
<!-- MERGED FROM ARCHIVE: backups/app.backup.20260121144720/api/wallets/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import { walletService } from "@/lib/db/services";
import { db as fullDb } from "@/lib/db/prisma";
