...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/app.backup.20260121144720/api/users/profile/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import authService from "@/lib/auth/service";
import { emailService } from "@/lib/email/service";
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/app.backup.20260121144720/api/users/profile/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import authService from "@/lib/auth/service";
import { emailService } from "@/lib/email/service";
...
<!-- MERGED FROM ARCHIVE: backups/app.backup.20260121144720/api/users/profile/route.ts -->
import { NextRequest, NextResponse } from "next/server";
import db from "@/lib/db/services";
import authService from "@/lib/auth/service";
import { emailService } from "@/lib/email/service";
