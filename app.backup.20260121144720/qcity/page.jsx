  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-5xl font-bold mb-8 text-cyan-300 drop-shadow-lg">
          QCity Device Management & Dashboard
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/10 rounded-xl p-6 border border-cyan-400/30 shadow-lg">
            <h2 className="text-2xl font-semibold mb-2 text-cyan-200">
              Device Status
            </h2>
            <p className="opacity-80">
              Live device health, compatibility, and resource usage.
            </p>
            <DeviceStatusWidget />
          </div>
          <div className="bg-white/10 rounded-xl p-6 border border-cyan-400/30 shadow-lg">
            ...
            <p className="opacity-80">
              Real-time logs, error tracking, and system notifications.
            </p>
          ...
          <div className="bg-white/10 rounded-xl p-6 border border-cyan-400/30 shadow-lg">
            ...
            <p className="opacity-80">
              Automated fixes, self-healing, and background tasks.
            </p>
            <AutomationWidget />
          </div>
        </div>
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/10 rounded-xl p-6 border border-cyan-400/30 shadow-lg">
            <h2 className="text-xl font-semibold mb-2 text-cyan-200">
              QMOI Memory
            </h2>
            <p className="opacity-80">
              Persistent memory, context, and correction history.
            </p>
            <MemoryWidget />
          </div>
          <div className="bg-white/10 rounded-xl p-6 border border-cyan-400/30 shadow-lg">
            ...
            <p className="opacity-80">
              Start/stop services, manage devices, and advanced settings.
            </p>
            ...
            <li key={i} className="py-2 flex justify-between items-center">
              ...
              <span
                className={
                  ...
                  (d.status === "online" ? "bg-green-700" : "bg-red-700")
                }
              >
                {d.status}
              </span>
...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/app.backup.20260121144720/qcity/page.jsx -->
"use client";
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/app.backup.20260121144720/qcity/page.jsx -->
"use client";
...
<!-- MERGED FROM ARCHIVE: backups/app.backup.20260121144720/qcity/page.jsx -->
"use client";
