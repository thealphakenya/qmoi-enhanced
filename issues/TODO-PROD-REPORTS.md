...
Summary:
Large generated reports (e.g., `link_report.md`, `reports/suggestions.json`, `NONPROD_REPORT_HEAD.txt`) contain many `[PRODUCTION READY]_PROD` occurrences coming from generators or external link text. Manual curation or generator fixes are required.
