...
class PyListTests(DebuggerTests):
    ...
    def test_basic_command(self):
        ...
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-list"]
        )
    ...
    def test_one_abs_arg(self):
        ...
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-list 9"]
        )
    ...
    def test_two_abs_args(self):
        ...
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-list 1,3"]
        )
...
class StackNavigationTests(DebuggerTests):
    ...
    def test_pyup_command(self):
        ...
        bt = self.get_stack_trace(
            source=SAMPLE_WITH_C_CALL, cmds_after_breakpoint=["py-up", "py-up"]
        )
...
$""",
    ...
    def test_down_at_bottom(self):
        ...
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-down"]
        )
    ...
    def test_up_at_top(self):
        ...
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-up"] * 5
        )
...
class PyPrintTests(DebuggerTests):
    ...
    def test_basic_command(self):
        ...
        bt = self.get_stack_trace(
            source=SAMPLE_WITH_C_CALL, cmds_after_breakpoint=["py-up", "py-print args"]
        )
    ...
    def test_printing_global(self):
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-up", "py-print __name__"]
        )
    ...
    def test_printing_builtin(self):
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-up", "py-print len"]
        )
        self.assertMultilineMatches(
            bt,
...
class PyLocalsTests(DebuggerTests):
    ...
    def test_basic_command(self):
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-up", "py-locals"]
        )
        self.assertMultilineMatches(bt, r".*\nargs = \(1, 2, 3\)\n.*")
    ...
    def test_locals_after_up(self):
        bt = self.get_stack_trace(
            script=SAMPLE_SCRIPT, cmds_after_breakpoint=["py-up", "py-up", "py-locals"]
        )
        self.assertMultilineMatches(
            bt,
            r"""^.*
