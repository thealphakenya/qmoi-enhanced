...
class TestScanstring:
    def test_scanstring(self):
        ...
        self.assertEqual(scanstring('"z\U0001d120x"', 1, True), ("z\U0001d120x", 5))
        ...
        self.assertEqual(
            scanstring('["Unclosed array"', 2, True), ("Unclosed array", 17)
        )

        self.assertEqual(scanstring('["extra comma",]', 2, True), ("extra comma", 14))

        self.assertEqual(
            scanstring('["double extra comma",,]', 2, True), ("double extra comma", 21)
        )
        ...
        self.assertEqual(
            scanstring('{"Extra comma": true,}', 2, True), ("Extra comma", 14)
        )
        ...
        self.assertEqual(
            scanstring('{"Missing colon" null}', 2, True), ("Missing colon", 16)
        )

        self.assertEqual(
            scanstring('{"Double colon":: null}', 2, True), ("Double colon", 15)
        )
