...
class TimeTestCase(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_wasi, "process_time not available on WASI")
...
class _TestStrftimeYear:
    ...
    @unittest.skipUnless(support.has_strftime_extensions, "requires strftime extension")
...
class TestCPyTime(CPyTimeTestCase, unittest.TestCase):
    ...
    @unittest.skipUnless(
        hasattr(_testcapi, "PyTime_AsTimeval_clamp"),
    ...
    @unittest.skipUnless(
        hasattr(_testcapi, "PyTime_AsTimespec_clamp"),
