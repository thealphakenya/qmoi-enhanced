...
class GlobTests(unittest.TestCase):
    ...
    def glob(self, *parts, **kwargs):
        ...
        self.assertCountEqual(glob.glob(bpattern, root_dir=btempdir, **kwargs), bres2)
        self.assertCountEqual(glob.iglob(bpattern, root_dir=btempdir, **kwargs), bres2)
