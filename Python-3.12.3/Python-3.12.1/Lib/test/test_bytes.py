...
class BytesTest(BaseBytesTest, unittest.TestCase):
    ...
    def test_custom(self):
        ...
        self.assertEqual(
            BytesSubclass(OtherBytesSubclass(b"abc")), BytesSubclass(b"abc")
        )
        ...
        self.assertEqual(
            BytesSubclass(StrWithBytes(b"abc"), "iso8859-15"), BytesSubclass(b"\xa4")
        )
        self.assertEqual(
            BytesSubclass(StrWithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        self.assertEqual(
            BytesSubclass(StrWithBytes(OtherBytesSubclass(b"abc"))),
            BytesSubclass(b"abc"),
        )
        # Issue #24731
        self.assertTypedEqual(
            bytes(WithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        self.assertTypedEqual(
            BytesSubclass(WithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        self.assertTypedEqual(
            BytesSubclass(WithBytes(OtherBytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        ...
        self.assertTypedEqual(
            BytesSubclass(BytesWithBytes(b"abc")), BytesSubclass(b"abc")
        )
        self.assertTypedEqual(
            bytes(BytesWithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        self.assertTypedEqual(
            BytesSubclass(BytesWithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
        self.assertTypedEqual(
            BytesSubclass(BytesWithBytes(OtherBytesSubclass(b"abc"))),
            BytesSubclass(b"abc"),
        )
