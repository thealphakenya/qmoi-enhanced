...
[[[[[[1,
 ...
 [[[[[1,
    ...
    def test_sort_dict(self):
        d = dict.fromkeys("cba")
        self.assertEqual(
            pprint.pformat(d, sort_dicts=False), "{'c': None, 'b': None, 'a': None}"
        )
        self.assertEqual(
...
AdvancedNamespace(the=0,
    ...
    def test_small_dataclass(self):
        ...
        formatted = pprint.pformat(dc)
        self.assertEqual(
            formatted, "dataclass1(field1='text', field2=123, field3=False)"
        )
...
set2({0,
      ...
      6})""",
        ...
        self.assertEqual(
            pprint.pformat(set3(range(7)), width=20), "set3({0, 1, 2, 3, 4, 5, 6})"
        )
...
frozenset2({0,
        ...
        self.assertEqual(
            pprint.pformat(frozenset3(range(7)), width=20),
...
{frozenset({frozenset({0, 2}), frozenset({0})}): frozenset({frozenset({frozenset({0,
 ...
 frozenset({frozenset({1, 2}), frozenset({0, 1, 2})}): frozenset({frozenset({frozenset({0,
    ...
    def test_sort_unorderable_values(self):
        ...
        self.assertEqual(
            clean(pprint.pformat(set(keys))), "{" + ",".join(map(repr, skeys)) + "}"
        )
        self.assertEqual(
            clean(pprint.pformat(frozenset(keys))),
        ...
        self.assertEqual(
            pprint.pformat({Unorderable: 0, 1: 0}),
