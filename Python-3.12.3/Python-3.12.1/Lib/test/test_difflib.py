...
class TestWithAscii(unittest.TestCase):
    def test_one_insert(self):
        ...
        self.assertEqual(
            list(sm.get_opcodes()), [("insert", 0, 0, 0, 1), ("equal", 0, 100, 1, 101)]
        )
    ...
    def test_bjunk(self):
        sm = difflib.SequenceMatcher(
            isjunk=lambda x: x == " ", a="a" * 40 + "b" * 40, b="a" * 44 + "b" * 40
        )
...
class TestSFpatches(unittest.TestCase):
    ...
    def test_html_diff(self):
        ...
        tables = "\n".join(
            [
                ...
                k.make_table(
                    f3.splitlines(), t3.splitlines(), context=True, numlines=0
                ),
    ...
    def test_make_file_default_charset(self):
        ...
        output = html_diff.make_file(
            patch914575_from1.splitlines(), patch914575_to1.splitlines()
        )
...
class TestOutputFormat(unittest.TestCase):
    def test_tab_delimiter(self):
        ...
        self.assertEqual(
            list(ud)[0:2],
            ["--- Original\t2005-01-26 23:30:50", "+++ Current\t2010-04-02 10:20:52"],
        )
...
class TestFindLongest(unittest.TestCase):
    ...
    def test_default_args(self):
        ...
        self.assertEqual(
            a[match.a : match.a + match.size], b[match.b : match.b + match.size]
        )
