...
class StructureTestCase(unittest.TestCase):
    ...
    def test_array_in_struct_registers(self):
        ...
        self.assertEqual(
            (result.data[0], result.data[1], result.data[2], result.data[3]), expected
        )
        ...
        result = func()
        # check the default values have been set properly
        self.assertEqual((result.x, result.y, result.z, result.t, result.u), expected)
