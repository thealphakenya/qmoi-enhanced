...
class FractionTest(unittest.TestCase):
    ...
    def testFromString(self):
        ...
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '3/'", F, "3/"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '/2'", F, "/2"
        )
        self.assertRaisesMessage(
        ...
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '_'", F, "_"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '_1'", F, "_1"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1__2'", F, "1__2"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '/_'", F, "/_"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1_/'", F, "1_/"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '_1/'", F, "_1/"
        )
        ...
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1/_'", F, "1/_"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1/_1'", F, "1/_1"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1/1__2'", F, "1/1__2"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1._111'", F, "1._111"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1.1__1'", F, "1.1__1"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1.1e+_1'", F, "1.1e+_1"
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1.1e+1__1'", F, "1.1e+1__1"
        )
        # Test catastrophic backtracking.
        val = "9" * 50 + "_"
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '" + val + "'", F, val
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1/" + val + "'", F, "1/" + val
        )
        self.assertRaisesMessage(
            ValueError, "Invalid literal for Fraction: '1." + val + "'", F, "1." + val
        )
        self.assertRaisesMessage(
            ValueError,
            "Invalid literal for Fraction: '1.1+e" + val + "'",
            F,
            "1.1+e" + val,
        )
    ...
    def testFromFloat(self):
        ...
        self.assertEqual((99999999999999991611392, 1), _components(F.from_float(1e23)))
        self.assertEqual(float(10**23), float(F.from_float(1e23)))
        self.assertEqual(
            (3602879701896397, 1125899906842624), _components(F.from_float(3.2))
        )
        ...
        # bug 16469: error types should be consistent with float -> int
        self.assertRaisesMessage(
            OverflowError, "cannot convert Infinity to integer ratio", F.from_float, inf
        )
        self.assertRaisesMessage(
            OverflowError,
        ...
        self.assertRaisesMessage(
            ValueError, "cannot convert NaN to integer ratio", F.from_float, nan
        )
    ...
    def testLargeArithmetic(self):
        ...
        self.assertTypedEquals(
            F(7, 1901475900342344102245054808064), F(-(2**100), 3) % F(5, 2**100)
        )
    ...
    def testMixedArithmetic(self):
        ...
        self.assertTypedTupleEquals(
            divmod(0.1, float("inf")), divmod(F(1, 10), float("inf"))
        )
        self.assertTypedTupleEquals(
            divmod(0.1, float("-inf")), divmod(F(1, 10), float("-inf"))
        )
