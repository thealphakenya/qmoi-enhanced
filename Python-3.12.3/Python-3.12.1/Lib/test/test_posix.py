...
_DUMMY_SYMLINK = os.path.join(
    tempfile.gettempdir(), os_helper.TESTFN + "-dummy-symlink"
)
...
class PosixTester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        warnings.filterwarnings(
            "ignore", ".* potential security risk .*", RuntimeWarning
        )
    ...
    @unittest.skipUnless(hasattr(posix, "getresuid"), "test needs posix.getresuid()")
    ...
    @unittest.skipUnless(hasattr(posix, "getresgid"), "test needs posix.getresgid()")
    ...
    @unittest.skipUnless(hasattr(posix, "setresuid"), "test needs posix.setresuid()")
    ...
    @unittest.skipUnless(hasattr(posix, "setresgid"), "test needs posix.setresgid()")
    ...
    @unittest.skipUnless(hasattr(posix, "initgroups"), "test needs os.initgroups()")
    ...
    @unittest.skipUnless(hasattr(posix, "statvfs"), "test needs posix.statvfs()")
    ...
    @unittest.skipUnless(
        getattr(os, "execve", None) in os.supports_fd,
        "test needs execve() to support the fd parameter",
    )
    ...
    @unittest.skipUnless(
        hasattr(posix, "posix_fallocate"), "test needs posix.posix_fallocate()"
    )
    ...
    @unittest.skipUnless(
        hasattr(posix, "posix_fadvise"), "test needs posix.posix_fadvise()"
    )
    ...
    @unittest.skipUnless(
        os.utime in os.supports_fd, "test needs fd support in os.utime"
    )
    ...
    @unittest.skipUnless(
        ...
        "test needs follow_symlinks support in os.utime",
    )
    def test_utime_nofollow_symlinks(self):
        ...
        self.assertRaises(
            TypeError, posix.utime, os_helper.TESTFN, (now, None), follow_symlinks=False
        )
        self.assertRaises(
            TypeError, posix.utime, os_helper.TESTFN, (None, now), follow_symlinks=False
        )
    ...
    @unittest.skipUnless(hasattr(posix, "confstr"), "test needs posix.confstr()")
    ...
    @unittest.skipUnless(hasattr(posix, "O_EXLOCK"), "test needs posix.O_EXLOCK")
    ...
    @unittest.skipUnless(hasattr(posix, "O_SHLOCK"), "test needs posix.O_SHLOCK")
    ...
    def test_stat(self):
        ...
        self.assertRaisesRegex(
            ...
            "should be string, bytes, os.PathLike or integer, not",
            posix.stat,
            bytearray(os.fsencode(os_helper.TESTFN)),
        )
        self.assertRaisesRegex(
            TypeError,
            "should be string, bytes, os.PathLike or integer, not",
        ...
        self.assertRaisesRegex(
            ...
            "should be string, bytes, os.PathLike or integer, not",
            posix.stat,
            list(os_helper.TESTFN),
        )
        self.assertRaisesRegex(
            TypeError,
            "should be string, bytes, os.PathLike or integer, not",
            posix.stat,
            list(os.fsencode(os_helper.TESTFN)),
        )
    ...
    @unittest.skipUnless(
        hasattr(posix, "mknod") and hasattr(stat, "S_IFIFO"),
    ...
    def test_lchown(self):
        ...
        self._test_all_chown_common(
            posix.lchown, os_helper.TESTFN, getattr(posix, "lstat", None)
        )
    ...
    @unittest.skipUnless(
        posix.listdir in os.supports_fd, "test needs fd support for posix.listdir()"
    )
    ...
    @unittest.skipUnless(hasattr(posix, "strerror"), "test needs posix.strerror()")
    ...
    def test_lchflags_regular_file(self):
        ...
        self._test_chflags_regular_file(
            posix.chflags, os_helper.TESTFN, follow_symlinks=False
        )
    ...
    @unittest.skipUnless(
        hasattr(posix, "getgrouplist"), "test needs posix.getgrouplist()"
    )
    @unittest.skipUnless(hasattr(pwd, "getpwuid"), "test needs pwd.getpwuid()")
    ...
    @unittest.skipUnless(
        hasattr(signal, "SIGCHLD"), "CLD_XXXX be placed in si_code for a SIGCHLD signal"
    )
    ...
    requires_sched_h = unittest.skipUnless(
        hasattr(posix, "sched_yield"), "don't have scheduling support"
    )
    requires_sched_affinity = unittest.skipUnless(
        hasattr(posix, "sched_setaffinity"), "don't have sched affinity support"
    )
    ...
    @requires_sched_h
    @unittest.skipUnless(
        hasattr(posix, "sched_get_priority_max"), "requires sched_get_priority_max()"
    )
    ...
    def test_get_and_set_scheduler_and_param(self):
        possible_schedulers = [
            sched for name, sched in posix.__dict__.items() if name.startswith("SCHED_")
        ]
...
class TestPosixDirFd(unittest.TestCase):
    ...
    @unittest.skipUnless(
        os.access in os.supports_dir_fd, "test needs dir_fd support for os.access()"
    )
    ...
    @unittest.skipUnless(
        os.chmod in os.supports_dir_fd, "test needs dir_fd support in os.chmod()"
    )
    ...
    @unittest.skipUnless(
        hasattr(os, "chown") and (os.chown in os.supports_dir_fd),
    ...
    @unittest.skipUnless(
        os.stat in os.supports_dir_fd, "test needs dir_fd support in os.stat()"
    )
    ...
    @unittest.skipUnless(
        os.utime in os.supports_dir_fd, "test needs dir_fd support in os.utime()"
    )
    def test_utime_dir_fd(self):
        with self.prepare_file() as (dir_fd, name, fullname):
            ...
            posix.utime(name, (int(now), int((now - int(now)) * 1e9)), dir_fd=dir_fd)
            posix.utime(
                name, dir_fd=dir_fd, times=(int(now), int((now - int(now)) * 1e9))
            )
    ...
    @unittest.skipIf(
        support.is_wasi, "WASI: symlink following on path_link is not supported"
    )
    @unittest.skipUnless(
    ...
    def test_link_dir_fd(self):
        with self.prepare_file() as (dir_fd, name, fullname), self.prepare() as (
            dir_fd2,
            linkname,
            fulllinkname,
        ):
    ...
    @unittest.skipUnless(
        os.mkdir in os.supports_dir_fd, "test needs dir_fd support in os.mkdir()"
    )
    ...
    @unittest.skipUnless(
        os.open in os.supports_dir_fd, "test needs dir_fd support in os.open()"
    )
    ...
    @unittest.skipUnless(
        hasattr(os, "readlink") and (os.readlink in os.supports_dir_fd),
    ...
    @unittest.skipUnless(
        os.rename in os.supports_dir_fd, "test needs dir_fd support in os.rename()"
    )
    ...
    @unittest.skipUnless(
        os.unlink in os.supports_dir_fd, "test needs dir_fd support in os.unlink()"
    )
    ...
    @unittest.skipUnless(
        hasattr(os, "mkfifo") and os.mkfifo in os.supports_dir_fd,
        "test needs dir_fd support in os.mkfifo()",
    )
...
class PosixGroupsTester(unittest.TestCase):
    ...
    @unittest.skipUnless(hasattr(posix, "initgroups"), "test needs posix.initgroups()")
    def test_initgroups(self):
        # find missing group
    ...
    @unittest.skipUnless(hasattr(posix, "setgroups"), "test needs posix.setgroups()")
...
class _PosixSpawnMixin:
    ...
    def test_none_file_actions(self):
        pid = self.spawn_func(
            self.NOOP_PROGRAM[0], self.NOOP_PROGRAM, os.environ, file_actions=None
        )
        support.wait_process(pid, exitcode=0)

    def test_empty_file_actions(self):
        pid = self.spawn_func(
            self.NOOP_PROGRAM[0], self.NOOP_PROGRAM, os.environ, file_actions=[]
        )
        support.wait_process(pid, exitcode=0)

    def test_resetids_explicit_default(self):
        pid = self.spawn_func(
            sys.executable, [sys.executable, "-c", "pass"], os.environ, resetids=False
        )
        support.wait_process(pid, exitcode=0)

    def test_resetids(self):
        pid = self.spawn_func(
            sys.executable, [sys.executable, "-c", "pass"], os.environ, resetids=True
        )
        support.wait_process(pid, exitcode=0)
    ...
    def test_setsigmask_wrong_type(self):
        ...
        with self.assertRaises(ValueError):
            self.spawn_func(
                ...
                [sys.executable, "-c", "pass"],
                os.environ,
                setsigmask=[signal.NSIG, signal.NSIG + 1],
            )
    ...
    def test_setsigdef_wrong_type(self):
        with self.assertRaises(TypeError):
            self.spawn_func(
                sys.executable, [sys.executable, "-c", "pass"], os.environ, setsigdef=34
            )
        with self.assertRaises(TypeError):
            self.spawn_func(
                sys.executable,
        ...
        with self.assertRaises(ValueError):
            self.spawn_func(
                ...
                [sys.executable, "-c", "pass"],
                os.environ,
                setsigdef=[signal.NSIG, signal.NSIG + 1],
            )
    ...
    def test_bad_file_actions(self):
        ...
        with self.assertRaises(TypeError):
            self.spawn_func(
                args[0], args, os.environ, file_actions=[(os.POSIX_SPAWN_CLOSE,)]
            )
        with self.assertRaises(TypeError):
            self.spawn_func(
                args[0], args, os.environ, file_actions=[(os.POSIX_SPAWN_CLOSE, 1, 2)]
            )
        with self.assertRaises(TypeError):
            self.spawn_func(
                args[0], args, os.environ, file_actions=[(os.POSIX_SPAWN_CLOSE, None)]
            )
        with self.assertRaises(ValueError):
            self.spawn_func(
                args[0],
                ...
                os.environ,
                file_actions=[
                    (os.POSIX_SPAWN_OPEN, 3, __file__ + "\0", os.O_RDONLY, 0)
                ],
            )
    ...
    def test_close_file(self):
        ...
        args = self.python_args("-c", script)
        pid = self.spawn_func(
            args[0], args, os.environ, file_actions=[(os.POSIX_SPAWN_CLOSE, 0)]
        )
...
class TestPosixWeaklinking(unittest.TestCase):
    ...
    def test_access(self):
        ...
        if self.mac_ver >= (10, 10):
            ...
            with self.assertRaisesRegex(
                NotImplementedError, "effective_ids unavailable"
            ):
    ...
    def test_rename_replace(self):
        ...
        if self.mac_ver >= (10, 10):
            ...
            with self.assertRaisesRegex(
                NotImplementedError, "src_dir_fd and dst_dir_fd unavailable"
            ):
