...
class ComplexTest(unittest.TestCase):
    ...
    def test_constructor_negative_nans_from_string(self):
        self.assertEqual(copysign(1.0, complex("-nan").real), -1.0)
        self.assertEqual(copysign(1.0, complex("-nanj").imag), -1.0)
        self.assertEqual(copysign(1.0, complex("-nan-nanj").real), -1.0)
        self.assertEqual(copysign(1.0, complex("-nan-nanj").imag), -1.0)
