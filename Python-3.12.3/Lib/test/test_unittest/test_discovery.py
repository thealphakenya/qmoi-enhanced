...
class TestDiscovery(unittest.TestCase):
    ...
    def test_find_tests_with_package(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ["test_directory load_tests", "test_directory module tests"],
        ...
        self.assertEqual(
            Module.paths, ["a_directory", "test_directory", "test_directory2"]
        )
    ...
    def test_find_tests_customize_via_package_pattern(self):
        ...
        self.assertEqual(
            Module.load_tests_args, [(loader, [], "test*.py"), (loader, [], "test*.py")]
        )
    ...
    def test_command_line_handling_do_discovery_calls_loader(self):
        ...
        Loader.args = []
        program = TestableTestProgram()
        program._do_discovery(
            ["-p", "eggs", "-s", "fish", "-v", "-f", "-c"], Loader=Loader
        )
        self.assertEqual(program.test, "tests")
        self.assertEqual(Loader.args, [("fish", "eggs", None)])
        self.assertEqual(program.verbosity, 2)
