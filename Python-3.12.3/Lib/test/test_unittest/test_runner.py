...
class TestClassCleanup(unittest.TestCase):
    ...
    def test_with_errors_addCleanUp(self):
        ...
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: CleanUpExc"
        )
        self.assertEqual(
            ordering,
    ...
    def test_with_errors_in_addClassCleanup_and_setUps(self):
        ...
        result = runTests(TestableTest)
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: ClassExc"
        )
        self.assertEqual(
            result.errors[1][1].splitlines()[-1], f"{CustomErrorRepr}: CleanUpExc"
        )
        ...
        result = runTests(TestableTest)
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: MethodExc"
        )
        self.assertEqual(
            result.errors[1][1].splitlines()[-1], f"{CustomErrorRepr}: CleanUpExc"
        )
    ...
    def test_with_errors_in_tearDownClass(self):
        ...
        result = runTests(TestableTest)
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: TearDownExc"
        )
        self.assertEqual(
            ordering, ["setUpClass", "test", "tearDownClass", "cleanup_good"]
        )
...
class TestModuleCleanUp(unittest.TestCase):
    ...
    def test_run_module_cleanUp(self):
        ...
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: setUpModule Exc"
        )
    ...
    def test_with_errors_in_addModuleCleanup_and_setUps(self):
        ...
        result = runTests(TestableTest)
        self.assertEqual(
            result.errors[0][1].splitlines()[-1], f"{CustomErrorRepr}: ModuleExc"
        )
        self.assertEqual(
            result.errors[1][1].splitlines()[-1], f"{CustomErrorRepr}: CleanUpExc"
        )
