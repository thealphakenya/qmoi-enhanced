...
class PackTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_pack_configure_padx_ipadx_fill(self):
        ...
        check(
            "30x40+255+80", "250x200+0+0", side="right", ipadx=5, padx=(5, 15), fill="x"
        )
    ...
    def test_pack_configure_pady_ipady_fill(self):
        ...
        check(
            "20x50+280+70", "280x200+0+0", side="right", ipady=5, pady=(5, 15), fill="x"
        )
...
class GridTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_grid_configure_ipadx(self):
        ...
        self.assertEqual(
            b.grid_info()["ipadx"], self._str(round(pixels_conv(".5c") * self.scaling))
        )
    ...
    def test_grid_configure_ipady(self):
        ...
        self.assertEqual(
            b.grid_info()["ipady"], self._str(round(pixels_conv(".5c") * self.scaling))
        )
    ...
    def test_grid_configure_padx(self):
        ...
        self.assertEqual(
            b.grid_info()["padx"], self._str(round(pixels_conv(".5c") * self.scaling))
        )
    ...
    def test_grid_configure_pady(self):
        ...
        self.assertEqual(
            b.grid_info()["pady"], self._str(round(pixels_conv(".5c") * self.scaling))
        )
    ...
    def test_grid_columnconfigure(self):
        ...
        with self.assertRaisesRegex(
            TclError, "must specify a single element on retrieval"
        ):
    ...
    def test_grid_forget(self):
        ...
        b.grid_configure(
            row=2, column=2, rowspan=2, columnspan=2, padx=3, pady=4, sticky="ns"
        )
