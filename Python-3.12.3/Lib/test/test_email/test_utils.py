...
class DateTimeTests(unittest.TestCase):
    ...
    def test_naive_datetime(self):
        self.assertEqual(
            utils.format_datetime(self.naive_dt), self.datestring + " -0000"
        )

    def test_aware_datetime(self):
        self.assertEqual(
            utils.format_datetime(self.aware_dt), self.datestring + self.offsetstring
        )

    def test_usegmt(self):
        utc_dt = datetime.datetime(*self.dateargs, tzinfo=datetime.timezone.utc)
        self.assertEqual(
            utils.format_datetime(utc_dt, usegmt=True), self.datestring + " GMT"
        )
    ...
    def test_parsedate_to_datetime_naive(self):
        self.assertEqual(
            utils.parsedate_to_datetime(self.datestring + " -0000"), self.naive_dt
        )
    ...
    def test_parsedate_to_datetime_with_invalid_raises_valueerror(self):
        ...
        invalid_dates = [
            ...
            "Wed, 3 Apr 2002 12.34.56.78+0800" "Tue, 06 Jun 2017 27:39:33 +0600",
