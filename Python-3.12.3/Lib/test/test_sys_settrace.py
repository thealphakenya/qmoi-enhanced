...
class TraceTestCase(unittest.TestCase):
    ...
    def compare_events(self, line_offset, events, expected_events):
        ...
        if events != expected_events:
            self.fail(
                ...
                + "\n".join(
                    difflib.ndiff(
                        [str(x) for x in expected_events], [str(x) for x in events]
                    )
                )
            )
    ...
    def test_13_genexp(self):
        ...
        sys.settrace(None)
        self.compare_events(
            generator_example.__code__.co_firstlineno,
            tracer.events,
            generator_example.events,
        )
    ...
    def test_14_onliner_if(self):
        ...
        self.run_and_compare(
            onliners, [(0, "call"), (1, "line"), (3, "line"), (3, "return")]
        )
    ...
    def test_21_repeated_pass(self):
        ...
        self.run_and_compare(
            func, [(0, "call"), (1, "line"), (2, "line"), (2, "return")]
        )
    ...
    def test_loop_in_try_except(self):
        ...
        self.run_and_compare(
            func, [(0, "call"), (1, "line"), (2, "line"), (3, "line"), (3, "return")]
        )
    ...
    def test_return_through_finally(self):
        ...
        self.run_and_compare(
            func, [(0, "call"), (1, "line"), (2, "line"), (4, "line"), (4, "return")]
        )
    ...
    def test_try_except_star_nested(self):
        ...
        def func():
            try:
                try:
                    raise ExceptionGroup("eg", [ValueError(5), TypeError("bad type")])
                except* TypeError as e:
                    7
                except* OSError:
                    9
    ...
    def test_no_line_event_after_creating_generator(self):
        ...
        _testcapi.settrace_to_record(events)
        func()
        sys.settrace(None)
        start_line = func.__code__.co_firstlineno
        events = [
            (line - start_line, EVENT_NAMES[what]) for (what, line, arg) in events
        ]
...
class JumpTracer:
    ...
    def trace(self, frame, event, arg):
        ...
        if (
            event == self.event
            and self.firstLine is not None
            and frame.f_lineno == self.firstLine + self.jumpFrom
        ):
            f = frame
...
class JumpTestCase(unittest.TestCase):
    ...
    def async_jump_test(
        jumpFrom, jumpTo, expected, error=None, event="line", warning=None
    ):
        """Decorator that creates a test that makes a jump
    ...
    @async_jump_test(
        3, 2, [2, 2], (ValueError, "can't jump into the body of a for loop")
    )
    ...
    @jump_test(
        ...
        5,
        [],
        (ValueError, "can't jump into an 'except' block as there's no exception"),
    )
...
""",
    ...
    def test_jump_extended_args_for_iter(self):
        ...
        f = namespace["f"]
        self.run_test(
            f, 2, 100_000, [1, 100_000], warning=(RuntimeWarning, self.unbound_locals)
        )
