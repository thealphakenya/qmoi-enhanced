...
class ReadWriteTests:
    ...
    def _test_int_range(self, name, minval, maxval, *, hardlimit=None, indexlimit=None):
    ...
    def test_byte(self):
        self._test_int_range(
            "T_BYTE", CHAR_MIN, CHAR_MAX, hardlimit=(LONG_MIN, LONG_MAX)
        )
        self._test_int_range("T_UBYTE", 0, UCHAR_MAX, hardlimit=(LONG_MIN, LONG_MAX))

    def test_short(self):
        self._test_int_range(
            "T_SHORT", SHRT_MIN, SHRT_MAX, hardlimit=(LONG_MIN, LONG_MAX)
        )
        self._test_int_range("T_USHORT", 0, USHRT_MAX, hardlimit=(LONG_MIN, LONG_MAX))

    def test_int(self):
        self._test_int_range("T_INT", INT_MIN, INT_MAX, hardlimit=(LONG_MIN, LONG_MAX))
        self._test_int_range("T_UINT", 0, UINT_MAX, hardlimit=(LONG_MIN, ULONG_MAX))

    def test_long(self):
        self._test_int_range("T_LONG", LONG_MIN, LONG_MAX)
        self._test_int_range("T_ULONG", 0, ULONG_MAX, hardlimit=(LONG_MIN, ULONG_MAX))

    def test_py_ssize_t(self):
        self._test_int_range(
            "T_PYSSIZET", PY_SSIZE_T_MIN, PY_SSIZE_T_MAX, indexlimit=False
        )

    def test_longlong(self):
        self._test_int_range("T_LONGLONG", LLONG_MIN, LLONG_MAX)
        self._test_int_range(
            "T_ULONGLONG", 0, ULLONG_MAX, hardlimit=(LONG_MIN, ULLONG_MAX)
        )
