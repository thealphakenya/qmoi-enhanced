...
class CAPITest(unittest.TestCase):
    ...
    def test_object_str(self):
        ...
        self.assertTypedEqual(
            object_str(WithStr(StrSubclass("abc"))), StrSubclass("abc")
        )
        self.assertTypedEqual(object_str(WithRepr("<abc>")), "<abc>")
        self.assertTypedEqual(
            object_str(WithRepr(StrSubclass("<abc>"))), StrSubclass("<abc>")
        )
    ...
    def test_object_repr(self):
        ...
        self.assertTypedEqual(
            object_repr(WithRepr(StrSubclass("<abc>"))), StrSubclass("<abc>")
        )
        self.assertTypedEqual(object_repr(WithRepr("<\U0001f40d>")), "<\U0001f40d>")
        self.assertTypedEqual(
            object_repr(WithRepr(StrSubclass("<\U0001f40d>"))),
            StrSubclass("<\U0001f40d>"),
        )
    ...
    def test_object_ascii(self):
        ...
        self.assertTypedEqual(
            object_ascii(WithRepr(StrSubclass("<abc>"))), StrSubclass("<abc>")
        )
        self.assertTypedEqual(object_ascii(WithRepr("<\U0001f40d>")), r"<\U0001f40d>")
        self.assertTypedEqual(
            object_ascii(WithRepr(StrSubclass("<\U0001f40d>"))), r"<\U0001f40d>"
        )
    ...
    def test_object_bytes(self):
        ...
        self.assertTypedEqual(
            object_bytes(WithBytes(BytesSubclass(b"abc"))), BytesSubclass(b"abc")
        )
    ...
    def test_mapping_keys_valuesitems(self):
        ...
        for mapping in [
            ...
            Mapping2(),
            dict_obj,
            OrderedDict(dict_obj),
            Mapping1(dict_obj),
            Mapping2(dict_obj),
        ]:
            self.assertListEqual(_testcapi.mapping_keys(mapping), list(mapping.keys()))
            self.assertListEqual(
                _testcapi.mapping_values(mapping), list(mapping.values())
            )
            self.assertListEqual(
                _testcapi.mapping_items(mapping), list(mapping.items())
            )
