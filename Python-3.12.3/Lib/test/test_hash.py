...
class HashRandomizationTests:
    ...
    def get_hash(self, repr_, seed=None):
        ...
        out = assert_python_ok("-c", self.get_hash_command(repr_), **env)
        stdout = out[1].strip()
        return int(stdout)
...
class StringlikeHashRandomizationTests(HashRandomizationTests):
    ...
    known_hashes = {
        ...
        "fnv": [
            # seed 0, 'abc'
            [-1600925533, 1453079729188098211, -1600925533, 1453079729188098211],
            # seed 42, 'abc'
            [-206076799, -4410911502303878509, -1024014457, -3570150969479994130],
            # seed 42, 'abcdefghijk'
            [811136751, -5046230049376118746, -77208053, -4779029615281019666],
            # seed 0, 'äú∑ℇ'
            [44402817, 8998297579845987431, -1956240331, -782697888614047887],
            # seed 42, 'äú∑ℇ'
            [-283066365, -4576729883824601543, -271871407, -3927695501187247084],
        ],
    }
...
class StrHashRandomizationTests(StringlikeHashRandomizationTests, unittest.TestCase):
    repr_ = repr("abc")
...
class BytesHashRandomizationTests(StringlikeHashRandomizationTests, unittest.TestCase):
    repr_ = repr(b"abc")
...
class MemoryviewHashRandomizationTests(
    StringlikeHashRandomizationTests, unittest.TestCase
):
