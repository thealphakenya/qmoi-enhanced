...
class UrlParseTestCase(unittest.TestCase):
    ...
    def test_invalid_bracketed_hosts(self):
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[192.0.2.146]/Path?Query"
        )
        self.assertRaises(
            ValueError,
        ...
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[v123r.IP]/Path?Query"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[v12ae]/Path?Query"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[v.IP]/Path?Query"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[v123.]/Path?Query"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@[v]/Path?Query"
        )
        self.assertRaises(
            ValueError,
            urllib.parse.urlsplit,
        ...
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "Scheme://user@]v6a.ip[/Path"
        )
    ...
    def test_splitting_bracketed_hosts(self):
        ...
        p2 = urllib.parse.urlsplit(
            "scheme://user@[0439:23af:2309::fae7%test]/path?query"
        )
        self.assertEqual(p2.hostname, "0439:23af:2309::fae7%test")
        self.assertEqual(p2.username, "user")
        self.assertEqual(p2.path, "/path")
        p3 = urllib.parse.urlsplit(
