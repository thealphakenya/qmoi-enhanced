...
"""
    ...
    def test_funky_hyphens(self):
        ...
        self.check_split(
            "foo --option-opt bar", ["foo", " ", "--option-", "opt", " ", "bar"]
        )
    ...
    def test_non_breaking_space(self):
        ...
        self.check_wrap(
            text,
            20,
            ["This is a sentence", "with non-", "breaking\N{NO-BREAK SPACE}space."],
...
class MaxLinesTestCase(BaseTestCase):
    ...
    def test_placeholder_backtrack(self):
        ...
        self.check_wrap(
            text, 12, ["Good grief", "Python*****"], max_lines=3, placeholder="*****"
        )
...
"""
    ...
    def test_max_lines_long(self):
        self.check_wrap(
            self.text,
            12,
            ["Did you say ", '"supercalifr', "agilisticexp", "[...]"],
            max_lines=4,
        )
...
"""
    ...
    def test_do_not_break_long_words_or_on_hyphens(self):
        ...
        self.check_wrap(
            self.text1, 50, expected, break_long_words=False, break_on_hyphens=False
        )
        ...
        self.check_wrap(
            self.text1, 10, expected, break_long_words=False, break_on_hyphens=False
        )
