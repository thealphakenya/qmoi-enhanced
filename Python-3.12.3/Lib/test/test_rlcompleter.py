...
class TestRlcompleter(unittest.TestCase):
    ...
    def test_global_matches(self):
        ...
        self.assertEqual(
            sorted(self.stdcompleter.global_matches("di")),
            [x + "(" for x in dir(builtins) if x.startswith("di")],
        )
        self.assertEqual(
            sorted(self.stdcompleter.global_matches("st")),
        ...
        self.assertEqual(
            self.completer.global_matches("CompleteM"),
    ...
    def test_attr_matches(self):
        ...
        # test with a customized namespace
        self.assertEqual(
            self.completer.attr_matches("CompleteMe.sp"), ["CompleteMe.spam"]
        )
        self.assertEqual(self.completer.attr_matches("Completeme.egg"), [])
        self.assertEqual(
            self.completer.attr_matches("CompleteMe."),
            ["CompleteMe.mro()", "CompleteMe.spam"],
        )
        self.assertEqual(
            self.completer.attr_matches("CompleteMe._"), ["CompleteMe._ham"]
        )
