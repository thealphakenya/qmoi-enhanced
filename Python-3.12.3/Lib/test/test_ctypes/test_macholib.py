...
class MachOTest(unittest.TestCase):
    ...
    def test_framework_info(self):
        ...
        self.assertEqual(
            framework_info("P/F.framework/F"), d("P", "F.framework/F", "F")
        )
        self.assertEqual(
            framework_info("P/F.framework/F_debug"),
        ...
        self.assertEqual(
            framework_info("P/F.framework/Versions/A/F"),
            d("P", "F.framework/Versions/A/F", "F", "A"),
        )
        self.assertEqual(
            framework_info("P/F.framework/Versions/A/F_debug"),
