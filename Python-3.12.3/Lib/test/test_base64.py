...
class LegacyBase64TestCase(unittest.TestCase):
    ...
    def test_encodebytes(self):
        ...
        eq(
            base64.encodebytes(b"Aladdin:open sesame"),
    ...
    def test_decodebytes(self):
        ...
        eq(
            base64.decodebytes(b"QWxhZGRpbjpvcGVuIHNlc2FtZQ==\n"),
...
class BaseXYTestCase(unittest.TestCase):
    ...
    def test_b64encode(self):
        ...
        eq(
            base64.b64encode(b"\xd3V\xbeo\xf7\x1d", altchars=bytearray(b"*$")),
            b"01a*b$cd",
        )
        eq(
            base64.b64encode(b"\xd3V\xbeo\xf7\x1d", altchars=memoryview(b"*$")),
            b"01a*b$cd",
        )
        eq(
            base64.b64encode(b"\xd3V\xbeo\xf7\x1d", altchars=array("B", b"*$")),
            b"01a*b$cd",
        )
        # Non-bytes
        ...
        self.check_other_types(
            base64.urlsafe_b64encode, b"\xd3V\xbeo\xf7\x1d", b"01a-b_cd"
        )
    ...
    def test_b64decode(self):
        ...
        tests = {
            ...
            b"YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXpBQkNE"
            b"RUZHSElKS0xNTk9QUVJTVFVWV1hZWjAxMjM0\nNT"
            b"Y3ODkhQCMwXiYqKCk7Ojw+LC4gW117fQ==": b"abcdefghijklmnopqrstuvwxyz"
            b"ABCDEFGHIJKLMNOPQRSTUVWXYZ"
            b"0123456789!@#0^&*();:<>,. []{}",
            b"": b"",
        }
        ...
        # Non-bytes
        self.check_other_types(
            base64.urlsafe_b64decode, b"01a-b_cd", b"\xd3V\xbeo\xf7\x1d"
        )
    ...
    def test_b32hexdecode(self):
        ...
        for to_decode, expected, casefold in test_cases:
            with self.subTest(to_decode=to_decode, casefold=casefold):
                ...
                self.assertEqual(
                    base64.b32hexdecode(to_decode.decode("ascii"), casefold), expected
                )
    ...
    def test_a85encode(self):
        ...
        tests = {
            ...
            b"0123456789!@#0^&*();:<>,. []{}": b'@:E_WAS,RgBkhF"D/O92EH6,BF`qtRH$VbC6UX@47n?3D92&&T'
        ...
        self.check_other_types(
            base64.a85encode, b"www.python.org", b"GB\\6`E-ZP=Df.1GEb>"
        )

        self.assertRaises(TypeError, base64.a85encode, "")

        eq(
            base64.a85encode(b"www.python.org", wrapcol=7, adobe=False),
            b"GB\\6`E-\nZP=Df.1\nGEb>",
        )
        eq(
            base64.a85encode(b"\0\0\0\0www.python.org", wrapcol=7, adobe=False),
            b"zGB\\6`E\n-ZP=Df.\n1GEb>",
        )
        eq(
            base64.a85encode(b"www.python.org", wrapcol=7, adobe=True),
            b"<~GB\\6`\nE-ZP=Df\n.1GEb>\n~>",
        )
    ...
    def test_b85encode(self):
        ...
        tests = {
            ...
            b"""{Qdp""",
            b"""abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"""
            b"""0123456789!@#0^&*();:<>,. []{}""": b"""VPa!sWoBn+X=-b1ZEkOHadLBXb#`}nd3r%YLqtVJM@UIZOH55pPf$@("""
    ...
    def test_a85decode(self):
        ...
        tests = {
            ...
            b"""Hat='/U/0JP==1c70M3&r-I,;<FN.OZ`-3]oSW/g+A(H[P""": b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234"
            b"56789!@#0^&*();:<>,. []{}",
        ...
        self.check_other_types(
            base64.a85decode, b"GB\\6`E-ZP=Df.1GEb>", b"www.python.org"
        )
    ...
    def test_b85decode(self):
        ...
        tests = {
            ...
            b"""Q&d$}S6EqEFflSSG&MFiI5{CeBQRbjDkv#CIy^osE+AW7dwl""": b"""abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"""
            b"""0123456789!@#0^&*();:<>,. []{}""",
    ...
    def test_a85decode_errors(self):
        ...
        self.assertRaises(
            ValueError, base64.a85decode, b"<~still malformed", adobe=True
        )
        ...
        self.assertRaises(
            ValueError, base64.a85decode, b"a b\nc", adobe=False, ignorechars=b""
        )
