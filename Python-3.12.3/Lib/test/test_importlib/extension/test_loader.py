...
class LoaderTests:
    ...
    def setUp(self):
        ...
        self.loader = self.machinery.ExtensionFileLoader(
            util.EXTENSIONS.name, util.EXTENSIONS.file_path
        )
    ...
    def test_inequality(self):
        other = self.machinery.ExtensionFileLoader(
            "_" + util.EXTENSIONS.name, util.EXTENSIONS.file_path
        )
...
class SinglePhaseExtensionModuleTests(abc.LoaderTests):
    ...
    def setUp(self):
        ...
        if self.name in sys.builtin_module_names:
            raise unittest.SkipTest(f"{self.name} is a builtin module")
...
(Frozen_SinglePhaseExtensionModuleTests, Source_SinglePhaseExtensionModuleTests) = (
