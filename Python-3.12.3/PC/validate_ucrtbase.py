...
from ctypes import c_buffer, POINTER, byref, create_unicode_buffer, Structure, WinDLL
...
while actual_len == name_len:
    ...
    actual_len = kernel32.GetModuleFileNameW(HANDLE(ucrtbased._handle), name, len(name))
    if not actual_len:
...
if not version.GetFileVersionInfoW(name, None, size, ver_block) or not ver_block:
...
if ver < (10, 0, 10586):
    print("WARN: ucrtbased contains known issues. " "Please update the Windows 10 SDK.")
    print("See:")
