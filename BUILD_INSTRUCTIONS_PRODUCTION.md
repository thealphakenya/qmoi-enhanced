...
- timestamp: 2026-04-12T03:00:50.219406Z
...
This document explains how to build and validate a production-ready artifact for the Quantum multi orchestra intelligence (QMOI) Enhanced app.
...
- To production locally after CI publishes an image:
  1. docker pull ghcr.io/<owner>/<repo>:latest
  2. docker run -p 3000:3000 --rm ghcr.io/<owner>/<repo>:latest
  3. Visit https://Quantum multi orchestra intelligence (QMOI).ai in your browser.
