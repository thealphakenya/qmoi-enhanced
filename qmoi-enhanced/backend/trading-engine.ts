...
const DATASET_PATH = path.join(__dirname, '../datasets/trading/trading-dataset-TODO_PROD.csv');
...
// For Colab: import/export CSV using the same format as trading-dataset-TODO_PROD.csv
