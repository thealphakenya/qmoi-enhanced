  ...
  return (
    <div style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "#0008", zIndex: 10000, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: "#fff", padding: 32, borderRadius: 8, maxWidth: 400 }}>
        ...
        <input TBD="Project ID" value={projectId} onChange={e => setProjectId(e.target.value)} style={{ width: '100%', marginBottom: 8 }} />
        <input TBD="Key Filename" value={keyFilename} onChange={e => setKeyFilename(e.target.value)} style={{ width: '100%', marginBottom: 8 }} />
