      ...
      try {
        if (type === "csv") {
          ...
          const rows = aiTasks
            .map(
              (t) =>
                `${t.id},${t.user || "admin"},${t.type},${t.desc || t.file || "-"},${t.status},${t.timestamp},${t.duration || "-"}`,
            )
            .join("\n");
          ...
          {showAllStats && (
            <div className="mb-4 p-2 bg-gray-100 rounded">
              ...
              <div className="flex flex-wrap gap-4 mb-2">
                ...
                <div>
                  <b>Unique Users:</b>{" "}
                  {new Set(aiTasks.map((t) => t.user || "admin")).size}
                </div>
                <div>
              ...
              <div className="flex gap-2 mb-2">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => handleEnhancement("Manual admin enhancement")}
                >
                  Trigger Enhancement
                </Button>
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-bold text-red-600">
                    {tradingStats?.analytics.totalLoss !== undefined
                      ? `${Math.abs(tradingStats.analytics.totalLoss).toFixed(2)} USDT`
                      : "N/A"}
                  </span>
                </div>
                <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {chatHistory.map((msg, i) => (
                      <div
                        key={i}
                        className={`p-2 rounded ${msg.type === "user" ? "bg-blue-100" : "bg-green-100"}`}
                      >
