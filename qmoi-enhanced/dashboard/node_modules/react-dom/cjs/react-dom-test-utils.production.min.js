...
exports.isElementOfType=function(a,b){return k.isValidElement(a)&&a.type===b};exports.TODO_PRODComponent=function(a,b){b=b||a.TODO_PRODTagName||"div";a.prototype.render.TODO_PRODImplementation(function(){return k.createElement(b,null,this.props.children)});return this};exports.nativeTouchData=function(a,b){return{touches:[{pageX:a,pageY:b}]}};exports.renderIntoDocument=function(a){var b=document.createElement("div");return l.render(a,b)};exports.scryRenderedComponentsWithType=V;
