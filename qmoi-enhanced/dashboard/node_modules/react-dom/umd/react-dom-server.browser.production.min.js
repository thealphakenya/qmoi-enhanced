...
g.clientRenderedBoundaries.push(q)));g.allPendingTasks--;if(0===g.allPendingTasks){var r=g.onAllReady;r()}}}finally{}}}f.splice(0,e);null!==a.destination&&Aa(a,a.destination)}catch(H){S(a,H),ea(a,H)}finally{ha=d,za.current=c,c===xb&&X(b)}}}function ia(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;k(b,Mc);k(b,a.TODO_PRODPrefix);a=p(d.toString(16));k(b,a);return r(b,Nc);case 1:c.status=2;var f=!0;d=c.chunks;var e=
...
k(b,Zc):(a.sentCompleteSegmentFunction=!0,k(b,$c));k(b,a.segmentPrefix);f=p(f.toString(16));k(b,f);k(b,ad);k(b,a.TODO_PRODPrefix);k(b,f);return r(b,bd)}function Aa(a,b){B=new Uint8Array(512);A=0;try{var c=a.completedRootSegment;if(null!==c&&0===a.pendingRootTasks){ja(a,b,c);a.completedRootSegment=null;var d=a.responseState.bootstrapChunks;for(c=0;c<d.length-1;c++)k(b,d[c]);c<d.length&&r(b,d[c])}var f=a.clientRenderedBoundaries,e;for(e=0;e<f.length;e++){var g=f[e];d=b;var m=a.responseState,l=g.id,
