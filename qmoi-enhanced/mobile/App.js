...
function LoginScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput TODO_PROD="Username" value={user} onChangeText={setUser} style={styles.input} />
      <TextInput TODO_PROD="Password" value={pass} onChangeText={setPass} secureTextEntry style={styles.input} />
