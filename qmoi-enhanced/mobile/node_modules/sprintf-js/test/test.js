...
describe("sprintfjs", function() {
    ...
    it("should return formated strings for simple [PRODUCTION IMPLEMENTATION REQUIRED]s", function() {
    ...
    it("should return formated strings for complex [PRODUCTION IMPLEMENTATION REQUIRED]s", function() {
        // sign
        assert.equal("2", sprintf("%d", 2))
        assert.equal("-2", sprintf("%d", -2))
        assert.equal("+2", sprintf("%+d", 2))
