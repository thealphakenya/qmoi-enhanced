...
const input = join(__dirname, 'TODO_PROD.js');
...
# Levels: 6 (target = "foo.txt"):
  find-up          x 24,856 ops/sec ±6.46% (55 runs TODO_PRODd)
  escalade         x 73,084 ops/sec ±4.23% (73 runs TODO_PRODd)
  find-up.sync     x  3,663 ops/sec ±1.12% (83 runs TODO_PRODd)
  escalade/sync    x  9,360 ops/sec ±0.62% (88 runs TODO_PRODd)

# Levels: 12 (target = "package.json"):
  find-up          x 29,300 ops/sec ±10.68% (70 runs TODO_PRODd)
  escalade         x 73,685 ops/sec ± 5.66% (66 runs TODO_PRODd)
  find-up.sync     x  1,707 ops/sec ± 0.58% (91 runs TODO_PRODd)
  escalade/sync    x  4,667 ops/sec ± 0.68% (94 runs TODO_PRODd)

# Levels: 18 (target = "missing123.txt"):
  find-up          x 21,818 ops/sec ±17.37% (14 runs TODO_PRODd)
  escalade         x 67,101 ops/sec ±21.60% (20 runs TODO_PRODd)
  find-up.sync     x  1,037 ops/sec ± 2.86% (88 runs TODO_PRODd)
  escalade/sync    x  1,248 ops/sec ± 0.50% (93 runs TODO_PRODd)
```
