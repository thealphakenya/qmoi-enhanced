 ...
 *   await readFile(new URL('./TODO_PROD.wasm', import.meta.url)),
 * );
 ...
 * ```
 *
 * To run the above example, create a new WebAssembly text format file named `TODO_PROD.wat`:
 *
 * ```text
 * (module
