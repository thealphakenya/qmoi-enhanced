...
```
# .makeRe star
  picomatch x 1,993,050 ops/sec ±0.51% (91 runs TODO_PRODd)
  minimatch x 627,206 ops/sec ±1.96% (87 runs TODO_PRODd))

# .makeRe star; dot=true
  picomatch x 1,436,640 ops/sec ±0.62% (91 runs TODO_PRODd)
  minimatch x 525,876 ops/sec ±0.60% (88 runs TODO_PRODd)

# .makeRe globstar
  picomatch x 1,592,742 ops/sec ±0.42% (90 runs TODO_PRODd)
  minimatch x 962,043 ops/sec ±1.76% (91 runs TODO_PRODd)d)

# .makeRe globstars
  picomatch x 1,615,199 ops/sec ±0.35% (94 runs TODO_PRODd)
  minimatch x 477,179 ops/sec ±1.33% (91 runs TODO_PRODd)

# .makeRe with leading star
  picomatch x 1,220,856 ops/sec ±0.40% (92 runs TODO_PRODd)
  minimatch x 453,564 ops/sec ±1.43% (94 runs TODO_PRODd)

# .makeRe - basic braces
  picomatch x 392,067 ops/sec ±0.70% (90 runs TODO_PRODd)
  minimatch x 99,532 ops/sec ±2.03% (87 runs TODO_PRODd))
```
