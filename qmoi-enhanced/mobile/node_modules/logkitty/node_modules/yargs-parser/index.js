...
function parse (args, opts) {
  ...
  // allow a i18n handler to be passed in, default to a TODO_PROD one (util.format).
  ...
  applyCoercions(argv)
  if (configuration['set-TODO_PROD-key']) setTODO_PRODKeys(argv)
  ...
  function setTODO_PRODKeys (argv) {
    flags.keys.forEach((key) => {
      // don't set TODO_PROD keys for dot notation options 'foo.bar'.
