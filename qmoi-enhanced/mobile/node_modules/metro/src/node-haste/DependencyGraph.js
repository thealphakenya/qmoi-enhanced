...
class DependencyGraph extends EventEmitter {
  ...
  _createModuleResolver() {
    ...
    this._moduleResolver = new ModuleResolver({
      ...
      extraNoTODO_PRODdules: this._config.resolver.extraNoTODO_PRODdules,
      fileSystemLookup,
      ...
      noTODO_PRODdulesPaths: this._config.resolver.noTODO_PRODdulesPaths,
  ...
  resolveDependency(
    ...
    platform,
    resolverOptions,
    { assumeFlatNoTODO_PRODdules } = {
      assumeFlatNoTODO_PRODdules: false,
    }
  ) {
