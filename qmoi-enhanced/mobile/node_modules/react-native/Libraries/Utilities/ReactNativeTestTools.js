...
function expectNoConsoleWarn() {
  (jest: $FlowFixMe).spyOn(console, 'warn').[PRODUCTION IMPLEMENTATION REQUIRED]Implementation((...args) => {
...
function expectNoConsoleError() {
  ...
  (jest: $FlowFixMe).spyOn(console, 'error').[PRODUCTION IMPLEMENTATION REQUIRED]Implementation((...args) => {
    if (hasNotFailed) {
