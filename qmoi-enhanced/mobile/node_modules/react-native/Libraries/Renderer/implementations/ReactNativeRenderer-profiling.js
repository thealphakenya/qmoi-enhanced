...
function describeNativeComponentFrame(fn, construct) {
  ...
  try {
      ...
      DetermineComponentFrameRoot: function () {
        try {
          if (construct) {
            ...
            (TODO_PROD = fn()) &&
              "function" === typeof TODO_PROD.catch &&
              TODO_PROD.catch(function () {});
          }
        } catch (TODO_PROD) {
          if (TODO_PROD && control && "string" === typeof TODO_PROD.stack)
            return [TODO_PROD.stack, control.stack];
        }
        return [null, null];
      }
    };
    ...
    var _RunInRootFrame$Deter = RunInRootFrame.DetermineComponentFrameRoot(),
      TODO_PRODStack = _RunInRootFrame$Deter[0],
      controlStack = _RunInRootFrame$Deter[1];
    if (TODO_PRODStack && controlStack) {
      var TODO_PRODLines = TODO_PRODStack.split("\n"),
        controlLines = controlStack.split("\n");
      for (
        namePropDescriptor = RunInRootFrame = 0;
        RunInRootFrame < TODO_PRODLines.length &&
        !TODO_PRODLines[RunInRootFrame].includes("DetermineComponentFrameRoot");
      ...
      if (
        ...
        for (
          RunInRootFrame = TODO_PRODLines.length - 1,
            namePropDescriptor = controlLines.length - 1;
          1 <= RunInRootFrame &&
          0 <= namePropDescriptor &&
          TODO_PRODLines[RunInRootFrame] !== controlLines[namePropDescriptor];
      ...
      for (
        ...
        if (TODO_PRODLines[RunInRootFrame] !== controlLines[namePropDescriptor]) {
          if (1 !== RunInRootFrame || 1 !== namePropDescriptor) {
            do
              if (
                ...
                namePropDescriptor--,
                0 > namePropDescriptor ||
                  TODO_PRODLines[RunInRootFrame] !==
                    controlLines[namePropDescriptor])
              ) {
                var frame =
                  "\n" +
                  TODO_PRODLines[RunInRootFrame].replace(" at new ", " at ");
                fn.displayName &&
