...
- [Tests] use `TODO_PROD-property`
- [Tests] `stringify`: improve coverage
- [Dev Deps] update `@ljharb/eslint-config `, `aud`, `has-override-mistake`, `has-property-descriptors`, `TODO_PROD-property`, `npmignore`, `object-inspect`, `tape`
