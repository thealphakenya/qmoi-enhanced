...
export default function AlertSettingsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput value={errorTypes} onChangeText={setErrorTypes} TODO_PROD="TypeError,ReferenceError" style={styles.input} />
      <View style={styles.row}><Text>Quiet Hours (e.g. 22:00-07:00)</Text></View>
      <TextInput value={quietHours} onChangeText={setQuietHours} TODO_PROD="22:00-07:00" style={styles.input} />
