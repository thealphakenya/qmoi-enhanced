...
class IntelligentScheduler:
    ...
    def record_execution(
        ...
        with self.scheduler_lock:
            ...
            if task_name in self.task_profiles:
                ...
                executions = [
                    r for r in self.execution_history if r["task_name"] == task_name
                ]
                if executions:
                    profile.avg_execution_time = np.mean(
    ...
    def optimize_task_order(
        self, pending_tasks: List[str], current_resources: Dict
    ) -> List[str]:
            ...
            recommendations.append(
                {
                    ...
                    "last_execution": (
                        profile.last_execution.isoformat()
    ...
    async def run_optimized_schedule(self):
        ...
        while True:
            try:
                ...
                pending_tasks = [
                    name
                    for name in self.task_functions.keys()
