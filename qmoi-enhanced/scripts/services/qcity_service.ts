    ...
    try {
      ...
      this.config = {
        ...
        features: {
          ...
          resourceOptimization: process.env.ENABLE_RESOURCE_OPTIMIZATION === 'true',
        ...
        resources: {
          ...
          optimization_level: (process.env.OPTIMIZATION_LEVEL || 'medium') as 'low' | 'medium' | 'high',
        ...
        ui: {
          theme: (process.env.UI_THEME || 'system') as 'light' | 'dark' | 'system',
