<!-- AUTODEV Enhanced: 2026-04-20T09:01:25.687659 -->
<!-- AUTODEV Enhanced: 2026-04-20T08:55:18.705015 -->
...
const AccessibilitySettingsPanel = () => {
  ...
  return (
    <section
      ...
      className="p-4 border rounded-lg bg-white dark:bg-gray-900 max-w-md mx-auto mt-6"
    >
      ...
      <form>
        ...
        <label className="flex items-center mb-2">
          <input
            ...
            onChange={(e) => setGestureControl(e.target.checked)}
            aria-checked={gestureControl}
          />
      ...
      <p className="mt-4 text-sm text-gray-600 dark:text-gray-300">
        All settings are saved and applied instantly. QMOI will remember your
