...
export default function AlphaQAISystem() {
  ...
  useEffect(() => {
    ...
    const featureTypes: AIProject['type'][] = ['game', 'animation', 'movie', 'music', 'architecture']
    ...
    // Ensure at least one long-form movie and one advanced music project
    ...
    toCreate.forEach((type, idx) => {
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            // Optionally, add learning/analytics here
          }, 1000)
        }, 1000 + idx * 500)
      }, idx * 200)
    })
