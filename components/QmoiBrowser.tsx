...
export const QmoiBrowser: React.FC<QmoiBrowserProps> = ({
  ...
  const [tabs, setTabs] = useState<Tab[]>([
    { id: '1', title: 'Qmoi Browser', url: 'https://www.google.com', isActive: true }
  ]);
  ...
  const addBookmark = (title: string, url: string) => {
    ...
    localStorage.setItem('qmoi-browser-bookmarks', JSON.stringify(newBookmarks));
  };
        ...
        <div className="w-64 bg-gray-50 border-r p-4 overflow-y-auto">
          ...
          <div className="space-y-2">
            {bookmarks.map(bookmark => (
              <div key={bookmark.id} className="flex items-center justify-between p-2 rounded hover:bg-gray-200">
                <button
            ...
            onLoad={(e) => {
              ...
              if (isAdRemovalEnabled) {
                ...
                try {
                  ...
                  if (iframeDoc) {
                    iframeDoc.body.innerHTML = removeAds(iframeDoc.body.innerHTML);
                  }
                } catch (error) {
