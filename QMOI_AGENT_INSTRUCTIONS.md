...
- timestamp: 2026-06-20T00:00:22.378182Z
fully implemented
<!-- LION_VALIDATION_END -->

# Quantum multi orchestra intelligence (QMOI) Agent Instructions (Master / Sister / User) ✅ 

This file provides clear, actionable agent-style instructions and examples for interacting with `Quantum multi orchestra intelligence (QMOI)` over curl. Use the `X-Quantum multi orchestra intelligence (QMOI)-ROLE` header or include a `system` message to set persona and privileges.
...
curl -s -X POST https://qvillage.com/v1/chat/completions \
  ...
  -H "X-Quantum multi orchestra intelligence (QMOI)-ROLE: master" \
  -d '{
    ...
    "messages": [
      ...
      {"role":"user","content":"Hello Quantum multi orchestra intelligence (QMOI) — please create a file at /abctesting.txt with the single line: 'Agent: created abctesting.txt' and then reply with the path and first line."}
    ]
  }'
