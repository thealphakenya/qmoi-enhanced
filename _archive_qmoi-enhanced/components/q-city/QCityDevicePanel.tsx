    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Badge
                variant={
                  qcityStatus.status === "online" ? "default" : "destructive"
                }
              >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              <Shield className="h-4 w-4" />
              <AlertDescription>
                Master access: You can view and manage all QCity build files,
                sensitive data, and unlimited resources.
              </AlertDescription>
            </Alert>
      ...
      {!isMaster && (
        <Alert>
          <Shield className="h-4 w-4" />
          <AlertDescription>
            Master access required to view unlimited build files and sensitive
            data in QCity.
          </AlertDescription>
        </Alert>
      )}
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="secondary"
                      onClick={() => handleAction("gitpod", ws.id, "stop")}
                    >
                      Stop
                    </Button>
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => handleAction("gitpod", ws.id, "clone")}
                    >
                      Clone
                    </Button>
                    <Button
                      size="sm"
                      variant="default"
                      onClick={() => handleAction("gitpod", ws.id, "sync")}
                    >
                      Sync
                    </Button>
                    <Button
                      size="sm"
                      variant="ghost"
                      onClick={() => fetchLogs("gitpod", ws.id)}
                    >
                      Logs
                    </Button>
                  </div>
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="secondary"
                      onClick={() => handleAction("local", ws.id, "stop")}
                    >
                      Stop
                    </Button>
                    <Button
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            <Button
              ...
              variant="default"
              title="Run self-check and auto-fix for this runner/device"
            >
          ...
          <div className="flex items-center gap-4">
            <span title="Current runner version">
              Runner Version: {runnerVersion}
            </span>
            <span title="Last self-update timestamp">
              Last Self-Update: {lastSelfUpdate}
            </span>
          </div>
          <div>
            ...
            <div className="bg-muted p-2 rounded text-xs max-h-32 overflow-y-auto">
              {errorFixHistory.length === 0
                ? "No history yet."
                : errorFixHistory.map((h, i) => <div key={i}>{h}</div>)}
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      {isMaster && (
        <>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground">
                Elastic scaling uses only free/local/cloud resources by default.
                No paid runners unless explicitly enabled by master.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              >
                <input
                  type="text"
                  placeholder="Enter command or file to process"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                Last Enhancement: Auto-optimized runner config (2024-06-10 12:00
                UTC)
              </div>
              <Button
                variant="default"
              ...
              <div className="text-xs text-muted-foreground">
                All enhancements are logged and used to improve future
                automation. Only master can trigger or schedule enhancements.
              </div>
            </CardContent>
          </Card>
        </>
