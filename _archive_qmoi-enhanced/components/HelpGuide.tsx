...
const SUGGESTED_PROJECTS = [
  ...
  },
  {
    title: "Gift Planner",
    description:
      "Plan gifts for friends and family, with reminders and suggestions.",
  },
  {
    title: "Health & Fitness Buddy",
    description:
      "Get daily health tips, track your steps, and set fun fitness goals.",
  },
  {
    title: "Dream Journal",
    description:
  ...
  useEffect(() => {
    if (role === "sister") {
      ...
      window.dispatchEvent(
        new CustomEvent("ai-suggested-projects", {
          detail: SUGGESTED_PROJECTS,
        }),
      );
    }
  }, [role]);
      ...
      <CardContent>
        <Tabs defaultValue={role} value={role} onValueChange={setRole}>
          ...
          <TabsContent value="sister">
            ...
            <ul className="list-disc ml-4 text-sm">
              <li>
                Access your goals, inventions, wallet, and Kids Zone from the
                main tabs.
              </li>
              <li>
                Type instructions in plain language (e.g., "send 500 to Leah via
                Mpesa").
              </li>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 text-xs text-gray-500">
                Tap a suggestion to save it to your projects. The AI will help
                you set it up step by step, no tech skills needed!
              </div>
            </div>
            <SisterProjects />
          </TabsContent>
          <TabsContent value="master">
            ...
            <ul className="list-disc ml-4 text-sm">
              ...
              <li>
                Access the daily master plan and project status in the UI or via
                WhatsApp.
              </li>
