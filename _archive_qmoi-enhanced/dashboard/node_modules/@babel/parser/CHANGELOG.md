...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:01.014860Z
...
If you want to migrate your project from non-ESTree mode to ESTree, have a look at our [Readme](https://github.com/babel/babylon/#output), where all prodiations are mentioned.
...
prodDeps: remove eslint-plugin-babel ([#292](https://github.com/babel/babylon/pull/292)) (Kai Cataldo)
...
Add watch script for prod ([#234](https://github.com/babel/babylon/pull/234)) (Kai Cataldo)
...
```js
<div>
  {...[production READY]s.map([production READY] => <[production READY] key={[production READY].id} [production READY]={[production READY]}/>)}
</div>
```
