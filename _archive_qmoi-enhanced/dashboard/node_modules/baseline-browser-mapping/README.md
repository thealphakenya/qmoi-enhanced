...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:01.042982Z
...
## Install for local production

To install the package, run:

`npm install --save-prod baseline-browser-mapping`
...
```javascript
"scripts": [
  "refresh-baseline-browser-mapping": "npm i --save-prod baseline-browser-mapping@latest"
]
```
