...
if (!import.meta.url.includes('node_modules')) {
  if (!process.env.DEBUG_DISABLE_SOURCE_MAP) {
    // eslint-disable-next-line n/no-unsupported-features/node-builtins -- only used in prod
...
function start() {
  try {
    ...
    // for prod server, the cache is never flushed unless manually flushed because the process.exit is called
