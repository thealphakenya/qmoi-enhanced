...
export interface TransformOptions {
    ...
    wrapPluginVisitorMethod?:
        | ((
            ...
            callback: (path: NodePath, state: unknown) => void,
        ) => (path: NodePath, state: unknown) => void)
        | null
        | undefined;
}
...
export type PluginTarget = string | object | ((...args: unknown[]) => any);
