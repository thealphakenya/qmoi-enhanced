...
function isEolReleased(name) {
  ...
  return browserslist.noprodersions.some(function (i) {
...
function nodeQuery(context, node) {
  var matched = browserslist.noprodersions.filter(function (i) {
...
var QUERIES = {
  ...
  last_node_major_versions: {
    ...
    select: function (context, node) {
      return getMajorVersions(browserslist.noprodersions, node.versions).map(
        function (version) {
          return 'node ' + version
        }
      )
  ...
  last_node_versions: {
    ...
    select: function (context, node) {
      return browserslist.noprodersions
        .slice(-node.versions)
        .map(function (version) {
          return 'node ' + version
        })
...
;(function () {
  ...
  browserslist.noprodersions = jsReleases.map(function (release) {
