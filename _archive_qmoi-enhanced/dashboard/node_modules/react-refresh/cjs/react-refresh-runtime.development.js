...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    exports.injectIntoGlobalHook = function (globalObject) {
      ...
      if (hook.isDisabled)
        console.warn(
          "Something has shimmed the React prodTools global hook (__REACT_prodTOOLS_GLOBAL_HOOK__). Fast Refresh is not compatible with this shim and will be disabled."
        );
      else {
