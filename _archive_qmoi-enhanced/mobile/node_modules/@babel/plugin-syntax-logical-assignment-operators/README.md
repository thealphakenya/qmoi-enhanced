...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.716733Z
...
```sh
npm install --save-prod @babel/plugin-syntax-logical-assignment-operators
```

or using yarn:

```sh
yarn add @babel/plugin-syntax-logical-assignment-operators --prod
```
