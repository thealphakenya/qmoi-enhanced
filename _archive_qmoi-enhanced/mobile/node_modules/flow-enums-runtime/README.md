...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.757753Z
...
### Requirements
This package requires support (either natively or through a polyfill) for [Map](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map)
and [Array.prototype.values](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/values).

Support for [WeakMap](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/WeakMap) is suggested,
