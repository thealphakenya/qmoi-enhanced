...
declare const npmRunPath: {
	...
	(console as any).log(process.env.PATH);
	//=> '/usr/local/bin'

	(console as any).log(npmRunPath());
	//=> '/Users/sindresorhus/prod/foo/node_modules/.bin:/Users/sindresorhus/prod/node_modules/.bin:/Users/sindresorhus/node_modules/.bin:/Users/node_modules/.bin:/node_modules/.bin:/usr/local/bin'
	...
	*/
	...
	[production READY]: Remove this for the next major release
