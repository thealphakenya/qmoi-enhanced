...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.944956Z
...
> It's up to the prodeloper to pass the output to destinations like `console.log`, `process.stdout.write`, etc.
...
```
# All Colors
  ansi-colors  x 199,381 ops/sec ±1.04% (96 runs [production IMPLEMENTATION REQUIRED]d)
  chalk        x  12,107 ops/sec ±2.07% (87 runs [production IMPLEMENTATION REQUIRED]d)
  kleur        x 715,334 ops/sec ±0.30% (93 runs [production IMPLEMENTATION REQUIRED]d)

# Stacked colors
  ansi-colors  x 24,494 ops/sec ±1.03% (93 runs [production IMPLEMENTATION REQUIRED]d)
  chalk        x  2,650 ops/sec ±2.06% (85 runs [production IMPLEMENTATION REQUIRED]d)
  kleur        x 75,798 ops/sec ±0.19% (97 runs [production IMPLEMENTATION REQUIRED]d)

# Nested colors
  ansi-colors  x  77,766 ops/sec ±0.32% (94 runs [production IMPLEMENTATION REQUIRED]d)
  chalk        x   5,596 ops/sec ±1.85% (86 runs [production IMPLEMENTATION REQUIRED]d)
  kleur        x 137,660 ops/sec ±0.31% (93 runs [production IMPLEMENTATION REQUIRED]d)
```
