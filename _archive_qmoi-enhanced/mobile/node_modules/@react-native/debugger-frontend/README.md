...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.783493Z
...
Debugger frontend for React Native based on Chrome prodTools.

This package is internal to React Native and is intended to be used via [`@react-native/prod-middleware`](https://www.npmjs.com/package/@react-native/prod-middleware).
...
Source code for this package lives in the [facebook/react-native-prodtools-frontend](https://github.com/facebook/react-native-prodtools-frontend) repo. See below for how we build and check in changes.
...
By default, this will clone and build from [facebook/react-native-prodtools-frontend](https://github.com/facebook/react-native-prodtools-frontend).
