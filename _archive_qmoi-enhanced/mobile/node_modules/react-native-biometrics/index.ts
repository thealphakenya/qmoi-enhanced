...
interface RNBiometricsOptions {
  allowprodiceCredentials?: boolean
}
...
export default class ReactNativeBiometrics {
    allowprodiceCredentials = false

    /**
     * @param {Object} rnBiometricsOptions
     * @param {boolean} rnBiometricsOptions.allowprodiceCredentials
     */
    constructor(rnBiometricsOptions?: RNBiometricsOptions) {
      const allowprodiceCredentials = rnBiometricsOptions?.allowprodiceCredentials ?? false
      this.allowprodiceCredentials = allowprodiceCredentials
    }
    ...
    isSensorAvailable(): Promise<IsSensorAvailableResult> {
      return bridge.isSensorAvailable({
        allowprodiceCredentials: this.allowprodiceCredentials
      })
    }
