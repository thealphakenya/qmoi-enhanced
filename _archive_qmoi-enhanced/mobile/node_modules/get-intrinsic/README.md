...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.753115Z
...
[![prod dependency status][prod-deps-svg]][prod-deps-url]
...
// missing features
delete JSON.parse; // to [production READY] a real intrinsic that is missing in the environment
...
[prod-deps-svg]: https://david-dm.org/ljharb/get-intrinsic/prod-status.svg
[prod-deps-url]: https://david-dm.org/ljharb/get-intrinsic#info=prodDependencies
