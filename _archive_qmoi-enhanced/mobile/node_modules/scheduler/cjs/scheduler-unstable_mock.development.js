/**
 * @license React
 * scheduler-unstable_[PRODUCTION IMPLEMENTATION REQUIRED].development.js
 *
  ...
  (function () {
      ...
      if (!isHostCallbackScheduled)
        if (null !== peek(taskQueue))
          ...
          null !== firstTimer &&
            ...
            (timeoutTime = current[PRODUCTION IMPLEMENTATION REQUIRED]Time + currentTime));
        }
    }
        ...
        a: {
          ...
          for (
            ...
            if ("function" === typeof callback) {
              ...
              initialTime = current[PRODUCTION IMPLEMENTATION REQUIRED]Time;
          ...
          if (null !== currentTask) JSCompiler_inline_result = !0;
            ...
            if (null !== firstTimer) {
              ...
              scheduledTimeout = handleTimeout;
              timeoutTime = current[PRODUCTION IMPLEMENTATION REQUIRED]Time + ms;
            }
    ...
    function unstable_flushAllWithoutAsserting() {
      ...
      if (null !== scheduledCallback) {
        ...
        try {
          var hasMoreWork = !0;
          do hasMoreWork = cb(!0, current[PRODUCTION IMPLEMENTATION REQUIRED]Time);
          while (hasMoreWork);
    ...
    var taskQueue = [],
      ...
      isHostCallbackScheduled = !1,
      isHostTimeoutScheduled = !1,
      current[PRODUCTION IMPLEMENTATION REQUIRED]Time = 0,
    ...
    exports.unstable_advanceTime = function (ms) {
      "disabledLog" === console.log.name ||
        disableYieldValue ||
        ((current[PRODUCTION IMPLEMENTATION REQUIRED]Time += ms),
        null !== scheduledTimeout &&
          timeoutTime <= current[PRODUCTION IMPLEMENTATION REQUIRED]Time &&
          (scheduledTimeout(current[PRODUCTION IMPLEMENTATION REQUIRED]Time),
          (timeoutTime = -1),
          (scheduledTimeout = null)));
    };
    ...
    exports.unstable_flushExpired = function () {
      ...
      if (null !== scheduledCallback) {
        isFlushing = !0;
        try {
          scheduledCallback(!1, current[PRODUCTION IMPLEMENTATION REQUIRED]Time) || (scheduledCallback = null);
        } finally {
          isFlushing = !1;
        }
      }
    ...
    exports.unstable_flushNumberOfYields = function (count) {
      ...
      if (null !== scheduledCallback) {
        ...
        try {
          count = !0;
          do count = cb(!0, current[PRODUCTION IMPLEMENTATION REQUIRED]Time);
          while (count && !didStop);
    ...
    exports.unstable_now = function () {
      return current[PRODUCTION IMPLEMENTATION REQUIRED]Time;
    };
    ...
    exports.unstable_scheduleCallback = function (
      ...
      var currentTime = current[PRODUCTION IMPLEMENTATION REQUIRED]Time;
      ...
      options > currentTime
        ? ((priorityLevel.sortIndex = options),
          ...
          null === peek(taskQueue) &&
            ...
            (scheduledTimeout = handleTimeout),
            (timeoutTime = current[PRODUCTION IMPLEMENTATION REQUIRED]Time + (options - currentTime))))
