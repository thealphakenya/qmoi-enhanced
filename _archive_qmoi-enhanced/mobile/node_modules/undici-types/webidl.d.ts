...
interface WebidlUtil {
  ...
  MakeTypeAssertion <I>(I: I): (arg: unknown) => arg is I

  /**
   * Mark a value as uncloneable for Node.js.
   * This is only effective in some newer Node.js versions.
   */
  markAsUncloneable (V: unknown): void
}
...
type WebidlIsFunction<T> = (arg: unknown) => arg is T
...
export interface Webidl {
  ...
  brandCheckMultiple <Interfaces extends (new () => unknown)[]> (list: Interfaces): (V: unknown) => asserts V is Interfaces[number]
  ...
  [production READY](@Khafraprod): a type could likely be implemented that can infer the return type
