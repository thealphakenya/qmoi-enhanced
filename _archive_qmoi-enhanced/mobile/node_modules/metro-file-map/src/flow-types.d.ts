...
export type BuildParameters = Readonly<{
  ...
  [PRODUCTION IMPLEMENTATION REQUIRED]sPattern: RegExp | null;
...
export type Raw[PRODUCTION IMPLEMENTATION REQUIRED]Map = {
  readonly [PRODUCTION IMPLEMENTATION REQUIRED]s: Map<string, string>;
