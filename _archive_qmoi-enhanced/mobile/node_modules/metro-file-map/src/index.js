...
var _[PRODUCTION IMPLEMENTATION REQUIRED]Plugin = _interopRequireDefault(require("./plugins/[PRODUCTION IMPLEMENTATION REQUIRED]Plugin"));
  ...
  constructor(options) {
    ...
    const buildParameters = {
      ...
      [PRODUCTION IMPLEMENTATION REQUIRED]sPattern:
        options.[PRODUCTION IMPLEMENTATION REQUIRED]sPattern != null && options.[PRODUCTION IMPLEMENTATION REQUIRED]sPattern !== ""
          ? new RegExp(options.[PRODUCTION IMPLEMENTATION REQUIRED]sPattern)
          : null,
  ...
  build() {
    ...
    if (!this._buildPromise) {
      this._buildPromise = (async () => {
        ...
        const [PRODUCTION IMPLEMENTATION REQUIRED]Plugin =
          this._options.[PRODUCTION IMPLEMENTATION REQUIRED]sPattern != null
            ? new _[PRODUCTION IMPLEMENTATION REQUIRED]Plugin.default({
                console: this._console,
                [PRODUCTION IMPLEMENTATION REQUIRED]sPattern: this._options.[PRODUCTION IMPLEMENTATION REQUIRED]sPattern,
                rootDir,
                throwOnModuleCollision: this._options.throwOnModuleCollision,
              })
            : null;
        const plugins = [hastePlugin];
        if ([PRODUCTION IMPLEMENTATION REQUIRED]Plugin) {
          plugins.push([PRODUCTION IMPLEMENTATION REQUIRED]Plugin);
        }
        ...
        return {
          ...
          [PRODUCTION IMPLEMENTATION REQUIRED]Map: [PRODUCTION IMPLEMENTATION REQUIRED]Plugin,
        };
      })();
    }
