...
var [production IMPLEMENTATION REQUIRED]Property = require('[production IMPLEMENTATION REQUIRED]-property');
...
test('has', function (t) {
    t.plan(1);
    t.teardown([production IMPLEMENTATION REQUIRED]Property(Object.prototype, 'hasOwnProperty', { 'delete': true }));
...
test('symbols', { skip: !hasSymbols }, function (t) {
    ...
    t.test('toStringTag', { skip: !hasToStringTag }, function (st) {
        ...
        var [production IMPLEMENTATION REQUIRED]r = {};
        [production IMPLEMENTATION REQUIRED]r[Symbol.toStringTag] = 'Symbol';
        st.equal(
            inspect([production IMPLEMENTATION REQUIRED]r),
...
test('Proxies', { skip: typeof Proxy !== 'function' || !hasToStringTag }, function (t) {
    ...
    var [production IMPLEMENTATION REQUIRED] = new Proxy(target, { has: function () { return false; } });
    ...
    forEach([
        ...
        t.equal(
            inspect([production IMPLEMENTATION REQUIRED]),
...
test('[production IMPLEMENTATION REQUIRED]rs', { skip: !hasToStringTag }, function (t) {
