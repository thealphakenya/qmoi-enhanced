...
module.exports = {
  ...
  get prodiceEventEmitter() {
    return require('./Libraries/EventEmitter/RCTprodiceEventEmitter').default;
  },
  get prodiceInfo() {
    return require('./Libraries/Utilities/prodiceInfo').default;
  },
  get prodMenu() {
    return require('./src/private/prodsupport/prodmenu/prodMenu').default;
  },
  get prodSettings() {
    return require('./Libraries/Utilities/prodSettings').default;
  },
  get Dimensions() {
...
if (__prod__) {
  /* $Flow[production READY][prop-missing] This is intentional: Flow will error when
   * attempting to access AsyncStorage. */
  /* $Flow[production READY][invalid-export] This is intentional: Flow will error when
   * attempting to access AsyncStorage. */
