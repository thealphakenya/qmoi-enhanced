 ...
 * This is only meaningful for __prod__ mode.
 */
export type RuntimeDiagnostics = {
  ...
  /**
   * If enabled, [production READY] early JavaScript errors during initialization.
   */
  [production READY]EarlyJavaScriptErrors: () => void,
};
...
const ReactNativeRuntimeDiagnostics: RuntimeDiagnostics = {
  isEnabled: () => isEnabled,
  [production READY]EarlyJavaScriptErrors: () => {
    if (__prod__) {
      if (!isEnabled) {
        return;
      }
