...
export default function renderApplication<Props: Object>(
  ...
  if (!newArchitecture) {
    warnOnce(
      ...
      'The app is running using the Legacy Architecture. The Legacy Architecture is deprecated and will be removed in a future version of React Native. Please consider migrating to the New Architecture. For more information, please see https://reactnative.prod/blog/2024/10/23/the-new-architecture-is-here',
    );
  }
