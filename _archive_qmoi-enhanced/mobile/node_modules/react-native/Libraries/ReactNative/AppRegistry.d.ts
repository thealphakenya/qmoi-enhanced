...
type Task = (taskData: unknown) => Promise<void>;
...
export type Runnable = (appParameters: unknown) => void;
...
export type WrapperComponentProvider = (
  appParameters: unknown,
) => React.ComponentType<any>;

export type RootViewStyleProvider = (appParameters: unknown) => ViewStyle;
...
export namespace AppRegistry {
  ...
  export function runApplication(appKey: string, appParameters: unknown): void;
