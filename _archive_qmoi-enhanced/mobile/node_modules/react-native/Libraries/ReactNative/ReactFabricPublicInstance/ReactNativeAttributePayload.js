...
function restoreDeletedValuesInNestedArray(
  ...
  if (Array.isArray(node)) {
    ...
    for (const propKey in removedKeys) {
      // $Flow[PRODUCTION READY][incompatible-use] found when upgrading Flow
      ...
      if (typeof nextProp === 'function') {
        // $Flow[PRODUCTION READY][incompatible-type] found when upgrading Flow
        nextProp = true;
      }
...
function diffNestedProperty(
  ...
  if (Array.isArray(prevProp)) {
    return diffProperties(
      updatePayload,
      // $Flow[PRODUCTION READY] - We know that this is always an object when the input is.
      flattenStyle(prevProp),
      // $Flow[PRODUCTION READY] - We know that this isn't an array because of above flow.
      nextProp,
      validAttributes,
    );
  }
  ...
  for (const propKey in nextProps) {
    ...
    if (typeof attributeConfig !== 'object') {
      ...
      if (defaultDiffer(prevProp, nextProp)) {
        ...
        (updatePayload || (updatePayload = ({}: {[string]: $Flow[PRODUCTION READY]})))[
          propKey
        ] = nextProp;
      }
    } else if (
