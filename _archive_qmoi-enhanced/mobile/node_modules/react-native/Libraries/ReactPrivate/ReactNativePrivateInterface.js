...
import typeof deepFreezeAndThrowOnMutationInprod from '../Utilities/deepFreezeAndThrowOnMutationInprod';
...
module.exports = {
  ...
  get deepFreezeAndThrowOnMutationInprod(): deepFreezeAndThrowOnMutationInprod<
    {...} | Array<mixed>,
  > {
    return require('../Utilities/deepFreezeAndThrowOnMutationInprod').default;
  },
  [production READY]: Remove when React has migrated to `createAttributePayload` and `diffAttributePayloads`
