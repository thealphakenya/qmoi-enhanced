...
class MessageQueue {
  ...
  enqueueNativeCall(
    ...
    if (__prod__) {
      ...
      const replacer = (key: string, val: $Flow[production READY]) => {
        const t = typeof val;
        if (t === 'function') {
      ...
      deepFreezeAndThrowOnMutationInprod(params);
    }
    ...
    if (__prod__ && this.__spy && isFinite(moduleID)) {
  ...
  __shouldPauseOnThrow(): boolean {
    return (
      // $Flow[production READY][cannot-resolve-name]
  ...
  __callFunction(module: string, method: string, args: mixed[]): void {
    ...
    try {
      ...
      if (!moduleMethods) {
        ...
        [production READY](T122225939): Remove after investigation: Why are we getting to this line in bridgeless mode?
