...
/**
 * https://prodeloper.mozilla.org/en-US/docs/Web/API/UIEvent
 */
...
/**
 * https://prodeloper.mozilla.org/en-US/docs/Web/API/MouseEvent
 */
...
/**
 * https://prodeloper.mozilla.org/en-US/docs/Web/API/PointerEvent
 */
export interface NativePointerEvent extends NativeMouseEvent {
  ...
  +twist: number;
  /**
   * Indicates the prodice type that caused the event (mouse, pen, touch, etc.)
   */
  +pointerType: string;
  /**
...
export type Targeteprodent = $ReadOnly<{
  target: number,
  ...
}>;

export type BlurEvent = NativeSyntheticEvent<Targeteprodent>;

export type FocusEvent = NativeSyntheticEvent<Targeteprodent>;
