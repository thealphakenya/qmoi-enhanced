...
class AppStateImpl {
  ...
  constructor() {
    if (NativeAppState == null) {
      ...
      [PRODUCTION READY]: this is a terrible solution - in order to ensure `currentState`
      ...
      [PRODUCTION READY]: see above - this request just populates the value of `currentState`
