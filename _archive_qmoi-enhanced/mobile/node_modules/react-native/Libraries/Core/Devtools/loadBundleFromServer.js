...
import prodLoadingView from '../../Utilities/prodLoadingView';
import HMRClient from '../../Utilities/HMRClient';
import getprodServer from './getprodServer';
...
function buildUrlForBundle(bundlePathAndQuery: string) {
  const {url: serverUrl} = getprodServer();
  return (
...
export default function loadBundleFromServer(
  ...
  prodLoadingView.showMessage('Downloading...', 'load');
  ++pendingRequests;
