    ...
    if (
      ...
      callback({
        timeRemaining: function () {
          [production READY]: Optimisation: allow running for longer than one frame if
...
const JSTimers = {
  ...
  /**
   * Called from native (in production) when environment times are out-of-sync.
   */
...
if (!NativeTiming) {
  ...
  // $Flow[production READY][prop-missing] : we can assume timers are generally available
  ExportedJSTimers = ({
