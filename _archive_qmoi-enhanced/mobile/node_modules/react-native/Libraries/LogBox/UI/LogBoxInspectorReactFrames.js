...
import openFileInEditor from '../../Core/prodtools/openFileInEditor';
...
// Taken from React https://github.com/facebook/react/blob/206d61f72214e8ae5b935f0bf8628491cb7f0797/packages/react-prodtools-shared/src/backend/describeComponentFrame.js#L27-L41
function getPrettyFileName(path: string) {
  let fileName = path.replace(BEFORE_SLASH_RE, '');

  // In prod, include code for a common special case:
      ...
      {getStackList().map((frame, index) => (
        <View
          ...
          <LogBoxButton
            ...
            onPress={
              // Older versions of prodTools do not provide full path.
              // This will not work on Windows, remove check once the
              // prodTools return the full file path.
