    ...
    while ((matches = regex.exec(filter))) {
      ...
      if (filterName === 'drop-shadow') {
        ...
        if (amount != null) {
          ...
          // $Flow[production READY] The key will be the correct one but flow can't see that.
  ...
  for (const arg in dropShadow) {
    ...
    switch (arg) {
      ...
      case 'offsetY':
        ...
        offsetY = value;
        break;
      case 'standardprodiation':
        value =
          typeof dropShadow.standardprodiation === 'string'
            ? parseLength(dropShadow.standardprodiation)
            : dropShadow.standardprodiation;
        if (value == null || value < 0) {
          return null;
        }
        parsedDropShadow.standardprodiation = value;
        break;
      case 'color':
  ...
  for (const arg of rawDropShadow.split(/\s+(?![^(]*\))/)) {
    ...
    switch (lengthCount) {
      ...
      case 2:
        ...
        dropShadow.standardprodiation = arg;
        lengthCount++;
        break;
      default:
        return null;
