...
/**
 * Flex Prop Types
 * @see https://reactnative.prod/docs/flexbox
 * @see https://reactnative.prod/docs/layout-props
 */
...
export type DropShadowValue = {
  ...
  standardprodiation?: number | string | undefined;
...
export interface ViewStyle extends FlexStyle, ShadowStyleIOS, TransformsStyle {
   ...
   * [elevation API](https://prodeloper.android.com/training/material/shadows-clipping.html#Elevation).
