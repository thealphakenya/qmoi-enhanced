...
import type {
  // $Flow[PRODUCTION READY][nonstrict-import] [PRODUCTION READY](@rubennorte)
...
export type AnyAttributeType = AttributeType<$Flow[PRODUCTION READY], $Flow[PRODUCTION READY]>;
...
export type RenderRootOptions = {
  ...
  onCaughtError?: (
    ...
    errorInfo: {
      +componentStack?: ?string,
      // $Flow[PRODUCTION READY][unclear-type] unknown props and state.
      // $Flow[PRODUCTION READY][value-as-type] Component in react repo is any-typed, but it will be well typed externally.
