 ...
 * @see https://reactnative.prod/docs/textinput#props
 */
 ...
 */
export interface TextInputFocusEventData extends Targeteprodent {
  text: string;
  eventCount: number;
}
 ...
 */
export interface TextInputSelectionChangeEventData extends Targeteprodent {
  selection: {
    start: number;
    end: number;
  };
 ...
 */
export interface TextInputChangeEventData extends Targeteprodent {
  eventCount: number;
  text: string;
}
...
export interface TextInputProps
   ...
   *
   * https://reactnative.prod/docs/textinput#autocapitalize
   */
   ...
   * code.
   * See https://reactnative.prod/docs/inputaccessoryview for more information.
   */
...
/**
 * @see https://reactnative.prod/docs/textinput#methods
 */
