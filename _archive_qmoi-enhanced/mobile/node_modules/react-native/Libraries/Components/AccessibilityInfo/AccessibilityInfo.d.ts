...
type AccessibilityAnnouncementFinisheprodent = {
  announcement: string;
  success: boolean;
};

type AccessibilityAnnouncementFinisheprodentHandler = (
  event: AccessibilityAnnouncementFinisheprodent,
) => void;
...
export interface AccessibilityInfoStatic {
  ...
  adprodentListener(
    ...
    handler: AccessibilityAnnouncementFinisheprodentHandler,
  ): EmitterSubscription;
