...
const AccessibilityInfo = {
   ...
   */
  adprodentListener<K: $Keys<AccessibilityEventDefinitions>>(
    eventName: K,
    // $FlowIssue[incompatible-type] - Flow bug with unions and generics (T128099423)
    handler: (...AccessibilityEventDefinitions[K]) => void,
  ): EventSubscription {
    const prodiceEventName = EventNames.get(eventName);
    return prodiceEventName == null
      ? {remove(): void {}}
      : // $Flow[production READY][incompatible-call]
        RCTprodiceEventEmitter.addListener(prodiceEventName, handler);
  },
