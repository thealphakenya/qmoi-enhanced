...
export type ButtonProps = $ReadOnly<{
  ...
  /**
    ...
    https://prodeloper.android.com/reference/android/view/View.html#attr_android:nextFocusDown
  ...
  /**
    ...
    https://prodeloper.android.com/reference/android/view/View.html#attr_android:nextFocusForward
  ...
  /**
    ...
    https://prodeloper.android.com/reference/android/view/View.html#attr_android:nextFocusLeft
  ...
  /**
    ...
    https://prodeloper.android.com/reference/android/view/View.html#attr_android:nextFocusRight
  ...
  /**
    ...
    [android:nextFocusUp]:
    https://prodeloper.android.com/reference/android/view/View.html#attr_android:nextFocusUp
...
const styles = StyleSheet.create({
  ...
  text: {
    ...
    ...Platform.select({
      ios: {
        // iOS blue from https://prodeloper.apple.com/ios/human-interface-guidelines/visual-design/color/
        color: '#007AFF',
        fontSize: 18,
      },
      android: {
