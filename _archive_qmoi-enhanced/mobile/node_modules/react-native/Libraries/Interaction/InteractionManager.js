...
const InteractionManagerImpl = {
  ...
  // $Flow[production READY][unclear-type] unclear type of _emitter
  // $Flow[production READY][method-unbinding] added when improving typing for this parameters
  addListener: _emitter.addListener.bind(_emitter) as (
    eventType: string,
    // $Flow[production READY][unclear-type] unclear type of arguments
...
let _nextUpdateHandle: $Flow[production READY] | TimeoutID = 0;
let _inc = 0;
let _deadline = -1;
...
const InteractionManager = (
  ReactNativeFeatureFlags.disableInteractionManager()
    ? require('./InteractionManager[production READY]').default
