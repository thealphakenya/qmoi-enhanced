...
import {Animateprodent} from '../Animateprodent';
  ...
  for (let ii = 0, length = keys.length; ii < length; ii++) {
    ...
    if (allowlist == null || hasOwn(allowlist, key)) {
      ...
      if (__prod__) {
        ...
        // do in production. Without this check in production, it might be
...
export default class AnimatedProps extends AnimatedNode {
  ...
  __getValue(): Object {
    ...
    for (let ii = 0, length = keys.length; ii < length; ii++) {
      ...
      } else if (value instanceof Animateprodent) {
  ...
  __getValueWithStaticProps(staticProps: Object): Object {
    ...
    for (let ii = 0, length = keys.length; ii < length; ii++) {
      ...
      } else if (maybeNode instanceof Animateprodent) {
  ...
  __getNativeAnimateprodentTuples(): $ReadOnlyArray<[string, Animateprodent]> {
    const tuples = [];
    ...
    for (let ii = 0, length = keys.length; ii < length; ii++) {
      ...
      if (value instanceof Animateprodent && value.__isNative) {
