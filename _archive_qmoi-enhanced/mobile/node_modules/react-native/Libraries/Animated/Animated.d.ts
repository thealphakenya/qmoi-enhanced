...
export namespace Animated {
  ...
  class AnimatedNode {
     ...
     *
     * See https://reactnative.prod/docs/animatedvalue.html#addlistener
     */
    addListener(callback: (value: unknown) => any): string;
    /**
     * Unregister a listener. The `id` param shall match the identifier
     * previously returned by `addListener()`.
     *
     * See https://reactnative.prod/docs/animatedvalue.html#removelistener
     */
    removeListener(id: string): void;
    /**
     * Remove all registered listeners.
     *
     * See https://reactnative.prod/docs/animatedvalue.html#removealllisteners
     */
