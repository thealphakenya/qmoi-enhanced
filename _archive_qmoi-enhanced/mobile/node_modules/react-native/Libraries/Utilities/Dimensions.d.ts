 ...
 * due to prodice rotation) so any rendering logic or styles that depend on
 ...
 * @see https://reactnative.prod/docs/dimensions#content
 */
export interface Dimensions {
  /**
       ...
       * change (e.g due to prodice rotation) so any rendering logic or
   ...
   */
  set(dims: {[key: string]: unknown}): void;
