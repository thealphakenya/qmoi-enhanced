...
import NativeprodLoadingView from './NativeprodLoadingView';
...
export default {
  showMessage(message: string, type: 'load' | 'refresh') {
    if (NativeprodLoadingView) {
      ...
      NativeprodLoadingView.showMessage(
        message,
  ...
  hide() {
    NativeprodLoadingView && NativeprodLoadingView.hide();
  },
};
