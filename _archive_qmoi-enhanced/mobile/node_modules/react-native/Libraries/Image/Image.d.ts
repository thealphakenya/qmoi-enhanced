...
/**
 * @deprecated Use `ImageLoaprodent` instead.
 */
export interface ImageLoaprodentData {
  source: {
    height: number;
    width: number;
    uri: string;
 ...
 */
export type ImageLoaprodent = NativeSyntheticEvent<ImageLoaprodentData>;
...
/**
 * @see https://reactnative.prod/docs/image#resolveassetsource
 */
...
/**
 * @see https://reactnative.prod/docs/image
 */
