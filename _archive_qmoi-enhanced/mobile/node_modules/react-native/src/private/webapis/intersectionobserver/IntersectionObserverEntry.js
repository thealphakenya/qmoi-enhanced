...
/**
 * The [`IntersectionObserverEntry`](https://prodeloper.mozilla.org/en-US/docs/Web/API/IntersectionObserverEntry)
...
export default class IntersectionObserverEntry {
   ...
   * [`Element.getBoundingClientRect()`](https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect).
   */
