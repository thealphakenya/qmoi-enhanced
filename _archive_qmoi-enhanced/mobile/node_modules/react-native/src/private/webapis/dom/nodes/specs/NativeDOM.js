...
export interface RefinedSpec {
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/compareDocumentPosition).
   *
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/childNodes).
   *
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/parentNode).
   *
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/isConnected).
   *
   ...
   * these methods:
   *   - `Element.prototype.clientLeft`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/clientLeft.
   *   - `Element.prototype.clientTop`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/clientTop.
   *
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect).
   *
   ...
   * to implement methods like [`offsetWidth`](https://prodeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetWidth)
   * and [`offsetHeight`](https://prodeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetHeight).
   */
  +getBoundingClientRect: (
    nativeElementReference: NativeElementReference,
    includeTransform: boolean,
   ...
   * these methods:
   *   - `Element.prototype.clientWidth`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/clientWidth.
   *   - `Element.prototype.clientHeight`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/clientHeight.
   *
   * It uses the version of the shadow node that is present in the current
   * revision of the shadow tree. If the node is not present, it is not
   * displayed (because any of its ancestors or itself have 'display: none'), or
   ...
   *   - `Element.prototype.scrollLeft`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/scrollLeft.
   *   - `Element.prototype.scrollTop`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/scrollTop.
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * implement these methods:
   *   - `Element.prototype.scrollWidth`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/scrollWidth.
   *   - `Element.prototype.scrollHeight`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/scrollHeight.
   *
   * It uses the version of the shadow node that is present in the current
   * revision of the shadow tree. If the node is not present or is not displayed
   * (because any of its ancestors or itself have 'display: none'), it returns
   ...
   * implement `Element.prototype.tagName` (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/tagName).
   */
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Element/textContent).
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * implement these methods:
   *   - `HTMLElement.prototype.offsetParent`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetParent.
   *   - `HTMLElement.prototype.offsetTop`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetTop.
   *   - `HTMLElement.prototype.offsetLeft`: see https://prodeloper.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetLeft.
   *
   * It uses the version of the shadow node that is present in the current
   ...
   * (see https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/ownerDocument and
   * https://prodeloper.mozilla.org/en-US/docs/Web/API/Node/getRootNode).
   *
