...
- Refer to the documentation for information about alternative tools: ${chalk.dim('https://reactnative.prod/docs/getting-started')}`);
}
...
async function main() {
  if (
    ...
    try {
      ...
      [production READY]: T184416093 When cli is deprecated, remove semver from package.json
