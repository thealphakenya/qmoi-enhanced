...
function getInputFiles(appPath, appPkgJSon) {
  ...
  const findCommand = `find ${path.join(appPath, jsSrcsDir)} -type f -not -path "*/__[production IMPLEMENTATION REQUIRED]s__/*" -and \\( ${jsFiles} -or ${tsFiles} \\)`;
