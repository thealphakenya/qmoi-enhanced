...
# Enables iOS prodices to get the IP address of the machine running Metro
...
case "$CONFIGURATION" in
  *Debug*)
    if [[ "$PLATFORM_NAME" == *simulator ]]; then
      ...
      echo "Bundling for physical prodice. Use the SKIP_BUNDLING flag to change this behavior."
    fi
...
if [[ $USE_HERMES != false && $prod == false ]]; then
...
if [[ $prod != true && ! -f "$BUNDLE_FILE" ]]; then
