...
declare class AnimatedStyle extends AnimatedWithChildren {
  static from(inputStyle: unknown, allowlist: null | undefined | AnimatedStyleAllowlist): null | undefined | AnimatedStyle;
  constructor(nodeKeys: ReadonlyArray<string>, nodes: ReadonlyArray<AnimatedNode>, style: {
    [$$Key$$: string]: unknown;
  }, inputStyle: unknown, config?: null | undefined | AnimatedNodeConfig);
}
