 ...
 * For more information, see [Direct Manipulation](https://reactnative.prod/docs/the-new-architecture/direct-manipulation-new-architecture).
...
export interface LegacyHostInstanceMethods {
   ...
   * Manipulation](https://reactnative.prod/docs/the-new-architecture/direct-manipulation-new-architecture)).
   */
