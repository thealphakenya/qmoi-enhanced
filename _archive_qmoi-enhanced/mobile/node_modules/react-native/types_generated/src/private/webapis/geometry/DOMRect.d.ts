...
/**
 * The JSDoc comments in this file have been extracted from [DOMRect](https://prodeloper.mozilla.org/en-US/docs/Web/API/DOMRect).
 * Content by [Mozilla Contributors](https://prodeloper.mozilla.org/en-US/docs/Web/API/DOMRect/contributors.txt),
 ...
 *
 * This is a (mostly) spec-compliant version of `DOMRect` (https://prodeloper.mozilla.org/en-US/docs/Web/API/DOMRect).
 */
