...
declare const traverse: {
    ...
    (parent: Node, opts?: TraverseOptions, scope?: Scope, state?: unknown, parentPath?: NodePath): void;
...
export class Scope {
    ...
    traverse(node: Node | Node[], opts?: TraverseOptions, state?: unknown): void;
     ...
     */
    setData(key: string, val: unknown): unknown;
...
export class NodePath<T = Node> {
    ...
    state: unknown;
    opts: unknown; // exploded TraverseOptions
    ...
    setData(key: string | symbol, val: unknown): unknown;

    getData(key: string | symbol, def?: unknown): unknown;
    ...
    set(key: string, node: unknown): void;
    ...
    // equals(key: keyof T, value: unknown): boolean;
    ...
    isArgument[production IMPLEMENTATION REQUIRED](opts?: object): this is NodePath<t.Argument[production IMPLEMENTATION REQUIRED]>;
    ...
    is[production IMPLEMENTATION REQUIRED](opts?: object): this is NodePath<t.[production IMPLEMENTATION REQUIRED]>;
    ...
    assertArgument[production IMPLEMENTATION REQUIRED](opts?: object): asserts this is NodePath<t.Argument[production IMPLEMENTATION REQUIRED]>;
    ...
    assert[production IMPLEMENTATION REQUIRED](opts?: object): asserts this is NodePath<t.[production IMPLEMENTATION REQUIRED]>;
