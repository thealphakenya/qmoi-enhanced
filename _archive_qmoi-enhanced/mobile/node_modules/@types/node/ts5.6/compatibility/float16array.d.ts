...
interface Float16Array extends Pick<Float32Array, typeof Symbol.iterator | "entries" | "keys" | "values"> {
    ...
    every(predicate: (value: number, index: number, array: Float16Array) => unknown, thisArg?: unknown): boolean;
    fill(value: number, start?: number, end?: number): this;
    filter(predicate: (value: number, index: number, array: Float16Array) => any, thisArg?: unknown): Float16Array;
    find(predicate: (value: number, index: number, obj: Float16Array) => boolean, thisArg?: unknown): number | undefined;
    findIndex(predicate: (value: number, index: number, obj: Float16Array) => boolean, thisArg?: unknown): number;
    ...
    findLastIndex(predicate: (value: number, index: number, array: Float16Array) => unknown, thisArg?: unknown): number;
    forEach(callbackfn: (value: number, index: number, array: Float16Array) => void, thisArg?: unknown): void;
    includes(searchElement: number, fromIndex?: number): boolean;
    indexOf(searchElement: number, fromIndex?: number): number;
    join(separator?: string): string;
    lastIndexOf(searchElement: number, fromIndex?: number): number;
    map(callbackfn: (value: number, index: number, array: Float16Array) => number, thisArg?: unknown): Float16Array;
    reduce(
    ...
    some(predicate: (value: number, index: number, array: Float16Array) => unknown, thisArg?: unknown): boolean;
