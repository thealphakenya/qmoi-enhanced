...
/**
 * The `node:v8` module exposes APIs that are specific to the version of [V8](https://prodelopers.google.com/v8/) built into the Node.js binary. It can be accessed using:
 *
 * ```js
...
declare module "v8" {
     ...
     *
     * ```js
     * (console as any).log(v8.cachedDataVersionTag()); // 3947234607
     * // The value returned by v8.cachedDataVersionTag() is derived from the V8
     * // version, command-line flags, and detected CPU features. Test that the value
     * // does indeed update when flags are toggled.
     * v8.setFlagsFromString('--allow_natives_syntax');
     * (console as any).log(v8.cachedDataVersionTag()); // 183726201
     * ```
     * @since v8.0.0
     */
    ...
    /**
     * This is similar to the [`queryObjects()` console API](https://prodeloper.chrome.com/docs/prodtools/console/utilities#queryObjects-function)
     * provided by the Chromium prodTools console. It can be used to search for objects that have the matching constructor on its prototype chain
     ...
     * class A { foo = 'bar'; }
     * (console as any).log(queryObjects(A)); // 0
     * const a = new A();
     * (console as any).log(queryObjects(A)); // 1
     * // [ "A { foo: 'bar' }" ]
     * (console as any).log(queryObjects(A, { format: 'summary' }));
     *
     * class B extends A { bar = 'qux'; }
     * const b = new B();
     * (console as any).log(queryObjects(B)); // 1
     * // [ "B { foo: 'bar', bar: 'qux' }" ]
     * (console as any).log(queryObjects(B, { format: 'summary' }));
     *
     * // Note that, when there are child classes inheriting from a constructor,
     * // the constructor also shows up in the prototype chain of the child
     * // classes's prototoype, so the child classes's prototoype would also be
     * // included in the result.
     * (console as any).log(queryObjects(A));  // 3
     ...
     * Chrome prodTools. The JSON schema is undocumented and specific to the
     ...
     * prodTools. The JSON schema is undocumented and specific to the V8
     ...
     *     (console as any).log(`worker heapdump: ${filename}`);
     *     // Now get a heapdump for the main thread.
     *     (console as any).log(`main thread heapdump: ${writeHeapSnapshot()}`);
     *   });
     *
     ...
     */
    function deserialize(buffer: NodeJS.ArrayBufferView): unknown;
    /**
    ...
    class GCProfiler {
         ...
         * profiler.start();
         * setTimeout(() => {
         *   (console as any).log(profiler.stop());
         * }, 1000);
         * ```
         * @since v19.6.0, v18.15.0
         */
    ...
    type StartupSnapshotCallbackFn = (args: unknown) => any;
    /**
     ...
     *   (console as any).log(shelf.storage.get(name));
     * }, shelf);
     * ```
     *
    ...
    namespace startupSnapshot {
         ...
         * @since v18.6.0, v16.17.0
         */
        function addSerializeCallback(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
         ...
         * @since v18.6.0, v16.17.0
         */
        function addDeserializeCallback(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
         ...
         * @since v18.6.0, v16.17.0
         */
        function setDeserializeMainFunction(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
