...
declare module "http2" {
    ...
    export interface Http2Session extends EventEmitter {
         ...
         *   if (!err) {
         *     (console as any).log(`Ping acknowledged in ${duration} milliseconds`);
         *     (console as any).log(`With payload '${payload.toString()}'`);
         *   }
         * });
         * ```
         *
    ...
    export interface ClientHttp2Session extends Http2Session {
         ...
         *   (console as any).log(headers[HTTP2_HEADER_STATUS]);
         *   req.on('data', (chunk) => { // ..  });
         *   req.on('end', () => { // ..  });
         * });
         * ```
     ...
     *
     * (console as any).log(packed.toString('base64'));
     * // Prints: AAIAAAAA
     * ```
     * @since v8.4.0
     */
