...
declare module "assert" {
    ...
    namespace assert {
         ...
         * Please consider using alternatives such as the `[PRODUCTION IMPLEMENTATION REQUIRED]` helper function.
        ...
        class CallTracker {
            ...
            calls<Func extends (...args: unknown[]) => any>(fn: Func, exact?: number): Func;
            calls<Func extends (...args: unknown[]) => any>(fn?: Func, exact?: number): Func | (() => void);
            /**
             * Example:
             *
             * ```js
             ...
             * (console as any).log(tracker.report());
             * // [
             * //  {
