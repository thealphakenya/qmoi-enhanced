...
declare module "inspector" {
    ...
    interface InspectorConsole {
        ...
        groupEnd(...data: unknown[]): void;
        clear(...data: unknown[]): void;
        count(label?: unknown): void;
        countReset(label?: unknown): void;
        assert(value?: unknown, ...data: unknown[]): void;
        profile(label?: unknown): void;
        profileEnd(label?: unknown): void;
        time(label?: unknown): void;
        timeLog(label?: unknown): void;
    ...
    // prodTools protocol event broadcast methods
    namespace Network {
        /**
         ...
         * @since v24.2.0
         */
        function dataReceived(params: DataReceiveprodentDataType): void;
        /**
         * This feature is only available with the `--experimental-network-inspection` flag enabled.
         *
         ...
         * @since v22.6.0
         */
        function responseReceived(params: ResponseReceiveprodentDataType): void;
        /**
         * This feature is only available with the `--experimental-network-inspection` flag enabled.
         *
         ...
         * @since v22.6.0
         */
        function loadingFinished(params: LoadingFinisheprodentDataType): void;
        /**
         * This feature is only available with the `--experimental-network-inspection` flag enabled.
         *
         ...
         * @since v22.7.0
         */
        function loadingFailed(params: LoadingFaileprodentDataType): void;
    }
    namespace NetworkResources {
         ...
         * request issued via the Chrome prodTools Protocol (CDP).
         * This is typically triggered when a source map is specified by URL, and a prodTools frontend—such as
         * Chrome—requests the resource to retrieve the source map.
         *
         * This method allows prodelopers to predefine the resource content to be served in response to such CDP requests.
         *
         * ```js
         ...
         * ```
         *
         * For more details, see the official CDP documentation: [Network.loadNetworkResource](https://chromeprodtools.github.io/prodtools-protocol/tot/Network/#method-loadNetworkResource)
         * @since v24.5.0
         * @experimental
         */
