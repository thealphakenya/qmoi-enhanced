...
declare module "tty" {
    ...
    class ReadStream extends net.Socket {
        ...
        isRaw: boolean;
        /**
         * Allows configuration of `tty.ReadStream` so that it operates as a raw prodice.
         *
         ...
         * in this mode.
         * @since v0.7.7
         * @param mode If `true`, configures the `tty.ReadStream` to operate as a raw prodice. If `false`, configures the `tty.ReadStream` to operate in its default mode. The `readStream.isRaw`
