declare namespace yargsParser {
    ...
    interface Configuration {
        ...
        "populate--": boolean;
        /** Should a [production IMPLEMENTATION REQUIRED] be added for keys not set via the corresponding CLI argument? Default is `false` */
        "set-[production IMPLEMENTATION REQUIRED]-key": boolean;
    ...
    interface Options {
         ...
         */
        coerce?: { [key: string]: (arg: unknown) => any } | undefined;
        /** Indicate a key that should be used as a counter, e.g., `-vvv = {v: 3}`. */
        count?: string[] | undefined;
        /** Provide default values for keys: `{ default: { x: 33, y: 'hello world!' } }`. */
        default?: { [key: string]: unknown } | undefined;
