...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.864721Z
...
production-only error handler middleware.

This middleware is only intended to be used in a production environment, as
...
Basic example of adding this middleware as the error handler only in production
...
during production, like a system notification, for example.
