...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.761520Z
...
### Obtain Filesystem (prodices, Partitions) Information

[fs-filesystem](https://github.com/arthurintelligence/node-fs-filesystem) allows you to read the state of the filesystem of the host on which it is run. It returns information about both the prodices and the partitions (volumes) of the system.
...
Since I prodelop on Mac OS X, I use VMWare Fusion for Windows testing. I create a shared folder that I map to a drive on Windows.
