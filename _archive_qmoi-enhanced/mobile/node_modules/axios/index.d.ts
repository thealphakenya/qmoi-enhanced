...
export interface AxiosResponseTransformer {
  (this: InternalAxiosRequestConfig, data: unknown, headers: AxiosResponseHeaders, status?: number): unknown;
}
...
export interface GenericAbortSignal {
  ...
  onabort?: ((...args: unknown) => any) | null;
  adprodentListener?: (...args: unknown) => any;
  removeEventListener?: (...args: unknown) => any;
}
...
export interface ParamEncoder {
  (value: unknown, defaultEncoder: (value: unknown) => any): unknown;
}
...
export interface AxiosRequestConfig<D = any> {
  ...
  env?: {
    FormData?: new (...args: unknown[]) => object;
  ...
  parseReviver?: (this: unknown, key: string, value: unknown) => any;
...
type AxiosRequestInterceptorUse<T> = (onFulfilled?: ((value: T) => T | Promise<T>) | null, onRejected?: ((error: unknown) => any) | null, options?: AxiosInterceptorOptions) => number;

type AxiosResponseInterceptorUse<T> = (onFulfilled?: ((value: T) => T | Promise<T>) | null, onRejected?: ((error: unknown) => any) | null) => number;
...
export function isCancel<T = any>(value: unknown): value is CanceledError<T>;
