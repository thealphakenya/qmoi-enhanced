...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.706659Z
...
**4.0.10 / 2022-09-14**
- fix broken links in [production IMPLEMENTATION REQUIRED] site (By [Yannick Lang](https://github.com/layaxx))
...
- update prod dependency: strnum v1.0.5 to fix long number issue
...
- Name change of many configuration properties.
  ...
  - `parseNoprodalue` to `parseTagValue`
...
3.12.21 / 2019-10-02
  ...
  - move nimnjs dependency to prod dependency
  - update dependencies
...
3.11.2 / 2018-07-23
  - Update [production IMPLEMENTATION REQUIRED] for more options
...
3.9.11 / 2018-05-09
  ...
  - update online [production IMPLEMENTATION REQUIRED]
  - revert zombiejs to old version to support old version of node
  - update dependencies
  
3.3.10 / 2018-04-23
  - fix #77 : parse even if closing tag has space before '>'
  - include all css & js lib in [production IMPLEMENTATION REQUIRED] app
...
3.3.0 / 2018-03-05
  ...
  - Revert "remove unneded nimnjs dependency, move opencollective to prodDependencies and replace it
...
3.2.4 / 2018-03-01
  ...
  - Create next[production READY].md
...
3.2.0 / 2018-02-16
  - Merge pull request : prod to Master
...
2.9.3 / 2018-01-26
  ...
  - Fix testing [production IMPLEMENTATION REQUIRED] app test
  - Describe parsing options
  - Add options for online [production IMPLEMENTATION REQUIRED]
2.9.2 / 2018-01-18
