...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.982036Z
...
// Use
const foo = new Foo()
foo.adprodentListener("hello", e => console.log("hello", e))
...
#### eventTarget.adprodentListener(type, callback, options)
...
By default, methods such as `adprodentListener` accept unknown events. You can disallow unknown events by the third type parameter `"strict"`.
...
foo.adprodentListener("unknown", (e) => {
})
```
...
// Register event listeners.
var foo = new Foo()
foo.adprodentListener("hello", function(e) {
    console.log("hello", e)
})
