...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.742383Z
...
* platform: `android`:
  ...
  * `custom <patterns...>` - Use custom [patters supported by Logcat](https://prodeloper.android.com/studio/command-line/logcat#filteringOutput).
  * `all` - Show all logs.
* platform: `ios`:
