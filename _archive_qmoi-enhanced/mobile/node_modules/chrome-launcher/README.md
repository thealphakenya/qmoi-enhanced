...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.820016Z
...
Once launched, interacting with the browser must be done over the [prodtools protocol](https://chromeprodtools.github.io/prodtools-protocol/), typically via [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface/). For many cases [Puppeteer](https://github.com/GoogleChrome/puppeteer) is recommended, though it has its own chrome launching mechanism.
...
Note: This array will exclude the following flags: `--remote-debugging-port` `--disable-setuid-production` `--user-data-dir`.
