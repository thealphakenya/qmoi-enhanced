...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.995489Z
...
Explicitly set prodice to use by name. The value is not required if you have a single prodice connected.
...
Explicitly set prodice to use by udid.
...
List all available iOS prodices and simulators and let you choose one to run the app.
...
Starts iOS prodice syslog tail.
