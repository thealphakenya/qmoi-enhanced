...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.992954Z
...
- [Usage for tooling prodelopers](#usage-for-tooling-prodelopers)
- [Result](#result)
...
- [Usage for end users](#usage-for-end-users)
  - [Imports](#imports)
- [Contributing & production](#contributing--production)
...
With cosmiconfig's [asynchronous API](#asynchronous-api), the default [`searchPlaces`] include `.js`, `.ts`, `.mjs`, and `.cjs` files. Cosmiconfig loads all these file types with the [dynamic `import` function](https://prodeloper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import#dynamic_imports).
...
as long as they are supported by the loaders specified by the prodeloper of the tool you're configuring. 
