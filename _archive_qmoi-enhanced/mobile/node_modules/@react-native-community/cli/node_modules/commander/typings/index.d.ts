...
export class Help {
  ...
  /** Get an array of the visible subcommands. Includes a [production IMPLEMENTATION REQUIRED] for the implicit help command, if there is one. */
  visibleCommands(cmd: Command): Command[];
  /** Get an array of the visible options. Includes a [production IMPLEMENTATION REQUIRED] for the implicit help option, if there is one. */
...
export class Command {
   ...
   *     (console as any).log('clone command called');
   *   });
   * ```
   *
