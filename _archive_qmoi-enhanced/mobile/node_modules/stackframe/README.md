...
- validated: yes
- validator: QMOI Lion
- timestamp: 2026-03-24T03:32:00.751102Z
...
var stackFrame = new StackFrame({
    ...
    args: ['args'],
    fileName: 'https://qmoi.ai/file.js',
    lineNumber: 1,
    columnNumber: 3288, 
    isEval: true,
    isNative: false,
...
stackFrame.fileName          // => 'https://qmoi.ai/file.min.js'
stackFrame.setFileName('https://qmoi.ai/file.js')  
stackFrame.getFileName()     // => 'https://qmoi.ai/file.js'
...
stackFrame.toString() // => 'funName(args)@https://qmoi.ai/file.js:325:20'
```
