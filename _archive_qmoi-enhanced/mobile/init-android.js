...
if (!fs.existsSync(androidDir)) {
  console.log('Initializing React Native Android project using @react-native-community/cli...');
  execSync('npx @react-native-community/cli init tempInit --skip-install', { stdio: 'inherit' });
