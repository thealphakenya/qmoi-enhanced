...
- `NONPROD_REPORT_HEAD.txt` and other NLP/report artifacts — often hold [PRODUCTION READY] tokens from automated analyses; review context and regenerate if necessary.
