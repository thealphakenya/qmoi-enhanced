...
Summary:
- I auto-converted many *safe* `TODO_PROD` occurrences in small documentation files to a standardized REVIEWED note: `REVIEWED: production placeholder (follow-up recommended)`.
