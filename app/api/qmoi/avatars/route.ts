...
export async function GET() {
  try {
    ...
    console.error("Error fetching avatars:", _error);
    return NextResponse.json(
...
export async function POST(_request: NextRequest) {
  try {
    ...
    console.error("Error in avatars API:", _error);
    return NextResponse.json(
...
async function switchAvatar(avatarId: string) {
  try {
    ...
    console.error("Error switching avatar:", _error);
    return NextResponse.json(
...
async function upgradeAvatar(avatarId: string) {
  try {
    ...
    console.error("Error upgrading avatar:", _error);
    return NextResponse.json(
...
async function enhanceAvatar(
  ...
  try {
    ...
    console.error("Error enhancing avatar:", _error);
    return NextResponse.json(
...
async function customizeAvatar(avatarId: string, voiceProfile: string) {
  try {
    ...
    console.error("Error customizing avatar:", _error);
    return NextResponse.json(
