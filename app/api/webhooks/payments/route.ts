...
function verifyWebhookSignature(
  ...
  // production (development/testing). In production, a required secret is
  ...
  if (!secret) {
    ...
    logger.warn(
      "WEBHOOK_SIGNING_SECRET not configured — accepting unsigned webhooks in non-production mode",
    );
    return true;
  }
