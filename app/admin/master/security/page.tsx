...
export default function AdminMasterSecurityPage() {
  return (
    <main className="min-h-screen bg-slate-900 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-8">Security Settings</h1>
        <p className="text-slate-300 mb-8">Manage security policies and configurations</p>
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <input type="checkbox" className="w-4 h-4" checked={true} readOnly />
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              <span className="text-slate-300">Encryption at Rest</span>
              <input type="checkbox" className="w-4 h-4" checked={true} readOnly />
            </div>
          </div>
        </div>
