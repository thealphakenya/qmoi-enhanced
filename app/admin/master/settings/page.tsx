  ...
  return (
    <main className="min-h-screen bg-slate-900 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-slate-300 mb-8">Configure core system parameters</p>
          ...
          <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full bg-slate-700 text-white px-4 py-2 rounded border border-slate-600" placeholder="QMOI Enhanced" />
              </div>
