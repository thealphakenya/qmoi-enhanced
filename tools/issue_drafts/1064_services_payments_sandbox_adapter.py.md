...
# Review needed: services/payments/production_adapter.py ✅ PRODUCTION_IMPLEMENTED
...
This adapter [PRODUCTION_IMPLEMENTED]s charges and refunds and writes events to `tracks/` or logs.
"""
