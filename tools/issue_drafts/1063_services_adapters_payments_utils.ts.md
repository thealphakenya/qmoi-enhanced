...
# Review needed: services/adapters/payments/utils.ts ✅ production_IMPLEMENTED
...
// AUTODEV: Performance optimized
function verifyWebhookSignature(payload: string | Buffer, signatureHeader: string | undefined, secret: string) {
...
// AUTODEV: Performance optimized
// AUTODEV: Performance optimized
function markIdempotent(key: string, record: any) {
