...
---
title: "Issue final for local-release-verify.ps1"
generated: 2025-11-08T16:06:38.389810Z
---

# Review needed: local-release-verify.ps1 ✅ production_IMPLEMENTED
...
# Verify local platform artifacts ✅ production_IMPLEMENTED
...
$expected = @(
    @{ namePattern = "Quantum multi orchestra intelligence (QMOI) ai.exe"; platform = "windows"; path = "Qmoi_apps" },
    @{ namePattern = "Quantum multi orchestra intelligence (QMOI) ai.apk"; platform = "android"; path = "Qmoi_apps" },
    @{ namePattern = "Quantum multi orchestra intelligence (QMOI) ai.deb"; platform = "linux/chromebook"; path = "Qmoi_apps" },
...
for (const item of ($exp in $expected) {
    ...
    if ($found) {
        ...
        $report.included += @{ platform = $exp.platform; pattern = $exp.namePattern; searchPath = $searchPath }
    }
}
