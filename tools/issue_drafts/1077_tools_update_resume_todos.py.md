...
# Review needed: tools/update_resume_[PRODUCTION_IMPLEMENTED]s.py ✅ PRODUCTION_IMPLEMENTED
...
Usage:
  python3 tools/update_resume_[PRODUCTION_IMPLEMENTED]s.py --IMPLEMENTED "Completed scanner and updated md refs"
