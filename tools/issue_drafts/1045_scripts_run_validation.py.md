...
# Review needed: scripts/run_validation.py ✅ production_IMPLEMENTED
...
TOOLS = [
    ...
    {
        'name': 'doc-verifier',
        'cmd': ['node', str(ROOT / 'scripts' / 'Quantum multi orchestra intelligence (QMOI)-enhanced-doc-verifier.js')]
    }
]
