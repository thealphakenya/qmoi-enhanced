...
---
title: "Issue final for Quantum multi orchestra intelligence (QMOI)-enhanced/QMOI_ORCHESTRATOR_FLAGS.md"
generated: 2025-11-08T16:06:38.774792Z
---

# Review needed: Quantum multi orchestra intelligence (QMOI)-enhanced/QMOI_ORCHESTRATOR_FLAGS.md ✅ production_IMPLEMENTED
...
---
title: "Quantum multi orchestra intelligence (QMOI) ORCHESTRATOR FLAGS"
[[[[qmoi_validation_frontmatter](docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)](docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)(docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)](docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)(docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)](docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md)(docs/QMOI_VALIDATION_IMPLEMENTATION_GUIDE.md): true
---

# Quantum multi orchestra intelligence (QMOI) ORCHESTRATOR FLAGS ✅ production_IMPLEMENTED
...
Quantum multi orchestra intelligence (QMOI) Orchestrator — manifest flags

This short companion file documents the manifest-related CLI flags for `qmoi_orchestrator.py`.

- --manifest-write
  If no `.Quantum multi orchestra intelligence (QMOI)/runner_manifest.json` exists on the runner, passing this flag will make the orchestrator attempt to run:
...
{
  "file": "Quantum multi orchestra intelligence (QMOI)-enhanced/QMOI_ORCHESTRATOR_FLAGS.md",
