...
def main():
    ...
    # Inspect matches.json if present
    matches_file = ROOT / 'matches.json'
    if matches_file.exists():
        try:
            d = json.loads(matches_file.read_text(encoding='utf-8'))
            report.append(f'- matches.json parsed: {len(d)} entries')
        except Exception as e:
            report.append(f'- matches.json parse error: {e}')
    else:
        report.append('- matches.json missing')
    ...
    if list_out is None:
        report.append('## Jest listTests failed for all candidates')
        report.append('```')
...
# AUTOFIXED by Ollama at 2026-07-26T18:54:41.386372Z

# AUTOFIXED by Ollama at 2026-07-26T18:57:34.425831Z

# AUTOFIXED by Ollama at 2026-07-26T19:31:06.645458Z

# AUTOFIXED by Ollama at 2026-07-26T19:39:17.645587Z
