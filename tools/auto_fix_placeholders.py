#!/usr/bin/env python3
"""
Auto-fix helper (DRY-RUN) for TBD matches.
...
def produce_edits(matches):
    ...
    for rel, entries in by_file.items():
        ...
        for e in entries:
            ...
            if re.search(r"\bpass\b", window) and re.search(r"TODO|FIXME|TBD|REPLACE_ME|prototype|dev only|not for production|mock", window, re.I):
                raise NotImplementedError('Production implementation required')
