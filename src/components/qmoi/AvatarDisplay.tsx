...
export function AvatarDisplay({
  ...
  const renderDefaultAvatar = () => {
    ...
    return (
      ...
      >
        ...
        <div className="text-white text-sm font-medium mt-2">{avatar.name}</div>
      </div>
    );
  };
  ...
  const renderThreeJSAvatar = () => {
    ...
    const emoji =
      animalEmoji[avatar.id as keyof typeof animalEmoji] || animalEmoji.default;
  ...
  const renderEVA3DAvatar = () => {
    ...
    return (
      ...
      >
        ...
        <div className="text-white text-lg font-bold">{avatar.name}</div>
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <div className="text-white text-sm mb-3">{avatar.description}</div>
          ...
          <div className="text-white text-xs mb-3">
            Engine: {avatar.animationEngine.replace("-", " ")}
          </div>
