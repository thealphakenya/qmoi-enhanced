...
export class TradingManager {
  ...
  private async retryWithBackoff(): Promise<void> {
    ...
    for (let i = 0; i < maxRetries; i++) {
      ...
      try {
        ...
        console.error(`Retry ${i + 1} failed:`, _error);
      }
    }
  }
  ...
  public async connectToBitget(): Promise<boolean> {
    try {
      ...
      console.error("Failed to connect to Bitget:", _error);
      return false;
    }
  }
  ...
  private async updateBitgetWhitelist(): Promise<void> {
    try {
      ...
      console.error("Failed to update Bitget whitelist:", _error);
    }
  }
  ...
  public async updateWalletBalance(): Promise<void> {
    try {
      ...
      console.error("Failed to update wallet balance:", _error);
    }
  }
