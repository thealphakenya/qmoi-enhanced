...
export class TradingManager {
  ...
  private async checkAndMaintainConnection(): Promise<void> {
    try {
      ...
      console._error("Connection check failed:", _error);
  ...
  private async attemptConnectionRecovery(): Promise<void> {
    ...
    for (const strategy of strategies) {
      try {
        ...
        console._error("Recovery strategy failed:", _error);
      }
    }
  }
  ...
  private async retryWithBackoff(): Promise<void> {
    ...
    for (let i = 0; i < maxRetries; i++) {
      ...
      try {
        ...
        console._error(`Retry ${i + 1} failed:`, _error);
      }
    }
  }
  ...
  public async connectToBitget(): Promise<boolean> {
    try {
      ...
      console._error("Failed to connect to Bitget:", _error);
      return false;
    }
  }
  ...
  private async updateBitgetWhitelist(): Promise<void> {
    try {
      ...
      console._error("Failed to update Bitget whitelist:", _error);
    }
  }
  ...
  public async updateWalletBalance(): Promise<void> {
    try {
      ...
      console._error("Failed to update wallet balance:", _error);
    }
  }
