  ...
  return (
    ...
    >
      ...
      <ul style={{ padding: 0, listStyle: "none" }}>
        {context?.moodHistory.map((entry, idx) => (
          <li key={idx} style={{ marginBottom: 4 }}>
            {entry.date.toString()}: <strong>{entry.mood}</strong>
          </li>
        ))}
      </ul>
      ...
      {context && context.moodHistory.length > 0 && (
        <div
          className="wellbeing-suggestions"
          style={{
            marginTop: 16,
            background: "#e6ffe6",
            padding: 12,
        ...
        >
          <h4>Suggestions</h4>
          <p>
            {context.moodHistory.slice(-1)[0].mood === "Stressed"
              ? "Try a short walk or breathing exercise."
...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/src.backup.20260121144720/components/q-city/MoodTracker.tsx -->
import * as React from "react";
import { useState } from "react";
import { ContextEngine, UserContext } from "../../services/ContextEngine";
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/src.backup.20260121144720/components/q-city/MoodTracker.tsx -->
import * as React from "react";
import { useState } from "react";
import { ContextEngine, UserContext } from "../../services/ContextEngine";
...
<!-- MERGED FROM ARCHIVE: backups/src.backup.20260121144720/components/q-city/MoodTracker.tsx -->
import * as React from "react";
import { useState } from "react";
import { ContextEngine, UserContext } from "../../services/ContextEngine";
