...
<!-- MERGED FROM ARCHIVE: /workspaces/qmoi-enhanced/backups/src.backup.20260121144720/config/assets.ts -->
export interface Asset {
  type: "spot" | "futures" | "otc";
  currency: string;
  balance: number;
...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/src.backup.20260121144720/config/assets.ts -->
export interface Asset {
  type: "spot" | "futures" | "otc";
  currency: string;
  balance: number;
...
<!-- MERGED FROM ARCHIVE: backups/src.backup.20260121144720/config/assets.ts -->
export interface Asset {
  type: "spot" | "futures" | "otc";
  currency: string;
  balance: number;
