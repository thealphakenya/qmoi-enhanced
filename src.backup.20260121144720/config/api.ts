...
<!-- MERGED FROM ARCHIVE: /home/runner/work/qmoi-enhanced/qmoi-enhanced/backups/src.backup.20260121144720/config/api.ts -->
/**
 * Centralized API configuration for production and development environments.
 * Adapters and components import from this file to get the correct base URL and endpoints.
 */
...
<!-- MERGED FROM ARCHIVE: backups/src.backup.20260121144720/config/api.ts -->
/**
 * Centralized API configuration for production and development environments.
 * Adapters and components import from this file to get the correct base URL and endpoints.
 */
