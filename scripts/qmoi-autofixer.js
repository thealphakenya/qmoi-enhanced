...
const APPS = [
  { name: 'QMOI Android APK', file: 'Qmoi_apps/android/qmoi ai.apk', minSizeMB: 30 },
  { name: 'QMOI Windows EXE', file: 'Qmoi_apps/windows/qmoi_ai.exe', minSizeMB: 45 },
  { name: 'QMOI macOS (Intel)', file: 'Qmoi_apps/macos/qmoi_mac_intel.app', minSizeMB: 60 },
  { name: 'QMOI macOS (ARM)', file: 'Qmoi_apps/macos/qmoi_mac_arm.app', minSizeMB: 60 },
  { name: 'QMOI iOS IPA', file: 'Qmoi_apps/ios/qmoi_ai.ipa', minSizeMB: 50 },
  { name: 'QMOI Linux x64', file: 'Qmoi_apps/linux/qmoi_linux_x64.AppImage', minSizeMB: 40 },
  { name: 'QMOI RaspberryPi', file: 'Qmoi_apps/pi/qmoi_pi_armv7l', minSizeMB: 35 },
  { name: 'QMOI Chromebook', file: 'Qmoi_apps/chromebook/qmoi_chrome.crx', minSizeMB: 15 },
  { name: 'QMOI QCity OS', file: 'Qmoi_apps/qcity/qmoi_qcity.pkg', minSizeMB: 50 }
];
...
function validateApp(app) {
  ...
  if (sizeMB < app.minSizeMB * 0.9) {
    console.warn(`⚠️ SIZE WARNING: ${app.name} is too small (${sizeMB.toFixed(2)} MB, expected ≥ ${app.minSizeMB} MB)`);
  } else {
