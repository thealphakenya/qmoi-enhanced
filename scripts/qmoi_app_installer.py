...
class QMOIAppInstaller:
    ...
    def get_install_directory(self) -> str:
        ...
        if self.platform == "windows":
            return os.path.join(
                os.environ.get("PROGRAMFILES", "C:\\Program Files"), "QMOI AI"
            )
    ...
    def setup_notifications(self, platform_type: str):
        ...
        if platform_type == "windows":
            ...
            notification_config.update(
                {"notification_center": True, "dock_badge": True, "menu_bar": True}
            )
        elif platform_type == "linux":
            notification_config.update(
                {
    ...
    def setup_network_auto_connection(self, platform_type: str):
        ...
        network_config = {
            "auto_connect": True,
            "preferred_networks": ["QMOI-Network", "QMOI-5G", "QMOI-WiFi"],
            "fallback_networks": ["Any available WiFi", "Mobile data", "Ethernet"],
            "connection_priority": ["WiFi", "Ethernet", "Mobile data", "Bluetooth"],
            "auto_switch": True,
