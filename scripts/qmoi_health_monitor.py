...
class QMOIHealthMonitor:
        ...
        for service in services:
            try:
                ...
                self.health_report["errors"].append(
                    f"Service check failed for {service}: {str(e)}"
                )
    ...
    def check_api_endpoints(self):
        ...
        for endpoint in endpoints:
            try:
                ...
                self.health_report["errors"].append(
                    f"API endpoint {endpoint} check failed: {str(e)}"
                )
        ...
        try:
            ...
            if revenue_data:
                ...
                self.health_report["services"]["revenue_system"] = {
                    "status": (
                        "healthy" if daily_revenue >= target_revenue else "warning"
                    ),
            ...
            self.health_report["errors"].append(
                f"Revenue health check failed: {str(e)}"
            )
        ...
        try:
            ...
            if employment_data:
                ...
                self.health_report["services"]["employment_system"] = {
                    ...
                    "fill_rate": (
                        (active_employees / total_positions) * 100
            ...
            self.health_report["errors"].append(
                f"Employment health check failed: {str(e)}"
            )
    ...
    def generate_health_score(self):
        ...
        stopped_services = sum(
            1
            for service in self.health_report["services"].values()
    ...
    def save_health_report(self):
        ...
        try:
            ...
            self.logger.info(
                f"Health report saved. Score: {self.health_report['health_score']}"
            )
    ...
    def run_health_check(self):
        ...
        try:
            ...
            # Log results
            self.logger.info(
                f"Health check completed. Status: {self.health_report['system_status']}"
            )
