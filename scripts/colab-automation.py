    ...
    def setup_colab_environment(self):
        ...
        try:
            ...
            if self.is_colab:
                ...
                packages = ["torch", "tensorflow", "transformers", "accelerate"]
...
"""
    ...
    def run_ml_training(self):
        ...
        try:
            ...
            training_scripts = list(self.project_root.rglob("*training*.py")) + list(
                self.project_root.rglob("*train*.py")
            )
...
"""
            ...
            subprocess.run(
                ["python", "performance_optimization.py"], cwd=self.project_root
            )
