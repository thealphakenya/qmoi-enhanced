...
def apply_direct_fixes():
    ...
    replacements = [
        ...
        (r'NotImplementedError\(\)', r'raise RuntimeError("Production implementation required")'),
        (r'NotImplemented\(\)', r'raise RuntimeError("Production implementation required")'),
        (r'pass\s*# IMPLEMENTED: ', r'raise NotImplementedError("Production implementation required")'),
