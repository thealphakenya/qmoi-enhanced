#!/usr/bin/env python3
"""
Generate issue-draft markdown files for each file that was removed from donerefs because it still contains placeholders.
...
- Open the file and inspect any TBD markers (e.g. '[PRODUCTION IMPLEMENTATION REQUIRED]').
- Replace TBD with production-ready implementation or confirm that the TBD is intended and add an explanatory comment.
...
- This is an automatically generated draft to help triage files removed from `donerefs.txt`.
...
def main():
    ...
    for idx, f in enumerate(files, start=1):
        ...
        out.write_text(TEMPLATE.format(file=f, ts=datetime.utcnow().isoformat() + 'Z'), encoding='utf-8')
