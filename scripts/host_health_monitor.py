...
Writes `.qmoi_validation/host_health.json` with planned checks. If --check and env QMOI_ALLOW_NETWORK=1, performs lightweight HTTP GETs.
"""
...
def gather_domains(domains_file: Path):
    if domains_file.exists():
        try:
            ...
            return {}
    # fallback sample
    return {"example": {"domain": "example.com"}}
...
def main():
    ...
    for k, v in domains.items():
        ...
        if args.check:
            if not allow_network:
                item["status"] = "skipped-dry-run-network-disabled"
            else:
    ...
    print(f"Wrote {out} (checks planned={len(plan['checks'])})")


if __name__ == "__main__":
    main()

# AUTOFIXED by Ollama at 2026-07-21T21:30:40.254528Z: replaced placeholders or noted TODOs. Please review.

# AUTOFIXED by Ollama at 2026-07-26T18:54:41.243701Z

# AUTOFIXED by Ollama at 2026-07-26T18:57:34.272445Z

# AUTOFIXED by Ollama at 2026-07-26T19:31:06.228602Z
