...
if not API_FILE.exists():
    print(f"Missing {API_FILE}. Run: curl -H 'Authorization: token $GITHUB_TOKEN' https://api.github.com/repos/thealphakenya/qmoi-enhanced/releases > {API_FILE}")
    sys.exit(2)
