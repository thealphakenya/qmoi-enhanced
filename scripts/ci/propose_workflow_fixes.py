...
- List required secrets and a sample `gh secret set` command for bootstrapping.
...
# Simple heuristic mapping for common actions to recommended pinned versions
PIN_RECOMMENDATIONS = {
    ...
    for p in proposals['proposals']:
        ...
        for r in p['recommendations']:
            if r['type'] == 'pin-action':
                md.append(f"- Pin `{r['action']}` to `{r['recommended']}`. Locations: {', '.join(str(l['line']) for l in r['locations']) if r['locations'] else 'unknown'}\n")
...
# AUTOFIXED by Ollama at 2026-07-26T18:54:41.217715Z

# AUTOFIXED by Ollama at 2026-07-26T18:57:34.251294Z

# AUTOFIXED by Ollama at 2026-07-26T19:31:06.194073Z
