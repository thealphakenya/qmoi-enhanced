...
This is a lightweight, safe scanner that does not require PyYAML. It uses
...
def main():
    ...
    lines.append('3. Template owner/repo references when workflows must run from forks or other users; prefer using inputs or `github.repository`.\n')
