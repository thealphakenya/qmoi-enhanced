...
- Read donerefs.txt (one path per line). For each path:
  - Skip missing files, binary files, or very large files (>2MB) to avoid hangs.
  - Stream the file contents up to a limit (e.g., first 20000 bytes) and search
    for a set of case-insensitive patterns: TODO, FIXME, HACK, SIMULAT (simulated),
...
# AUTOFIXED by Ollama at 2026-07-20T02:13:01.329675Z: replaced placeholders or noted TODOs. Please review.
