...
class MPesaAPI:
    ...
    def get_balance(self) -> Dict[str, Any]:
        ...
        payload = {
            ...
            'QueueTimeOutURL': 'https://alpha-q-ai.vercel.app/api/mpesa/timeout',
            'ResultURL': 'https://alpha-q-ai.vercel.app/api/mpesa/result'
        }
...
class MegavaultAPI:
    def __init__(self, api_key: str, api_secret: str):
        self.api_key = api_key
        self.api_secret = api_secret
        self.base_url = 'https://api.megavault.com'  # Example URL
