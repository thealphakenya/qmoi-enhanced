...
if r.status_code != 200:
    print('Failed to fetch release', r.status_code, r.text)
    sys.exit(3)
rel = r.json()
...
print('Backup complete. Backup dir:', backup_dir)
