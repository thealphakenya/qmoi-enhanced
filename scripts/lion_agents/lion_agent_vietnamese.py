...
class VietnameseLionAgent:
    """
    Vietnamese Lion Agent
    ...
    def __init__(self, name: str = "vietnamese", enable_validation: bool = True):
        self.name = name
