...
class BusinessLionAgent:
    """
    Business Lion Agent
    
    Specialization: English Language Support
    Capabilities:
    ...
    def __init__(self, name: str = "business", enable_validation: bool = True):
        self.name = name
