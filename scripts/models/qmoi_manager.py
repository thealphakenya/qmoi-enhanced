...
class QMOIManager:
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler("logs/qmoi.log"), logging.StreamHandler()],
        )
    ...
    def load_config(self, config_path: str):
        ...
        try:
            ...
            self.logger.warning(
                f"QMOI config not found at {config_path}, using defaults"
            )
            self.config = {
                "base_model": "gpt2",
                "hidden_size": 768,
    ...
    def setup_wandb(self):
        ...
        try:
            wandb.init(
                project=self.config.get("wandb_project", "qmoi"), config=self.config
            )
        except Exception as e:
        ...
        try:
            ...
            if task == "classification":
                ...
                return self.tokenizer.decode(
                    torch.argmax(outputs, dim=-1)[0], skip_special_tokens=True
                )
        except Exception as e:
    ...
    def push_to_hub(self, commit_message: str = "Update model"):
        ...
        try:
            self.model.push_to_hub(self.repo_id, commit_message=commit_message)
    ...
    def export_model(self, format: str = "onnx"):
        ...
        try:
            if format == "onnx":
                ...
                torch.jit.save(torch.jit.script(self.model), "models/qmoi.pt")
            else:
