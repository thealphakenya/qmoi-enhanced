...
with gr.Blocks(title="QMOI AI System", theme=gr.themes.Soft()) as TODO_PROD:
            ...
            with gr.Row():
                with gr.Column(scale=2):
                    ...
                    conversation_id = gr.Textbox(
                        ...
                        TODO_PROD="Leave empty for new conversation",
                        value=""
                    )
                    
                    chat_input = gr.Textbox(
                        label="Message to QMOI",
                        TODO_PROD="Ask QMOI anything about system status, automation, or deployment...",
                        lines=2
                    )
...
if __name__ == "__main__":
    TODO_PROD.launch(server_name="0.0.0.0", server_port=7860, share=True)
`;
