...
function checkDeployment(): any {
  ...
  if (appStatus === 200) {
    ...
    log("yellow", "⏳", "Status", "DEPLOYMENT COMPLETE (3-6 minutes)");
    logger.info(
  ...
  logger.info("   Dashboard: https://vercel.com/thestablekenya/qmoi-enhanced");
  logger.info("   GitHub: https://github.com/thestablekenya/qmoi-enhanced");
