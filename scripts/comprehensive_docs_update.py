...
"""
    scan_api_endpoints function
    """
def scan_api_endpoints() -> Any:
...
"""
    parse_route_file function
    """
def parse_route_file(route_file, base) -> Any:
...
"""
    scan_test_files function
    """
def scan_test_files() -> Any:
    """Scan all test files"""
    tests = []
...
"""
    generate_api_md function
    """
def generate_api_md(endpoints) -> Any:
...
"""
    generate_endpoints_md function
    """
def generate_endpoints_md(endpoints) -> Any:
...
"""
    generate_allmdfiles_ref function
    """
def generate_allmdfiles_ref(md_files) -> Any:
...
"""
    generate_alltests_md function
    """
def generate_alltests_md(tests) -> Any:
...
"""
    generate_hooks_md function
    """
def generate_hooks_md(hooks) -> Any:
...
"""
    scan_webhooks function
    """
def scan_webhooks(endpoints) -> Any:
    """Scan webhook-related endpoints from the API endpoint list"""
    return [ep for ep in endpoints if 'webhook' in ep['path'].lower()]


"""
    generate_webhooks_md function
    """
def generate_webhooks_md(webhooks) -> Any:
...
"""
    generate_allhooks_webhooks_md function
    """
def generate_allhooks_webhooks_md(hooks, webhooks) -> Any:
...
"""
    scan_lib_directory function
    """
def scan_lib_directory() -> Any:
...
"""
    generate_lib_md function
    """
def generate_lib_md(lib_files) -> Any:
...
def main() -> Any:
    ...
    logger.info("\n🪝 Scanning hooks...")
    hooks = scan_hooks()
    logger.info(f"   ✅ Found {len(hooks)} custom hooks")
    
    # Scan webhooks
    logger.info("\n🌐 Scanning webhooks...")
    webhooks = scan_webhooks(endpoints)
    logger.info(f"   ✅ Found {len(webhooks)} webhook endpoints")
    ...
    logger.info(f"   ✅ Updated ENDPOINTS.md")
    ...
    logger.info(f"   ✅ Updated ALLMDFILESREFS.md")
    ...
    logger.info(f"   ✅ Updated WEBHOOKS.md")
    ...
    logger.info(f"   ✅ Updated ALLHOOKSWEBHOOKS.md")
    ...
    logger.info(f"  • Test Files: {len(tests)}")
    logger.info(f"  • Custom Hooks: {len(hooks)}")
    logger.info(f"  • Lib Files: {len(lib_files)}")
    logger.info(f"  • Documentation Files: {len(md_files)}")
    logger.info(f"  • Files Updated: 10 (API.md, ENDPOINTS.md, ALLMDFILESREFS.md, ALLTESTSAUTOTESTS.md, HOOKS.md, WEBHOOKS.md, ALLHOOKSWEBHOOKS.md, TREE.md, LIB.md)")
