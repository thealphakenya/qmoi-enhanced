...
- Adapters:
  ...
  - `TestnetAdapter` — TBD: See PLACEHOLDER_REMEDIATION_PLAN.md (TBD: replace with production content; see PLACEHOLDER_REMEDIATION_PLAN.md) for real testnet SDK integrations; returns mock if no credentials.
