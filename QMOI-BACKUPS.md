...
This document provides an overview and maintenance instructions for the `qmoi-backups/` directory.

## Purpose

Document the purpose of the `qmoi-backups` directory and the key files it contains.
