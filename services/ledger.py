"""Minimal SQLite-backed ledger scaffold for QMOI.

Design goals:
"""Lightweight ledger scaffold for QMOI.

Provides a minimal SQLite-backed ledger with approval and query helpers.
This implementation is intended for local/staging use and safe review before
production extension. It exposes a simple `Ledger` class with methods:
  - init_db()
  - record_transaction(...)
  - set_approved(tx_id, approver)
  - get_balance(account)
